...
"""Tellurium-backed SBML BioModule wrapper for Kim2011_Oscillator_DetailedII."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Kim2011OscillatorDetailediiModel1012090003Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Kim2011_Oscillator_DetailedII."""

    _SBML_ID = 'MODEL1012090003'
    _TITLE = 'Kim2011_Oscillator_DetailedII'
    _TIME_UNIT = "model_time"
    _OBSERVABLE_STRATEGY = 'species'
    _OBSERVABLES = ['species_1', 'species_2', 'species_3', 'species_4', 'species_5', 'species_6', 'species_7', 'species_8', 'species_9', 'species_10', 'species_11', 'species_12', 'species_13', 'species_14', 'species_15', 'species_16', 'species_17', 'species_18', 'species_19', 'species_20', 'species_21', 'species_22', 'species_23', 'species_24']
    ...
    def __init__(self, model_path: str = 'data/MODEL1012090003.xml', integration_step: float = 0.1) -> None:
