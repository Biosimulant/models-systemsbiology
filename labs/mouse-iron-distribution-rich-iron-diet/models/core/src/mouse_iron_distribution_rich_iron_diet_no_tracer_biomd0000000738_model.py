...
"""Tellurium-backed SBML BioModule wrapper for Mouse Iron Distribution - Rich iron diet (No Tracer)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class MouseIronDistributionRichIronDietNoTracerBiomd0000000738Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mouse Iron Distribution - Rich iron diet (No Tracer)."""

    _SBML_ID = 'BIOMD0000000738'
    _TITLE = 'Mouse Iron Distribution - Rich iron diet (No Tracer)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000738.xml', integration_step: float = 0.1) -> None:
