...
"""Tellurium-backed SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelC."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Waugh2006WoundhealingDiabeticModelcModel1006230099Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Waugh2006_WoundHealing_Diabetic_ModelC."""

    _SBML_ID = 'MODEL1006230099'
    _TITLE = 'Waugh2006_WoundHealing_Diabetic_ModelC'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230099.xml', integration_step: float = 0.1) -> None:
