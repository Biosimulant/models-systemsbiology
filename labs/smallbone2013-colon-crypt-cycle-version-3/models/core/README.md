...
Smallbone2013 - Colon Crypt cycle - Version 3 This model is described in the article: A mathematical model of the colon crypt capturing compositional dynamic interactions between cell types Kieran Sma. It can be used to explore systemsbiology smallbone2013 colon crypt cycle version dynamics and compare simulation behavior across conditions.

## Source

- Source ID: `BIOMD0000000517`
- Source database: `biomodels_ebi`
- Original URL: https://www.ebi.ac.uk/biomodels/BIOMD0000000517

## Biosimulant Layout

- Lab: `labs/smallbone2013-colon-crypt-cycle-version-3`
