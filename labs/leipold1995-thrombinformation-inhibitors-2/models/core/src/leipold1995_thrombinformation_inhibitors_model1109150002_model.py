...
class Leipold1995ThrombinformationInhibitorsModel1109150002Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Leipold1995_ThrombinFormation+inhibitors."""

    _SBML_ID = 'MODEL1109150002'
