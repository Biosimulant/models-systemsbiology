...
class Musante2017SwitchingBehaviourOfPp2aInhibitiBiomd0000000644Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000644.xml', integration_step: float = 0.1) -> None:
