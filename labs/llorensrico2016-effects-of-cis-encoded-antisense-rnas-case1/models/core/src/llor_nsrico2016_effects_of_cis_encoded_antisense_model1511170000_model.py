...
"""Tellurium-backed SBML BioModule wrapper for LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case1."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class LlorNsrico2016EffectsOfCisEncodedAntisenseModel1511170000Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case1."""

    _SBML_ID = 'MODEL1511170000'
    _TITLE = 'LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case1'
    ...
    def __init__(self, model_path: str = 'data/MODEL1511170000.xml', integration_step: float = 0.1) -> None:
