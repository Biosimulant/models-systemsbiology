...
"""Tellurium-backed SBML BioModule wrapper for Chickarmane2008 - Stem cell lineage determination."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Chickarmane2008StemCellLineageDeterminationBiomd0000000209Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Chickarmane2008 - Stem cell lineage determination."""

    _SBML_ID = 'BIOMD0000000209'
    _TITLE = 'Chickarmane2008 - Stem cell lineage determination'
    _TIME_UNIT = "model_time"
    _OBSERVABLE_STRATEGY = 'species'
    _OBSERVABLES = ['OCT4_Gene', 'NANOG_Gene', 'SOX2_Gene', 'GATA6_Gene', 'CDX2_Gene', 'GCNF_Gene', 'targetGene', 'degradation', 'p53', 'A', 'SG', 'SN', 'OCT4', 'SOX2', 'NANOG', 'GATA6', 'CDX2', 'GCNF', 'OCT4_SOX2', 'Protein']
    _SPECIES_LABELS = {'OCT4_Gene': 'OCT4 Gene', 'NANOG_Gene': 'NANOG Gene', 'SOX2_Gene': 'SOX2 Gene', 'GATA6_Gene': 'GATA6 Gene', 'CDX2_Gene': 'CDX2 Gene', 'GCNF_Gene': 'GCNF Gene', 'targetGene': 'TargetGene', 'degradation': 'Degradation', 'p53': 'P53', 'A': 'A', 'SG': 'SG', 'SN': 'SN', 'OCT4': 'OCT4', 'SOX2': 'SOX2', 'NANOG': 'NANOG', 'GATA6': 'GATA6', 'CDX2': 'CDX2', 'GCNF': 'GCNF', 'OCT4_SOX2': 'OCT4 SOX2', 'Protein': 'Protein'}
    _PARAMETER_INPUTS = {}
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000209.xml', integration_step: float = 0.1) -> None:
