...
"""Tellurium-backed SBML BioModule wrapper for Mitrophanov2015 - Simulating extended Hockin Blood Coagulation Model under varied pH."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Mitrophanov2015SimulatingExtendedHockinBloodBiomd0000000951Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mitrophanov2015 - Simulating extended Hockin Blood Coagulation Model under varied pH."""

    _SBML_ID = 'BIOMD0000000951'
    _TITLE = 'Mitrophanov2015 - Simulating extended Hockin Blood Coagulation Model under varied pH'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000951.xml', integration_step: float = 0.1) -> None:
