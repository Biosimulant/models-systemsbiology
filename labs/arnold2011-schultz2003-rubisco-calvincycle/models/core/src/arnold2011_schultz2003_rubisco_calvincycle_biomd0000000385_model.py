...
class Arnold2011Schultz2003RubiscoCalvincycleBiomd0000000385Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000385.xml', integration_step: float = 0.1) -> None:
