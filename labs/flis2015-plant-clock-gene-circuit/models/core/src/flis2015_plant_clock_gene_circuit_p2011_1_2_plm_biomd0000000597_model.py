...
"""Tellurium-backed SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.1.2 PLM_71 ver 1)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Flis2015PlantClockGeneCircuitP201112PlmBiomd0000000597Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Flis2015 - Plant clock gene circuit (P2011.1.2 PLM_71 ver 1)."""

    _SBML_ID = 'BIOMD0000000597'
    _TITLE = 'Flis2015 - Plant clock gene circuit (P2011.1.2 PLM_71 ver 1)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000597.xml', integration_step: float = 0.1) -> None:
