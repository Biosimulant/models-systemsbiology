...
"""Tellurium-backed SBML BioModule wrapper for Legewie2006_apoptosis_WT."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Legewie2006ApoptosisWtBiomd0000000102Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Legewie2006_apoptosis_WT."""

    _SBML_ID = 'BIOMD0000000102'
    _TITLE = 'Legewie2006_apoptosis_WT'
    _TIME_UNIT = "model_time"
    _OBSERVABLE_STRATEGY = 'species'
    _OBSERVABLES = ['A', 'C9', 'C9X', 'X', 'AC9X', 'AC9', 'C3', 'C3_star', 'C3_starX', 'C9_starX', 'C9_star', 'AC9_star', 'AC9_starX']
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000102.xml', integration_step: float = 0.1) -> None:
