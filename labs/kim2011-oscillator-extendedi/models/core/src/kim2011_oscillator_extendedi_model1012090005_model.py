...
class Kim2011OscillatorExtendediModel1012090005Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/MODEL1012090005.xml', integration_step: float = 0.1) -> None:
