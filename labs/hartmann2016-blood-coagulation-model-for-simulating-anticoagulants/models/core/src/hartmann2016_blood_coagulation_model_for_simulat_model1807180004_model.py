...
"""Tellurium-backed SBML BioModule wrapper for Hartmann2016 - Blood coagulation model for simulating anticoagulants."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Hartmann2016BloodCoagulationModelForSimulatModel1807180004Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Hartmann2016 - Blood coagulation model for simulating anticoagulants."""

    _SBML_ID = 'MODEL1807180004'
    _TITLE = 'Hartmann2016 - Blood coagulation model for simulating anticoagulants'
