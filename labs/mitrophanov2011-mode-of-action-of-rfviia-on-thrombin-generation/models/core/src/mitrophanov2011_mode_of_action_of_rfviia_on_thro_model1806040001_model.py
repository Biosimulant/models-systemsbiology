...
"""Tellurium-backed SBML BioModule wrapper for Mitrophanov2011 - Mode of action of rFVIIa on thrombin generation (Update to Hockin2002 Blood Coagulation Model)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Mitrophanov2011ModeOfActionOfRfviiaOnThroModel1806040001Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mitrophanov2011 - Mode of action of rFVIIa on thrombin generation (Update to Hockin2002 Blood Coagulation Model)."""

    _SBML_ID = 'MODEL1806040001'
    _TITLE = 'Mitrophanov2011 - Mode of action of rFVIIa on thrombin generation (Update to Hockin2002 Blood Coagulation Model)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1806040001.xml', integration_step: float = 0.1) -> None:
