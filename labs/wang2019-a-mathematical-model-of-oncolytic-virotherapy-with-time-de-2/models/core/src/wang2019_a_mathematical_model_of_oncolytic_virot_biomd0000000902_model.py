...
class Wang2019AMathematicalModelOfOncolyticVirotBiomd0000000902Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Wang2019 - A mathematical model of oncolytic virotherapy with time delay."""

    _SBML_ID = 'BIOMD0000000902'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000902.xml', integration_step: float = 0.1) -> None:
