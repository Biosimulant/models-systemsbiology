...
class Arnold2011Farquhar1980RubiscoCalvincycleBiomd0000000383Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000383.xml', integration_step: float = 0.1) -> None:
