...
"""Tellurium-backed SBML BioModule wrapper for Mears1997_CRAC_PancreaticBetaCells."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Mears1997CracPancreaticbetacellsBiomd0000000375Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mears1997_CRAC_PancreaticBetaCells."""

    _SBML_ID = 'BIOMD0000000375'
    _TITLE = 'Mears1997_CRAC_PancreaticBetaCells'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000375.xml', integration_step: float = 0.1) -> None:
