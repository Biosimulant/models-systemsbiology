...
"""Tellurium-backed SBML BioModule wrapper for Orfeo2010 - Simulating the effects of fondaparinux and Rivaroxaban on thrombin generation."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Orfeo2010SimulatingTheEffectsOfFondaparinuxModel1807240001Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Orfeo2010 - Simulating the effects of fondaparinux and Rivaroxaban on thrombin generation."""

    _SBML_ID = 'MODEL1807240001'
    _TITLE = 'Orfeo2010 - Simulating the effects of fondaparinux and Rivaroxaban on thrombin generation'
    _TIME_UNIT = "model_time"
    _OBSERVABLE_STRATEGY = 'species'
    _OBSERVABLES = ['TF', 'TF_VII', 'VII', 'TF_VIIa', 'VIIa', 'Xa', 'IIa', 'TF_VIIa_X', 'X', 'TF_VIIa_Xa', 'IX', 'TF_VIIa_IX', 'IXa', 'II', 'VIII', 'VIIIa', 'IXa_VIIIa', 'IXa_VIIIa_X', 'VIIIa1_L', 'VIIIa2', 'V', 'Va', 'Xa_Va', 'Xa_Va_II', 'mIIa', 'TFPI', 'Xa_TFPI', 'TF_VIIa_Xa_TFPI', 'ATIII', 'Xa_ATIII', 'mIIa_ATIII', 'IXa_ATIII', 'IIa_ATIII', 'TF_VIIa_ATIII', 'Fpx', 'Riva', 'Riva_Xa', 'Riva_Xa_Va', 'Fpx_ATIII', 'Fpx_ATIII_Xa', 'Fpx_ATIII_IXa', 'Fpx_ATIII_mIIa', 'Fpx_ATIII_TF_VIIa', 'Fpx_ATIII_Xa_Va', 'Fpx_ATIII_IIa']
    _SPECIES_LABELS = {'TF': 'TF', 'TF_VII': 'TF_VII', 'VII': 'VII', 'TF_VIIa': 'TF_VIIa', 'VIIa': 'VIIa', 'Xa': 'Xa', 'IIa': 'IIa', 'TF_VIIa_X': 'TF_VIIa_X', 'X': 'X', 'TF_VIIa_Xa': 'TF_VIIa_Xa', 'IX': 'IX', 'TF_VIIa_IX': 'TF_VIIa_IX', 'IXa': 'IXa', 'II': 'II', 'VIII': 'VIII', 'VIIIa': 'VIIIa', 'IXa_VIIIa': 'IXa_VIIIa', 'IXa_VIIIa_X': 'IXa_VIIIa_X', 'VIIIa1_L': 'VIIIa1_L', 'VIIIa2': 'VIIIa2', 'V': 'V', 'Va': 'Va', 'Xa_Va': 'Xa_Va', 'Xa_Va_II': 'Xa_Va_II', 'mIIa': 'mIIa', 'TFPI': 'TFPI', 'Xa_TFPI': 'Xa_TFPI', 'TF_VIIa_Xa_TFPI': 'TF_VIIa_Xa_TFPI', 'ATIII': 'ATIII', 'Xa_ATIII': 'Xa_ATIII', 'mIIa_ATIII': 'mIIa_ATIII', 'IXa_ATIII': 'IXa_ATIII', 'IIa_ATIII': 'IIa_ATIII', 'TF_VIIa_ATIII': 'TF_VIIa_ATIII', 'Fpx': 'Fpx', 'Riva': 'Riva', 'Riva_Xa': 'Riva:Xa', 'Riva_Xa_Va': 'Riva:Xa_Va', 'Fpx_ATIII': 'Fpx:ATIII', 'Fpx_ATIII_Xa': 'Fpx:ATIII:Xa', 'Fpx_ATIII_IXa': 'Fpx:ATIII:IXa', 'Fpx_ATIII_mIIa': 'Fpx:ATIII:mIIa', 'Fpx_ATIII_TF_VIIa': 'Fpx:ATIII:TF_VIIa', 'Fpx_ATIII_Xa_Va': 'Fpx:ATIII:Xa_Va', 'Fpx_ATIII_IIa': 'Fpx:ATIII:IIa'}
    _PARAMETER_INPUTS = {}
    ...
    def __init__(self, model_path: str = 'data/MODEL1807240001.xml', integration_step: float = 0.1) -> None:
