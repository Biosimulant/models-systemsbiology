...
"""Auto-generated tests for Proctor2008P53Mdm2CircuitP53StablisationByBiomd0000000189Model.
...
from src.proctor2008_p53_mdm2_circuit_p53_stablisation_by_biomd0000000189_model import Proctor2008P53Mdm2CircuitP53StablisationByBiomd0000000189Model  # noqa: E402
...
def test_instantiation() -> None:
    module = Proctor2008P53Mdm2CircuitP53StablisationByBiomd0000000189Model()
...
def test_advance_produces_outputs() -> None:
    module = Proctor2008P53Mdm2CircuitP53StablisationByBiomd0000000189Model(integration_step=0.1)
