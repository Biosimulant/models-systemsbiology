...
"""Tellurium-backed SBML BioModule wrapper for Ehrenstein2000 - Positive-Feedback model for the loss of acetylcholine in Alzheimer's disease."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Ehrenstein2000PositiveFeedbackModelForTheLBiomd0000000552Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Ehrenstein2000 - Positive-Feedback model for the loss of acetylcholine in Alzheimer's disease."""

    _SBML_ID = 'BIOMD0000000552'
    _TITLE = "Ehrenstein2000 - Positive-Feedback model for the loss of acetylcholine in Alzheimer's disease"
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000552.xml', integration_step: float = 0.1) -> None:
