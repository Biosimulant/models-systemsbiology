...
"""Tellurium-backed SBML BioModule wrapper for Phillips2008_AscendingArousalSystem_SleepDeprivation."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Phillips2008AscendingarousalsystemSleepdeprivaModel1006230115Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Phillips2008_AscendingArousalSystem_SleepDeprivation."""

    _SBML_ID = 'MODEL1006230115'
    _TITLE = 'Phillips2008_AscendingArousalSystem_SleepDeprivation'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230115.xml', integration_step: float = 0.1) -> None:
