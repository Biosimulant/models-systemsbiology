...
"""Tellurium-backed SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.6.1 PLM_1044 ver 1)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Flis2015PlantClockGeneCircuitP201161PlmModel1510190005Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Flis2015 - Plant clock gene circuit (P2011.6.1 PLM_1044 ver 1)."""

    _SBML_ID = 'MODEL1510190005'
    _TITLE = 'Flis2015 - Plant clock gene circuit (P2011.6.1 PLM_1044 ver 1)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1510190005.xml', integration_step: float = 0.1) -> None:
