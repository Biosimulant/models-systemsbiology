...
"""Tellurium-backed SBML BioModule wrapper for Koivumaki2009_SERCAATPase_short."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Koivumaki2009SercaatpaseShortModel1006230029Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Koivumaki2009_SERCAATPase_short."""

    _SBML_ID = 'MODEL1006230029'
    _TITLE = 'Koivumaki2009_SERCAATPase_short'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230029.xml', integration_step: float = 0.1) -> None:
