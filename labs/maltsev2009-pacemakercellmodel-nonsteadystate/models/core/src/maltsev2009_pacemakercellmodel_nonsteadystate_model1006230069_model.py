...
"""Tellurium-backed SBML BioModule wrapper for Maltsev2009_PacemakerCellModel_nonSteadyState."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Maltsev2009PacemakercellmodelNonsteadystateModel1006230069Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Maltsev2009_PacemakerCellModel_nonSteadyState."""

    _SBML_ID = 'MODEL1006230069'
    _TITLE = 'Maltsev2009_PacemakerCellModel_nonSteadyState'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230069.xml', integration_step: float = 0.1) -> None:
