...
"""Tellurium-backed SBML BioModule wrapper for Fisher2006_NFAT_Activation."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Fisher2006NfatActivationBiomd0000000123Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Fisher2006_NFAT_Activation."""

    _SBML_ID = 'BIOMD0000000123'
    _TITLE = 'Fisher2006_NFAT_Activation'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000123.xml', integration_step: float = 0.1) -> None:
