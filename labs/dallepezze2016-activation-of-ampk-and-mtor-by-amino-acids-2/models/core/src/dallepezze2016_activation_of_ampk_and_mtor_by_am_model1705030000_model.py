...
"""Tellurium-backed SBML BioModule wrapper for DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 1)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Dallepezze2016ActivationOfAmpkAndMtorByAmModel1705030000Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 1)."""

    _SBML_ID = 'MODEL1705030000'
    _TITLE = 'DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 1)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1705030000.xml', integration_step: float = 0.1) -> None:
