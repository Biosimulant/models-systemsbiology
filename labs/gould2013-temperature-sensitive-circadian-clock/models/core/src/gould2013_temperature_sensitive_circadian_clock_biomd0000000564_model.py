...
"""Tellurium-backed SBML BioModule wrapper for Gould2013 - Temperature Sensitive Circadian Clock."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Gould2013TemperatureSensitiveCircadianClockBiomd0000000564Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Gould2013 - Temperature Sensitive Circadian Clock."""

    _SBML_ID = 'BIOMD0000000564'
    _TITLE = 'Gould2013 - Temperature Sensitive Circadian Clock'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000564.xml', integration_step: float = 0.1) -> None:
