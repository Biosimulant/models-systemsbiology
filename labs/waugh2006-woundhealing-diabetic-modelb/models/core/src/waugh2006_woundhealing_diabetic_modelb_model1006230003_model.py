...
"""Tellurium-backed SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelB."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Waugh2006WoundhealingDiabeticModelbModel1006230003Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Waugh2006_WoundHealing_Diabetic_ModelB."""

    _SBML_ID = 'MODEL1006230003'
    _TITLE = 'Waugh2006_WoundHealing_Diabetic_ModelB'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230003.xml', integration_step: float = 0.1) -> None:
