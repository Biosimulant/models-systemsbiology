...
"""Tellurium-backed SBML BioModule wrapper for Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Disease Condition."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Palmer2014EffectOfIl1BlockingTherapiesInBiomd0000000620Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Disease Condition."""

    _SBML_ID = 'BIOMD0000000620'
    _TITLE = 'Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Disease Condition'
