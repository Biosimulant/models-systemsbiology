...
"""Tellurium-backed SBML BioModule wrapper for Butenas2004_BloodCoagulation."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Butenas2004BloodcoagulationBiomd0000000362Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Butenas2004_BloodCoagulation."""

    _SBML_ID = 'BIOMD0000000362'
    _TITLE = 'Butenas2004_BloodCoagulation'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000362.xml', integration_step: float = 0.1) -> None:
