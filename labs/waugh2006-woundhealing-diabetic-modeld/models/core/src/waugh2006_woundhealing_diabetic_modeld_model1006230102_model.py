...
"""Tellurium-backed SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelD."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Waugh2006WoundhealingDiabeticModeldModel1006230102Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Waugh2006_WoundHealing_Diabetic_ModelD."""

    _SBML_ID = 'MODEL1006230102'
    _TITLE = 'Waugh2006_WoundHealing_Diabetic_ModelD'
    ...
    def __init__(self, model_path: str = 'data/MODEL1006230102.xml', integration_step: float = 0.1) -> None:
