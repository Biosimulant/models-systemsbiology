...
"""Tellurium-backed SBML BioModule wrapper for Orfao2008_ThrombinGeneration_AmidolyticActivity."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Orfao2008ThrombingenerationAmidolyticactivityBiomd0000000366Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Orfao2008_ThrombinGeneration_AmidolyticActivity."""

    _SBML_ID = 'BIOMD0000000366'
    _TITLE = 'Orfao2008_ThrombinGeneration_AmidolyticActivity'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000366.xml', integration_step: float = 0.1) -> None:
