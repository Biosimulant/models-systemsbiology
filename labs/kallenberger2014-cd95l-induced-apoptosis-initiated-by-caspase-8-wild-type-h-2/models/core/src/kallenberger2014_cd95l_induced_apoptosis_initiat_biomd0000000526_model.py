...
"""Tellurium-backed SBML BioModule wrapper for Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans-cis/trans variant)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Kallenberger2014Cd95lInducedApoptosisInitiatBiomd0000000526Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans-cis/trans variant)."""

    _SBML_ID = 'BIOMD0000000526'
    _TITLE = 'Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans-cis/trans variant)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000526.xml', integration_step: float = 0.1) -> None:
