...
"""Tellurium-backed SBML BioModule wrapper for Mitrophanov2013 - Simulation of Hockin Blood Coagulation Model under reduced temperature."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Mitrophanov2013SimulationOfHockinBloodCoaguModel1806250002Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mitrophanov2013 - Simulation of Hockin Blood Coagulation Model under reduced temperature."""

    _SBML_ID = 'MODEL1806250002'
    _TITLE = 'Mitrophanov2013 - Simulation of Hockin Blood Coagulation Model under reduced temperature'
    ...
    def __init__(self, model_path: str = 'data/MODEL1806250002.xml', integration_step: float = 0.1) -> None:
