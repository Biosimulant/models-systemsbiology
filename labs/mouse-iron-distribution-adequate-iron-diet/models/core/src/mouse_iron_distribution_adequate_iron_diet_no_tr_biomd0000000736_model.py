...
"""Tellurium-backed SBML BioModule wrapper for Mouse Iron Distribution - Adequate iron diet (No Tracer)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class MouseIronDistributionAdequateIronDietNoTrBiomd0000000736Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Mouse Iron Distribution - Adequate iron diet (No Tracer)."""

    _SBML_ID = 'BIOMD0000000736'
    _TITLE = 'Mouse Iron Distribution - Adequate iron diet (No Tracer)'
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000736.xml', integration_step: float = 0.1) -> None:
