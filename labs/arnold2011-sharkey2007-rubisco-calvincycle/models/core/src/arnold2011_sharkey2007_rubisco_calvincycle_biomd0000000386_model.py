...
class Arnold2011Sharkey2007RubiscoCalvincycleBiomd0000000386Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000386.xml', integration_step: float = 0.1) -> None:
