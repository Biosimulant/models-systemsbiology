...
"""Tellurium-backed SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.3.1 PLM_1041 ver 1)."""
from __future__ import annotations

from biosim.contrib.sbml import TelluriumSBMLBioModule


class Flis2015PlantClockGeneCircuitP201131PlmModel1510190002Model(TelluriumSBMLBioModule):
    """Faithful SBML execution wrapper for Flis2015 - Plant clock gene circuit (P2011.3.1 PLM_1041 ver 1)."""

    _SBML_ID = 'MODEL1510190002'
    _TITLE = 'Flis2015 - Plant clock gene circuit (P2011.3.1 PLM_1041 ver 1)'
    ...
    def __init__(self, model_path: str = 'data/MODEL1510190002.xml', integration_step: float = 0.1) -> None:
