...
class Dallepezze2016ActivationOfAmpkAndMtorByAmBiomd0000000640Model(TelluriumSBMLBioModule):
    ...
    def __init__(self, model_path: str = 'data/BIOMD0000000640.xml', integration_step: float = 0.1) -> None:
