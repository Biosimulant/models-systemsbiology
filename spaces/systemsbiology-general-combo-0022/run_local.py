#!/usr/bin/env python3
"""Run generated space: systemsbiology-general-combo-0022."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'systemsbiology-general-combo-0022')} duration={duration} tick_dt={tick_dt}")
