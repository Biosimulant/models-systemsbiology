#!/usr/bin/env python3
"""Run generated space: systemsbiology-gene-expression-combo-0062."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'systemsbiology-gene-expression-combo-0062')} duration={duration} tick_dt={tick_dt}")
