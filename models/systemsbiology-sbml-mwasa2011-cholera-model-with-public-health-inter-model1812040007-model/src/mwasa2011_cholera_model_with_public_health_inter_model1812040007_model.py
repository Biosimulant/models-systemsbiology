...
"""Auto-generated SBML BioModule wrapper for Mwasa2011 - Cholera model with public health interventions.

Source: biomodels_ebi:MODEL1812040007
Original: https://www.ebi.ac.uk/biomodels/MODEL1812040007
"""
...
class SbmlMwasa2011CholeraModelWithPublicHealthInterventions(biosim.BioModule):
    """BioModule wrapper for SBML model: Mwasa2011 - Cholera model with public health interventions."""

    def __init__(self, model_path: str = "data/MODEL1812040007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mwasa2011CholeraModelWithPublicHealthInterModel1812040007Model = SbmlMwasa2011CholeraModelWithPublicHealthInterventions
