...
"""Auto-generated SBML BioModule wrapper for Kuznetsov2016(II) - α-syn aggregation kinetics in Parkinson's Disease.

Source: biomodels_ebi:BIOMD0000000615
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000615
"""
...
class SbmlKuznetsov2016IiSynAggregationKineticsInParkinsonS(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuznetsov2016(II) - α-syn aggregation kinetics in Parkinson's Disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000615.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuznetsov2016IiSynAggregationKineticsInParBiomd0000000615Model = SbmlKuznetsov2016IiSynAggregationKineticsInParkinsonS
