...
"""Auto-generated SBML BioModule wrapper for Sedaghat2002_InsulinSignalling_noFeedback.

Source: biomodels_ebi:BIOMD0000000137
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000137
"""
...
class SbmlSedaghat2002InsulinsignallingNofeedback(biosim.BioModule):
    """BioModule wrapper for SBML model: Sedaghat2002_InsulinSignalling_noFeedback."""

    def __init__(self, model_path: str = "data/BIOMD0000000137.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sedaghat2002InsulinsignallingNofeedbackBiomd0000000137Model = SbmlSedaghat2002InsulinsignallingNofeedback
