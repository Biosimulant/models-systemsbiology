...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1808080001)
**Standard**: sbml
**Authors**: M Susree; Mikhail A Panteleev; M Anand
...
models:
  - path: ../../models/systemsbiology-sbml-susree2018-effect-of-coated-platelets-on-thrombi-model1808080001-model
    alias: model
```
