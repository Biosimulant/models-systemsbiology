...
"""Auto-generated SBML BioModule wrapper for Susree2018 - Effect of coated platelets on thrombin generation.

Source: biomodels_ebi:MODEL1808080001
Original: https://www.ebi.ac.uk/biomodels/MODEL1808080001
"""
...
class SbmlSusree2018EffectOfCoatedPlateletsOnThrombinGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Susree2018 - Effect of coated platelets on thrombin generation."""

    def __init__(self, model_path: str = "data/MODEL1808080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Susree2018EffectOfCoatedPlateletsOnThrombiModel1808080001Model = SbmlSusree2018EffectOfCoatedPlateletsOnThrombinGeneration
