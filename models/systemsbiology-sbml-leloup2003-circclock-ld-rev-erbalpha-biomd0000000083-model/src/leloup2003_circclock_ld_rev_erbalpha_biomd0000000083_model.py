...
"""Auto-generated SBML BioModule wrapper for Leloup2003_CircClock_LD_REV-ERBalpha.

Source: biomodels_ebi:BIOMD0000000083
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000083
"""
...
class SbmlLeloup2003CircclockLdRevErbalpha(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup2003_CircClock_LD_REV-ERBalpha."""

    def __init__(self, model_path: str = "data/BIOMD0000000083.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup2003CircclockLdRevErbalphaBiomd0000000083Model = SbmlLeloup2003CircclockLdRevErbalpha
