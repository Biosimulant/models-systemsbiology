...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Poolman2000_CalvinCycle_Starch.

Source: biomodels_ebi:BIOMD0000000391
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000391
"""
...
class SbmlArnold2011Poolman2000CalvincycleStarch(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Poolman2000_CalvinCycle_Starch."""

    def __init__(self, model_path: str = "data/BIOMD0000000391.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Poolman2000CalvincycleStarchBiomd0000000391Model = SbmlArnold2011Poolman2000CalvincycleStarch
