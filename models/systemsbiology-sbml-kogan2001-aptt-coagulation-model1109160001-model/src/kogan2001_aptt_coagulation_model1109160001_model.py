...
"""Auto-generated SBML BioModule wrapper for Kogan2001_aPTT_coagulation.

Source: biomodels_ebi:MODEL1109160001
Original: https://www.ebi.ac.uk/biomodels/MODEL1109160001
"""
...
class SbmlKogan2001ApttCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Kogan2001_aPTT_coagulation."""

    def __init__(self, model_path: str = "data/MODEL1109160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kogan2001ApttCoagulationModel1109160001Model = SbmlKogan2001ApttCoagulation
