...
"""Auto-generated SBML BioModule wrapper for Lai2014 - Hemiconcerted MWC model of intact calmodulin with two targets.

Source: biomodels_ebi:BIOMD0000000574
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000574
"""
...
class SbmlLai2014HemiconcertedMwcModelOfIntactCalmodulinWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Lai2014 - Hemiconcerted MWC model of intact calmodulin with two targets."""

    def __init__(self, model_path: str = "data/BIOMD0000000574.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lai2014HemiconcertedMwcModelOfIntactCalmodBiomd0000000574Model = SbmlLai2014HemiconcertedMwcModelOfIntactCalmodulinWith
