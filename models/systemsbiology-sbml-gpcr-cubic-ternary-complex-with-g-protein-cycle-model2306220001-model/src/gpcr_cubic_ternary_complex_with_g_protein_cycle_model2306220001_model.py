...
"""Auto-generated SBML BioModule wrapper for GPCR Cubic Ternary Complex with G protein Cycle, Redfern-Nichols 2023.

Source: biomodels_ebi:MODEL2306220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2306220001
"""
...
class SbmlGpcrCubicTernaryComplexWithGProteinCycleRedfern(biosim.BioModule):
    """BioModule wrapper for SBML model: GPCR Cubic Ternary Complex with G protein Cycle, Redfern-Nichols 2023."""

    def __init__(self, model_path: str = "data/MODEL2306220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GpcrCubicTernaryComplexWithGProteinCycleModel2306220001Model = SbmlGpcrCubicTernaryComplexWithGProteinCycleRedfern
