...
"""Auto-generated SBML BioModule wrapper for Maltsev2009_PacemakerCellModel_nonSteadyState.

Source: biomodels_ebi:MODEL1006230069
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230069
"""
...
class SbmlMaltsev2009PacemakercellmodelNonsteadystate(biosim.BioModule):
    """BioModule wrapper for SBML model: Maltsev2009_PacemakerCellModel_nonSteadyState."""

    def __init__(self, model_path: str = "data/MODEL1006230069.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maltsev2009PacemakercellmodelNonsteadystateModel1006230069Model = SbmlMaltsev2009PacemakercellmodelNonsteadystate
