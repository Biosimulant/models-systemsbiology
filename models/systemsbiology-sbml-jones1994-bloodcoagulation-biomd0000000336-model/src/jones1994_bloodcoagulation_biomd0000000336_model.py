...
"""Auto-generated SBML BioModule wrapper for Jones1994_BloodCoagulation.

Source: biomodels_ebi:BIOMD0000000336
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000336
"""
...
class SbmlJones1994Bloodcoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Jones1994_BloodCoagulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000336.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jones1994BloodcoagulationBiomd0000000336Model = SbmlJones1994Bloodcoagulation
