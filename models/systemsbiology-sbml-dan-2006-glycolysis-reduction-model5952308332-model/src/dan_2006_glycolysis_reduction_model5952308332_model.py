...
"""Auto-generated SBML BioModule wrapper for Danø2006_Glycolysis_Reduction.

Source: biomodels_ebi:MODEL5952308332
Original: https://www.ebi.ac.uk/biomodels/MODEL5952308332
"""
...
class SbmlDan2006GlycolysisReduction(biosim.BioModule):
    """BioModule wrapper for SBML model: Danø2006_Glycolysis_Reduction."""

    def __init__(self, model_path: str = "data/MODEL5952308332.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dan2006GlycolysisReductionModel5952308332Model = SbmlDan2006GlycolysisReduction
