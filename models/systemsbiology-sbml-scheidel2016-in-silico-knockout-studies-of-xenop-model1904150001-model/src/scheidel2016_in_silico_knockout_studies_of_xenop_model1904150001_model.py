...
"""Auto-generated SBML BioModule wrapper for Scheidel2016 - In Silico Knockout Studies of Xenophagy Capturing of Salmonella.

Source: biomodels_ebi:MODEL1904150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1904150001
"""
...
class SbmlScheidel2016InSilicoKnockoutStudiesOfXenophagy(biosim.BioModule):
    """BioModule wrapper for SBML model: Scheidel2016 - In Silico Knockout Studies of Xenophagy Capturing of Salmonella."""

    def __init__(self, model_path: str = "data/MODEL1904150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Scheidel2016InSilicoKnockoutStudiesOfXenopModel1904150001Model = SbmlScheidel2016InSilicoKnockoutStudiesOfXenophagy
