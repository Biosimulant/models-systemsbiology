...
"""Auto-generated SBML BioModule wrapper for Rodriguez2005_denovo_pyrimidine_biosynthesis.

Source: biomodels_ebi:MODEL0995500644
Original: https://www.ebi.ac.uk/biomodels/MODEL0995500644
"""
...
class SbmlRodriguez2005DenovoPyrimidineBiosynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodriguez2005_denovo_pyrimidine_biosynthesis."""

    def __init__(self, model_path: str = "data/MODEL0995500644.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rodriguez2005DenovoPyrimidineBiosynthesisModel0995500644Model = SbmlRodriguez2005DenovoPyrimidineBiosynthesis
