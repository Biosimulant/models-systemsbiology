...
"""Auto-generated SBML BioModule wrapper for Stone1996 - activation of soluble guanylate cyclase by nitric oxide.

Source: biomodels_ebi:BIOMD0000000198
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000198
"""
...
class SbmlStone1996ActivationOfSolubleGuanylateCyclaseByNitric(biosim.BioModule):
    """BioModule wrapper for SBML model: Stone1996 - activation of soluble guanylate cyclase by nitric oxide."""

    def __init__(self, model_path: str = "data/BIOMD0000000198.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stone1996ActivationOfSolubleGuanylateCyclasBiomd0000000198Model = SbmlStone1996ActivationOfSolubleGuanylateCyclaseByNitric
