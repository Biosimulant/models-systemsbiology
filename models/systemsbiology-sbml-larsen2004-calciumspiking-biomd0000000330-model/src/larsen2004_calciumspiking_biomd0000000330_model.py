...
"""Auto-generated SBML BioModule wrapper for Larsen2004_CalciumSpiking.

Source: biomodels_ebi:BIOMD0000000330
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000330
"""
...
class SbmlLarsen2004Calciumspiking(biosim.BioModule):
    """BioModule wrapper for SBML model: Larsen2004_CalciumSpiking."""

    def __init__(self, model_path: str = "data/BIOMD0000000330.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larsen2004CalciumspikingBiomd0000000330Model = SbmlLarsen2004Calciumspiking
