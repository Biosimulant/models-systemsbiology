...
"""Auto-generated SBML BioModule wrapper for Rahman2022 - High throughput antibacterial screening with machine learning..

Source: biomodels_ebi:MODEL2404080002
Original: https://www.ebi.ac.uk/biomodels/MODEL2404080002
"""
...
class SbmlRahman2022HighThroughputAntibacterialScreeningWith(bsim.BioModule):
    """BioModule wrapper for SBML model: Rahman2022 - High throughput antibacterial screening with machine learning.."""

    def __init__(self, model_path: str = "data/MODEL2404080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rahman2022HighThroughputAntibacterialScreeniModel2404080002Model = SbmlRahman2022HighThroughputAntibacterialScreeningWith
