...
"""Auto-generated SBML BioModule wrapper for Vilar2006_TGFbeta.

Source: biomodels_ebi:BIOMD0000000101
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000101
"""
...
class SbmlVilar2006Tgfbeta(biosim.BioModule):
    """BioModule wrapper for SBML model: Vilar2006_TGFbeta."""

    def __init__(self, model_path: str = "data/BIOMD0000000101.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vilar2006TgfbetaBiomd0000000101Model = SbmlVilar2006Tgfbeta
