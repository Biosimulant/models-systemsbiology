...
"""Auto-generated SBML BioModule wrapper for Wilhelm2009_BistableReaction.

Source: biomodels_ebi:BIOMD0000000233
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000233
"""
...
class SbmlWilhelm2009Bistablereaction(biosim.BioModule):
    """BioModule wrapper for SBML model: Wilhelm2009_BistableReaction."""

    def __init__(self, model_path: str = "data/BIOMD0000000233.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wilhelm2009BistablereactionBiomd0000000233Model = SbmlWilhelm2009Bistablereaction
