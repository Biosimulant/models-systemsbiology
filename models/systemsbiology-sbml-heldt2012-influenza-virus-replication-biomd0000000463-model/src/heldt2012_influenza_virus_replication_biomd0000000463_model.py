...
"""Auto-generated SBML BioModule wrapper for Heldt2012 - Influenza Virus Replication.

Source: biomodels_ebi:BIOMD0000000463
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000463
"""
...
class SbmlHeldt2012InfluenzaVirusReplication(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2012 - Influenza Virus Replication."""

    def __init__(self, model_path: str = "data/BIOMD0000000463.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2012InfluenzaVirusReplicationBiomd0000000463Model = SbmlHeldt2012InfluenzaVirusReplication
