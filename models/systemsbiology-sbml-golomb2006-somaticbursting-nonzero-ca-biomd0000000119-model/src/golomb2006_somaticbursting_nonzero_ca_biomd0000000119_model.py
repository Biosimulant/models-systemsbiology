...
"""Auto-generated SBML BioModule wrapper for Golomb2006_SomaticBursting_nonzero[Ca].

Source: biomodels_ebi:BIOMD0000000119
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000119
"""
...
class SbmlGolomb2006SomaticburstingNonzeroCa(biosim.BioModule):
    """BioModule wrapper for SBML model: Golomb2006_SomaticBursting_nonzero[Ca]."""

    def __init__(self, model_path: str = "data/BIOMD0000000119.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Golomb2006SomaticburstingNonzeroCaBiomd0000000119Model = SbmlGolomb2006SomaticburstingNonzeroCa
