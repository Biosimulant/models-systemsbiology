...
"""Auto-generated SBML BioModule wrapper for DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 2).

Source: biomodels_ebi:MODEL1705030001
Original: https://www.ebi.ac.uk/biomodels/MODEL1705030001
"""
...
class SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids3(biosim.BioModule):
    """BioModule wrapper for SBML model: DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 2)."""

    def __init__(self, model_path: str = "data/MODEL1705030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallepezze2016ActivationOfAmpkAndMtorByAmModel1705030001Model = SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids3
