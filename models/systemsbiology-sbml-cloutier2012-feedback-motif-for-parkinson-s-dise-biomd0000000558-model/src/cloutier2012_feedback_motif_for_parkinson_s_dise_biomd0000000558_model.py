...
"""Auto-generated SBML BioModule wrapper for Cloutier2012 - Feedback motif for Parkinson's disease.

Source: biomodels_ebi:BIOMD0000000558
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000558
"""
...
class SbmlCloutier2012FeedbackMotifForParkinsonSDisease(biosim.BioModule):
    """BioModule wrapper for SBML model: Cloutier2012 - Feedback motif for Parkinson's disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000558.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cloutier2012FeedbackMotifForParkinsonSDiseBiomd0000000558Model = SbmlCloutier2012FeedbackMotifForParkinsonSDisease
