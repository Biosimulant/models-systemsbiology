...
"""Auto-generated SBML BioModule wrapper for Pokhilko2012_CircClock_RepressilatorFeedbackloop.

Source: biomodels_ebi:BIOMD0000000412
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000412
"""
...
class SbmlPokhilko2012CircclockRepressilatorfeedbackloop(biosim.BioModule):
    """BioModule wrapper for SBML model: Pokhilko2012_CircClock_RepressilatorFeedbackloop."""

    def __init__(self, model_path: str = "data/BIOMD0000000412.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pokhilko2012CircclockRepressilatorfeedbackloopBiomd0000000412Model = SbmlPokhilko2012CircclockRepressilatorfeedbackloop
