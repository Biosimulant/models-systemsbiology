...
"""Auto-generated SBML BioModule wrapper for Naski1991 - alpha-Thrombin-catalyzed conversion of Fibrinogen.

Source: biomodels_ebi:MODEL1808210002
Original: https://www.ebi.ac.uk/biomodels/MODEL1808210002
"""
...
class SbmlNaski1991AlphaThrombinCatalyzedConversionOfFibrinogen(biosim.BioModule):
    """BioModule wrapper for SBML model: Naski1991 - alpha-Thrombin-catalyzed conversion of Fibrinogen."""

    def __init__(self, model_path: str = "data/MODEL1808210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Naski1991AlphaThrombinCatalyzedConversionOfModel1808210002Model = SbmlNaski1991AlphaThrombinCatalyzedConversionOfFibrinogen
