...
"""Auto-generated SBML BioModule wrapper for Fuentes2005_ZymogenActivation.

Source: biomodels_ebi:BIOMD0000000092
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000092
"""
...
class SbmlFuentes2005Zymogenactivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Fuentes2005_ZymogenActivation."""

    def __init__(self, model_path: str = "data/BIOMD0000000092.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fuentes2005ZymogenactivationBiomd0000000092Model = SbmlFuentes2005Zymogenactivation
