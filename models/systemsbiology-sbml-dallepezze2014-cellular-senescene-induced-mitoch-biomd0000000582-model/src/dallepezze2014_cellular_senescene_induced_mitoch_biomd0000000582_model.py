...
"""Auto-generated SBML BioModule wrapper for DallePezze2014 -  Cellular senescene-induced mitochondrial dysfunction.

Source: biomodels_ebi:BIOMD0000000582
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000582
"""
...
class SbmlDallepezze2014CellularSenesceneInducedMitochondrial(biosim.BioModule):
    """BioModule wrapper for SBML model: DallePezze2014 -  Cellular senescene-induced mitochondrial dysfunction."""

    def __init__(self, model_path: str = "data/BIOMD0000000582.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallepezze2014CellularSenesceneInducedMitochBiomd0000000582Model = SbmlDallepezze2014CellularSenesceneInducedMitochondrial
