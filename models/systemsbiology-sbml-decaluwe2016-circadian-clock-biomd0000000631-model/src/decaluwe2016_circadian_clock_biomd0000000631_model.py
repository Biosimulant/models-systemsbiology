...
"""Auto-generated SBML BioModule wrapper for DeCaluwe2016 - Circadian Clock.

Source: biomodels_ebi:BIOMD0000000631
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000631
"""
...
class SbmlDecaluwe2016CircadianClock(biosim.BioModule):
    """BioModule wrapper for SBML model: DeCaluwe2016 - Circadian Clock."""

    def __init__(self, model_path: str = "data/BIOMD0000000631.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Decaluwe2016CircadianClockBiomd0000000631Model = SbmlDecaluwe2016CircadianClock
