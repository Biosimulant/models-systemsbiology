...
"""Auto-generated SBML BioModule wrapper for Abu-Soud1999_HomoArginine.

Source: biomodels_ebi:MODEL9087988095
Original: https://www.ebi.ac.uk/biomodels/MODEL9087988095
"""
...
class SbmlAbuSoud1999Homoarginine(biosim.BioModule):
    """BioModule wrapper for SBML model: Abu-Soud1999_HomoArginine."""

    def __init__(self, model_path: str = "data/MODEL9087988095.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AbuSoud1999HomoarginineModel9087988095Model = SbmlAbuSoud1999Homoarginine
