...
"""Auto-generated SBML BioModule wrapper for Liu2023 - Acinetobacter baumannii growth inhibition prediction with Deep Learning.

Source: biomodels_ebi:MODEL2405080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405080001
"""
...
class SbmlLiu2023AcinetobacterBaumanniiGrowthInhibition(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2023 - Acinetobacter baumannii growth inhibition prediction with Deep Learning."""

    def __init__(self, model_path: str = "data/MODEL2405080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2023AcinetobacterBaumanniiGrowthInhibitioModel2405080001Model = SbmlLiu2023AcinetobacterBaumanniiGrowthInhibition
