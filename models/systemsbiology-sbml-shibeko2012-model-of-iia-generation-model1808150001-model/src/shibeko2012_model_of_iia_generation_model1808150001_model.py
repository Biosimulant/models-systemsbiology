...
"""Auto-generated SBML BioModule wrapper for Shibeko2012 - Model of IIa generation.

Source: biomodels_ebi:MODEL1808150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1808150001
"""
...
class SbmlShibeko2012ModelOfIiaGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Shibeko2012 - Model of IIa generation."""

    def __init__(self, model_path: str = "data/MODEL1808150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shibeko2012ModelOfIiaGenerationModel1808150001Model = SbmlShibeko2012ModelOfIiaGeneration
