...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1808150001)
**Standard**: sbml
...
models:
  - path: ../../models/systemsbiology-sbml-shibeko2012-model-of-iia-generation-model1808150001-model
    alias: model
```
