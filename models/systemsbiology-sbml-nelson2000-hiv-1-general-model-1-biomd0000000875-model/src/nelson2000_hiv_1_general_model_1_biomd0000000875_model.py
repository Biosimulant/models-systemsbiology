...
"""Auto-generated SBML BioModule wrapper for Nelson2000- HIV-1 general model 1.

Source: biomodels_ebi:BIOMD0000000875
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000875
"""
...
class SbmlNelson2000Hiv1GeneralModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Nelson2000- HIV-1 general model 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000875.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nelson2000Hiv1GeneralModel1Biomd0000000875Model = SbmlNelson2000Hiv1GeneralModel1
