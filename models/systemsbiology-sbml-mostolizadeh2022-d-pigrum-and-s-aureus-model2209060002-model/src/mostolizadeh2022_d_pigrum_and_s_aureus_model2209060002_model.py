...
"""Auto-generated SBML BioModule wrapper for Mostolizadeh2022 - D. pigrum and S. aureus.

Source: biomodels_ebi:MODEL2209060002
Original: https://www.ebi.ac.uk/biomodels/MODEL2209060002
"""
...
class SbmlMostolizadeh2022DPigrumAndSAureus(biosim.BioModule):
    """BioModule wrapper for SBML model: Mostolizadeh2022 - D. pigrum and S. aureus."""

    def __init__(self, model_path: str = "data/MODEL2209060002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mostolizadeh2022DPigrumAndSAureusModel2209060002Model = SbmlMostolizadeh2022DPigrumAndSAureus
