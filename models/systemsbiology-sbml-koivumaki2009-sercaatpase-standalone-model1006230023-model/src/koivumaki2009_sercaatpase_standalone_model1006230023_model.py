...
"""Auto-generated SBML BioModule wrapper for Koivumaki2009_SERCAATPase_Standalone.

Source: biomodels_ebi:MODEL1006230023
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230023
"""
...
class SbmlKoivumaki2009SercaatpaseStandalone(biosim.BioModule):
    """BioModule wrapper for SBML model: Koivumaki2009_SERCAATPase_Standalone."""

    def __init__(self, model_path: str = "data/MODEL1006230023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koivumaki2009SercaatpaseStandaloneModel1006230023Model = SbmlKoivumaki2009SercaatpaseStandalone
