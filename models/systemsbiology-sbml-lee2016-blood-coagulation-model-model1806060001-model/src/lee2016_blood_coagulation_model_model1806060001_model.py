...
"""Auto-generated SBML BioModule wrapper for Lee2016 - Blood Coagulation Model.

Source: biomodels_ebi:MODEL1806060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806060001
"""
...
class SbmlLee2016BloodCoagulationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2016 - Blood Coagulation Model."""

    def __init__(self, model_path: str = "data/MODEL1806060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2016BloodCoagulationModelModel1806060001Model = SbmlLee2016BloodCoagulationModel
