...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_DXepo-0mMCD).

Source: biomodels_ebi:MODEL1907260010
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260010
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoDxepo0mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_DXepo-0mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoDModel1907260010Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoDxepo0mmcd
