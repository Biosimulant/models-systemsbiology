...
"""Auto-generated SBML BioModule wrapper for Proctor2017 - Identifying microRNA for muscle regeneration during ageing (Mir1_in_muscle).

Source: biomodels_ebi:MODEL1704110000
Original: https://www.ebi.ac.uk/biomodels/MODEL1704110000
"""
...
class SbmlProctor2017IdentifyingMicrornaForMuscleRegeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017 - Identifying microRNA for muscle regeneration during ageing (Mir1_in_muscle)."""

    def __init__(self, model_path: str = "data/MODEL1704110000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017IdentifyingMicrornaForMuscleRegeModel1704110000Model = SbmlProctor2017IdentifyingMicrornaForMuscleRegeneration
