...
"""Auto-generated SBML BioModule wrapper for Yi2003_GproteinCycle.

Source: biomodels_ebi:BIOMD0000000072
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000072
"""
...
class SbmlYi2003Gproteincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Yi2003_GproteinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000072.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yi2003GproteincycleBiomd0000000072Model = SbmlYi2003Gproteincycle
