...
"""Auto-generated SBML BioModule wrapper for Chickarmane2008 - Stem cell lineage determination.

Source: biomodels_ebi:BIOMD0000000209
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000209
"""
...
class SbmlChickarmane2008StemCellLineageDetermination(biosim.BioModule):
    """BioModule wrapper for SBML model: Chickarmane2008 - Stem cell lineage determination."""

    def __init__(self, model_path: str = "data/BIOMD0000000209.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chickarmane2008StemCellLineageDeterminationBiomd0000000209Model = SbmlChickarmane2008StemCellLineageDetermination
