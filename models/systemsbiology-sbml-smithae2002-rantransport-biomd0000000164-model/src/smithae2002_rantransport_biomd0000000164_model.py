...
"""Auto-generated SBML BioModule wrapper for SmithAE2002_RanTransport.

Source: biomodels_ebi:BIOMD0000000164
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000164
"""
...
class SbmlSmithae2002Rantransport(biosim.BioModule):
    """BioModule wrapper for SBML model: SmithAE2002_RanTransport."""

    def __init__(self, model_path: str = "data/BIOMD0000000164.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smithae2002RantransportBiomd0000000164Model = SbmlSmithae2002Rantransport
