...
"""Auto-generated SBML BioModule wrapper for Mouse Iron Distribution - Deficient iron diet (No Tracer).

Source: biomodels_ebi:BIOMD0000000737
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000737
"""
...
class SbmlMouseIronDistributionDeficientIronDietNoTracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mouse Iron Distribution - Deficient iron diet (No Tracer)."""

    def __init__(self, model_path: str = "data/BIOMD0000000737.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MouseIronDistributionDeficientIronDietNoTBiomd0000000737Model = SbmlMouseIronDistributionDeficientIronDietNoTracer
