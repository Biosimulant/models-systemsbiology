...
"""Auto-generated SBML BioModule wrapper for Francoeur2021 - SolTranNet–A Machine Learning Tool for Fast Aqueous Solubility Prediction.

Source: biomodels_ebi:MODEL2406030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2406030002
"""
...
class SbmlFrancoeur2021SoltrannetaMachineLearningToolForFast(biosim.BioModule):
    """BioModule wrapper for SBML model: Francoeur2021 - SolTranNet–A Machine Learning Tool for Fast Aqueous Solubility Prediction."""

    def __init__(self, model_path: str = "data/MODEL2406030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Francoeur2021SoltrannetAMachineLearningToolModel2406030002Model = SbmlFrancoeur2021SoltrannetaMachineLearningToolForFast
