...
"""Auto-generated SBML BioModule wrapper for Weisse2015 - Cell Growth.

Source: biomodels_ebi:MODEL1502270000
Original: https://www.ebi.ac.uk/biomodels/MODEL1502270000
"""
...
class SbmlWeisse2015CellGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Weisse2015 - Cell Growth."""

    def __init__(self, model_path: str = "data/MODEL1502270000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Weisse2015CellGrowthModel1502270000Model = SbmlWeisse2015CellGrowth
