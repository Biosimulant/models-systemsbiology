...
Source: biomodels_ebi:BIOMD0000000772
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000772
"""
...
class SbmlWang2019AMathematicalModelOfOncolyticVirotherapyWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2019 - A mathematical model of oncolytic virotherapy with time delay."""

    def __init__(self, model_path: str = "data/BIOMD0000000772.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2019AMathematicalModelOfOncolyticVirotBiomd0000000772Model = SbmlWang2019AMathematicalModelOfOncolyticVirotherapyWith
