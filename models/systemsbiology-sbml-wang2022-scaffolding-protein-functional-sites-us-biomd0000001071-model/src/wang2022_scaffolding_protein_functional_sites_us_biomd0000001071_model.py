...
"""Auto-generated SBML BioModule wrapper for Wang2022 - Scaffolding protein functional sites using deep learning.

Source: biomodels_ebi:BIOMD0000001071
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001071
"""
...
class SbmlWang2022ScaffoldingProteinFunctionalSitesUsingDeep(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2022 - Scaffolding protein functional sites using deep learning."""

    def __init__(self, model_path: str = "data/BIOMD0000001071.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2022ScaffoldingProteinFunctionalSitesUsBiomd0000001071Model = SbmlWang2022ScaffoldingProteinFunctionalSitesUsingDeep
