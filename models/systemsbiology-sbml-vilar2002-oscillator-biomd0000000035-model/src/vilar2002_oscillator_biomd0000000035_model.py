...
"""Auto-generated SBML BioModule wrapper for Vilar2002_Oscillator.

Source: biomodels_ebi:BIOMD0000000035
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000035
"""
...
class SbmlVilar2002Oscillator(biosim.BioModule):
    """BioModule wrapper for SBML model: Vilar2002_Oscillator."""

    def __init__(self, model_path: str = "data/BIOMD0000000035.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vilar2002OscillatorBiomd0000000035Model = SbmlVilar2002Oscillator
