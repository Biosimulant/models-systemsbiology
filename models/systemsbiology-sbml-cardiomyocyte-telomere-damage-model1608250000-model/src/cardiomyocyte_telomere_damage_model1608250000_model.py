...
"""Auto-generated SBML BioModule wrapper for Cardiomyocyte Telomere Damage.

Source: biomodels_ebi:MODEL1608250000
Original: https://www.ebi.ac.uk/biomodels/MODEL1608250000
"""
...
class SbmlCardiomyocyteTelomereDamage(biosim.BioModule):
    """BioModule wrapper for SBML model: Cardiomyocyte Telomere Damage."""

    def __init__(self, model_path: str = "data/MODEL1608250000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CardiomyocyteTelomereDamageModel1608250000Model = SbmlCardiomyocyteTelomereDamage
