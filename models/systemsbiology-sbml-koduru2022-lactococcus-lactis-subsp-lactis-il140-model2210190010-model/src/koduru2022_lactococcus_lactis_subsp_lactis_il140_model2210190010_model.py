...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactococcus lactis subsp. lactis IL1403.

Source: biomodels_ebi:MODEL2210190010
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190010
"""
...
class SbmlKoduru2022LactococcusLactisSubspLactisIl1403(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactococcus lactis subsp. lactis IL1403."""

    def __init__(self, model_path: str = "data/MODEL2210190010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactococcusLactisSubspLactisIl140Model2210190010Model = SbmlKoduru2022LactococcusLactisSubspLactisIl1403
