...
"""Auto-generated SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.3.1 PLM_1041 ver 1).

Source: biomodels_ebi:MODEL1510190002
Original: https://www.ebi.ac.uk/biomodels/MODEL1510190002
"""
...
class SbmlFlis2015PlantClockGeneCircuitP201131Plm1041Ver1(biosim.BioModule):
    """BioModule wrapper for SBML model: Flis2015 - Plant clock gene circuit (P2011.3.1 PLM_1041 ver 1)."""

    def __init__(self, model_path: str = "data/MODEL1510190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flis2015PlantClockGeneCircuitP201131PlmModel1510190002Model = SbmlFlis2015PlantClockGeneCircuitP201131Plm1041Ver1
