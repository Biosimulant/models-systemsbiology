...
"""Auto-generated SBML BioModule wrapper for Feist2006_methanogenesis_OptiMethanol.

Source: biomodels_ebi:BIOMD0000001098
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001098
"""
...
class SbmlFeist2006MethanogenesisOptimethanol(biosim.BioModule):
    """BioModule wrapper for SBML model: Feist2006_methanogenesis_OptiMethanol."""

    def __init__(self, model_path: str = "data/BIOMD0000001098.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Feist2006MethanogenesisOptimethanolBiomd0000001098Model = SbmlFeist2006MethanogenesisOptimethanol
