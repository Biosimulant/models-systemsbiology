...
"""Auto-generated SBML BioModule wrapper for Chi2019 - In Silico Prediction of PAMPA Effective Permeability Using a Two-QSAR Approach.

Source: biomodels_ebi:MODEL2406030003
Original: https://www.ebi.ac.uk/biomodels/MODEL2406030003
"""
...
class SbmlChi2019InSilicoPredictionOfPampaEffective(biosim.BioModule):
    """BioModule wrapper for SBML model: Chi2019 - In Silico Prediction of PAMPA Effective Permeability Using a Two-QSAR Approach."""

    def __init__(self, model_path: str = "data/MODEL2406030003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chi2019InSilicoPredictionOfPampaEffectiveModel2406030003Model = SbmlChi2019InSilicoPredictionOfPampaEffective
