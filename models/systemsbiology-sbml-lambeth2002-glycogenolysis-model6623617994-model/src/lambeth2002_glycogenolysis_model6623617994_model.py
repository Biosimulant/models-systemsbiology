...
"""Auto-generated SBML BioModule wrapper for Lambeth2002_Glycogenolysis.

Source: biomodels_ebi:MODEL6623617994
Original: https://www.ebi.ac.uk/biomodels/MODEL6623617994
"""
...
class SbmlLambeth2002Glycogenolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Lambeth2002_Glycogenolysis."""

    def __init__(self, model_path: str = "data/MODEL6623617994.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lambeth2002GlycogenolysisModel6623617994Model = SbmlLambeth2002Glycogenolysis
