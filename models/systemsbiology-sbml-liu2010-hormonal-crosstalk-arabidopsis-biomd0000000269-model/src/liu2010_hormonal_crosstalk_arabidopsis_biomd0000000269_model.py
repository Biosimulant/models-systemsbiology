...
"""Auto-generated SBML BioModule wrapper for Liu2010_Hormonal_Crosstalk_Arabidopsis.

Source: biomodels_ebi:BIOMD0000000269
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000269
"""
...
class SbmlLiu2010HormonalCrosstalkArabidopsis(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2010_Hormonal_Crosstalk_Arabidopsis."""

    def __init__(self, model_path: str = "data/BIOMD0000000269.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2010HormonalCrosstalkArabidopsisBiomd0000000269Model = SbmlLiu2010HormonalCrosstalkArabidopsis
