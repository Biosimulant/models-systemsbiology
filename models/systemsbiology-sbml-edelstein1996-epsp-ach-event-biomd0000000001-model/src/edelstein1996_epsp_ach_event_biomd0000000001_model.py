...
"""Auto-generated SBML BioModule wrapper for Edelstein1996 - EPSP ACh event.

Source: biomodels_ebi:BIOMD0000000001
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000001
"""
...
class SbmlEdelstein1996EpspAchEvent(biosim.BioModule):
    """BioModule wrapper for SBML model: Edelstein1996 - EPSP ACh event."""

    def __init__(self, model_path: str = "data/BIOMD0000000001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Edelstein1996EpspAchEventBiomd0000000001Model = SbmlEdelstein1996EpspAchEvent
