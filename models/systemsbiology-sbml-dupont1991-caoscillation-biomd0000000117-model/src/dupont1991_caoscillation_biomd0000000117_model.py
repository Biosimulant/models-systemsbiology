...
"""Auto-generated SBML BioModule wrapper for Dupont1991_CaOscillation.

Source: biomodels_ebi:BIOMD0000000117
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000117
"""
...
class SbmlDupont1991Caoscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Dupont1991_CaOscillation."""

    def __init__(self, model_path: str = "data/BIOMD0000000117.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dupont1991CaoscillationBiomd0000000117Model = SbmlDupont1991Caoscillation
