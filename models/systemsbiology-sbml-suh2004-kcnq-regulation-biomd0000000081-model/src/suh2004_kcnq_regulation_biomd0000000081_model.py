...
"""Auto-generated SBML BioModule wrapper for Suh2004_KCNQ_Regulation.

Source: biomodels_ebi:BIOMD0000000081
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000081
"""
...
class SbmlSuh2004KcnqRegulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Suh2004_KCNQ_Regulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000081.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Suh2004KcnqRegulationBiomd0000000081Model = SbmlSuh2004KcnqRegulation
