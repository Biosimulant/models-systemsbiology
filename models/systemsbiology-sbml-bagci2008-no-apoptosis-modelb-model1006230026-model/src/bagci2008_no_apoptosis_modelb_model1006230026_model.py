...
"""Auto-generated SBML BioModule wrapper for Bagci2008_NO_Apoptosis_modelB.

Source: biomodels_ebi:MODEL1006230026
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230026
"""
...
class SbmlBagci2008NoApoptosisModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Bagci2008_NO_Apoptosis_modelB."""

    def __init__(self, model_path: str = "data/MODEL1006230026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bagci2008NoApoptosisModelbModel1006230026Model = SbmlBagci2008NoApoptosisModelb
