...
"""Auto-generated SBML BioModule wrapper for Lenbury1991_CortisolSecretionSystem.

Source: biomodels_ebi:MODEL0479926177
Original: https://www.ebi.ac.uk/biomodels/MODEL0479926177
"""
...
class SbmlLenbury1991Cortisolsecretionsystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Lenbury1991_CortisolSecretionSystem."""

    def __init__(self, model_path: str = "data/MODEL0479926177.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lenbury1991CortisolsecretionsystemModel0479926177Model = SbmlLenbury1991Cortisolsecretionsystem
