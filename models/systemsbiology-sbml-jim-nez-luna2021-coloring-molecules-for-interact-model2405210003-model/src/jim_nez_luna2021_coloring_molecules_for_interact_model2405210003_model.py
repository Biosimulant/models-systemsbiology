...
"""Auto-generated SBML BioModule wrapper for Jiménez-Luna2021 - Coloring molecules for interaction with CYP3A4.

Source: biomodels_ebi:MODEL2405210003
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210003
"""
...
class SbmlJimenezLuna2021ColoringMoleculesForInteractionWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiménez-Luna2021 - Coloring molecules for interaction with CYP3A4."""

    def __init__(self, model_path: str = "data/MODEL2405210003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
JimNezLuna2021ColoringMoleculesForInteractModel2405210003Model = SbmlJimenezLuna2021ColoringMoleculesForInteractionWith
