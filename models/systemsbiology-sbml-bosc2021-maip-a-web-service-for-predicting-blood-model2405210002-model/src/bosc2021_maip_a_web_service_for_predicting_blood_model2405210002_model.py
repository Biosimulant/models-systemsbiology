...
"""Auto-generated SBML BioModule wrapper for Bosc2021 - MAIP: a web service for predicting blood‐stage malaria inhibitors.

Source: biomodels_ebi:MODEL2405210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210002
"""
...
class SbmlBosc2021MaipAWebServiceForPredictingBloodstage(biosim.BioModule):
    """BioModule wrapper for SBML model: Bosc2021 - MAIP: a web service for predicting blood‐stage malaria inhibitors."""

    def __init__(self, model_path: str = "data/MODEL2405210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bosc2021MaipAWebServiceForPredictingBloodModel2405210002Model = SbmlBosc2021MaipAWebServiceForPredictingBloodstage
