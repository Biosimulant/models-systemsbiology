...
"""Auto-generated SBML BioModule wrapper for Stefan2008 - calmodulin allostery.

Source: biomodels_ebi:BIOMD0000000183
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000183
"""
...
class SbmlStefan2008CalmodulinAllostery(biosim.BioModule):
    """BioModule wrapper for SBML model: Stefan2008 - calmodulin allostery."""

    def __init__(self, model_path: str = "data/BIOMD0000000183.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stefan2008CalmodulinAllosteryBiomd0000000183Model = SbmlStefan2008CalmodulinAllostery
