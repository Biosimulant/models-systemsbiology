...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Colon Crypt cycle - Version 1.

Source: biomodels_ebi:BIOMD0000000519
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000519
"""
...
class SbmlSmallbone2013ColonCryptCycleVersion1(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Colon Crypt cycle - Version 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000519.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013ColonCryptCycleVersion1Biomd0000000519Model = SbmlSmallbone2013ColonCryptCycleVersion1
