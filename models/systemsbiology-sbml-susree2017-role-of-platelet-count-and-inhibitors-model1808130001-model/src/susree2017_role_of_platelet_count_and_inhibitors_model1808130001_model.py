...
"""Auto-generated SBML BioModule wrapper for Susree2017 - Role of platelet count and inhibitors in blood coagulation.

Source: biomodels_ebi:MODEL1808130001
Original: https://www.ebi.ac.uk/biomodels/MODEL1808130001
"""
...
class SbmlSusree2017RoleOfPlateletCountAndInhibitorsInBlood(biosim.BioModule):
    """BioModule wrapper for SBML model: Susree2017 - Role of platelet count and inhibitors in blood coagulation."""

    def __init__(self, model_path: str = "data/MODEL1808130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Susree2017RoleOfPlateletCountAndInhibitorsModel1808130001Model = SbmlSusree2017RoleOfPlateletCountAndInhibitorsInBlood
