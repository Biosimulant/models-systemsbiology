...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1808130001)
**Standard**: sbml
**Authors**: M. Susree; M. Anand
...
models:
  - path: ../../models/systemsbiology-sbml-susree2017-role-of-platelet-count-and-inhibitors-model1808130001-model
    alias: model
```
