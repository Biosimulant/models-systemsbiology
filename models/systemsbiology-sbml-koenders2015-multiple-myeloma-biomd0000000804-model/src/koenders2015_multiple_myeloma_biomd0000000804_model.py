...
"""Auto-generated SBML BioModule wrapper for Koenders2015 - multiple myeloma.

Source: biomodels_ebi:BIOMD0000000804
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000804
"""
...
class SbmlKoenders2015MultipleMyeloma(biosim.BioModule):
    """BioModule wrapper for SBML model: Koenders2015 - multiple myeloma."""

    def __init__(self, model_path: str = "data/BIOMD0000000804.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koenders2015MultipleMyelomaBiomd0000000804Model = SbmlKoenders2015MultipleMyeloma
