...
"""Auto-generated SBML BioModule wrapper for Toro2018 - Streptomyces clavuligerus - iLT1021.

Source: biomodels_ebi:MODEL2408210002
Original: https://www.ebi.ac.uk/biomodels/MODEL2408210002
"""
...
class SbmlToro2018StreptomycesClavuligerusIlt1021(biosim.BioModule):
    """BioModule wrapper for SBML model: Toro2018 - Streptomyces clavuligerus - iLT1021."""

    def __init__(self, model_path: str = "data/MODEL2408210002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Toro2018StreptomycesClavuligerusIlt1021Model2408210002Model = SbmlToro2018StreptomycesClavuligerusIlt1021
