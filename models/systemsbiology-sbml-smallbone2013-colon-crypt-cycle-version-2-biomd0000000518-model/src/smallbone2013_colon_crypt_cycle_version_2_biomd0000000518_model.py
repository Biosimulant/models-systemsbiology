...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Colon Crypt cycle - Version 2.

Source: biomodels_ebi:BIOMD0000000518
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000518
"""
...
class SbmlSmallbone2013ColonCryptCycleVersion2(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Colon Crypt cycle - Version 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000518.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013ColonCryptCycleVersion2Biomd0000000518Model = SbmlSmallbone2013ColonCryptCycleVersion2
