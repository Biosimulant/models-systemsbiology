...
"""Auto-generated SBML BioModule wrapper for Lee2020 - M. elsdenii (iME375).

Source: biomodels_ebi:MODEL2408040004
Original: https://www.ebi.ac.uk/biomodels/MODEL2408040004
"""
...
class SbmlLee2020MElsdeniiIme375(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2020 - M. elsdenii (iME375)."""

    def __init__(self, model_path: str = "data/MODEL2408040004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2020MElsdeniiIme375Model2408040004Model = SbmlLee2020MElsdeniiIme375
