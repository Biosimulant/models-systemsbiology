...
"""Auto-generated SBML BioModule wrapper for Sorokina2009_PhyA_FHL_ON_OFF_9h.

Source: biomodels_ebi:MODEL0911120000
Original: https://www.ebi.ac.uk/biomodels/MODEL0911120000
"""
...
class SbmlSorokina2009PhyaFhlOnOff9h(biosim.BioModule):
    """BioModule wrapper for SBML model: Sorokina2009_PhyA_FHL_ON_OFF_9h."""

    def __init__(self, model_path: str = "data/MODEL0911120000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sorokina2009PhyaFhlOnOff9hModel0911120000Model = SbmlSorokina2009PhyaFhlOnOff9h
