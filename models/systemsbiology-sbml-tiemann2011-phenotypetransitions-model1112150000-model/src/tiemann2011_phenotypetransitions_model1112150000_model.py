...
"""Auto-generated SBML BioModule wrapper for Tiemann2011_PhenotypeTransitions.

Source: biomodels_ebi:MODEL1112150000
Original: https://www.ebi.ac.uk/biomodels/MODEL1112150000
"""
...
class SbmlTiemann2011Phenotypetransitions(biosim.BioModule):
    """BioModule wrapper for SBML model: Tiemann2011_PhenotypeTransitions."""

    def __init__(self, model_path: str = "data/MODEL1112150000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tiemann2011PhenotypetransitionsModel1112150000Model = SbmlTiemann2011Phenotypetransitions
