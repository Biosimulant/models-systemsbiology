...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedforward Coherent By MicroRNA).

Source: biomodels_ebi:MODEL1610100003
Original: https://www.ebi.ac.uk/biomodels/MODEL1610100003
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive2(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedforward Coherent By MicroRNA)."""

    def __init__(self, model_path: str = "data/MODEL1610100003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1610100003Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive2
