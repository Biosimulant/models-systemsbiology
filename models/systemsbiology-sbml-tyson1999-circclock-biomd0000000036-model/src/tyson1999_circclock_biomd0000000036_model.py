...
"""Auto-generated SBML BioModule wrapper for Tyson1999_CircClock.

Source: biomodels_ebi:BIOMD0000000036
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000036
"""
...
class SbmlTyson1999Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson1999_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000036.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson1999CircclockBiomd0000000036Model = SbmlTyson1999Circclock
