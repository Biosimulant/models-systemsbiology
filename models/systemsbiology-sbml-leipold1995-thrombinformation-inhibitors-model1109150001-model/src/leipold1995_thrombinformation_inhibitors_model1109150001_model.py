...
"""Auto-generated SBML BioModule wrapper for Leipold1995_ThrombinFormation-inhibitors.

Source: biomodels_ebi:MODEL1109150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1109150001
"""
...
class SbmlLeipold1995ThrombinformationInhibitors2(biosim.BioModule):
    """BioModule wrapper for SBML model: Leipold1995_ThrombinFormation-inhibitors."""

    def __init__(self, model_path: str = "data/MODEL1109150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leipold1995ThrombinformationInhibitorsModel1109150001Model = SbmlLeipold1995ThrombinformationInhibitors2
