...
"""Auto-generated SBML BioModule wrapper for Chacón-Martínez2016 - Self-organizing plasticity of stem cells and their progeny.

Source: biomodels_ebi:MODEL1612120000
Original: https://www.ebi.ac.uk/biomodels/MODEL1612120000
"""
...
class SbmlChaconMartinez2016SelfOrganizingPlasticityOfStem(biosim.BioModule):
    """BioModule wrapper for SBML model: Chacón-Martínez2016 - Self-organizing plasticity of stem cells and their progeny."""

    def __init__(self, model_path: str = "data/MODEL1612120000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ChacNMartNez2016SelfOrganizingPlasticityOModel1612120000Model = SbmlChaconMartinez2016SelfOrganizingPlasticityOfStem
