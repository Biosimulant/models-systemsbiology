...
"""Auto-generated SBML BioModule wrapper for Calzone2010_Cellfate_Master_Model.

Source: biomodels_ebi:MODEL0912180000
Original: https://www.ebi.ac.uk/biomodels/MODEL0912180000
"""
...
class SbmlCalzone2010CellfateMasterModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Calzone2010_Cellfate_Master_Model."""

    def __init__(self, model_path: str = "data/MODEL0912180000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Calzone2010CellfateMasterModelModel0912180000Model = SbmlCalzone2010CellfateMasterModel
