...
"""Auto-generated SBML BioModule wrapper for Sivakumar2011_NeuralStemCellDifferentiation_Crosstalk.

Source: biomodels_ebi:BIOMD0000000398
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000398
"""
...
class SbmlSivakumar2011NeuralstemcelldifferentiationCrosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: Sivakumar2011_NeuralStemCellDifferentiation_Crosstalk."""

    def __init__(self, model_path: str = "data/BIOMD0000000398.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sivakumar2011NeuralstemcelldifferentiationCrosBiomd0000000398Model = SbmlSivakumar2011NeuralstemcelldifferentiationCrosstalk
