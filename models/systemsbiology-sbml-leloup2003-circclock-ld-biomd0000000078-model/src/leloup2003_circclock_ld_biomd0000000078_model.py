...
"""Auto-generated SBML BioModule wrapper for Leloup2003_CircClock_LD.

Source: biomodels_ebi:BIOMD0000000078
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000078
"""
...
class SbmlLeloup2003CircclockLd(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup2003_CircClock_LD."""

    def __init__(self, model_path: str = "data/BIOMD0000000078.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup2003CircclockLdBiomd0000000078Model = SbmlLeloup2003CircclockLd
