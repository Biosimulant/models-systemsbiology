...
"""Auto-generated SBML BioModule wrapper for DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 1).

Source: biomodels_ebi:MODEL1705030000
Original: https://www.ebi.ac.uk/biomodels/MODEL1705030000
"""
...
class SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids(biosim.BioModule):
    """BioModule wrapper for SBML model: DallePezze2016 - Activation of AMPK and mTOR by amino acids (Model 1)."""

    def __init__(self, model_path: str = "data/MODEL1705030000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallepezze2016ActivationOfAmpkAndMtorByAmModel1705030000Model = SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids
