...
"""Auto-generated SBML BioModule wrapper for Cooper2015 - Modeling the effects of systemic mediators on the inflammatory phase of wound healing.

Source: biomodels_ebi:BIOMD0000000855
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000855
"""
...
class SbmlCooper2015ModelingTheEffectsOfSystemicMediatorsOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Cooper2015 - Modeling the effects of systemic mediators on the inflammatory phase of wound healing."""

    def __init__(self, model_path: str = "data/BIOMD0000000855.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cooper2015ModelingTheEffectsOfSystemicMediBiomd0000000855Model = SbmlCooper2015ModelingTheEffectsOfSystemicMediatorsOn
