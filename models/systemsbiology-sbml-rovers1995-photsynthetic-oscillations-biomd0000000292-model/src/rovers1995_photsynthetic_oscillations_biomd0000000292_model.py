...
"""Auto-generated SBML BioModule wrapper for Rovers1995_Photsynthetic_Oscillations.

Source: biomodels_ebi:BIOMD0000000292
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000292
"""
...
class SbmlRovers1995PhotsyntheticOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Rovers1995_Photsynthetic_Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000292.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rovers1995PhotsyntheticOscillationsBiomd0000000292Model = SbmlRovers1995PhotsyntheticOscillations
