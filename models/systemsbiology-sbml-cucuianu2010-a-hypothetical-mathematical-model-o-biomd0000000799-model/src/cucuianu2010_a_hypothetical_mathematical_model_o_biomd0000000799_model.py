...
"""Auto-generated SBML BioModule wrapper for Cucuianu2010 - A hypothetical-mathematical model of acute myeloid leukaemia pathogenesis.

Source: biomodels_ebi:BIOMD0000000799
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000799
"""
...
class SbmlCucuianu2010AHypotheticalMathematicalModelOfAcute(biosim.BioModule):
    """BioModule wrapper for SBML model: Cucuianu2010 - A hypothetical-mathematical model of acute myeloid leukaemia pathogenesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000799.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cucuianu2010AHypotheticalMathematicalModelOBiomd0000000799Model = SbmlCucuianu2010AHypotheticalMathematicalModelOfAcute
