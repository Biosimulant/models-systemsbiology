...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - iEC7871 GSM model of Quercus suber.

Source: biomodels_ebi:MODEL2205040005
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040005
"""
...
class SbmlCunha2022Iec7871GsmModelOfQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - iEC7871 GSM model of Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022Iec7871GsmModelOfQuercusSuberModel2205040005Model = SbmlCunha2022Iec7871GsmModelOfQuercusSuber
