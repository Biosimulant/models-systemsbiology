...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Mir140-IGFBP5 incoherent feed forward).

Source: biomodels_ebi:MODEL1705170004
Original: https://www.ebi.ac.uk/biomodels/MODEL1705170004
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Mir140-IGFBP5 incoherent feed forward)."""

    def __init__(self, model_path: str = "data/MODEL1705170004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1705170004Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140
