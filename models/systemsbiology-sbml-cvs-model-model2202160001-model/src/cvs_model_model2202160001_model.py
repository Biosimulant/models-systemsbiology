...
"""Auto-generated SBML BioModule wrapper for CVS model.

Source: biomodels_ebi:MODEL2202160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2202160001
"""
...
class SbmlCvsModel(biosim.BioModule):
    """BioModule wrapper for SBML model: CVS model."""

    def __init__(self, model_path: str = "data/MODEL2202160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CvsModelModel2202160001Model = SbmlCvsModel
