...
"""Auto-generated SBML BioModule wrapper for Görlich2003_RanGTP_gradient.

Source: biomodels_ebi:BIOMD0000000192
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000192
"""
...
class SbmlGorlich2003RangtpGradient(biosim.BioModule):
    """BioModule wrapper for SBML model: Görlich2003_RanGTP_gradient."""

    def __init__(self, model_path: str = "data/BIOMD0000000192.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GRlich2003RangtpGradientBiomd0000000192Model = SbmlGorlich2003RangtpGradient
