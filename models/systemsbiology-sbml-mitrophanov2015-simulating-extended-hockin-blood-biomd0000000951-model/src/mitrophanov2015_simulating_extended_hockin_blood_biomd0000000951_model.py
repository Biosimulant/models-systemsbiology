...
"""Auto-generated SBML BioModule wrapper for Mitrophanov2015 - Simulating extended Hockin Blood Coagulation Model under varied pH.

Source: biomodels_ebi:BIOMD0000000951
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000951
"""
...
class SbmlMitrophanov2015SimulatingExtendedHockinBlood(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitrophanov2015 - Simulating extended Hockin Blood Coagulation Model under varied pH."""

    def __init__(self, model_path: str = "data/BIOMD0000000951.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitrophanov2015SimulatingExtendedHockinBloodBiomd0000000951Model = SbmlMitrophanov2015SimulatingExtendedHockinBlood
