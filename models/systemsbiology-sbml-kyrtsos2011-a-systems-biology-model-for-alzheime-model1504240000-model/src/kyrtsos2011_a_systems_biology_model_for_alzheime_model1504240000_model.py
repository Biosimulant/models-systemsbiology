...
"""Auto-generated SBML BioModule wrapper for Kyrtsos2011 - A systems biology model for Alzheimer's disease (Cholesterol in AD).

Source: biomodels_ebi:MODEL1504240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504240000
"""
...
class SbmlKyrtsos2011ASystemsBiologyModelForAlzheimerSDisease(biosim.BioModule):
    """BioModule wrapper for SBML model: Kyrtsos2011 - A systems biology model for Alzheimer's disease (Cholesterol in AD)."""

    def __init__(self, model_path: str = "data/MODEL1504240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kyrtsos2011ASystemsBiologyModelForAlzheimeModel1504240000Model = SbmlKyrtsos2011ASystemsBiologyModelForAlzheimerSDisease
