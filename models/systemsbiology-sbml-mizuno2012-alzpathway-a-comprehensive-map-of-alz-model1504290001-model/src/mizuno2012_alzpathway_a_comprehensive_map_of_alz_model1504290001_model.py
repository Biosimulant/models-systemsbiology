...
"""Auto-generated SBML BioModule wrapper for Mizuno2012 - AlzPathway: a comprehensive map of Alzheimer's disease.

Source: biomodels_ebi:MODEL1504290001
Original: https://www.ebi.ac.uk/biomodels/MODEL1504290001
"""
...
class SbmlMizuno2012AlzpathwayAComprehensiveMapOfAlzheimerS(biosim.BioModule):
    """BioModule wrapper for SBML model: Mizuno2012 - AlzPathway: a comprehensive map of Alzheimer's disease."""

    def __init__(self, model_path: str = "data/MODEL1504290001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mizuno2012AlzpathwayAComprehensiveMapOfAlzModel1504290001Model = SbmlMizuno2012AlzpathwayAComprehensiveMapOfAlzheimerS
