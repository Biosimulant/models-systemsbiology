...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (miR140-SMAD3 double negative feedback).

Source: biomodels_ebi:MODEL1705170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1705170000
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir1402(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (miR140-SMAD3 double negative feedback)."""

    def __init__(self, model_path: str = "data/MODEL1705170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1705170000Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir1402
