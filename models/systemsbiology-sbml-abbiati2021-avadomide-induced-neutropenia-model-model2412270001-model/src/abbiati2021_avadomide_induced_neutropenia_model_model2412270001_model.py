...
"""Auto-generated SBML BioModule wrapper for Abbiati2021_Avadomide-induced neutropenia model.

Source: biomodels_ebi:MODEL2412270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2412270001
"""
...
class SbmlAbbiati2021AvadomideInducedNeutropeniaModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Abbiati2021_Avadomide-induced neutropenia model."""

    def __init__(self, model_path: str = "data/MODEL2412270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Abbiati2021AvadomideInducedNeutropeniaModelModel2412270001Model = SbmlAbbiati2021AvadomideInducedNeutropeniaModel
