...
"""Auto-generated SBML BioModule wrapper for Meyer1991_CalciumSpike_ICC.

Source: biomodels_ebi:BIOMD0000000224
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000224
"""
...
class SbmlMeyer1991CalciumspikeIcc(biosim.BioModule):
    """BioModule wrapper for SBML model: Meyer1991_CalciumSpike_ICC."""

    def __init__(self, model_path: str = "data/BIOMD0000000224.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Meyer1991CalciumspikeIccBiomd0000000224Model = SbmlMeyer1991CalciumspikeIcc
