...
"""Auto-generated SBML BioModule wrapper for Ung2008_EGFR_Endocytosis.

Source: biomodels_ebi:BIOMD0000000205
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000205
"""
...
class SbmlUng2008EgfrEndocytosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Ung2008_EGFR_Endocytosis."""

    def __init__(self, model_path: str = "data/BIOMD0000000205.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ung2008EgfrEndocytosisBiomd0000000205Model = SbmlUng2008EgfrEndocytosis
