...
"""Auto-generated SBML BioModule wrapper for Baldwin1994 - Nondimensionalized Model of Thrombin Production.

Source: biomodels_ebi:MODEL1806010001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806010001
"""
...
class SbmlBaldwin1994NondimensionalizedModelOfThrombinProduction(biosim.BioModule):
    """BioModule wrapper for SBML model: Baldwin1994 - Nondimensionalized Model of Thrombin Production."""

    def __init__(self, model_path: str = "data/MODEL1806010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baldwin1994NondimensionalizedModelOfThrombinModel1806010001Model = SbmlBaldwin1994NondimensionalizedModelOfThrombinProduction
