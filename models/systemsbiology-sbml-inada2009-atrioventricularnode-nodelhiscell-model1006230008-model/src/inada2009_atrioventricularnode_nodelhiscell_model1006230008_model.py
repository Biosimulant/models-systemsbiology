...
"""Auto-generated SBML BioModule wrapper for Inada2009_AtrioventricularNode_NodelHisCell.

Source: biomodels_ebi:MODEL1006230008
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230008
"""
...
class SbmlInada2009AtrioventricularnodeNodelhiscell(biosim.BioModule):
    """BioModule wrapper for SBML model: Inada2009_AtrioventricularNode_NodelHisCell."""

    def __init__(self, model_path: str = "data/MODEL1006230008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Inada2009AtrioventricularnodeNodelhiscellModel1006230008Model = SbmlInada2009AtrioventricularnodeNodelhiscell
