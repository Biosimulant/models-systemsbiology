...
"""Auto-generated SBML BioModule wrapper for Ibrahim2008_Cdc20_Sequestring_Template_Model.

Source: biomodels_ebi:BIOMD0000000194
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000194
"""
...
class SbmlIbrahim2008Cdc20SequestringTemplateModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Ibrahim2008_Cdc20_Sequestring_Template_Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000194.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ibrahim2008Cdc20SequestringTemplateModelBiomd0000000194Model = SbmlIbrahim2008Cdc20SequestringTemplateModel
