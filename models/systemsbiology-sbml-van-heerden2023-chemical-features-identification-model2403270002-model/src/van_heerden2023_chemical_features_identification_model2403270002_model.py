...
"""Auto-generated SBML BioModule wrapper for van-Heerden2023 - Chemical Features Identification for Stage-Specific Antimalarial Compounds.

Source: biomodels_ebi:MODEL2403270002
Original: https://www.ebi.ac.uk/biomodels/MODEL2403270002
"""
...
class SbmlVanHeerden2023ChemicalFeaturesIdentificationForStage(biosim.BioModule):
    """BioModule wrapper for SBML model: van-Heerden2023 - Chemical Features Identification for Stage-Specific Antimalarial Compounds."""

    def __init__(self, model_path: str = "data/MODEL2403270002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VanHeerden2023ChemicalFeaturesIdentificationModel2403270002Model = SbmlVanHeerden2023ChemicalFeaturesIdentificationForStage
