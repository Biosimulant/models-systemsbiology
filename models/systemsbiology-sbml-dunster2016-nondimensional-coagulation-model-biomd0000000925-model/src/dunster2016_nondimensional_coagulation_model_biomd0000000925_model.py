...
"""Auto-generated SBML BioModule wrapper for Dunster2016 - Nondimensional Coagulation Model.

Source: biomodels_ebi:BIOMD0000000925
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000925
"""
...
class SbmlDunster2016NondimensionalCoagulationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Dunster2016 - Nondimensional Coagulation Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000925.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dunster2016NondimensionalCoagulationModelBiomd0000000925Model = SbmlDunster2016NondimensionalCoagulationModel
