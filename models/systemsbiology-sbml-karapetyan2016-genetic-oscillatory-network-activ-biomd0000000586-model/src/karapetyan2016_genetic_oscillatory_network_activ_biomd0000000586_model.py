...
"""Auto-generated SBML BioModule wrapper for Karapetyan2016 - Genetic oscillatory network - Activator Titration Circuit (ATC).

Source: biomodels_ebi:BIOMD0000000586
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000586
"""
...
class SbmlKarapetyan2016GeneticOscillatoryNetworkActivator(biosim.BioModule):
    """BioModule wrapper for SBML model: Karapetyan2016 - Genetic oscillatory network - Activator Titration Circuit (ATC)."""

    def __init__(self, model_path: str = "data/BIOMD0000000586.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karapetyan2016GeneticOscillatoryNetworkActivBiomd0000000586Model = SbmlKarapetyan2016GeneticOscillatoryNetworkActivator
