...
"""Auto-generated SBML BioModule wrapper for Nutsch2005_phototaxis_noncyc_spontaneous.

Source: biomodels_ebi:MODEL0403888565
Original: https://www.ebi.ac.uk/biomodels/MODEL0403888565
"""
...
class SbmlNutsch2005PhototaxisNoncycSpontaneous(biosim.BioModule):
    """BioModule wrapper for SBML model: Nutsch2005_phototaxis_noncyc_spontaneous."""

    def __init__(self, model_path: str = "data/MODEL0403888565.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nutsch2005PhototaxisNoncycSpontaneousModel0403888565Model = SbmlNutsch2005PhototaxisNoncycSpontaneous
