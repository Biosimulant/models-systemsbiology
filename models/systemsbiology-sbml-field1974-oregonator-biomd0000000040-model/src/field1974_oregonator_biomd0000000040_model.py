...
"""Auto-generated SBML BioModule wrapper for Field1974_Oregonator.

Source: biomodels_ebi:BIOMD0000000040
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000040
"""
...
class SbmlField1974Oregonator(biosim.BioModule):
    """BioModule wrapper for SBML model: Field1974_Oregonator."""

    def __init__(self, model_path: str = "data/BIOMD0000000040.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Field1974OregonatorBiomd0000000040Model = SbmlField1974Oregonator
