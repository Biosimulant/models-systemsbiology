...
"""Auto-generated SBML BioModule wrapper for P. pastoris model iMT1026 v3.

Source: biomodels_ebi:MODEL1612130000
Original: https://www.ebi.ac.uk/biomodels/MODEL1612130000
"""
...
class SbmlPPastorisModelImt1026V3(biosim.BioModule):
    """BioModule wrapper for SBML model: P. pastoris model iMT1026 v3."""

    def __init__(self, model_path: str = "data/MODEL1612130000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PPastorisModelImt1026V3Model1612130000Model = SbmlPPastorisModelImt1026V3
