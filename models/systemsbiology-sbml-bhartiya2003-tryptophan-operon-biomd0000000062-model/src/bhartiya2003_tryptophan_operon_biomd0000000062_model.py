...
"""Auto-generated SBML BioModule wrapper for Bhartiya2003_Tryptophan_operon.

Source: biomodels_ebi:BIOMD0000000062
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000062
"""
...
class SbmlBhartiya2003TryptophanOperon(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhartiya2003_Tryptophan_operon."""

    def __init__(self, model_path: str = "data/BIOMD0000000062.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhartiya2003TryptophanOperonBiomd0000000062Model = SbmlBhartiya2003TryptophanOperon
