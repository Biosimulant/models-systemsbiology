...
"""Auto-generated SBML BioModule wrapper for Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics.

Source: biomodels_ebi:BIOMD0000000551
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000551
"""
...
class SbmlDas2010EffectOfAGammaSecretaseInhibitorOnAmyloid(biosim.BioModule):
    """BioModule wrapper for SBML model: Das2010 - Effect of a gamma-secretase inhibitor on Amyloid-beta dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000551.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Das2010EffectOfAGammaSecretaseInhibitorOnBiomd0000000551Model = SbmlDas2010EffectOfAGammaSecretaseInhibitorOnAmyloid
