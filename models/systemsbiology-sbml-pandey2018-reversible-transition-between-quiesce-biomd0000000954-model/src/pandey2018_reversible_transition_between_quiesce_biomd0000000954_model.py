...
"""Auto-generated SBML BioModule wrapper for Pandey2018-reversible transition between quiescence and proliferation.

Source: biomodels_ebi:BIOMD0000000954
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000954
"""
...
class SbmlPandey2018ReversibleTransitionBetweenQuiescenceAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Pandey2018-reversible transition between quiescence and proliferation."""

    def __init__(self, model_path: str = "data/BIOMD0000000954.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pandey2018ReversibleTransitionBetweenQuiesceBiomd0000000954Model = SbmlPandey2018ReversibleTransitionBetweenQuiescenceAnd
