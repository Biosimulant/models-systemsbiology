...
"""Auto-generated SBML BioModule wrapper for Westermark2003_Pancreatic_GlycOsc_basic.

Source: biomodels_ebi:BIOMD0000000225
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000225
"""
...
class SbmlWestermark2003PancreaticGlycoscBasic(biosim.BioModule):
    """BioModule wrapper for SBML model: Westermark2003_Pancreatic_GlycOsc_basic."""

    def __init__(self, model_path: str = "data/BIOMD0000000225.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Westermark2003PancreaticGlycoscBasicBiomd0000000225Model = SbmlWestermark2003PancreaticGlycoscBasic
