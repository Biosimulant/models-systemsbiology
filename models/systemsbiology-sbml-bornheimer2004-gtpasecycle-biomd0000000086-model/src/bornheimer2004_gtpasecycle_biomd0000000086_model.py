...
"""Auto-generated SBML BioModule wrapper for Bornheimer2004_GTPaseCycle.

Source: biomodels_ebi:BIOMD0000000086
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000086
"""
...
class SbmlBornheimer2004Gtpasecycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Bornheimer2004_GTPaseCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000086.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bornheimer2004GtpasecycleBiomd0000000086Model = SbmlBornheimer2004Gtpasecycle
