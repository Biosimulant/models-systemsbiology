...
"""Auto-generated SBML BioModule wrapper for Radosavljevic2009_BioterroristAttack_PanicProtection_1.

Source: biomodels_ebi:BIOMD0000000836
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000836
"""
...
class SbmlRadosavljevic2009BioterroristattackPanicprotection1(biosim.BioModule):
    """BioModule wrapper for SBML model: Radosavljevic2009_BioterroristAttack_PanicProtection_1."""

    def __init__(self, model_path: str = "data/BIOMD0000000836.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Radosavljevic2009BioterroristattackPanicprotecBiomd0000000836Model = SbmlRadosavljevic2009BioterroristattackPanicprotection1
