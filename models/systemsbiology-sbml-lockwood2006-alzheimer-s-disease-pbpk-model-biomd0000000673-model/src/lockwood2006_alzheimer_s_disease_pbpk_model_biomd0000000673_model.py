...
"""Auto-generated SBML BioModule wrapper for Lockwood2006 - Alzheimer's Disease PBPK model.

Source: biomodels_ebi:BIOMD0000000673
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000673
"""
...
class SbmlLockwood2006AlzheimerSDiseasePbpkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Lockwood2006 - Alzheimer's Disease PBPK model."""

    def __init__(self, model_path: str = "data/BIOMD0000000673.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lockwood2006AlzheimerSDiseasePbpkModelBiomd0000000673Model = SbmlLockwood2006AlzheimerSDiseasePbpkModel
