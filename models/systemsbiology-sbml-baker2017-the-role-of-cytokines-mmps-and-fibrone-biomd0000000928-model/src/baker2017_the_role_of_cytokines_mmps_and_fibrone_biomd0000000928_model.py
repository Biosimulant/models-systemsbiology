...
"""Auto-generated SBML BioModule wrapper for Baker2017 - The role of cytokines, MMPs and fibronectin fragments osteoarthritis.

Source: biomodels_ebi:BIOMD0000000928
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000928
"""
...
class SbmlBaker2017TheRoleOfCytokinesMmpsAndFibronectin(biosim.BioModule):
    """BioModule wrapper for SBML model: Baker2017 - The role of cytokines, MMPs and fibronectin fragments osteoarthritis."""

    def __init__(self, model_path: str = "data/BIOMD0000000928.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Baker2017TheRoleOfCytokinesMmpsAndFibroneBiomd0000000928Model = SbmlBaker2017TheRoleOfCytokinesMmpsAndFibronectin
