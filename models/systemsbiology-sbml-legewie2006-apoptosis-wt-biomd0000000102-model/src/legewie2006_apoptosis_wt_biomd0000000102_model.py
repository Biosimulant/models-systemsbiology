...
"""Auto-generated SBML BioModule wrapper for Legewie2006_apoptosis_WT.

Source: biomodels_ebi:BIOMD0000000102
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000102
"""
...
class SbmlLegewie2006ApoptosisWt(biosim.BioModule):
    """BioModule wrapper for SBML model: Legewie2006_apoptosis_WT."""

    def __init__(self, model_path: str = "data/BIOMD0000000102.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Legewie2006ApoptosisWtBiomd0000000102Model = SbmlLegewie2006ApoptosisWt
