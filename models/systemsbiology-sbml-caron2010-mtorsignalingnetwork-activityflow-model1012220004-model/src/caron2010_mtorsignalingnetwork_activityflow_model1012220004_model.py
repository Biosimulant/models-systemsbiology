...
"""Auto-generated SBML BioModule wrapper for Caron2010_mTORsignalingNetwork_ActivityFlow.

Source: biomodels_ebi:MODEL1012220004
Original: https://www.ebi.ac.uk/biomodels/MODEL1012220004
"""
...
class SbmlCaron2010MtorsignalingnetworkActivityflow(biosim.BioModule):
    """BioModule wrapper for SBML model: Caron2010_mTORsignalingNetwork_ActivityFlow."""

    def __init__(self, model_path: str = "data/MODEL1012220004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caron2010MtorsignalingnetworkActivityflowModel1012220004Model = SbmlCaron2010MtorsignalingnetworkActivityflow
