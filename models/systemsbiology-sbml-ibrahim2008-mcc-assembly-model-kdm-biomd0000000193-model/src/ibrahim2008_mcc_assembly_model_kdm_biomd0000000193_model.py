...
"""Auto-generated SBML BioModule wrapper for Ibrahim2008_MCC_assembly_model_KDM.

Source: biomodels_ebi:BIOMD0000000193
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000193
"""
...
class SbmlIbrahim2008MccAssemblyModelKdm(biosim.BioModule):
    """BioModule wrapper for SBML model: Ibrahim2008_MCC_assembly_model_KDM."""

    def __init__(self, model_path: str = "data/BIOMD0000000193.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ibrahim2008MccAssemblyModelKdmBiomd0000000193Model = SbmlIbrahim2008MccAssemblyModelKdm
