...
"""Auto-generated SBML BioModule wrapper for Fisher2006_NFAT_Activation.

Source: biomodels_ebi:BIOMD0000000123
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000123
"""
...
class SbmlFisher2006NfatActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Fisher2006_NFAT_Activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000123.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fisher2006NfatActivationBiomd0000000123Model = SbmlFisher2006NfatActivation
