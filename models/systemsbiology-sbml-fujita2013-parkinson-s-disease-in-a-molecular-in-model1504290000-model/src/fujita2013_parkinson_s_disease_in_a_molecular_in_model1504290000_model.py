...
"""Auto-generated SBML BioModule wrapper for Fujita2013 - Parkinson's disease in a molecular interaction map.

Source: biomodels_ebi:MODEL1504290000
Original: https://www.ebi.ac.uk/biomodels/MODEL1504290000
"""
...
class SbmlFujita2013ParkinsonSDiseaseInAMolecularInteraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Fujita2013 - Parkinson's disease in a molecular interaction map."""

    def __init__(self, model_path: str = "data/MODEL1504290000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fujita2013ParkinsonSDiseaseInAMolecularInModel1504290000Model = SbmlFujita2013ParkinsonSDiseaseInAMolecularInteraction
