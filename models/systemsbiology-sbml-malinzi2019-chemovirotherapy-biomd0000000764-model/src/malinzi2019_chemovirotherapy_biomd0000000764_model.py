...
"""Auto-generated SBML BioModule wrapper for Malinzi2019 - chemovirotherapy.

Source: biomodels_ebi:BIOMD0000000764
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000764
"""
...
class SbmlMalinzi2019Chemovirotherapy(biosim.BioModule):
    """BioModule wrapper for SBML model: Malinzi2019 - chemovirotherapy."""

    def __init__(self, model_path: str = "data/BIOMD0000000764.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Malinzi2019ChemovirotherapyBiomd0000000764Model = SbmlMalinzi2019Chemovirotherapy
