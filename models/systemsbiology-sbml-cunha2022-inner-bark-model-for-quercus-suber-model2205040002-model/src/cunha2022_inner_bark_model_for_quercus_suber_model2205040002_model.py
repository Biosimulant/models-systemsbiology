...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - Inner Bark Model for Quercus suber.

Source: biomodels_ebi:MODEL2205040002
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040002
"""
...
class SbmlCunha2022InnerBarkModelForQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - Inner Bark Model for Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022InnerBarkModelForQuercusSuberModel2205040002Model = SbmlCunha2022InnerBarkModelForQuercusSuber
