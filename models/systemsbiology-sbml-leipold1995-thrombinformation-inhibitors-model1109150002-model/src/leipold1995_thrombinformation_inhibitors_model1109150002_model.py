...
Source: biomodels_ebi:MODEL1109150002
Original: https://www.ebi.ac.uk/biomodels/MODEL1109150002
"""
...
class SbmlLeipold1995ThrombinformationInhibitors(biosim.BioModule):
    """BioModule wrapper for SBML model: Leipold1995_ThrombinFormation+inhibitors."""

    def __init__(self, model_path: str = "data/MODEL1109150002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leipold1995ThrombinformationInhibitorsModel1109150002Model = SbmlLeipold1995ThrombinformationInhibitors
