...
"""Auto-generated SBML BioModule wrapper for Oda2006_TollLikeR.

Source: biomodels_ebi:MODEL2463683119
Original: https://www.ebi.ac.uk/biomodels/MODEL2463683119
"""
...
class SbmlOda2006Tollliker(biosim.BioModule):
    """BioModule wrapper for SBML model: Oda2006_TollLikeR."""

    def __init__(self, model_path: str = "data/MODEL2463683119.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oda2006TolllikerModel2463683119Model = SbmlOda2006Tollliker
