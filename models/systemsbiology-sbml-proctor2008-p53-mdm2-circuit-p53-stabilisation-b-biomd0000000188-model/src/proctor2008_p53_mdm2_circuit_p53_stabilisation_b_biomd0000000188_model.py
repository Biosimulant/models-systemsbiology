...
"""Auto-generated SBML BioModule wrapper for Proctor2008 - p53/Mdm2 circuit - p53 stabilisation by ATM.

Source: biomodels_ebi:BIOMD0000000188
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000188
"""
...
class SbmlProctor2008P53Mdm2CircuitP53StabilisationByAtm(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2008 - p53/Mdm2 circuit - p53 stabilisation by ATM."""

    def __init__(self, model_path: str = "data/BIOMD0000000188.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2008P53Mdm2CircuitP53StabilisationBBiomd0000000188Model = SbmlProctor2008P53Mdm2CircuitP53StabilisationByAtm
