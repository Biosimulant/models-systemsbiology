...
"""Auto-generated SBML BioModule wrapper for Hayer2005_AMPAR_traff_model0.

Source: biomodels_ebi:MODEL9086207764
Original: https://www.ebi.ac.uk/biomodels/MODEL9086207764
"""
...
class SbmlHayer2005AmparTraffModel0(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_AMPAR_traff_model0."""

    def __init__(self, model_path: str = "data/MODEL9086207764.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005AmparTraffModel0Model9086207764Model = SbmlHayer2005AmparTraffModel0
