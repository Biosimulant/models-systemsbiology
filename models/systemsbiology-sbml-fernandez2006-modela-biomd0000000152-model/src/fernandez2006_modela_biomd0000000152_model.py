...
"""Auto-generated SBML BioModule wrapper for Fernandez2006_ModelA.

Source: biomodels_ebi:BIOMD0000000152
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000152
"""
...
class SbmlFernandez2006Modela(biosim.BioModule):
    """BioModule wrapper for SBML model: Fernandez2006_ModelA."""

    def __init__(self, model_path: str = "data/BIOMD0000000152.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fernandez2006ModelaBiomd0000000152Model = SbmlFernandez2006Modela
