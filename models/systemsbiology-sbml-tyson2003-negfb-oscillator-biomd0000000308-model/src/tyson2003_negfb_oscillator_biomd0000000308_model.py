...
"""Auto-generated SBML BioModule wrapper for Tyson2003_NegFB_Oscillator.

Source: biomodels_ebi:BIOMD0000000308
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000308
"""
...
class SbmlTyson2003NegfbOscillator(biosim.BioModule):
    """BioModule wrapper for SBML model: Tyson2003_NegFB_Oscillator."""

    def __init__(self, model_path: str = "data/BIOMD0000000308.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tyson2003NegfbOscillatorBiomd0000000308Model = SbmlTyson2003NegfbOscillator
