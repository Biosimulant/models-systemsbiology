...
"""Auto-generated SBML BioModule wrapper for Wu2006_ATPsynthesis_SkeletalMuscle.

Source: biomodels_ebi:MODEL1006230034
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230034
"""
...
class SbmlWu2006AtpsynthesisSkeletalmuscle(biosim.BioModule):
    """BioModule wrapper for SBML model: Wu2006_ATPsynthesis_SkeletalMuscle."""

    def __init__(self, model_path: str = "data/MODEL1006230034.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wu2006AtpsynthesisSkeletalmuscleModel1006230034Model = SbmlWu2006AtpsynthesisSkeletalmuscle
