...
"""Auto-generated SBML BioModule wrapper for Markevich2004_MAPK_AllRandomElementary.

Source: biomodels_ebi:BIOMD0000000030
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000030
"""
...
class SbmlMarkevich2004MapkAllrandomelementary(biosim.BioModule):
    """BioModule wrapper for SBML model: Markevich2004_MAPK_AllRandomElementary."""

    def __init__(self, model_path: str = "data/BIOMD0000000030.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Markevich2004MapkAllrandomelementaryBiomd0000000030Model = SbmlMarkevich2004MapkAllrandomelementary
