...
"""Auto-generated SBML BioModule wrapper for Akman2008_Circadian_Clock_Model2.

Source: biomodels_ebi:BIOMD0000000214
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000214
"""
...
class SbmlAkman2008CircadianClockModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: Akman2008_Circadian_Clock_Model2."""

    def __init__(self, model_path: str = "data/BIOMD0000000214.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Akman2008CircadianClockModel2Biomd0000000214Model = SbmlAkman2008CircadianClockModel2
