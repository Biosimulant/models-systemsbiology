...
"""Auto-generated SBML BioModule wrapper for Martins2001_glyoxalase.

Source: biomodels_ebi:MODEL6624199343
Original: https://www.ebi.ac.uk/biomodels/MODEL6624199343
"""
...
class SbmlMartins2001Glyoxalase(biosim.BioModule):
    """BioModule wrapper for SBML model: Martins2001_glyoxalase."""

    def __init__(self, model_path: str = "data/MODEL6624199343.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Martins2001GlyoxalaseModel6624199343Model = SbmlMartins2001Glyoxalase
