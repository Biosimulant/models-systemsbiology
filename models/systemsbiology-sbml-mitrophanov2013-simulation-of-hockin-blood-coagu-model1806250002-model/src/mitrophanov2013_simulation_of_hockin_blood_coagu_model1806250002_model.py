...
"""Auto-generated SBML BioModule wrapper for Mitrophanov2013 - Simulation of Hockin Blood Coagulation Model under reduced temperature.

Source: biomodels_ebi:MODEL1806250002
Original: https://www.ebi.ac.uk/biomodels/MODEL1806250002
"""
...
class SbmlMitrophanov2013SimulationOfHockinBloodCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitrophanov2013 - Simulation of Hockin Blood Coagulation Model under reduced temperature."""

    def __init__(self, model_path: str = "data/MODEL1806250002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitrophanov2013SimulationOfHockinBloodCoaguModel1806250002Model = SbmlMitrophanov2013SimulationOfHockinBloodCoagulation
