...
"""Auto-generated SBML BioModule wrapper for Morris1981_MuscleFibre_Voltage_reduced.

Source: biomodels_ebi:BIOMD0000000280
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000280
"""
...
class SbmlMorris1981MusclefibreVoltageReduced(biosim.BioModule):
    """BioModule wrapper for SBML model: Morris1981_MuscleFibre_Voltage_reduced."""

    def __init__(self, model_path: str = "data/BIOMD0000000280.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morris1981MusclefibreVoltageReducedBiomd0000000280Model = SbmlMorris1981MusclefibreVoltageReduced
