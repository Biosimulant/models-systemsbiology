...
"""Auto-generated SBML BioModule wrapper for Santos2018 - Pneumococcal infection in alveoli.

Source: biomodels_ebi:MODEL1805170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1805170001
"""
...
class SbmlSantos2018PneumococcalInfectionInAlveoli(biosim.BioModule):
    """BioModule wrapper for SBML model: Santos2018 - Pneumococcal infection in alveoli."""

    def __init__(self, model_path: str = "data/MODEL1805170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Santos2018PneumococcalInfectionInAlveoliModel1805170001Model = SbmlSantos2018PneumococcalInfectionInAlveoli
