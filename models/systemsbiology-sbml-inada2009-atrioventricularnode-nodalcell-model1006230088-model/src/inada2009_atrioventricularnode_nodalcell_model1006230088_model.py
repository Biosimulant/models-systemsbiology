...
"""Auto-generated SBML BioModule wrapper for Inada2009_AtrioventricularNode_NodalCell.

Source: biomodels_ebi:MODEL1006230088
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230088
"""
...
class SbmlInada2009AtrioventricularnodeNodalcell(biosim.BioModule):
    """BioModule wrapper for SBML model: Inada2009_AtrioventricularNode_NodalCell."""

    def __init__(self, model_path: str = "data/MODEL1006230088.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Inada2009AtrioventricularnodeNodalcellModel1006230088Model = SbmlInada2009AtrioventricularnodeNodalcell
