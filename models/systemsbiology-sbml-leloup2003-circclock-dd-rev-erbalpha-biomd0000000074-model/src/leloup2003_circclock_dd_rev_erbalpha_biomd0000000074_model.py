...
"""Auto-generated SBML BioModule wrapper for Leloup2003_CircClock_DD_REV-ERBalpha.

Source: biomodels_ebi:BIOMD0000000074
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000074
"""
...
class SbmlLeloup2003CircclockDdRevErbalpha(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup2003_CircClock_DD_REV-ERBalpha."""

    def __init__(self, model_path: str = "data/BIOMD0000000074.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup2003CircclockDdRevErbalphaBiomd0000000074Model = SbmlLeloup2003CircclockDdRevErbalpha
