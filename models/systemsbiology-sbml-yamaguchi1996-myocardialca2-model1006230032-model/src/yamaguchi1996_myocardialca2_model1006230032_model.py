...
"""Auto-generated SBML BioModule wrapper for Yamaguchi1996_MyocardialCa2.

Source: biomodels_ebi:MODEL1006230032
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230032
"""
...
class SbmlYamaguchi1996Myocardialca2(biosim.BioModule):
    """BioModule wrapper for SBML model: Yamaguchi1996_MyocardialCa2."""

    def __init__(self, model_path: str = "data/MODEL1006230032.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yamaguchi1996Myocardialca2Model1006230032Model = SbmlYamaguchi1996Myocardialca2
