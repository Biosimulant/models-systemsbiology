...
"""Auto-generated SBML BioModule wrapper for Abu-Soud1999_NOHArginine.

Source: biomodels_ebi:MODEL9088294310
Original: https://www.ebi.ac.uk/biomodels/MODEL9088294310
"""
...
class SbmlAbuSoud1999Noharginine(biosim.BioModule):
    """BioModule wrapper for SBML model: Abu-Soud1999_NOHArginine."""

    def __init__(self, model_path: str = "data/MODEL9088294310.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AbuSoud1999NoharginineModel9088294310Model = SbmlAbuSoud1999Noharginine
