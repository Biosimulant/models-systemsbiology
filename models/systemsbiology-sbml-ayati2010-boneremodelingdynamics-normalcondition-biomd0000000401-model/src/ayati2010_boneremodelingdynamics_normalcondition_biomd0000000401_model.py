...
"""Auto-generated SBML BioModule wrapper for Ayati2010_BoneRemodelingDynamics_NormalCondition.

Source: biomodels_ebi:BIOMD0000000401
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000401
"""
...
class SbmlAyati2010BoneremodelingdynamicsNormalcondition(biosim.BioModule):
    """BioModule wrapper for SBML model: Ayati2010_BoneRemodelingDynamics_NormalCondition."""

    def __init__(self, model_path: str = "data/BIOMD0000000401.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ayati2010BoneremodelingdynamicsNormalconditionBiomd0000000401Model = SbmlAyati2010BoneremodelingdynamicsNormalcondition
