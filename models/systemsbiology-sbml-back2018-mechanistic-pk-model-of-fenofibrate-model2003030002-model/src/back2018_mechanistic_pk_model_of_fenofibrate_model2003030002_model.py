...
"""Auto-generated SBML BioModule wrapper for Back2018 - Mechanistic PK model of Fenofibrate.

Source: biomodels_ebi:MODEL2003030002
Original: https://www.ebi.ac.uk/biomodels/MODEL2003030002
"""
...
class SbmlBack2018MechanisticPkModelOfFenofibrate(biosim.BioModule):
    """BioModule wrapper for SBML model: Back2018 - Mechanistic PK model of Fenofibrate."""

    def __init__(self, model_path: str = "data/MODEL2003030002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Back2018MechanisticPkModelOfFenofibrateModel2003030002Model = SbmlBack2018MechanisticPkModelOfFenofibrate
