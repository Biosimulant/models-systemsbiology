...
"""Auto-generated SBML BioModule wrapper for Larsen2004_CalciumSpiking_EnzymeBinding.

Source: biomodels_ebi:BIOMD0000000331
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000331
"""
...
class SbmlLarsen2004CalciumspikingEnzymebinding(biosim.BioModule):
    """BioModule wrapper for SBML model: Larsen2004_CalciumSpiking_EnzymeBinding."""

    def __init__(self, model_path: str = "data/BIOMD0000000331.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Larsen2004CalciumspikingEnzymebindingBiomd0000000331Model = SbmlLarsen2004CalciumspikingEnzymebinding
