...
"""Auto-generated SBML BioModule wrapper for Reed2004 - Methionine Cycle.

Source: biomodels_ebi:BIOMD0000000698
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000698
"""
...
class SbmlReed2004MethionineCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Reed2004 - Methionine Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000698.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reed2004MethionineCycleBiomd0000000698Model = SbmlReed2004MethionineCycle
