...
"""Auto-generated SBML BioModule wrapper for Keating2019 -  Minimal model demonstrating SBML Level 3 packages..

Source: biomodels_ebi:MODEL1904090001
Original: https://www.ebi.ac.uk/biomodels/MODEL1904090001
"""
...
class SbmlKeating2019MinimalModelDemonstratingSbmlLevel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Keating2019 -  Minimal model demonstrating SBML Level 3 packages.."""

    def __init__(self, model_path: str = "data/MODEL1904090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Keating2019MinimalModelDemonstratingSbmlLevModel1904090001Model = SbmlKeating2019MinimalModelDemonstratingSbmlLevel3
