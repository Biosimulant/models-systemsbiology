...
"""Auto-generated SBML BioModule wrapper for Ayati2010_BoneRemodelingDynamics_WithTumour.

Source: biomodels_ebi:BIOMD0000000402
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000402
"""
...
class SbmlAyati2010BoneremodelingdynamicsWithtumour(biosim.BioModule):
    """BioModule wrapper for SBML model: Ayati2010_BoneRemodelingDynamics_WithTumour."""

    def __init__(self, model_path: str = "data/BIOMD0000000402.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ayati2010BoneremodelingdynamicsWithtumourBiomd0000000402Model = SbmlAyati2010BoneremodelingdynamicsWithtumour
