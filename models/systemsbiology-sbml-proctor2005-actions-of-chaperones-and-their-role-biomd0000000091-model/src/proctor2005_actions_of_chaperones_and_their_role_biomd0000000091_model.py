...
"""Auto-generated SBML BioModule wrapper for Proctor2005 - Actions of chaperones and their role in ageing.

Source: biomodels_ebi:BIOMD0000000091
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000091
"""
...
class SbmlProctor2005ActionsOfChaperonesAndTheirRoleInAgeing(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2005 - Actions of chaperones and their role in ageing."""

    def __init__(self, model_path: str = "data/BIOMD0000000091.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2005ActionsOfChaperonesAndTheirRoleBiomd0000000091Model = SbmlProctor2005ActionsOfChaperonesAndTheirRoleInAgeing
