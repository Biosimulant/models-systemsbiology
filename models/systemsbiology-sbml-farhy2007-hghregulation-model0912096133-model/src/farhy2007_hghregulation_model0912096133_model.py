...
"""Auto-generated SBML BioModule wrapper for Farhy2007_hGHregulation.

Source: biomodels_ebi:MODEL0912096133
Original: https://www.ebi.ac.uk/biomodels/MODEL0912096133
"""
...
class SbmlFarhy2007Hghregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Farhy2007_hGHregulation."""

    def __init__(self, model_path: str = "data/MODEL0912096133.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Farhy2007HghregulationModel0912096133Model = SbmlFarhy2007Hghregulation
