...
"""Auto-generated SBML BioModule wrapper for Lo2016 – IBD Response to Anti-TNFα treatment.

Source: biomodels_ebi:MODEL2505090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2505090001
"""
...
class SbmlLo2016IbdResponseToAntiTnfTreatment(biosim.BioModule):
    """BioModule wrapper for SBML model: Lo2016 – IBD Response to Anti-TNFα treatment."""

    def __init__(self, model_path: str = "data/MODEL2505090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lo2016IbdResponseToAntiTnfTreatmentModel2505090001Model = SbmlLo2016IbdResponseToAntiTnfTreatment
