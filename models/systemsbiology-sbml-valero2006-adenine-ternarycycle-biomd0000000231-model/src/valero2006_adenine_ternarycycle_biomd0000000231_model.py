...
"""Auto-generated SBML BioModule wrapper for Valero2006_Adenine_TernaryCycle.

Source: biomodels_ebi:BIOMD0000000231
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000231
"""
...
class SbmlValero2006AdenineTernarycycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Valero2006_Adenine_TernaryCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000231.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Valero2006AdenineTernarycycleBiomd0000000231Model = SbmlValero2006AdenineTernarycycle
