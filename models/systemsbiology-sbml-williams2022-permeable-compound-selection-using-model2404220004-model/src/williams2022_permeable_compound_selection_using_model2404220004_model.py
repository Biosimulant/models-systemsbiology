...
"""Auto-generated SBML BioModule wrapper for Williams2022 - Permeable compound selection using in vitro ADME data (PAMPA pH 5)..

Source: biomodels_ebi:MODEL2404220004
Original: https://www.ebi.ac.uk/biomodels/MODEL2404220004
"""
...
class SbmlWilliams2022PermeableCompoundSelectionUsingInVitro(biosim.BioModule):
    """BioModule wrapper for SBML model: Williams2022 - Permeable compound selection using in vitro ADME data (PAMPA pH 5).."""

    def __init__(self, model_path: str = "data/MODEL2404220004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Williams2022PermeableCompoundSelectionUsingModel2404220004Model = SbmlWilliams2022PermeableCompoundSelectionUsingInVitro
