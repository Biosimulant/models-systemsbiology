...
"""Auto-generated SBML BioModule wrapper for Bakker1997_Glycolysis.

Source: biomodels_ebi:MODEL1101100000
Original: https://www.ebi.ac.uk/biomodels/MODEL1101100000
"""
...
class SbmlBakker1997Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bakker1997_Glycolysis."""

    def __init__(self, model_path: str = "data/MODEL1101100000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bakker1997GlycolysisModel1101100000Model = SbmlBakker1997Glycolysis
