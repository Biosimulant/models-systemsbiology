...
"""Auto-generated SBML BioModule wrapper for Jiménez-Luna2021 - Coloring molecules for plasma protein binding prediction.

Source: biomodels_ebi:MODEL2405210005
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210005
"""
...
class SbmlJimenezLuna2021ColoringMoleculesForPlasmaProtein(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiménez-Luna2021 - Coloring molecules for plasma protein binding prediction."""

    def __init__(self, model_path: str = "data/MODEL2405210005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
JimNezLuna2021ColoringMoleculesForPlasmaPModel2405210005Model = SbmlJimenezLuna2021ColoringMoleculesForPlasmaProtein
