...
"""Auto-generated SBML BioModule wrapper for PpaCore_3HP.

Source: biomodels_ebi:MODEL2210090004
Original: https://www.ebi.ac.uk/biomodels/MODEL2210090004
"""
...
class SbmlPpacore3hp(biosim.BioModule):
    """BioModule wrapper for SBML model: PpaCore_3HP."""

    def __init__(self, model_path: str = "data/MODEL2210090004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ppacore3hpModel2210090004Model = SbmlPpacore3hp
