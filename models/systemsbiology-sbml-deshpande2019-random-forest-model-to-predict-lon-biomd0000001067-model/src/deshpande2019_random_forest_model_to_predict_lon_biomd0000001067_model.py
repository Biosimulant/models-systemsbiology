...
"""Auto-generated SBML BioModule wrapper for Deshpande2019 - Random Forest model to predict long non-coding RNAs from coding RNAs in Zea Mays plant transcriptomic data.

Source: biomodels_ebi:BIOMD0000001067
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001067
"""
...
class SbmlDeshpande2019RandomForestModelToPredictLongNon(biosim.BioModule):
    """BioModule wrapper for SBML model: Deshpande2019 - Random Forest model to predict long non-coding RNAs from coding RNAs in Zea Mays plant transcriptomic data."""

    def __init__(self, model_path: str = "data/BIOMD0000001067.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Deshpande2019RandomForestModelToPredictLonBiomd0000001067Model = SbmlDeshpande2019RandomForestModelToPredictLongNon
