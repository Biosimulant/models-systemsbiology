...
"""Auto-generated SBML BioModule wrapper for Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans variant).

Source: biomodels_ebi:BIOMD0000000524
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000524
"""
...
class SbmlKallenberger2014Cd95lInducedApoptosisInitiatedBy2(biosim.BioModule):
    """BioModule wrapper for SBML model: Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, wild-type HeLa cells (cis/trans variant)."""

    def __init__(self, model_path: str = "data/BIOMD0000000524.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kallenberger2014Cd95lInducedApoptosisInitiatBiomd0000000524Model = SbmlKallenberger2014Cd95lInducedApoptosisInitiatedBy2
