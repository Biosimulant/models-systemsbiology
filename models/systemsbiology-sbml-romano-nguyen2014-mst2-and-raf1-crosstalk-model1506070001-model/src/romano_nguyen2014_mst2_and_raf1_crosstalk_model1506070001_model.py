...
"""Auto-generated SBML BioModule wrapper for Romano-Nguyen2014 -  MST2 and Raf1 Crosstalk.

Source: biomodels_ebi:MODEL1506070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1506070001
"""
...
class SbmlRomanoNguyen2014Mst2AndRaf1Crosstalk(biosim.BioModule):
    """BioModule wrapper for SBML model: Romano-Nguyen2014 -  MST2 and Raf1 Crosstalk."""

    def __init__(self, model_path: str = "data/MODEL1506070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RomanoNguyen2014Mst2AndRaf1CrosstalkModel1506070001Model = SbmlRomanoNguyen2014Mst2AndRaf1Crosstalk
