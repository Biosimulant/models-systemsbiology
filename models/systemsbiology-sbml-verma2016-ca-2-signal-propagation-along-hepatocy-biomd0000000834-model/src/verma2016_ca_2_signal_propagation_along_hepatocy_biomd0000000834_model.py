...
"""Auto-generated SBML BioModule wrapper for Verma2016 - Ca(2+) Signal Propagation Along Hepatocyte Cords.

Source: biomodels_ebi:BIOMD0000000834
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000834
"""
...
class SbmlVerma2016Ca2SignalPropagationAlongHepatocyteCords(biosim.BioModule):
    """BioModule wrapper for SBML model: Verma2016 - Ca(2+) Signal Propagation Along Hepatocyte Cords."""

    def __init__(self, model_path: str = "data/BIOMD0000000834.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Verma2016Ca2SignalPropagationAlongHepatocyBiomd0000000834Model = SbmlVerma2016Ca2SignalPropagationAlongHepatocyteCords
