...
"""Auto-generated SBML BioModule wrapper for Tanos2008 - Blood coagulation and Snake Venom.

Source: biomodels_ebi:MODEL1806150001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806150001
"""
...
class SbmlTanos2008BloodCoagulationAndSnakeVenom(biosim.BioModule):
    """BioModule wrapper for SBML model: Tanos2008 - Blood coagulation and Snake Venom."""

    def __init__(self, model_path: str = "data/MODEL1806150001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tanos2008BloodCoagulationAndSnakeVenomModel1806150001Model = SbmlTanos2008BloodCoagulationAndSnakeVenom
