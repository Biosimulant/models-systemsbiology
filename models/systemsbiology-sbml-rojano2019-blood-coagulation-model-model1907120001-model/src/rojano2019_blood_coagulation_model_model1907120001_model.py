...
"""Auto-generated SBML BioModule wrapper for Rojano2019 - Blood Coagulation Model.

Source: biomodels_ebi:MODEL1907120001
Original: https://www.ebi.ac.uk/biomodels/MODEL1907120001
"""
...
class SbmlRojano2019BloodCoagulationModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Rojano2019 - Blood Coagulation Model."""

    def __init__(self, model_path: str = "data/MODEL1907120001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rojano2019BloodCoagulationModelModel1907120001Model = SbmlRojano2019BloodCoagulationModel
