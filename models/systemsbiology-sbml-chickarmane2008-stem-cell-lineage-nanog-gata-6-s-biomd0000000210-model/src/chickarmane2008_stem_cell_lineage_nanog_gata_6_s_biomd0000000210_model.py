...
"""Auto-generated SBML BioModule wrapper for Chickarmane2008 - Stem cell lineage - NANOG GATA-6 switch.

Source: biomodels_ebi:BIOMD0000000210
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000210
"""
...
class SbmlChickarmane2008StemCellLineageNanogGata6Switch(biosim.BioModule):
    """BioModule wrapper for SBML model: Chickarmane2008 - Stem cell lineage - NANOG GATA-6 switch."""

    def __init__(self, model_path: str = "data/BIOMD0000000210.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chickarmane2008StemCellLineageNanogGata6SBiomd0000000210Model = SbmlChickarmane2008StemCellLineageNanogGata6Switch
