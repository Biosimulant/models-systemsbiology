...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_K1par-8mMAP).

Source: biomodels_ebi:MODEL1907260014
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260014
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoK1par8mmap(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_K1par-8mMAP)."""

    def __init__(self, model_path: str = "data/MODEL1907260014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoKModel1907260014Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoK1par8mmap
