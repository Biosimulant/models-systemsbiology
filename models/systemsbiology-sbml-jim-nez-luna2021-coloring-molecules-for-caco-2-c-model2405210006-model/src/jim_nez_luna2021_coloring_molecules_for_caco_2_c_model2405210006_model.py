...
"""Auto-generated SBML BioModule wrapper for Jiménez-Luna2021 - Coloring molecules for Caco-2 cell permeability.

Source: biomodels_ebi:MODEL2405210006
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210006
"""
...
class SbmlJimenezLuna2021ColoringMoleculesForCaco2Cell(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiménez-Luna2021 - Coloring molecules for Caco-2 cell permeability."""

    def __init__(self, model_path: str = "data/MODEL2405210006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
JimNezLuna2021ColoringMoleculesForCaco2CModel2405210006Model = SbmlJimenezLuna2021ColoringMoleculesForCaco2Cell
