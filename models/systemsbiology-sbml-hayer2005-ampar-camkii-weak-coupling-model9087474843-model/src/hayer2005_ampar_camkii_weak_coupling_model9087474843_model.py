...
"""Auto-generated SBML BioModule wrapper for Hayer2005_AMPAR_CaMKII_weak_coupling.

Source: biomodels_ebi:MODEL9087474843
Original: https://www.ebi.ac.uk/biomodels/MODEL9087474843
"""
...
class SbmlHayer2005AmparCamkiiWeakCoupling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_AMPAR_CaMKII_weak_coupling."""

    def __init__(self, model_path: str = "data/MODEL9087474843.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005AmparCamkiiWeakCouplingModel9087474843Model = SbmlHayer2005AmparCamkiiWeakCoupling
