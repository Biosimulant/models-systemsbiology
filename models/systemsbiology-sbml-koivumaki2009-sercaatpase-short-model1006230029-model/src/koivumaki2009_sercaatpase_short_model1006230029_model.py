...
"""Auto-generated SBML BioModule wrapper for Koivumaki2009_SERCAATPase_short.

Source: biomodels_ebi:MODEL1006230029
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230029
"""
...
class SbmlKoivumaki2009SercaatpaseShort(biosim.BioModule):
    """BioModule wrapper for SBML model: Koivumaki2009_SERCAATPase_short."""

    def __init__(self, model_path: str = "data/MODEL1006230029.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koivumaki2009SercaatpaseShortModel1006230029Model = SbmlKoivumaki2009SercaatpaseShort
