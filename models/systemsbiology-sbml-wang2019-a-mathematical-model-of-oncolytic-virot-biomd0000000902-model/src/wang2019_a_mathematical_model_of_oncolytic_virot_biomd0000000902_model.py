...
"""Auto-generated SBML BioModule wrapper for Wang2019 - A mathematical model of oncolytic virotherapy with time delay.

Source: biomodels_ebi:BIOMD0000000902
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000902
"""
...
class SbmlWang2019AMathematicalModelOfOncolyticVirotherapyWith2(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2019 - A mathematical model of oncolytic virotherapy with time delay."""

    def __init__(self, model_path: str = "data/BIOMD0000000902.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2019AMathematicalModelOfOncolyticVirotBiomd0000000902Model = SbmlWang2019AMathematicalModelOfOncolyticVirotherapyWith2
