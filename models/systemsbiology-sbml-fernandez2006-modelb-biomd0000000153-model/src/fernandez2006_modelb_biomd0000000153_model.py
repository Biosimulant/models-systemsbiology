...
"""Auto-generated SBML BioModule wrapper for Fernandez2006_ModelB.

Source: biomodels_ebi:BIOMD0000000153
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000153
"""
...
class SbmlFernandez2006Modelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Fernandez2006_ModelB."""

    def __init__(self, model_path: str = "data/BIOMD0000000153.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fernandez2006ModelbBiomd0000000153Model = SbmlFernandez2006Modelb
