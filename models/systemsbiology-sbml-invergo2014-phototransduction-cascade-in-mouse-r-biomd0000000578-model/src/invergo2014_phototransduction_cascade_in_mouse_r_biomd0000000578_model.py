...
"""Auto-generated SBML BioModule wrapper for Invergo2014 - Phototransduction cascade in mouse rod cells.

Source: biomodels_ebi:BIOMD0000000578
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000578
"""
...
class SbmlInvergo2014PhototransductionCascadeInMouseRodCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Invergo2014 - Phototransduction cascade in mouse rod cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000578.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Invergo2014PhototransductionCascadeInMouseRBiomd0000000578Model = SbmlInvergo2014PhototransductionCascadeInMouseRodCells
