...
"""Auto-generated SBML BioModule wrapper for Gidvani2012 - DNA replication initiation model in S. Cevevisiae.

Source: biomodels_ebi:MODEL2003180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003180001
"""
...
class SbmlGidvani2012DnaReplicationInitiationModelInSCevevisiae(biosim.BioModule):
    """BioModule wrapper for SBML model: Gidvani2012 - DNA replication initiation model in S. Cevevisiae."""

    def __init__(self, model_path: str = "data/MODEL2003180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gidvani2012DnaReplicationInitiationModelInModel2003180001Model = SbmlGidvani2012DnaReplicationInitiationModelInSCevevisiae
