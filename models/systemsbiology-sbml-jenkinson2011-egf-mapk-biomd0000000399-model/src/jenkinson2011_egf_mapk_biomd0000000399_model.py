...
"""Auto-generated SBML BioModule wrapper for Jenkinson2011_EGF_MAPK.

Source: biomodels_ebi:BIOMD0000000399
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000399
"""
...
class SbmlJenkinson2011EgfMapk(biosim.BioModule):
    """BioModule wrapper for SBML model: Jenkinson2011_EGF_MAPK."""

    def __init__(self, model_path: str = "data/BIOMD0000000399.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jenkinson2011EgfMapkBiomd0000000399Model = SbmlJenkinson2011EgfMapk
