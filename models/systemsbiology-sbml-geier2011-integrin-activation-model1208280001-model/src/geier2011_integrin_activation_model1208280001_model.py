...
"""Auto-generated SBML BioModule wrapper for Geier2011 - Integrin activation.

Source: biomodels_ebi:MODEL1208280001
Original: https://www.ebi.ac.uk/biomodels/MODEL1208280001
"""
...
class SbmlGeier2011IntegrinActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Geier2011 - Integrin activation."""

    def __init__(self, model_path: str = "data/MODEL1208280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Geier2011IntegrinActivationModel1208280001Model = SbmlGeier2011IntegrinActivation
