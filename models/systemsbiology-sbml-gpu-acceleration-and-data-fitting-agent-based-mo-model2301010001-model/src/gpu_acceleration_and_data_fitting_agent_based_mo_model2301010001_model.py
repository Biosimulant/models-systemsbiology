...
"""Auto-generated SBML BioModule wrapper for GPU acceleration and data fitting: Agent-based models of viral infections can now be parameterized in hours.

Source: biomodels_ebi:MODEL2301010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2301010001
"""
...
class SbmlGpuAccelerationAndDataFittingAgentBasedModelsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: GPU acceleration and data fitting: Agent-based models of viral infections can now be parameterized in hours."""

    def __init__(self, model_path: str = "data/MODEL2301010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GpuAccelerationAndDataFittingAgentBasedMoModel2301010001Model = SbmlGpuAccelerationAndDataFittingAgentBasedModelsOf
