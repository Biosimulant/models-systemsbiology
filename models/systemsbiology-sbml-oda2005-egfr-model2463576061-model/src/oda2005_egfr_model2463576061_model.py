...
"""Auto-generated SBML BioModule wrapper for Oda2005_EGFR.

Source: biomodels_ebi:MODEL2463576061
Original: https://www.ebi.ac.uk/biomodels/MODEL2463576061
"""
...
class SbmlOda2005Egfr(biosim.BioModule):
    """BioModule wrapper for SBML model: Oda2005_EGFR."""

    def __init__(self, model_path: str = "data/MODEL2463576061.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oda2005EgfrModel2463576061Model = SbmlOda2005Egfr
