...
"""Auto-generated SBML BioModule wrapper for Goldbeter1990_CalciumSpike_CICR.

Source: biomodels_ebi:BIOMD0000000098
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000098
"""
...
class SbmlGoldbeter1990CalciumspikeCicr(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter1990_CalciumSpike_CICR."""

    def __init__(self, model_path: str = "data/BIOMD0000000098.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1990CalciumspikeCicrBiomd0000000098Model = SbmlGoldbeter1990CalciumspikeCicr
