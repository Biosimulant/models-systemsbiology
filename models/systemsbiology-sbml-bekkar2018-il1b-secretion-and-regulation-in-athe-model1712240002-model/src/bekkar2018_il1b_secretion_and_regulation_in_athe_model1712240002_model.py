...
"""Auto-generated SBML BioModule wrapper for Bekkar2018 - IL1B secretion and regulation in atherosclerosis.

Source: biomodels_ebi:MODEL1712240002
Original: https://www.ebi.ac.uk/biomodels/MODEL1712240002
"""
...
class SbmlBekkar2018Il1bSecretionAndRegulationInAtherosclerosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bekkar2018 - IL1B secretion and regulation in atherosclerosis."""

    def __init__(self, model_path: str = "data/MODEL1712240002.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bekkar2018Il1bSecretionAndRegulationInAtheModel1712240002Model = SbmlBekkar2018Il1bSecretionAndRegulationInAtherosclerosis
