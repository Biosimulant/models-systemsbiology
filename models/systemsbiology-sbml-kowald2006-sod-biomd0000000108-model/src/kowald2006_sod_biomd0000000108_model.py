...
"""Auto-generated SBML BioModule wrapper for Kowald2006_SOD.

Source: biomodels_ebi:BIOMD0000000108
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000108
"""
...
class SbmlKowald2006Sod(biosim.BioModule):
    """BioModule wrapper for SBML model: Kowald2006_SOD."""

    def __init__(self, model_path: str = "data/BIOMD0000000108.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kowald2006SodBiomd0000000108Model = SbmlKowald2006Sod
