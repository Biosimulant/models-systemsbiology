...
"""Auto-generated SBML BioModule wrapper for Sen2013 - Phospholipid Synthesis in P.knowlesi.

Source: biomodels_ebi:BIOMD0000000495
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000495
"""
...
class SbmlSen2013PhospholipidSynthesisInPKnowlesi(biosim.BioModule):
    """BioModule wrapper for SBML model: Sen2013 - Phospholipid Synthesis in P.knowlesi."""

    def __init__(self, model_path: str = "data/BIOMD0000000495.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sen2013PhospholipidSynthesisInPKnowlesiBiomd0000000495Model = SbmlSen2013PhospholipidSynthesisInPKnowlesi
