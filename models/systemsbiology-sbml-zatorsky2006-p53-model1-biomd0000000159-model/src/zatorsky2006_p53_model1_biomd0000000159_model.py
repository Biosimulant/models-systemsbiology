...
"""Auto-generated SBML BioModule wrapper for Zatorsky2006_p53_Model1.

Source: biomodels_ebi:BIOMD0000000159
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000159
"""
...
class SbmlZatorsky2006P53Model1(biosim.BioModule):
    """BioModule wrapper for SBML model: Zatorsky2006_p53_Model1."""

    def __init__(self, model_path: str = "data/BIOMD0000000159.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zatorsky2006P53Model1Biomd0000000159Model = SbmlZatorsky2006P53Model1
