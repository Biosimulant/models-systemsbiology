...
"""Auto-generated SBML BioModule wrapper for Wodarz2003 - Cytotoxic T lymphocyte cross-priming.

Source: biomodels_ebi:BIOMD0000000685
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000685
"""
...
class SbmlWodarz2003CytotoxicTLymphocyteCrossPriming(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2003 - Cytotoxic T lymphocyte cross-priming."""

    def __init__(self, model_path: str = "data/BIOMD0000000685.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2003CytotoxicTLymphocyteCrossPrimingBiomd0000000685Model = SbmlWodarz2003CytotoxicTLymphocyteCrossPriming
