...
"""Auto-generated SBML BioModule wrapper for Graham2013 - Role of osteocytes in targeted bone remodeling.

Source: biomodels_ebi:BIOMD0000000721
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000721
"""
...
class SbmlGraham2013RoleOfOsteocytesInTargetedBoneRemodeling(biosim.BioModule):
    """BioModule wrapper for SBML model: Graham2013 - Role of osteocytes in targeted bone remodeling."""

    def __init__(self, model_path: str = "data/BIOMD0000000721.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Graham2013RoleOfOsteocytesInTargetedBoneRBiomd0000000721Model = SbmlGraham2013RoleOfOsteocytesInTargetedBoneRemodeling
