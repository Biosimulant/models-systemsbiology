...
"""Auto-generated SBML BioModule wrapper for Chance1952_Catalase_Mechanism.

Source: biomodels_ebi:BIOMD0000000282
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000282
"""
...
class SbmlChance1952CatalaseMechanism(biosim.BioModule):
    """BioModule wrapper for SBML model: Chance1952_Catalase_Mechanism."""

    def __init__(self, model_path: str = "data/BIOMD0000000282.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chance1952CatalaseMechanismBiomd0000000282Model = SbmlChance1952CatalaseMechanism
