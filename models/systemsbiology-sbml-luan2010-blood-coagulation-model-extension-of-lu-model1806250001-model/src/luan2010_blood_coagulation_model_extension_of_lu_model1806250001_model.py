...
"""Auto-generated SBML BioModule wrapper for Luan2010 - Blood Coagulation Model (extension of Luan2007).

Source: biomodels_ebi:MODEL1806250001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806250001
"""
...
class SbmlLuan2010BloodCoagulationModelExtensionOfLuan2007(biosim.BioModule):
    """BioModule wrapper for SBML model: Luan2010 - Blood Coagulation Model (extension of Luan2007)."""

    def __init__(self, model_path: str = "data/MODEL1806250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luan2010BloodCoagulationModelExtensionOfLuModel1806250001Model = SbmlLuan2010BloodCoagulationModelExtensionOfLuan2007
