...
"""Auto-generated SBML BioModule wrapper for Whitcomb2004_Bicarbonate_Pancreas.

Source: biomodels_ebi:BIOMD0000000327
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000327
"""
...
class SbmlWhitcomb2004BicarbonatePancreas(biosim.BioModule):
    """BioModule wrapper for SBML model: Whitcomb2004_Bicarbonate_Pancreas."""

    def __init__(self, model_path: str = "data/BIOMD0000000327.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Whitcomb2004BicarbonatePancreasBiomd0000000327Model = SbmlWhitcomb2004BicarbonatePancreas
