...
"""Auto-generated SBML BioModule wrapper for HCV data fitting.

Source: biomodels_ebi:MODEL1807030001
Original: https://www.ebi.ac.uk/biomodels/MODEL1807030001
"""
...
class SbmlHcvDataFitting(biosim.BioModule):
    """BioModule wrapper for SBML model: HCV data fitting."""

    def __init__(self, model_path: str = "data/MODEL1807030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HcvDataFittingModel1807030001Model = SbmlHcvDataFitting
