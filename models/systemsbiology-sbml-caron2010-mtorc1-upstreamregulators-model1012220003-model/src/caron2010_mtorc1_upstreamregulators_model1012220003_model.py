...
"""Auto-generated SBML BioModule wrapper for Caron2010_mTORC1_UpstreamRegulators.

Source: biomodels_ebi:MODEL1012220003
Original: https://www.ebi.ac.uk/biomodels/MODEL1012220003
"""
...
class SbmlCaron2010Mtorc1Upstreamregulators(biosim.BioModule):
    """BioModule wrapper for SBML model: Caron2010_mTORC1_UpstreamRegulators."""

    def __init__(self, model_path: str = "data/MODEL1012220003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caron2010Mtorc1UpstreamregulatorsModel1012220003Model = SbmlCaron2010Mtorc1Upstreamregulators
