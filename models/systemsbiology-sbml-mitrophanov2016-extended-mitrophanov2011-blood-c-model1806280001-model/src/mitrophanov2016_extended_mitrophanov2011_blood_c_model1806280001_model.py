...
"""Auto-generated SBML BioModule wrapper for Mitrophanov2016 - Extended Mitrophanov2011 Blood Coagulation Model (additional thrombin reactions).

Source: biomodels_ebi:MODEL1806280001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806280001
"""
...
class SbmlMitrophanov2016ExtendedMitrophanov2011BloodCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitrophanov2016 - Extended Mitrophanov2011 Blood Coagulation Model (additional thrombin reactions)."""

    def __init__(self, model_path: str = "data/MODEL1806280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitrophanov2016ExtendedMitrophanov2011BloodCModel1806280001Model = SbmlMitrophanov2016ExtendedMitrophanov2011BloodCoagulation
