...
"""Auto-generated SBML BioModule wrapper for Talarmain2022- Model of JAK2/TET2/HOXA9 in myeloproliferative neoplasms.

Source: biomodels_ebi:MODEL2212110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2212110001
"""
...
class SbmlTalarmain2022ModelOfJak2Tet2Hoxa9In(biosim.BioModule):
    """BioModule wrapper for SBML model: Talarmain2022- Model of JAK2/TET2/HOXA9 in myeloproliferative neoplasms."""

    def __init__(self, model_path: str = "data/MODEL2212110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Talarmain2022ModelOfJak2Tet2Hoxa9InMyelopModel2212110001Model = SbmlTalarmain2022ModelOfJak2Tet2Hoxa9In
