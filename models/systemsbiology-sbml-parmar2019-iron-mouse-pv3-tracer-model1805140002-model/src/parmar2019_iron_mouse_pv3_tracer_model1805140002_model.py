...
"""Auto-generated SBML BioModule wrapper for Parmar2019 - Iron Mouse PV3 - tracer.

Source: biomodels_ebi:MODEL1805140002
Original: https://www.ebi.ac.uk/biomodels/MODEL1805140002
"""
...
class SbmlParmar2019IronMousePv3Tracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Parmar2019 - Iron Mouse PV3 - tracer."""

    def __init__(self, model_path: str = "data/MODEL1805140002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Parmar2019IronMousePv3TracerModel1805140002Model = SbmlParmar2019IronMousePv3Tracer
