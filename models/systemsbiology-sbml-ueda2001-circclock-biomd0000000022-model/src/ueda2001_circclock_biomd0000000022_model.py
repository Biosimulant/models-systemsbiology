...
"""Auto-generated SBML BioModule wrapper for Ueda2001_CircClock.

Source: biomodels_ebi:BIOMD0000000022
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000022
"""
...
class SbmlUeda2001Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Ueda2001_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000022.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ueda2001CircclockBiomd0000000022Model = SbmlUeda2001Circclock
