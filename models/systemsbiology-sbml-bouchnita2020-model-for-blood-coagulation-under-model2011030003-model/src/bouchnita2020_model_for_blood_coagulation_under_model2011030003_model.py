...
"""Auto-generated SBML BioModule wrapper for Bouchnita2020 - Model for blood coagulation under venous flow condition.

Source: biomodels_ebi:MODEL2011030003
Original: https://www.ebi.ac.uk/biomodels/MODEL2011030003
"""
...
class SbmlBouchnita2020ModelForBloodCoagulationUnderVenousFlow(biosim.BioModule):
    """BioModule wrapper for SBML model: Bouchnita2020 - Model for blood coagulation under venous flow condition."""

    def __init__(self, model_path: str = "data/MODEL2011030003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bouchnita2020ModelForBloodCoagulationUnderModel2011030003Model = SbmlBouchnita2020ModelForBloodCoagulationUnderVenousFlow
