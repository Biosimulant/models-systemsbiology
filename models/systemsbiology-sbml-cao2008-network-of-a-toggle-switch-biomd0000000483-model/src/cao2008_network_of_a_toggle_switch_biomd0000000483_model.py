...
"""Auto-generated SBML BioModule wrapper for Cao2008 - Network of a toggle switch.

Source: biomodels_ebi:BIOMD0000000483
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000483
"""
...
class SbmlCao2008NetworkOfAToggleSwitch(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2008 - Network of a toggle switch."""

    def __init__(self, model_path: str = "data/BIOMD0000000483.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2008NetworkOfAToggleSwitchBiomd0000000483Model = SbmlCao2008NetworkOfAToggleSwitch
