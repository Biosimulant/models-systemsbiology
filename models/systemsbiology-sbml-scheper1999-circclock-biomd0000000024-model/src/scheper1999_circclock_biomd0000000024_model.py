...
"""Auto-generated SBML BioModule wrapper for Scheper1999_CircClock.

Source: biomodels_ebi:BIOMD0000000024
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000024
"""
...
class SbmlScheper1999Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Scheper1999_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000024.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Scheper1999CircclockBiomd0000000024Model = SbmlScheper1999Circclock
