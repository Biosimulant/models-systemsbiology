...
"""Auto-generated SBML BioModule wrapper for Potassium balance in dairy cows, model update 2021.

Source: biomodels_ebi:MODEL2201250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2201250001
"""
...
class SbmlPotassiumBalanceInDairyCowsModelUpdate2021(biosim.BioModule):
    """BioModule wrapper for SBML model: Potassium balance in dairy cows, model update 2021."""

    def __init__(self, model_path: str = "data/MODEL2201250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PotassiumBalanceInDairyCowsModelUpdate202Model2201250001Model = SbmlPotassiumBalanceInDairyCowsModelUpdate2021
