...
"""Auto-generated SBML BioModule wrapper for Hornberg2005_ERKcascade.

Source: biomodels_ebi:BIOMD0000000084
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000084
"""
...
class SbmlHornberg2005Erkcascade(biosim.BioModule):
    """BioModule wrapper for SBML model: Hornberg2005_ERKcascade."""

    def __init__(self, model_path: str = "data/BIOMD0000000084.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hornberg2005ErkcascadeBiomd0000000084Model = SbmlHornberg2005Erkcascade
