...
"""Auto-generated SBML BioModule wrapper for GiantsosAdams2013 - Growth of glycocalyx under static conditions.

Source: biomodels_ebi:BIOMD0000000830
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000830
"""
...
class SbmlGiantsosadams2013GrowthOfGlycocalyxUnderStatic(biosim.BioModule):
    """BioModule wrapper for SBML model: GiantsosAdams2013 - Growth of glycocalyx under static conditions."""

    def __init__(self, model_path: str = "data/BIOMD0000000830.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Giantsosadams2013GrowthOfGlycocalyxUnderStaBiomd0000000830Model = SbmlGiantsosadams2013GrowthOfGlycocalyxUnderStatic
