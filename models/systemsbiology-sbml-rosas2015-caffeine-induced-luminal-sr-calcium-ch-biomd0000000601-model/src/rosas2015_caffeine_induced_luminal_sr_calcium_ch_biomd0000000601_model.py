...
"""Auto-generated SBML BioModule wrapper for Rosas2015 - Caffeine-induced luminal SR calcium changes.

Source: biomodels_ebi:BIOMD0000000601
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000601
"""
...
class SbmlRosas2015CaffeineInducedLuminalSrCalciumChanges(biosim.BioModule):
    """BioModule wrapper for SBML model: Rosas2015 - Caffeine-induced luminal SR calcium changes."""

    def __init__(self, model_path: str = "data/BIOMD0000000601.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rosas2015CaffeineInducedLuminalSrCalciumChBiomd0000000601Model = SbmlRosas2015CaffeineInducedLuminalSrCalciumChanges
