...
"""Auto-generated SBML BioModule wrapper for Emiola2016 - Crosstalk between the lipopolysaccharide and phospholipid pathways during outer membrane biosynthesis,.

Source: biomodels_ebi:MODEL1601080000
Original: https://www.ebi.ac.uk/biomodels/MODEL1601080000
"""
...
class SbmlEmiola2016CrosstalkBetweenTheLipopolysaccharideAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Emiola2016 - Crosstalk between the lipopolysaccharide and phospholipid pathways during outer membrane biosynthesis,."""

    def __init__(self, model_path: str = "data/MODEL1601080000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Emiola2016CrosstalkBetweenTheLipopolysaccharModel1601080000Model = SbmlEmiola2016CrosstalkBetweenTheLipopolysaccharideAnd
