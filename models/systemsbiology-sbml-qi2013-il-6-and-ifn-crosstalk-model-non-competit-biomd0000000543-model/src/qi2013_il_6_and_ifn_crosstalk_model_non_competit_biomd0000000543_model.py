...
"""Auto-generated SBML BioModule wrapper for Qi2013 - IL-6 and IFN crosstalk model (non-competitive).

Source: biomodels_ebi:BIOMD0000000543
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000543
"""
...
class SbmlQi2013Il6AndIfnCrosstalkModelNonCompetitive(biosim.BioModule):
    """BioModule wrapper for SBML model: Qi2013 - IL-6 and IFN crosstalk model (non-competitive)."""

    def __init__(self, model_path: str = "data/BIOMD0000000543.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qi2013Il6AndIfnCrosstalkModelNonCompetitBiomd0000000543Model = SbmlQi2013Il6AndIfnCrosstalkModelNonCompetitive
