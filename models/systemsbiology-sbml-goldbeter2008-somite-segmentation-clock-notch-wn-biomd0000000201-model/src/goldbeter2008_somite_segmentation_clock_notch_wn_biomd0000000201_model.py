...
"""Auto-generated SBML BioModule wrapper for Goldbeter2008_Somite_Segmentation_Clock_Notch_Wnt_FGF.

Source: biomodels_ebi:BIOMD0000000201
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000201
"""
...
class SbmlGoldbeter2008SomiteSegmentationClockNotchWntFgf(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter2008_Somite_Segmentation_Clock_Notch_Wnt_FGF."""

    def __init__(self, model_path: str = "data/BIOMD0000000201.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter2008SomiteSegmentationClockNotchWnBiomd0000000201Model = SbmlGoldbeter2008SomiteSegmentationClockNotchWntFgf
