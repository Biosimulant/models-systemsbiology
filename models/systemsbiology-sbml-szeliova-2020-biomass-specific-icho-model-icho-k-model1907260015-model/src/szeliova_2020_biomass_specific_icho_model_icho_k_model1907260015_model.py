...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_K1par-0mMCD).

Source: biomodels_ebi:MODEL1907260015
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260015
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoK1par0mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_K1par-0mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoKModel1907260015Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoK1par0mmcd
