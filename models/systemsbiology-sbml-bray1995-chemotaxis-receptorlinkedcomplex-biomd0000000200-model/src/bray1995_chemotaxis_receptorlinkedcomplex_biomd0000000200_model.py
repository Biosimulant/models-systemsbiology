...
"""Auto-generated SBML BioModule wrapper for Bray1995_chemotaxis_receptorlinkedcomplex.

Source: biomodels_ebi:BIOMD0000000200
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000200
"""
...
class SbmlBray1995ChemotaxisReceptorlinkedcomplex(biosim.BioModule):
    """BioModule wrapper for SBML model: Bray1995_chemotaxis_receptorlinkedcomplex."""

    def __init__(self, model_path: str = "data/BIOMD0000000200.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bray1995ChemotaxisReceptorlinkedcomplexBiomd0000000200Model = SbmlBray1995ChemotaxisReceptorlinkedcomplex
