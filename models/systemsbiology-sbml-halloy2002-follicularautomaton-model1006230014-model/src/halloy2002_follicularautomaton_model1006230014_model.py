...
"""Auto-generated SBML BioModule wrapper for Halloy2002_FollicularAutomaton.

Source: biomodels_ebi:MODEL1006230014
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230014
"""
...
class SbmlHalloy2002Follicularautomaton(biosim.BioModule):
    """BioModule wrapper for SBML model: Halloy2002_FollicularAutomaton."""

    def __init__(self, model_path: str = "data/MODEL1006230014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Halloy2002FollicularautomatonModel1006230014Model = SbmlHalloy2002Follicularautomaton
