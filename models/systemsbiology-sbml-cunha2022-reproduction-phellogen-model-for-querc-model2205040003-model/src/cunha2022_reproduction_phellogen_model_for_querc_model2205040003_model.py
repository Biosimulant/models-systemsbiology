...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - Reproduction Phellogen Model for Quercus suber.

Source: biomodels_ebi:MODEL2205040003
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040003
"""
...
class SbmlCunha2022ReproductionPhellogenModelForQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - Reproduction Phellogen Model for Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022ReproductionPhellogenModelForQuercModel2205040003Model = SbmlCunha2022ReproductionPhellogenModelForQuercusSuber
