...
"""Auto-generated SBML BioModule wrapper for Zhang2007 - Mechanism of DNA damage response (Model3).

Source: biomodels_ebi:BIOMD0000001010
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001010
"""
...
class SbmlZhang2007MechanismOfDnaDamageResponseModel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2007 - Mechanism of DNA damage response (Model3)."""

    def __init__(self, model_path: str = "data/BIOMD0000001010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2007MechanismOfDnaDamageResponseModelBiomd0000001010Model = SbmlZhang2007MechanismOfDnaDamageResponseModel3
