...
"""Auto-generated SBML BioModule wrapper for Kogan2001_aPTT_preincubation.

Source: biomodels_ebi:MODEL1109160000
Original: https://www.ebi.ac.uk/biomodels/MODEL1109160000
"""
...
class SbmlKogan2001ApttPreincubation(biosim.BioModule):
    """BioModule wrapper for SBML model: Kogan2001_aPTT_preincubation."""

    def __init__(self, model_path: str = "data/MODEL1109160000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kogan2001ApttPreincubationModel1109160000Model = SbmlKogan2001ApttPreincubation
