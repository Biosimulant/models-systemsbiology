...
"""Auto-generated SBML BioModule wrapper for Xu2002 - Blood Coagulation Model of Activated Factors with Platelet Activation.

Source: biomodels_ebi:MODEL1806130001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806130001
"""
...
class SbmlXu2002BloodCoagulationModelOfActivatedFactorsWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Xu2002 - Blood Coagulation Model of Activated Factors with Platelet Activation."""

    def __init__(self, model_path: str = "data/MODEL1806130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Xu2002BloodCoagulationModelOfActivatedFactModel1806130001Model = SbmlXu2002BloodCoagulationModelOfActivatedFactorsWith
