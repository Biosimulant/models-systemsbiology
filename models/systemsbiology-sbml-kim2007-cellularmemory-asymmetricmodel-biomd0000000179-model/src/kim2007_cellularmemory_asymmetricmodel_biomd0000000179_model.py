...
"""Auto-generated SBML BioModule wrapper for Kim2007_CellularMemory_AsymmetricModel.

Source: biomodels_ebi:BIOMD0000000179
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000179
"""
...
class SbmlKim2007CellularmemoryAsymmetricmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2007_CellularMemory_AsymmetricModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000179.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2007CellularmemoryAsymmetricmodelBiomd0000000179Model = SbmlKim2007CellularmemoryAsymmetricmodel
