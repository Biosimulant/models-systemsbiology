...
"""Auto-generated SBML BioModule wrapper for Golomb2006_SomaticBursting.

Source: biomodels_ebi:BIOMD0000000118
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000118
"""
...
class SbmlGolomb2006Somaticbursting(biosim.BioModule):
    """BioModule wrapper for SBML model: Golomb2006_SomaticBursting."""

    def __init__(self, model_path: str = "data/BIOMD0000000118.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Golomb2006SomaticburstingBiomd0000000118Model = SbmlGolomb2006Somaticbursting
