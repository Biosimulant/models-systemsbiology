...
"""Auto-generated SBML BioModule wrapper for Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions and PKA inhibits MAST3 and dominant negative effect.

Source: biomodels_ebi:BIOMD0000000645
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000645
"""
...
class SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp3(biosim.BioModule):
    """BioModule wrapper for SBML model: Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions and PKA inhibits MAST3 and dominant negative effect."""

    def __init__(self, model_path: str = "data/BIOMD0000000645.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Musante2017SwitchingBehaviourOfPp2aInhibitiBiomd0000000645Model = SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp3
