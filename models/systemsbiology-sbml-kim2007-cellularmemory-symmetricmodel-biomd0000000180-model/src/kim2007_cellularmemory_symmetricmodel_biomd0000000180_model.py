...
"""Auto-generated SBML BioModule wrapper for Kim2007_CellularMemory_SymmetricModel.

Source: biomodels_ebi:BIOMD0000000180
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000180
"""
...
class SbmlKim2007CellularmemorySymmetricmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2007_CellularMemory_SymmetricModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000180.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2007CellularmemorySymmetricmodelBiomd0000000180Model = SbmlKim2007CellularmemorySymmetricmodel
