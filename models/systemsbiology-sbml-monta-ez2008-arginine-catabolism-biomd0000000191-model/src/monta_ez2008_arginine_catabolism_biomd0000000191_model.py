...
"""Auto-generated SBML BioModule wrapper for Montañez2008_Arginine_catabolism.

Source: biomodels_ebi:BIOMD0000000191
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000191
"""
...
class SbmlMontanez2008ArginineCatabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Montañez2008_Arginine_catabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000191.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MontaEz2008ArginineCatabolismBiomd0000000191Model = SbmlMontanez2008ArginineCatabolism
