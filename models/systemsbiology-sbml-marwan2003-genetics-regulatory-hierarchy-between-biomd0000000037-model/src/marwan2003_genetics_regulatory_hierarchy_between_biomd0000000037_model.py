...
"""Auto-generated SBML BioModule wrapper for Marwan2003 - Genetics, regulatory hierarchy between genes.

Source: biomodels_ebi:BIOMD0000000037
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000037
"""
...
class SbmlMarwan2003GeneticsRegulatoryHierarchyBetweenGenes(biosim.BioModule):
    """BioModule wrapper for SBML model: Marwan2003 - Genetics, regulatory hierarchy between genes."""

    def __init__(self, model_path: str = "data/BIOMD0000000037.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Marwan2003GeneticsRegulatoryHierarchyBetweenBiomd0000000037Model = SbmlMarwan2003GeneticsRegulatoryHierarchyBetweenGenes
