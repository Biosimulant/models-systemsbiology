...
"""Auto-generated SBML BioModule wrapper for Astaburuaga2019 - ODE model of lysosomal ion homeostasis (LIH) including calcium pathways.

Source: biomodels_ebi:MODEL1910220001
Original: https://www.ebi.ac.uk/biomodels/MODEL1910220001
"""
...
class SbmlAstaburuaga2019OdeModelOfLysosomalIonHomeostasisLih(biosim.BioModule):
    """BioModule wrapper for SBML model: Astaburuaga2019 - ODE model of lysosomal ion homeostasis (LIH) including calcium pathways."""

    def __init__(self, model_path: str = "data/MODEL1910220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Astaburuaga2019OdeModelOfLysosomalIonHomeoModel1910220001Model = SbmlAstaburuaga2019OdeModelOfLysosomalIonHomeostasisLih
