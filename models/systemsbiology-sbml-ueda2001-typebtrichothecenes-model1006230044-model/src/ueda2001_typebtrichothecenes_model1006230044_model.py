...
"""Auto-generated SBML BioModule wrapper for Ueda2001_typeBtrichothecenes.

Source: biomodels_ebi:MODEL1006230044
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230044
"""
...
class SbmlUeda2001Typebtrichothecenes(biosim.BioModule):
    """BioModule wrapper for SBML model: Ueda2001_typeBtrichothecenes."""

    def __init__(self, model_path: str = "data/MODEL1006230044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ueda2001TypebtrichothecenesModel1006230044Model = SbmlUeda2001Typebtrichothecenes
