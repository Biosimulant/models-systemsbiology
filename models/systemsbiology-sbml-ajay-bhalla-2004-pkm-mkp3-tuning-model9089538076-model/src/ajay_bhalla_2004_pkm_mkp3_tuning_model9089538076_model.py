...
"""Auto-generated SBML BioModule wrapper for Ajay_Bhalla_2004_PKM_MKP3_Tuning.

Source: biomodels_ebi:MODEL9089538076
Original: https://www.ebi.ac.uk/biomodels/MODEL9089538076
"""
...
class SbmlAjayBhalla2004PkmMkp3Tuning(biosim.BioModule):
    """BioModule wrapper for SBML model: Ajay_Bhalla_2004_PKM_MKP3_Tuning."""

    def __init__(self, model_path: str = "data/MODEL9089538076.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AjayBhalla2004PkmMkp3TuningModel9089538076Model = SbmlAjayBhalla2004PkmMkp3Tuning
