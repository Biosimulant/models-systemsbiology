...
"""Auto-generated SBML BioModule wrapper for Nutsch2005_phototaxis_noncyc_repellent_light.

Source: biomodels_ebi:MODEL0403928902
Original: https://www.ebi.ac.uk/biomodels/MODEL0403928902
"""
...
class SbmlNutsch2005PhototaxisNoncycRepellentLight(biosim.BioModule):
    """BioModule wrapper for SBML model: Nutsch2005_phototaxis_noncyc_repellent_light."""

    def __init__(self, model_path: str = "data/MODEL0403928902.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nutsch2005PhototaxisNoncycRepellentLightModel0403928902Model = SbmlNutsch2005PhototaxisNoncycRepellentLight
