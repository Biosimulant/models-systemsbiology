...
"""Auto-generated SBML BioModule wrapper for Ferreira2003_CML_generation2.

Source: biomodels_ebi:BIOMD0000000053
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000053
"""
...
class SbmlFerreira2003CmlGeneration2(biosim.BioModule):
    """BioModule wrapper for SBML model: Ferreira2003_CML_generation2."""

    def __init__(self, model_path: str = "data/BIOMD0000000053.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ferreira2003CmlGeneration2Biomd0000000053Model = SbmlFerreira2003CmlGeneration2
