...
"""Auto-generated SBML BioModule wrapper for NothaGEM iSM1809.

Source: biomodels_ebi:MODEL2310300002
Original: https://www.ebi.ac.uk/biomodels/MODEL2310300002
"""
...
class SbmlNothagemIsm1809(biosim.BioModule):
    """BioModule wrapper for SBML model: NothaGEM iSM1809."""

    def __init__(self, model_path: str = "data/MODEL2310300002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NothagemIsm1809Model2310300002Model = SbmlNothagemIsm1809
