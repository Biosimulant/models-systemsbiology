...
"""Auto-generated SBML BioModule wrapper for Mazet2020 - model of the PI cycle.

Source: biomodels_ebi:MODEL2006300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2006300001
"""
...
class SbmlMazet2020ModelOfThePiCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Mazet2020 - model of the PI cycle."""

    def __init__(self, model_path: str = "data/MODEL2006300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mazet2020ModelOfThePiCycleModel2006300001Model = SbmlMazet2020ModelOfThePiCycle
