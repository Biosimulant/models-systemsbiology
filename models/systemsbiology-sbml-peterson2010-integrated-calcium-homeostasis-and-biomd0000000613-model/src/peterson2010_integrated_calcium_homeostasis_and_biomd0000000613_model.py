...
"""Auto-generated SBML BioModule wrapper for Peterson2010 - Integrated calcium homeostasis and bone remodelling.

Source: biomodels_ebi:BIOMD0000000613
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000613
"""
...
class SbmlPeterson2010IntegratedCalciumHomeostasisAndBone(biosim.BioModule):
    """BioModule wrapper for SBML model: Peterson2010 - Integrated calcium homeostasis and bone remodelling."""

    def __init__(self, model_path: str = "data/BIOMD0000000613.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Peterson2010IntegratedCalciumHomeostasisAndBiomd0000000613Model = SbmlPeterson2010IntegratedCalciumHomeostasisAndBone
