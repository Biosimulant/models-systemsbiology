...
"""Auto-generated SBML BioModule wrapper for VanTol2020 - Thalassiosira pseudonana CCMP 1335 GEM, acclimated to low light intensity.

Source: biomodels_ebi:MODEL2010230003
Original: https://www.ebi.ac.uk/biomodels/MODEL2010230003
"""
...
class SbmlVantol2020ThalassiosiraPseudonanaCcmp1335Gem3(biosim.BioModule):
    """BioModule wrapper for SBML model: VanTol2020 - Thalassiosira pseudonana CCMP 1335 GEM, acclimated to low light intensity."""

    def __init__(self, model_path: str = "data/MODEL2010230003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vantol2020ThalassiosiraPseudonanaCcmp1335GeModel2010230003Model = SbmlVantol2020ThalassiosiraPseudonanaCcmp1335Gem3
