...
"""Auto-generated SBML BioModule wrapper for ChowHall2008 Dynamics of Human Weight Change_ODE_1.

Source: biomodels_ebi:BIOMD0000000901
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000901
"""
...
class SbmlChowhall2008DynamicsOfHumanWeightChangeOde1(biosim.BioModule):
    """BioModule wrapper for SBML model: ChowHall2008 Dynamics of Human Weight Change_ODE_1."""

    def __init__(self, model_path: str = "data/BIOMD0000000901.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chowhall2008DynamicsOfHumanWeightChangeOdeBiomd0000000901Model = SbmlChowhall2008DynamicsOfHumanWeightChangeOde1
