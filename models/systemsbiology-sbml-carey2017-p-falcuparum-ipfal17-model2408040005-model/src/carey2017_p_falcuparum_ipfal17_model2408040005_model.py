...
"""Auto-generated SBML BioModule wrapper for Carey2017 - P. falcuparum (iPfal17).

Source: biomodels_ebi:MODEL2408040005
Original: https://www.ebi.ac.uk/biomodels/MODEL2408040005
"""
...
class SbmlCarey2017PFalcuparumIpfal17(biosim.BioModule):
    """BioModule wrapper for SBML model: Carey2017 - P. falcuparum (iPfal17)."""

    def __init__(self, model_path: str = "data/MODEL2408040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Carey2017PFalcuparumIpfal17Model2408040005Model = SbmlCarey2017PFalcuparumIpfal17
