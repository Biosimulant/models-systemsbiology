...
"""Auto-generated SBML BioModule wrapper for Butenas2004_BloodCoagulation.

Source: biomodels_ebi:BIOMD0000000362
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000362
"""
...
class SbmlButenas2004Bloodcoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Butenas2004_BloodCoagulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000362.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Butenas2004BloodcoagulationBiomd0000000362Model = SbmlButenas2004Bloodcoagulation
