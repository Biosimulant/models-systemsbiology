...
"""Auto-generated SBML BioModule wrapper for Zerrouk2024 - Rheumatoid arthritis multi-cellular model.

Source: biomodels_ebi:MODEL2408030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2408030001
"""
...
class SbmlZerrouk2024RheumatoidArthritisMultiCellularModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Zerrouk2024 - Rheumatoid arthritis multi-cellular model."""

    def __init__(self, model_path: str = "data/MODEL2408030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zerrouk2024RheumatoidArthritisMultiCellularModel2408030001Model = SbmlZerrouk2024RheumatoidArthritisMultiCellularModel
