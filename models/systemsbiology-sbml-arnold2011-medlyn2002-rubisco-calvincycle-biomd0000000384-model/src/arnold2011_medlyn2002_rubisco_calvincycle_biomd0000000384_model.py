...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Medlyn2002_RuBisCO-CalvinCycle.

Source: biomodels_ebi:BIOMD0000000384
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000384
"""
...
class SbmlArnold2011Medlyn2002RubiscoCalvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Medlyn2002_RuBisCO-CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000384.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Medlyn2002RubiscoCalvincycleBiomd0000000384Model = SbmlArnold2011Medlyn2002RubiscoCalvincycle
