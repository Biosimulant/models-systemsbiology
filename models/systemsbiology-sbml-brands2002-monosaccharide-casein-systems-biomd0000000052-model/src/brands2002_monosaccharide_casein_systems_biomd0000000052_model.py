...
"""Auto-generated SBML BioModule wrapper for Brands2002 - Monosaccharide-casein systems.

Source: biomodels_ebi:BIOMD0000000052
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000052
"""
...
class SbmlBrands2002MonosaccharideCaseinSystems(biosim.BioModule):
    """BioModule wrapper for SBML model: Brands2002 - Monosaccharide-casein systems."""

    def __init__(self, model_path: str = "data/BIOMD0000000052.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Brands2002MonosaccharideCaseinSystemsBiomd0000000052Model = SbmlBrands2002MonosaccharideCaseinSystems
