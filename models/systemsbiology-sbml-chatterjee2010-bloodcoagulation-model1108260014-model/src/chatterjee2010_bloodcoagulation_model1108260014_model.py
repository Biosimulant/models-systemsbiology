...
"""Auto-generated SBML BioModule wrapper for Chatterjee2010_BloodCoagulation.

Source: biomodels_ebi:MODEL1108260014
Original: https://www.ebi.ac.uk/biomodels/MODEL1108260014
"""
...
class SbmlChatterjee2010Bloodcoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Chatterjee2010_BloodCoagulation."""

    def __init__(self, model_path: str = "data/MODEL1108260014.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chatterjee2010BloodcoagulationModel1108260014Model = SbmlChatterjee2010Bloodcoagulation
