...
"""Auto-generated SBML BioModule wrapper for Sachse2008_FibroblastInteractingMyocytes.

Source: biomodels_ebi:MODEL7914759868
Original: https://www.ebi.ac.uk/biomodels/MODEL7914759868
"""
...
class SbmlSachse2008Fibroblastinteractingmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Sachse2008_FibroblastInteractingMyocytes."""

    def __init__(self, model_path: str = "data/MODEL7914759868.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sachse2008FibroblastinteractingmyocytesModel7914759868Model = SbmlSachse2008Fibroblastinteractingmyocytes
