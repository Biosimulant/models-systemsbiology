...
"""Auto-generated SBML BioModule wrapper for Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Healthy Condition.

Source: biomodels_ebi:BIOMD0000000621
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000621
"""
...
class SbmlPalmer2014EffectOfIl1BlockingTherapiesInT2dm2(biosim.BioModule):
    """BioModule wrapper for SBML model: Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Healthy Condition."""

    def __init__(self, model_path: str = "data/BIOMD0000000621.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palmer2014EffectOfIl1BlockingTherapiesInBiomd0000000621Model = SbmlPalmer2014EffectOfIl1BlockingTherapiesInT2dm2
