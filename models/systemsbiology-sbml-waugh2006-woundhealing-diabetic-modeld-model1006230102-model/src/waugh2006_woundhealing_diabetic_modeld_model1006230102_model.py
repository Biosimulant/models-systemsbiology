...
"""Auto-generated SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelD.

Source: biomodels_ebi:MODEL1006230102
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230102
"""
...
class SbmlWaugh2006WoundhealingDiabeticModeld(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006_WoundHealing_Diabetic_ModelD."""

    def __init__(self, model_path: str = "data/MODEL1006230102.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006WoundhealingDiabeticModeldModel1006230102Model = SbmlWaugh2006WoundhealingDiabeticModeld
