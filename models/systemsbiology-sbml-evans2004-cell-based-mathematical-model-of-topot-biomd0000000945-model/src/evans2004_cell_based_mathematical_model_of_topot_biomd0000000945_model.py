...
"""Auto-generated SBML BioModule wrapper for Evans2004 - Cell based mathematical model of topotecan.

Source: biomodels_ebi:BIOMD0000000945
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000945
"""
...
class SbmlEvans2004CellBasedMathematicalModelOfTopotecan(biosim.BioModule):
    """BioModule wrapper for SBML model: Evans2004 - Cell based mathematical model of topotecan."""

    def __init__(self, model_path: str = "data/BIOMD0000000945.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Evans2004CellBasedMathematicalModelOfTopotBiomd0000000945Model = SbmlEvans2004CellBasedMathematicalModelOfTopotecan
