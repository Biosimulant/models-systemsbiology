...
"""Auto-generated SBML BioModule wrapper for Calzone2008_Rb.

Source: biomodels_ebi:MODEL4132046015
Original: https://www.ebi.ac.uk/biomodels/MODEL4132046015
"""
...
class SbmlCalzone2008Rb(biosim.BioModule):
    """BioModule wrapper for SBML model: Calzone2008_Rb."""

    def __init__(self, model_path: str = "data/MODEL4132046015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Calzone2008RbModel4132046015Model = SbmlCalzone2008Rb
