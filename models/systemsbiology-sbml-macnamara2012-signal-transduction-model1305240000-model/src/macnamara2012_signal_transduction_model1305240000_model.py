...
"""Auto-generated SBML BioModule wrapper for MacNamara2012 - Signal transduction.

Source: biomodels_ebi:MODEL1305240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1305240000
"""
...
class SbmlMacnamara2012SignalTransduction(biosim.BioModule):
    """BioModule wrapper for SBML model: MacNamara2012 - Signal transduction."""

    def __init__(self, model_path: str = "data/MODEL1305240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Macnamara2012SignalTransductionModel1305240000Model = SbmlMacnamara2012SignalTransduction
