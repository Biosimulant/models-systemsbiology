...
"""Auto-generated SBML BioModule wrapper for Mothes2020_NFkB_A20_signaling.

Source: biomodels_ebi:MODEL2307110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2307110001
"""
...
class SbmlMothes2020NfkbA20Signaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Mothes2020_NFkB_A20_signaling."""

    def __init__(self, model_path: str = "data/MODEL2307110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mothes2020NfkbA20SignalingModel2307110001Model = SbmlMothes2020NfkbA20Signaling
