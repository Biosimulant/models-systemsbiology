...
"""Auto-generated SBML BioModule wrapper for Nelson1995_HIV1therapy_DIVadministraion_ModelB.

Source: biomodels_ebi:MODEL1006230033
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230033
"""
...
class SbmlNelson1995Hiv1therapyDivadministraionModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Nelson1995_HIV1therapy_DIVadministraion_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230033.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nelson1995Hiv1therapyDivadministraionModelbModel1006230033Model = SbmlNelson1995Hiv1therapyDivadministraionModelb
