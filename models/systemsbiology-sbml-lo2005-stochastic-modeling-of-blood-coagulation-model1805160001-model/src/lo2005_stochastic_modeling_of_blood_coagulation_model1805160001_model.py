...
"""Auto-generated SBML BioModule wrapper for Lo2005 - Stochastic Modeling of Blood Coagulation Initiation.

Source: biomodels_ebi:MODEL1805160001
Original: https://www.ebi.ac.uk/biomodels/MODEL1805160001
"""
...
class SbmlLo2005StochasticModelingOfBloodCoagulationInitiation(biosim.BioModule):
    """BioModule wrapper for SBML model: Lo2005 - Stochastic Modeling of Blood Coagulation Initiation."""

    def __init__(self, model_path: str = "data/MODEL1805160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lo2005StochasticModelingOfBloodCoagulationModel1805160001Model = SbmlLo2005StochasticModelingOfBloodCoagulationInitiation
