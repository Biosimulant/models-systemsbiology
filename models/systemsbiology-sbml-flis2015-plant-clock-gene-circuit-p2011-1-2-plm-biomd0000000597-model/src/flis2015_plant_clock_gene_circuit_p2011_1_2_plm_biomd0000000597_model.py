...
"""Auto-generated SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.1.2 PLM_71 ver 1).

Source: biomodels_ebi:BIOMD0000000597
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000597
"""
...
class SbmlFlis2015PlantClockGeneCircuitP201112Plm71Ver1(biosim.BioModule):
    """BioModule wrapper for SBML model: Flis2015 - Plant clock gene circuit (P2011.1.2 PLM_71 ver 1)."""

    def __init__(self, model_path: str = "data/BIOMD0000000597.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flis2015PlantClockGeneCircuitP201112PlmBiomd0000000597Model = SbmlFlis2015PlantClockGeneCircuitP201112Plm71Ver1
