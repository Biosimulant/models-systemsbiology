...
"""Auto-generated SBML BioModule wrapper for Salazar2009_PhotoperiodicRegulation.

Source: biomodels_ebi:MODEL1005050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1005050000
"""
...
class SbmlSalazar2009Photoperiodicregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Salazar2009_PhotoperiodicRegulation."""

    def __init__(self, model_path: str = "data/MODEL1005050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Salazar2009PhotoperiodicregulationModel1005050000Model = SbmlSalazar2009Photoperiodicregulation
