...
"""Auto-generated SBML BioModule wrapper for Li2019 - In Silico mechanistic model for proarrhythmia risk prediction under the CiPA initiative.

Source: biomodels_ebi:MODEL2111260002
Original: https://www.ebi.ac.uk/biomodels/MODEL2111260002
"""
...
class SbmlLi2019InSilicoMechanisticModelForProarrhythmiaRisk(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2019 - In Silico mechanistic model for proarrhythmia risk prediction under the CiPA initiative."""

    def __init__(self, model_path: str = "data/MODEL2111260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2019InSilicoMechanisticModelForProarrhytModel2111260002Model = SbmlLi2019InSilicoMechanisticModelForProarrhythmiaRisk
