...
"""Auto-generated SBML BioModule wrapper for Proctor2006_telomere.

Source: biomodels_ebi:BIOMD0000000087
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000087
"""
...
class SbmlProctor2006Telomere(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2006_telomere."""

    def __init__(self, model_path: str = "data/BIOMD0000000087.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2006TelomereBiomd0000000087Model = SbmlProctor2006Telomere
