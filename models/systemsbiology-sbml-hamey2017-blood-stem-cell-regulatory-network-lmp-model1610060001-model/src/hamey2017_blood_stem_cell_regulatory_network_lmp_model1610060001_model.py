...
"""Auto-generated SBML BioModule wrapper for Hamey2017 - Blood stem cell regulatory network (LMPP network).

Source: biomodels_ebi:MODEL1610060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1610060001
"""
...
class SbmlHamey2017BloodStemCellRegulatoryNetworkLmppNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Hamey2017 - Blood stem cell regulatory network (LMPP network)."""

    def __init__(self, model_path: str = "data/MODEL1610060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hamey2017BloodStemCellRegulatoryNetworkLmpModel1610060001Model = SbmlHamey2017BloodStemCellRegulatoryNetworkLmppNetwork
