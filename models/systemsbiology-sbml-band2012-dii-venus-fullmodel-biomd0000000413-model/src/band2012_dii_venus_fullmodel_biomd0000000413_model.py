...
"""Auto-generated SBML BioModule wrapper for Band2012_DII-Venus_FullModel.

Source: biomodels_ebi:BIOMD0000000413
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000413
"""
...
class SbmlBand2012DiiVenusFullmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Band2012_DII-Venus_FullModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000413.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Band2012DiiVenusFullmodelBiomd0000000413Model = SbmlBand2012DiiVenusFullmodel
