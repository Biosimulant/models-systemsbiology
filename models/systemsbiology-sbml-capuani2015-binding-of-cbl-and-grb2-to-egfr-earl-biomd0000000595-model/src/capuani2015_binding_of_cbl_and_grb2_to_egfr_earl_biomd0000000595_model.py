...
"""Auto-generated SBML BioModule wrapper for Capuani2015 - Binding of Cbl and Grb2 to EGFR (Early Activation Model - EAM).

Source: biomodels_ebi:BIOMD0000000595
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000595
"""
...
class SbmlCapuani2015BindingOfCblAndGrb2ToEgfrEarly(biosim.BioModule):
    """BioModule wrapper for SBML model: Capuani2015 - Binding of Cbl and Grb2 to EGFR (Early Activation Model - EAM)."""

    def __init__(self, model_path: str = "data/BIOMD0000000595.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Capuani2015BindingOfCblAndGrb2ToEgfrEarlBiomd0000000595Model = SbmlCapuani2015BindingOfCblAndGrb2ToEgfrEarly
