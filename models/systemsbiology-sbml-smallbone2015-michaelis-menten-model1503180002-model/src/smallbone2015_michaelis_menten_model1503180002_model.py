...
"""Auto-generated SBML BioModule wrapper for Smallbone2015 - Michaelis Menten.

Source: biomodels_ebi:MODEL1503180002
Original: https://www.ebi.ac.uk/biomodels/MODEL1503180002
"""
...
class SbmlSmallbone2015MichaelisMenten(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2015 - Michaelis Menten."""

    def __init__(self, model_path: str = "data/MODEL1503180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2015MichaelisMentenModel1503180002Model = SbmlSmallbone2015MichaelisMenten
