...
"""Auto-generated SBML BioModule wrapper for Dunster2014 - WBC Interactions (Model1).

Source: biomodels_ebi:BIOMD0000000616
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000616
"""
...
class SbmlDunster2014WbcInteractionsModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Dunster2014 - WBC Interactions (Model1)."""

    def __init__(self, model_path: str = "data/BIOMD0000000616.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dunster2014WbcInteractionsModel1Biomd0000000616Model = SbmlDunster2014WbcInteractionsModel1
