...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - Diel Multi-tissue Model of Quercus suber.

Source: biomodels_ebi:MODEL2205040006
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040006
"""
...
class SbmlCunha2022DielMultiTissueModelOfQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - Diel Multi-tissue Model of Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022DielMultiTissueModelOfQuercusSubModel2205040006Model = SbmlCunha2022DielMultiTissueModelOfQuercusSuber
