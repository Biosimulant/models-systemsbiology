...
"""Auto-generated SBML BioModule wrapper for Rohwer2001_Sucrose.

Source: biomodels_ebi:BIOMD0000000023
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000023
"""
...
class SbmlRohwer2001Sucrose(biosim.BioModule):
    """BioModule wrapper for SBML model: Rohwer2001_Sucrose."""

    def __init__(self, model_path: str = "data/BIOMD0000000023.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rohwer2001SucroseBiomd0000000023Model = SbmlRohwer2001Sucrose
