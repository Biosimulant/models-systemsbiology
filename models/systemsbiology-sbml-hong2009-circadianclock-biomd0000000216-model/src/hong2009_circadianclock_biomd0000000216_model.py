...
"""Auto-generated SBML BioModule wrapper for Hong2009_CircadianClock.

Source: biomodels_ebi:BIOMD0000000216
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000216
"""
...
class SbmlHong2009Circadianclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Hong2009_CircadianClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000216.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hong2009CircadianclockBiomd0000000216Model = SbmlHong2009Circadianclock
