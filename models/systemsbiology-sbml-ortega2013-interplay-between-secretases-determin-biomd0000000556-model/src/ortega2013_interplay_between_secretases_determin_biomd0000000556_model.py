...
"""Auto-generated SBML BioModule wrapper for Ortega2013 - Interplay between secretases determines biphasic amyloid-beta level.

Source: biomodels_ebi:BIOMD0000000556
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000556
"""
...
class SbmlOrtega2013InterplayBetweenSecretasesDeterminesBiphasic(biosim.BioModule):
    """BioModule wrapper for SBML model: Ortega2013 - Interplay between secretases determines biphasic amyloid-beta level."""

    def __init__(self, model_path: str = "data/BIOMD0000000556.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ortega2013InterplayBetweenSecretasesDeterminBiomd0000000556Model = SbmlOrtega2013InterplayBetweenSecretasesDeterminesBiphasic
