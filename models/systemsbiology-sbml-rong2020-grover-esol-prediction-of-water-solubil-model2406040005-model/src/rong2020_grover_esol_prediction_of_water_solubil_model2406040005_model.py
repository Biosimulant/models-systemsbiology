...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-Esol: Prediction of water solubility (log solubility in mols per litre) for common organic small molecules.

Source: biomodels_ebi:MODEL2406040005
Original: https://www.ebi.ac.uk/biomodels/MODEL2406040005
"""
...
class SbmlRong2020GroverEsolPredictionOfWaterSolubilityLog(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-Esol: Prediction of water solubility (log solubility in mols per litre) for common organic small molecules."""

    def __init__(self, model_path: str = "data/MODEL2406040005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverEsolPredictionOfWaterSolubilModel2406040005Model = SbmlRong2020GroverEsolPredictionOfWaterSolubilityLog
