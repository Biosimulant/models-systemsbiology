...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (miR140-SOX9 incoherent feed forward).

Source: biomodels_ebi:MODEL1705170003
Original: https://www.ebi.ac.uk/biomodels/MODEL1705170003
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140Sox9(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (miR140-SOX9 incoherent feed forward)."""

    def __init__(self, model_path: str = "data/MODEL1705170003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1705170003Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140Sox9
