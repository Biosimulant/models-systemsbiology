...
"""Auto-generated SBML BioModule wrapper for Nassar2022 - Metagenomics Classification Task for Scientific Literature Text.

Source: biomodels_ebi:BIOMD0000001068
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001068
"""
...
class SbmlNassar2022MetagenomicsClassificationTaskForScientific(biosim.BioModule):
    """BioModule wrapper for SBML model: Nassar2022 - Metagenomics Classification Task for Scientific Literature Text."""

    def __init__(self, model_path: str = "data/BIOMD0000001068.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nassar2022MetagenomicsClassificationTaskForBiomd0000001068Model = SbmlNassar2022MetagenomicsClassificationTaskForScientific
