...
"""Auto-generated SBML BioModule wrapper for Wong2024 - Discovery of a structural class of antibiotics with explainable deep learning.

Source: biomodels_ebi:MODEL2405080002
Original: https://www.ebi.ac.uk/biomodels/MODEL2405080002
"""
...
class SbmlWong2024DiscoveryOfAStructuralClassOfAntibiotics(biosim.BioModule):
    """BioModule wrapper for SBML model: Wong2024 - Discovery of a structural class of antibiotics with explainable deep learning."""

    def __init__(self, model_path: str = "data/MODEL2405080002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wong2024DiscoveryOfAStructuralClassOfAntiModel2405080002Model = SbmlWong2024DiscoveryOfAStructuralClassOfAntibiotics
