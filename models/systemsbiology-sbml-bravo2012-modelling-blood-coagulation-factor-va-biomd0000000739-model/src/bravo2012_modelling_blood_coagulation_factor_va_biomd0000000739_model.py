...
"""Auto-generated SBML BioModule wrapper for Bravo2012 - Modelling blood coagulation factor Va inactivation by APC.

Source: biomodels_ebi:BIOMD0000000739
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000739
"""
...
class SbmlBravo2012ModellingBloodCoagulationFactorVa(biosim.BioModule):
    """BioModule wrapper for SBML model: Bravo2012 - Modelling blood coagulation factor Va inactivation by APC."""

    def __init__(self, model_path: str = "data/BIOMD0000000739.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bravo2012ModellingBloodCoagulationFactorVaBiomd0000000739Model = SbmlBravo2012ModellingBloodCoagulationFactorVa
