...
"""Auto-generated SBML BioModule wrapper for Bhalla2002_MAPK-bistability-fig1c.

Source: biomodels_ebi:MODEL9079179924
Original: https://www.ebi.ac.uk/biomodels/MODEL9079179924
"""
...
class SbmlBhalla2002MapkBistabilityFig1c(biosim.BioModule):
    """BioModule wrapper for SBML model: Bhalla2002_MAPK-bistability-fig1c."""

    def __init__(self, model_path: str = "data/MODEL9079179924.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bhalla2002MapkBistabilityFig1cModel9079179924Model = SbmlBhalla2002MapkBistabilityFig1c
