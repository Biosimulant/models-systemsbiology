...
"""Auto-generated SBML BioModule wrapper for Kogan2013 - A mathematical model for the immunotherapeutic control of the TH1 TH2 imbalance in melanoma.

Source: biomodels_ebi:BIOMD0000000881
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000881
"""
...
class SbmlKogan2013AMathematicalModelForTheImmunotherapeutic(biosim.BioModule):
    """BioModule wrapper for SBML model: Kogan2013 - A mathematical model for the immunotherapeutic control of the TH1 TH2 imbalance in melanoma."""

    def __init__(self, model_path: str = "data/BIOMD0000000881.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kogan2013AMathematicalModelForTheImmunotheBiomd0000000881Model = SbmlKogan2013AMathematicalModelForTheImmunotherapeutic
