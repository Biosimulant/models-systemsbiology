...
"""Auto-generated SBML BioModule wrapper for Rohwer2000_Phosphotransferase_System.

Source: biomodels_ebi:BIOMD0000000038
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000038
"""
...
class SbmlRohwer2000PhosphotransferaseSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Rohwer2000_Phosphotransferase_System."""

    def __init__(self, model_path: str = "data/BIOMD0000000038.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rohwer2000PhosphotransferaseSystemBiomd0000000038Model = SbmlRohwer2000PhosphotransferaseSystem
