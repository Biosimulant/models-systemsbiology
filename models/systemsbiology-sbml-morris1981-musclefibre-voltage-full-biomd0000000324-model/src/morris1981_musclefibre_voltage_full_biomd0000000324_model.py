...
"""Auto-generated SBML BioModule wrapper for Morris1981_MuscleFibre_Voltage_full.

Source: biomodels_ebi:BIOMD0000000324
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000324
"""
...
class SbmlMorris1981MusclefibreVoltageFull(biosim.BioModule):
    """BioModule wrapper for SBML model: Morris1981_MuscleFibre_Voltage_full."""

    def __init__(self, model_path: str = "data/BIOMD0000000324.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morris1981MusclefibreVoltageFullBiomd0000000324Model = SbmlMorris1981MusclefibreVoltageFull
