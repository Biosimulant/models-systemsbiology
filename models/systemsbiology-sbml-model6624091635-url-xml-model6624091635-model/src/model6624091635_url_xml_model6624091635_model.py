...
"""Auto-generated SBML BioModule wrapper for MODEL6624091635_url.xml.

Source: biomodels_ebi:MODEL6624091635
Original: https://www.ebi.ac.uk/biomodels/MODEL6624091635
"""
...
class SbmlModel6624091635UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL6624091635_url.xml."""

    def __init__(self, model_path: str = "data/MODEL6624091635.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model6624091635UrlXmlModel6624091635Model = SbmlModel6624091635UrlXml
