...
"""Auto-generated SBML BioModule wrapper for Hamey2017 - Blood stem cell regulatory network.

Source: biomodels_ebi:MODEL1610060000
Original: https://www.ebi.ac.uk/biomodels/MODEL1610060000
"""
...
class SbmlHamey2017BloodStemCellRegulatoryNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Hamey2017 - Blood stem cell regulatory network."""

    def __init__(self, model_path: str = "data/MODEL1610060000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hamey2017BloodStemCellRegulatoryNetworkModel1610060000Model = SbmlHamey2017BloodStemCellRegulatoryNetwork
