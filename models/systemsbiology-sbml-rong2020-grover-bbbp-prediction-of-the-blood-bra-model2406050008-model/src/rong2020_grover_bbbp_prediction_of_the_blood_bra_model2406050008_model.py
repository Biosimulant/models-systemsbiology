...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-bbbp: Prediction of the Blood-brain barrier penetration..

Source: biomodels_ebi:MODEL2406050008
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050008
"""
...
class SbmlRong2020GroverBbbpPredictionOfTheBloodBrainBarrier(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-bbbp: Prediction of the Blood-brain barrier penetration.."""

    def __init__(self, model_path: str = "data/MODEL2406050008.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverBbbpPredictionOfTheBloodBraModel2406050008Model = SbmlRong2020GroverBbbpPredictionOfTheBloodBrainBarrier
