...
"""Auto-generated SBML BioModule wrapper for Proctor2012 - Role of Amyloid-beta dimers in aggregation formation.

Source: biomodels_ebi:BIOMD0000000462
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000462
"""
...
class SbmlProctor2012RoleOfAmyloidBetaDimersInAggregation(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2012 - Role of Amyloid-beta dimers in aggregation formation."""

    def __init__(self, model_path: str = "data/BIOMD0000000462.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2012RoleOfAmyloidBetaDimersInAggreBiomd0000000462Model = SbmlProctor2012RoleOfAmyloidBetaDimersInAggregation
