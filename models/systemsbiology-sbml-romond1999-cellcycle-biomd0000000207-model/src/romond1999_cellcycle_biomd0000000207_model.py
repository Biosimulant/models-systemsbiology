...
"""Auto-generated SBML BioModule wrapper for Romond1999_CellCycle.

Source: biomodels_ebi:BIOMD0000000207
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000207
"""
...
class SbmlRomond1999Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Romond1999_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000207.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Romond1999CellcycleBiomd0000000207Model = SbmlRomond1999Cellcycle
