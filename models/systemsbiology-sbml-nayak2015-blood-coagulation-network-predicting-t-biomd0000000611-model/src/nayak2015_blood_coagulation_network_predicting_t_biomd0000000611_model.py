...
"""Auto-generated SBML BioModule wrapper for Nayak2015 - Blood Coagulation Network - Predicting the Effects of Various Therapies on Biomarkers.

Source: biomodels_ebi:BIOMD0000000611
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000611
"""
...
class SbmlNayak2015BloodCoagulationNetworkPredictingTheEffects(biosim.BioModule):
    """BioModule wrapper for SBML model: Nayak2015 - Blood Coagulation Network - Predicting the Effects of Various Therapies on Biomarkers."""

    def __init__(self, model_path: str = "data/BIOMD0000000611.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nayak2015BloodCoagulationNetworkPredictingTBiomd0000000611Model = SbmlNayak2015BloodCoagulationNetworkPredictingTheEffects
