...
"""Auto-generated SBML BioModule wrapper for Khanin1998 - Mathematical Model of Blood Coagulation Prothrombin Time Test.

Source: biomodels_ebi:MODEL1806120001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806120001
"""
...
class SbmlKhanin1998MathematicalModelOfBloodCoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Khanin1998 - Mathematical Model of Blood Coagulation Prothrombin Time Test."""

    def __init__(self, model_path: str = "data/MODEL1806120001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Khanin1998MathematicalModelOfBloodCoagulatiModel1806120001Model = SbmlKhanin1998MathematicalModelOfBloodCoagulation
