...
"""Auto-generated SBML BioModule wrapper for Tomida2003 - Calcium Oscillatory-induced translocation of nuclear factor of activated T cells.

Source: biomodels_ebi:BIOMD0000000678
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000678
"""
...
class SbmlTomida2003CalciumOscillatoryInducedTranslocationOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Tomida2003 - Calcium Oscillatory-induced translocation of nuclear factor of activated T cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000678.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tomida2003CalciumOscillatoryInducedTranslocaBiomd0000000678Model = SbmlTomida2003CalciumOscillatoryInducedTranslocationOf
