...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Giersch1990_CalvinCycle.

Source: biomodels_ebi:BIOMD0000000390
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000390
"""
...
class SbmlArnold2011Giersch1990Calvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Giersch1990_CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000390.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Giersch1990CalvincycleBiomd0000000390Model = SbmlArnold2011Giersch1990Calvincycle
