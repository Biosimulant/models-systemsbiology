...
"""Auto-generated SBML BioModule wrapper for GonzalezHeydrich1994_HPAaxisRegulation_CortisolProduction.

Source: biomodels_ebi:MODEL0911270004
Original: https://www.ebi.ac.uk/biomodels/MODEL0911270004
"""
...
class SbmlGonzalezheydrich1994HpaaxisregulationCortisolproduction(biosim.BioModule):
    """BioModule wrapper for SBML model: GonzalezHeydrich1994_HPAaxisRegulation_CortisolProduction."""

    def __init__(self, model_path: str = "data/MODEL0911270004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gonzalezheydrich1994HpaaxisregulationCortisolpModel0911270004Model = SbmlGonzalezheydrich1994HpaaxisregulationCortisolproduction
