...
"""Auto-generated SBML BioModule wrapper for Li2010_YeastGlycolysis.

Source: biomodels_ebi:MODEL1012110001
Original: https://www.ebi.ac.uk/biomodels/MODEL1012110001
"""
...
class SbmlLi2010Yeastglycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2010_YeastGlycolysis."""

    def __init__(self, model_path: str = "data/MODEL1012110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2010YeastglycolysisModel1012110001Model = SbmlLi2010Yeastglycolysis
