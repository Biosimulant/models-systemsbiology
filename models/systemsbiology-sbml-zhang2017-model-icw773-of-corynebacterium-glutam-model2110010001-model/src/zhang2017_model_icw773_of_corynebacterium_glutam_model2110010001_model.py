...
"""Auto-generated SBML BioModule wrapper for Zhang2017 - Model iCW773 of Corynebacterium glutamicum ATCC 13032 (Bielefeld).

Source: biomodels_ebi:MODEL2110010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2110010001
"""
...
class SbmlZhang2017ModelIcw773OfCorynebacteriumGlutamicumAtcc(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2017 - Model iCW773 of Corynebacterium glutamicum ATCC 13032 (Bielefeld)."""

    def __init__(self, model_path: str = "data/MODEL2110010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2017ModelIcw773OfCorynebacteriumGlutamModel2110010001Model = SbmlZhang2017ModelIcw773OfCorynebacteriumGlutamicumAtcc
