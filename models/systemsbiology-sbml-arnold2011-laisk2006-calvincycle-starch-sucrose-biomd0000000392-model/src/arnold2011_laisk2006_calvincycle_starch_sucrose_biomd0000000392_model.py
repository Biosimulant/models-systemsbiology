...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Laisk2006_CalvinCycle_Starch_Sucrose.

Source: biomodels_ebi:BIOMD0000000392
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000392
"""
...
class SbmlArnold2011Laisk2006CalvincycleStarchSucrose(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Laisk2006_CalvinCycle_Starch_Sucrose."""

    def __init__(self, model_path: str = "data/BIOMD0000000392.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Laisk2006CalvincycleStarchSucroseBiomd0000000392Model = SbmlArnold2011Laisk2006CalvincycleStarchSucrose
