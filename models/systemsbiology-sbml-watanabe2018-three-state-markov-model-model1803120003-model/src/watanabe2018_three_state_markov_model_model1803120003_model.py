...
"""Auto-generated SBML BioModule wrapper for Watanabe2018_Three state markov model.

Source: biomodels_ebi:MODEL1803120003
Original: https://www.ebi.ac.uk/biomodels/MODEL1803120003
"""
...
class SbmlWatanabe2018ThreeStateMarkovModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Watanabe2018_Three state markov model."""

    def __init__(self, model_path: str = "data/MODEL1803120003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Watanabe2018ThreeStateMarkovModelModel1803120003Model = SbmlWatanabe2018ThreeStateMarkovModel
