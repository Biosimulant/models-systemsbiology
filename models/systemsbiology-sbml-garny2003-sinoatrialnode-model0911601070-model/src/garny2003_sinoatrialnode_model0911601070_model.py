...
"""Auto-generated SBML BioModule wrapper for Garny2003_SinoatrialNode.

Source: biomodels_ebi:MODEL0911601070
Original: https://www.ebi.ac.uk/biomodels/MODEL0911601070
"""
...
class SbmlGarny2003Sinoatrialnode(biosim.BioModule):
    """BioModule wrapper for SBML model: Garny2003_SinoatrialNode."""

    def __init__(self, model_path: str = "data/MODEL0911601070.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Garny2003SinoatrialnodeModel0911601070Model = SbmlGarny2003Sinoatrialnode
