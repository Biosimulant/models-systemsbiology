...
"""Auto-generated SBML BioModule wrapper for Marhl2000_CaOscillations.

Source: biomodels_ebi:BIOMD0000000039
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000039
"""
...
class SbmlMarhl2000Caoscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Marhl2000_CaOscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000039.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Marhl2000CaoscillationsBiomd0000000039Model = SbmlMarhl2000Caoscillations
