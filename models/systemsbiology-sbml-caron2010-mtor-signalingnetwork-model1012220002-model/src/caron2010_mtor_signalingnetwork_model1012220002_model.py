...
"""Auto-generated SBML BioModule wrapper for Caron2010_mTOR_SignalingNetwork.

Source: biomodels_ebi:MODEL1012220002
Original: https://www.ebi.ac.uk/biomodels/MODEL1012220002
"""
...
class SbmlCaron2010MtorSignalingnetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Caron2010_mTOR_SignalingNetwork."""

    def __init__(self, model_path: str = "data/MODEL1012220002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Caron2010MtorSignalingnetworkModel1012220002Model = SbmlCaron2010MtorSignalingnetwork
