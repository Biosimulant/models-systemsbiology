...
"""Auto-generated SBML BioModule wrapper for Mitrophanov2011 - Mode of action of rFVIIa on thrombin generation (Update to Hockin2002 Blood Coagulation Model).

Source: biomodels_ebi:MODEL1806040001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806040001
"""
...
class SbmlMitrophanov2011ModeOfActionOfRfviiaOnThrombin(biosim.BioModule):
    """BioModule wrapper for SBML model: Mitrophanov2011 - Mode of action of rFVIIa on thrombin generation (Update to Hockin2002 Blood Coagulation Model)."""

    def __init__(self, model_path: str = "data/MODEL1806040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mitrophanov2011ModeOfActionOfRfviiaOnThroModel1806040001Model = SbmlMitrophanov2011ModeOfActionOfRfviiaOnThrombin
