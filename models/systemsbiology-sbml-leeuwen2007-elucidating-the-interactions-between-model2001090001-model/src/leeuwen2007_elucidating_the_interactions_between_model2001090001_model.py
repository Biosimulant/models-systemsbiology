...
"""Auto-generated SBML BioModule wrapper for Leeuwen2007 - Elucidating the interactions between the adhesive and transcriptional functions of beta-catenin in normal and cancerous cells.

Source: biomodels_ebi:MODEL2001090001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001090001
"""
...
class SbmlLeeuwen2007ElucidatingTheInteractionsBetweenThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Leeuwen2007 - Elucidating the interactions between the adhesive and transcriptional functions of beta-catenin in normal and cancerous cells."""

    def __init__(self, model_path: str = "data/MODEL2001090001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leeuwen2007ElucidatingTheInteractionsBetweenModel2001090001Model = SbmlLeeuwen2007ElucidatingTheInteractionsBetweenThe
