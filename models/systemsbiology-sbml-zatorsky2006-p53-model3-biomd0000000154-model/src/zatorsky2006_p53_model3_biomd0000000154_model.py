...
"""Auto-generated SBML BioModule wrapper for Zatorsky2006_p53_Model3.

Source: biomodels_ebi:BIOMD0000000154
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000154
"""
...
class SbmlZatorsky2006P53Model3(biosim.BioModule):
    """BioModule wrapper for SBML model: Zatorsky2006_p53_Model3."""

    def __init__(self, model_path: str = "data/BIOMD0000000154.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zatorsky2006P53Model3Biomd0000000154Model = SbmlZatorsky2006P53Model3
