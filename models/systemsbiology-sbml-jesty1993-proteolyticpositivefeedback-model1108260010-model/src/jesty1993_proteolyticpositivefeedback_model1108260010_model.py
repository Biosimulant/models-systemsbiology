...
"""Auto-generated SBML BioModule wrapper for Jesty1993_ProteolyticPositiveFeedback.

Source: biomodels_ebi:MODEL1108260010
Original: https://www.ebi.ac.uk/biomodels/MODEL1108260010
"""
...
class SbmlJesty1993Proteolyticpositivefeedback(biosim.BioModule):
    """BioModule wrapper for SBML model: Jesty1993_ProteolyticPositiveFeedback."""

    def __init__(self, model_path: str = "data/MODEL1108260010.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jesty1993ProteolyticpositivefeedbackModel1108260010Model = SbmlJesty1993Proteolyticpositivefeedback
