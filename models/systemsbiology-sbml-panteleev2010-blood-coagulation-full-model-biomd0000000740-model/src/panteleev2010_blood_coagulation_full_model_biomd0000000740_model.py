...
"""Auto-generated SBML BioModule wrapper for Panteleev2010 - Blood Coagulation: Full Model.

Source: biomodels_ebi:BIOMD0000000740
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000740
"""
...
class SbmlPanteleev2010BloodCoagulationFullModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Panteleev2010 - Blood Coagulation: Full Model."""

    def __init__(self, model_path: str = "data/BIOMD0000000740.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Panteleev2010BloodCoagulationFullModelBiomd0000000740Model = SbmlPanteleev2010BloodCoagulationFullModel
