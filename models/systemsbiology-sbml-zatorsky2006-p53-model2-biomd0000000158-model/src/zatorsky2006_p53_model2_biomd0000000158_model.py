...
"""Auto-generated SBML BioModule wrapper for Zatorsky2006_p53_Model2.

Source: biomodels_ebi:BIOMD0000000158
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000158
"""
...
class SbmlZatorsky2006P53Model2(biosim.BioModule):
    """BioModule wrapper for SBML model: Zatorsky2006_p53_Model2."""

    def __init__(self, model_path: str = "data/BIOMD0000000158.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zatorsky2006P53Model2Biomd0000000158Model = SbmlZatorsky2006P53Model2
