...
"""Auto-generated SBML BioModule wrapper for Fuss2006_MitoticActivation.

Source: biomodels_ebi:BIOMD0000000069
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000069
"""
...
class SbmlFuss2006Mitoticactivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Fuss2006_MitoticActivation."""

    def __init__(self, model_path: str = "data/BIOMD0000000069.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fuss2006MitoticactivationBiomd0000000069Model = SbmlFuss2006Mitoticactivation
