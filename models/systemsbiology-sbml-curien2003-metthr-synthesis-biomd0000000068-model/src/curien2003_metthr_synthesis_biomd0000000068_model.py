...
"""Auto-generated SBML BioModule wrapper for Curien2003_MetThr_synthesis.

Source: biomodels_ebi:BIOMD0000000068
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000068
"""
...
class SbmlCurien2003MetthrSynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Curien2003_MetThr_synthesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000068.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Curien2003MetthrSynthesisBiomd0000000068Model = SbmlCurien2003MetthrSynthesis
