...
"""Auto-generated SBML BioModule wrapper for Saucerman2006_PKA.

Source: biomodels_ebi:BIOMD0000000165
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000165
"""
...
class SbmlSaucerman2006Pka(biosim.BioModule):
    """BioModule wrapper for SBML model: Saucerman2006_PKA."""

    def __init__(self, model_path: str = "data/BIOMD0000000165.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saucerman2006PkaBiomd0000000165Model = SbmlSaucerman2006Pka
