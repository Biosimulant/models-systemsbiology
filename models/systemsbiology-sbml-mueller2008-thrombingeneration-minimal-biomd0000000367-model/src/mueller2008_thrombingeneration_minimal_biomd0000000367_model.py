...
"""Auto-generated SBML BioModule wrapper for Mueller2008_ThrombinGeneration_minimal.

Source: biomodels_ebi:BIOMD0000000367
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000367
"""
...
class SbmlMueller2008ThrombingenerationMinimal(biosim.BioModule):
    """BioModule wrapper for SBML model: Mueller2008_ThrombinGeneration_minimal."""

    def __init__(self, model_path: str = "data/BIOMD0000000367.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mueller2008ThrombingenerationMinimalBiomd0000000367Model = SbmlMueller2008ThrombingenerationMinimal
