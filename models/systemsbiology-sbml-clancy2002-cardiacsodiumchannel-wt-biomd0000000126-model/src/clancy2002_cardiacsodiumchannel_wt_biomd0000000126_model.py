...
"""Auto-generated SBML BioModule wrapper for Clancy2002_CardiacSodiumChannel_WT.

Source: biomodels_ebi:BIOMD0000000126
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000126
"""
...
class SbmlClancy2002CardiacsodiumchannelWt(biosim.BioModule):
    """BioModule wrapper for SBML model: Clancy2002_CardiacSodiumChannel_WT."""

    def __init__(self, model_path: str = "data/BIOMD0000000126.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Clancy2002CardiacsodiumchannelWtBiomd0000000126Model = SbmlClancy2002CardiacsodiumchannelWt
