...
"""Auto-generated SBML BioModule wrapper for Stortelder1997 - Thrombin Generation Amidolytic Activity.

Source: biomodels_ebi:BIOMD0000000358
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000358
"""
...
class SbmlStortelder1997ThrombinGenerationAmidolyticActivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Stortelder1997 - Thrombin Generation Amidolytic Activity."""

    def __init__(self, model_path: str = "data/BIOMD0000000358.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stortelder1997ThrombinGenerationAmidolyticAcBiomd0000000358Model = SbmlStortelder1997ThrombinGenerationAmidolyticActivity
