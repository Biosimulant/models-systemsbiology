...
"""Auto-generated SBML BioModule wrapper for Mayya2005_STATmodule.

Source: biomodels_ebi:BIOMD0000000167
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000167
"""
...
class SbmlMayya2005Statmodule(biosim.BioModule):
    """BioModule wrapper for SBML model: Mayya2005_STATmodule."""

    def __init__(self, model_path: str = "data/BIOMD0000000167.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mayya2005StatmoduleBiomd0000000167Model = SbmlMayya2005Statmodule
