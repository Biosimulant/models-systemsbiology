...
"""Auto-generated SBML BioModule wrapper for Sharma2017 - L. donovani (iMS604).

Source: biomodels_ebi:MODEL2408040003
Original: https://www.ebi.ac.uk/biomodels/MODEL2408040003
"""
...
class SbmlSharma2017LDonovaniIms604(biosim.BioModule):
    """BioModule wrapper for SBML model: Sharma2017 - L. donovani (iMS604)."""

    def __init__(self, model_path: str = "data/MODEL2408040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sharma2017LDonovaniIms604Model2408040003Model = SbmlSharma2017LDonovaniIms604
