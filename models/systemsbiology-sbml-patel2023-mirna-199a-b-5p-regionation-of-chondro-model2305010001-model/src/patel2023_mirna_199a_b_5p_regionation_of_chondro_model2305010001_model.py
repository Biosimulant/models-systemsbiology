...
"""Auto-generated SBML BioModule wrapper for Patel2023 - miRNA-199a/b-5p regionation of chondrogenesis - enchanced.

Source: biomodels_ebi:MODEL2305010001
Original: https://www.ebi.ac.uk/biomodels/MODEL2305010001
"""
...
class SbmlPatel2023Mirna199aB5pRegionationOfChondrogenesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Patel2023 - miRNA-199a/b-5p regionation of chondrogenesis - enchanced."""

    def __init__(self, model_path: str = "data/MODEL2305010001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Patel2023Mirna199aB5pRegionationOfChondroModel2305010001Model = SbmlPatel2023Mirna199aB5pRegionationOfChondrogenesis
