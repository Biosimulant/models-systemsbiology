...
"""Auto-generated SBML BioModule wrapper for Wolf2000_Glycolytic_Oscillations.

Source: biomodels_ebi:BIOMD0000000206
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000206
"""
...
class SbmlWolf2000GlycolyticOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Wolf2000_Glycolytic_Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000206.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wolf2000GlycolyticOscillationsBiomd0000000206Model = SbmlWolf2000GlycolyticOscillations
