...
"""Auto-generated SBML BioModule wrapper for Westermark2003_Pancreatic_GlycOsc_extended.

Source: biomodels_ebi:BIOMD0000000236
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000236
"""
...
class SbmlWestermark2003PancreaticGlycoscExtended(biosim.BioModule):
    """BioModule wrapper for SBML model: Westermark2003_Pancreatic_GlycOsc_extended."""

    def __init__(self, model_path: str = "data/BIOMD0000000236.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Westermark2003PancreaticGlycoscExtendedBiomd0000000236Model = SbmlWestermark2003PancreaticGlycoscExtended
