...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_DXpar-8mMCD).

Source: biomodels_ebi:MODEL1907260011
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260011
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoDxpar8mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_DXpar-8mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoDModel1907260011Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoDxpar8mmcd
