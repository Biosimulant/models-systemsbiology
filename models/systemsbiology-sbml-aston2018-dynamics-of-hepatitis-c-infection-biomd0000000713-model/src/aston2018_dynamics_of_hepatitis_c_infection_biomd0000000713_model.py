...
"""Auto-generated SBML BioModule wrapper for Aston2018 - Dynamics of Hepatitis C Infection.

Source: biomodels_ebi:BIOMD0000000713
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000713
"""
...
class SbmlAston2018DynamicsOfHepatitisCInfection(biosim.BioModule):
    """BioModule wrapper for SBML model: Aston2018 - Dynamics of Hepatitis C Infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000713.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aston2018DynamicsOfHepatitisCInfectionBiomd0000000713Model = SbmlAston2018DynamicsOfHepatitisCInfection
