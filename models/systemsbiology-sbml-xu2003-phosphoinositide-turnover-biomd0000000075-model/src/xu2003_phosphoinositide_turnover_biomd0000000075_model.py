...
"""Auto-generated SBML BioModule wrapper for Xu2003 - Phosphoinositide turnover.

Source: biomodels_ebi:BIOMD0000000075
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000075
"""
...
class SbmlXu2003PhosphoinositideTurnover(biosim.BioModule):
    """BioModule wrapper for SBML model: Xu2003 - Phosphoinositide turnover."""

    def __init__(self, model_path: str = "data/BIOMD0000000075.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Xu2003PhosphoinositideTurnoverBiomd0000000075Model = SbmlXu2003PhosphoinositideTurnover
