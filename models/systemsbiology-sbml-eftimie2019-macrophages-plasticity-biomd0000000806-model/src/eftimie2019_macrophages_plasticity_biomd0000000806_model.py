...
"""Auto-generated SBML BioModule wrapper for Eftimie2019-Macrophages Plasticity.

Source: biomodels_ebi:BIOMD0000000806
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000806
"""
...
class SbmlEftimie2019MacrophagesPlasticity(biosim.BioModule):
    """BioModule wrapper for SBML model: Eftimie2019-Macrophages Plasticity."""

    def __init__(self, model_path: str = "data/BIOMD0000000806.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Eftimie2019MacrophagesPlasticityBiomd0000000806Model = SbmlEftimie2019MacrophagesPlasticity
