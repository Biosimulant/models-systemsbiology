...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Hahn1986_CalvinCycle_Starch_Sucrose.

Source: biomodels_ebi:BIOMD0000000389
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000389
"""
...
class SbmlArnold2011Hahn1986CalvincycleStarchSucrose(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Hahn1986_CalvinCycle_Starch_Sucrose."""

    def __init__(self, model_path: str = "data/BIOMD0000000389.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Hahn1986CalvincycleStarchSucroseBiomd0000000389Model = SbmlArnold2011Hahn1986CalvincycleStarchSucrose
