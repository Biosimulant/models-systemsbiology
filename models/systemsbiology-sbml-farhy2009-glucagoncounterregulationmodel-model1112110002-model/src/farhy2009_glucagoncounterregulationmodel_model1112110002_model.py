...
"""Auto-generated SBML BioModule wrapper for Farhy2009_GlucagonCounterRegulationModel.

Source: biomodels_ebi:MODEL1112110002
Original: https://www.ebi.ac.uk/biomodels/MODEL1112110002
"""
...
class SbmlFarhy2009Glucagoncounterregulationmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Farhy2009_GlucagonCounterRegulationModel."""

    def __init__(self, model_path: str = "data/MODEL1112110002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Farhy2009GlucagoncounterregulationmodelModel1112110002Model = SbmlFarhy2009Glucagoncounterregulationmodel
