...
"""Auto-generated SBML BioModule wrapper for Vu2019 - Planarian tissue polarity.

Source: biomodels_ebi:MODEL2107170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2107170001
"""
...
class SbmlVu2019PlanarianTissuePolarity(biosim.BioModule):
    """BioModule wrapper for SBML model: Vu2019 - Planarian tissue polarity."""

    def __init__(self, model_path: str = "data/MODEL2107170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vu2019PlanarianTissuePolarityModel2107170001Model = SbmlVu2019PlanarianTissuePolarity
