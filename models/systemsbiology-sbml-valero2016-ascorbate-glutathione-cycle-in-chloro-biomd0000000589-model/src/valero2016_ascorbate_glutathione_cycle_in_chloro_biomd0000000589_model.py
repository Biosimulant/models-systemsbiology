...
"""Auto-generated SBML BioModule wrapper for Valero2016 - Ascorbate-Glutathione cycle in chloroplasts under light/dark conditions.

Source: biomodels_ebi:BIOMD0000000589
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000589
"""
...
class SbmlValero2016AscorbateGlutathioneCycleInChloroplasts(biosim.BioModule):
    """BioModule wrapper for SBML model: Valero2016 - Ascorbate-Glutathione cycle in chloroplasts under light/dark conditions."""

    def __init__(self, model_path: str = "data/BIOMD0000000589.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Valero2016AscorbateGlutathioneCycleInChloroBiomd0000000589Model = SbmlValero2016AscorbateGlutathioneCycleInChloroplasts
