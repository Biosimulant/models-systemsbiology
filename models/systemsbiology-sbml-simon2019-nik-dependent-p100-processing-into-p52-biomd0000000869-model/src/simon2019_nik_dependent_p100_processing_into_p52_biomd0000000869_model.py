...
"""Auto-generated SBML BioModule wrapper for Simon2019 - NIK-dependent p100 processing into p52 and IkBd degradation, Michaelis-Menten, SBML 2v4.

Source: biomodels_ebi:BIOMD0000000869
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000869
"""
...
class SbmlSimon2019NikDependentP100ProcessingIntoP52AndIkbd(biosim.BioModule):
    """BioModule wrapper for SBML model: Simon2019 - NIK-dependent p100 processing into p52 and IkBd degradation, Michaelis-Menten, SBML 2v4."""

    def __init__(self, model_path: str = "data/BIOMD0000000869.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Simon2019NikDependentP100ProcessingIntoP52Biomd0000000869Model = SbmlSimon2019NikDependentP100ProcessingIntoP52AndIkbd
