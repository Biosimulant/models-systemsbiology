...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Zhu2007_CalvinCycle_Starch_Sucrose_Photorespiration.

Source: biomodels_ebi:BIOMD0000000393
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000393
"""
...
class SbmlArnold2011Zhu2007CalvincycleStarchSucrose(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Zhu2007_CalvinCycle_Starch_Sucrose_Photorespiration."""

    def __init__(self, model_path: str = "data/BIOMD0000000393.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Zhu2007CalvincycleStarchSucrosePhBiomd0000000393Model = SbmlArnold2011Zhu2007CalvincycleStarchSucrose
