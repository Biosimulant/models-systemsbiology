...
"""Auto-generated SBML BioModule wrapper for Banerjee2018 - Influence of Intracellular Delay on the Dynamics ofHepatitis C Virus.

Source: biomodels_ebi:MODEL2001300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2001300001
"""
...
class SbmlBanerjee2018InfluenceOfIntracellularDelayOnThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Banerjee2018 - Influence of Intracellular Delay on the Dynamics ofHepatitis C Virus."""

    def __init__(self, model_path: str = "data/MODEL2001300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Banerjee2018InfluenceOfIntracellularDelayOnModel2001300001Model = SbmlBanerjee2018InfluenceOfIntracellularDelayOnThe
