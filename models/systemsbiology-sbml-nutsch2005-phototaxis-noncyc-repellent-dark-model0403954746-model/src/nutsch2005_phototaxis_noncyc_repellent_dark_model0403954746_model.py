...
"""Auto-generated SBML BioModule wrapper for Nutsch2005_phototaxis_noncyc_repellent_dark.

Source: biomodels_ebi:MODEL0403954746
Original: https://www.ebi.ac.uk/biomodels/MODEL0403954746
"""
...
class SbmlNutsch2005PhototaxisNoncycRepellentDark(biosim.BioModule):
    """BioModule wrapper for SBML model: Nutsch2005_phototaxis_noncyc_repellent_dark."""

    def __init__(self, model_path: str = "data/MODEL0403954746.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nutsch2005PhototaxisNoncycRepellentDarkModel0403954746Model = SbmlNutsch2005PhototaxisNoncycRepellentDark
