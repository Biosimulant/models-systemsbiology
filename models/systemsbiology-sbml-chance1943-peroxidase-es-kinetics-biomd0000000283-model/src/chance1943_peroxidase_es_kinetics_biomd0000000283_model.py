...
"""Auto-generated SBML BioModule wrapper for Chance1943_Peroxidase_ES_Kinetics.

Source: biomodels_ebi:BIOMD0000000283
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000283
"""
...
class SbmlChance1943PeroxidaseEsKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Chance1943_Peroxidase_ES_Kinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000000283.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chance1943PeroxidaseEsKineticsBiomd0000000283Model = SbmlChance1943PeroxidaseEsKinetics
