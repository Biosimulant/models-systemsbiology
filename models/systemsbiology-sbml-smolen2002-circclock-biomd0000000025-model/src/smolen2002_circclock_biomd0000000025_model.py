...
"""Auto-generated SBML BioModule wrapper for Smolen2002_CircClock.

Source: biomodels_ebi:BIOMD0000000025
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000025
"""
...
class SbmlSmolen2002Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Smolen2002_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000025.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smolen2002CircclockBiomd0000000025Model = SbmlSmolen2002Circclock
