...
"""Auto-generated SBML BioModule wrapper for Inada2009_AtrioventricularNode_AtrioNodalCell.

Source: biomodels_ebi:MODEL1006230082
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230082
"""
...
class SbmlInada2009AtrioventricularnodeAtrionodalcell(biosim.BioModule):
    """BioModule wrapper for SBML model: Inada2009_AtrioventricularNode_AtrioNodalCell."""

    def __init__(self, model_path: str = "data/MODEL1006230082.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Inada2009AtrioventricularnodeAtrionodalcellModel1006230082Model = SbmlInada2009AtrioventricularnodeAtrionodalcell
