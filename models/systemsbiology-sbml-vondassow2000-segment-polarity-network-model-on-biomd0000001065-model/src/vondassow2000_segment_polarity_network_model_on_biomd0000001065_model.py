...
"""Auto-generated SBML BioModule wrapper for vonDassow2000 - Segment Polarity Network model on 1x4 grid of cells.

Source: biomodels_ebi:BIOMD0000001065
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001065
"""
...
class SbmlVondassow2000SegmentPolarityNetworkModelOn1x4GridOf(biosim.BioModule):
    """BioModule wrapper for SBML model: vonDassow2000 - Segment Polarity Network model on 1x4 grid of cells."""

    def __init__(self, model_path: str = "data/BIOMD0000001065.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vondassow2000SegmentPolarityNetworkModelOnBiomd0000001065Model = SbmlVondassow2000SegmentPolarityNetworkModelOn1x4GridOf
