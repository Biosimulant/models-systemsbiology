...
"""Auto-generated SBML BioModule wrapper for Stephanou2019 - pH as a potential therapeutic target to improve temozolomide antitumor efficacy.

Source: biomodels_ebi:MODEL1909300003
Original: https://www.ebi.ac.uk/biomodels/MODEL1909300003
"""
...
class SbmlStephanou2019PhAsAPotentialTherapeuticTargetTo(biosim.BioModule):
    """BioModule wrapper for SBML model: Stephanou2019 - pH as a potential therapeutic target to improve temozolomide antitumor efficacy."""

    def __init__(self, model_path: str = "data/MODEL1909300003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stephanou2019PhAsAPotentialTherapeuticTargModel1909300003Model = SbmlStephanou2019PhAsAPotentialTherapeuticTargetTo
