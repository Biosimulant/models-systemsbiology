...
"""Auto-generated SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.5.1 PLM_1043 ver 1).

Source: biomodels_ebi:MODEL1510190004
Original: https://www.ebi.ac.uk/biomodels/MODEL1510190004
"""
...
class SbmlFlis2015PlantClockGeneCircuitP201151Plm1043Ver1(biosim.BioModule):
    """BioModule wrapper for SBML model: Flis2015 - Plant clock gene circuit (P2011.5.1 PLM_1043 ver 1)."""

    def __init__(self, model_path: str = "data/MODEL1510190004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flis2015PlantClockGeneCircuitP201151PlmModel1510190004Model = SbmlFlis2015PlantClockGeneCircuitP201151Plm1043Ver1
