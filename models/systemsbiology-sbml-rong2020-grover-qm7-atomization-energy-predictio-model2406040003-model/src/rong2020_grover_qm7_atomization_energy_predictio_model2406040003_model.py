...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-QM7: Atomization energy prediction of small molecules..

Source: biomodels_ebi:MODEL2406040003
Original: https://www.ebi.ac.uk/biomodels/MODEL2406040003
"""
...
class SbmlRong2020GroverQm7AtomizationEnergyPredictionOfSmall(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-QM7: Atomization energy prediction of small molecules.."""

    def __init__(self, model_path: str = "data/MODEL2406040003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverQm7AtomizationEnergyPredictioModel2406040003Model = SbmlRong2020GroverQm7AtomizationEnergyPredictionOfSmall
