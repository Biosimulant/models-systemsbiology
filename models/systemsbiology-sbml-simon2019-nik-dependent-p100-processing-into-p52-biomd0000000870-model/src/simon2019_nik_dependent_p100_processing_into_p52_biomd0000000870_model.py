...
"""Auto-generated SBML BioModule wrapper for Simon2019 - NIK-dependent p100 processing into p52 and IkBd degradation, mass action, SBML 2v4.

Source: biomodels_ebi:BIOMD0000000870
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000870
"""
...
class SbmlSimon2019NikDependentP100ProcessingIntoP52AndIkbd2(biosim.BioModule):
    """BioModule wrapper for SBML model: Simon2019 - NIK-dependent p100 processing into p52 and IkBd degradation, mass action, SBML 2v4."""

    def __init__(self, model_path: str = "data/BIOMD0000000870.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Simon2019NikDependentP100ProcessingIntoP52Biomd0000000870Model = SbmlSimon2019NikDependentP100ProcessingIntoP52AndIkbd2
