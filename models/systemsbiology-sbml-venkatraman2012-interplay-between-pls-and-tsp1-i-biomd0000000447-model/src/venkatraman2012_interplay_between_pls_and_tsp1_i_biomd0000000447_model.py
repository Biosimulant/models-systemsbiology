...
"""Auto-generated SBML BioModule wrapper for Venkatraman2012 - Interplay between PLS and TSP1 in TGF-β1 activation.

Source: biomodels_ebi:BIOMD0000000447
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000447
"""
...
class SbmlVenkatraman2012InterplayBetweenPlsAndTsp1InTgf1(biosim.BioModule):
    """BioModule wrapper for SBML model: Venkatraman2012 - Interplay between PLS and TSP1 in TGF-β1 activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000447.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Venkatraman2012InterplayBetweenPlsAndTsp1IBiomd0000000447Model = SbmlVenkatraman2012InterplayBetweenPlsAndTsp1InTgf1
