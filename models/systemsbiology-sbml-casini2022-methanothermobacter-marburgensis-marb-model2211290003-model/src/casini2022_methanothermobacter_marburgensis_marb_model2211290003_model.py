...
"""Auto-generated SBML BioModule wrapper for Casini2022 - Methanothermobacter marburgensis Marburg.

Source: biomodels_ebi:MODEL2211290003
Original: https://www.ebi.ac.uk/biomodels/MODEL2211290003
"""
...
class SbmlCasini2022MethanothermobacterMarburgensisMarburg(biosim.BioModule):
    """BioModule wrapper for SBML model: Casini2022 - Methanothermobacter marburgensis Marburg."""

    def __init__(self, model_path: str = "data/MODEL2211290003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Casini2022MethanothermobacterMarburgensisMarbModel2211290003Model = SbmlCasini2022MethanothermobacterMarburgensisMarburg
