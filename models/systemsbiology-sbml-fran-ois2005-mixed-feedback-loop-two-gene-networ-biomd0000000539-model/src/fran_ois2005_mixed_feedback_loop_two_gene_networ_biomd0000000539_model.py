...
"""Auto-generated SBML BioModule wrapper for François2005 - Mixed Feedback Loop (two-gene network).

Source: biomodels_ebi:BIOMD0000000539
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000539
"""
...
class SbmlFrancois2005MixedFeedbackLoopTwoGeneNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: François2005 - Mixed Feedback Loop (two-gene network)."""

    def __init__(self, model_path: str = "data/BIOMD0000000539.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FranOis2005MixedFeedbackLoopTwoGeneNetworBiomd0000000539Model = SbmlFrancois2005MixedFeedbackLoopTwoGeneNetwork
