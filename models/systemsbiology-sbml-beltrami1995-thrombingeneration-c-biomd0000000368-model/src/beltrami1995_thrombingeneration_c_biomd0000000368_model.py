...
"""Auto-generated SBML BioModule wrapper for Beltrami1995_ThrombinGeneration_C.

Source: biomodels_ebi:BIOMD0000000368
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000368
"""
...
class SbmlBeltrami1995ThrombingenerationC(biosim.BioModule):
    """BioModule wrapper for SBML model: Beltrami1995_ThrombinGeneration_C."""

    def __init__(self, model_path: str = "data/BIOMD0000000368.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beltrami1995ThrombingenerationCBiomd0000000368Model = SbmlBeltrami1995ThrombingenerationC
