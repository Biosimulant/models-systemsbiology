...
"""Auto-generated SBML BioModule wrapper for Heiland2012_CircadianClock_C.reinhardtii.

Source: biomodels_ebi:BIOMD0000000411
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000411
"""
...
class SbmlHeiland2012CircadianclockCReinhardtii(biosim.BioModule):
    """BioModule wrapper for SBML model: Heiland2012_CircadianClock_C.reinhardtii."""

    def __init__(self, model_path: str = "data/BIOMD0000000411.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heiland2012CircadianclockCReinhardtiiBiomd0000000411Model = SbmlHeiland2012CircadianclockCReinhardtii
