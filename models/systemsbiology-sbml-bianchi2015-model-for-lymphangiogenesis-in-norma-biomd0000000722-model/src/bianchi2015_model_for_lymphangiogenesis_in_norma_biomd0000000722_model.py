...
"""Auto-generated SBML BioModule wrapper for Bianchi2015 -Model for lymphangiogenesis in normal and diabetic wounds.

Source: biomodels_ebi:BIOMD0000000722
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000722
"""
...
class SbmlBianchi2015ModelForLymphangiogenesisInNormalAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Bianchi2015 -Model for lymphangiogenesis in normal and diabetic wounds."""

    def __init__(self, model_path: str = "data/BIOMD0000000722.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bianchi2015ModelForLymphangiogenesisInNormaBiomd0000000722Model = SbmlBianchi2015ModelForLymphangiogenesisInNormalAnd
