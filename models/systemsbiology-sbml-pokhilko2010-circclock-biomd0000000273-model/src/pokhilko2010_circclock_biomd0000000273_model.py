...
"""Auto-generated SBML BioModule wrapper for Pokhilko2010_CircClock.

Source: biomodels_ebi:BIOMD0000000273
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000273
"""
...
class SbmlPokhilko2010Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Pokhilko2010_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000273.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pokhilko2010CircclockBiomd0000000273Model = SbmlPokhilko2010Circclock
