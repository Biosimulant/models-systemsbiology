...
"""Auto-generated SBML BioModule wrapper for Ratushny2012_SPF_I.

Source: biomodels_ebi:BIOMD0000000419
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000419
"""
...
class SbmlRatushny2012SpfI(biosim.BioModule):
    """BioModule wrapper for SBML model: Ratushny2012_SPF_I."""

    def __init__(self, model_path: str = "data/BIOMD0000000419.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ratushny2012SpfIBiomd0000000419Model = SbmlRatushny2012SpfI
