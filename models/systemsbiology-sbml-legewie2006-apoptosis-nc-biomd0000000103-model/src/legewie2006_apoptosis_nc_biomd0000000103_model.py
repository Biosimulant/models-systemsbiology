...
"""Auto-generated SBML BioModule wrapper for Legewie2006_apoptosis_NC.

Source: biomodels_ebi:BIOMD0000000103
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000103
"""
...
class SbmlLegewie2006ApoptosisNc(biosim.BioModule):
    """BioModule wrapper for SBML model: Legewie2006_apoptosis_NC."""

    def __init__(self, model_path: str = "data/BIOMD0000000103.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Legewie2006ApoptosisNcBiomd0000000103Model = SbmlLegewie2006ApoptosisNc
