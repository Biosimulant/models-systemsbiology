...
"""Auto-generated SBML BioModule wrapper for Kim2011_Oscillator_SimpleI.

Source: biomodels_ebi:BIOMD0000000322
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000322
"""
...
class SbmlKim2011OscillatorSimplei(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2011_Oscillator_SimpleI."""

    def __init__(self, model_path: str = "data/BIOMD0000000322.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2011OscillatorSimpleiBiomd0000000322Model = SbmlKim2011OscillatorSimplei
