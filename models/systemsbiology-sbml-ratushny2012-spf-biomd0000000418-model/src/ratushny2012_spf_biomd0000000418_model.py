...
"""Auto-generated SBML BioModule wrapper for Ratushny2012_SPF.

Source: biomodels_ebi:BIOMD0000000418
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000418
"""
...
class SbmlRatushny2012Spf(biosim.BioModule):
    """BioModule wrapper for SBML model: Ratushny2012_SPF."""

    def __init__(self, model_path: str = "data/BIOMD0000000418.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ratushny2012SpfBiomd0000000418Model = SbmlRatushny2012Spf
