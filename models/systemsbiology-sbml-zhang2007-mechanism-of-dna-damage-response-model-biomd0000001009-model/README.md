...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000001009)
**Standard**: sbml
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/systemsbiology-sbml-zhang2007-mechanism-of-dna-damage-response-model-biomd0000001009-model/model.yaml
```
