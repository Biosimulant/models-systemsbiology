...
"""Auto-generated SBML BioModule wrapper for Zhang2007 - Mechanism of DNA damage response (Model2).

Source: biomodels_ebi:BIOMD0000001009
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001009
"""
...
class SbmlZhang2007MechanismOfDnaDamageResponseModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2007 - Mechanism of DNA damage response (Model2)."""

    def __init__(self, model_path: str = "data/BIOMD0000001009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2007MechanismOfDnaDamageResponseModelBiomd0000001009Model = SbmlZhang2007MechanismOfDnaDamageResponseModel2
