...
"""Auto-generated SBML BioModule wrapper for Munz2009 - Zombie SIZRC.

Source: biomodels_ebi:BIOMD0000000882
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000882
"""
...
class SbmlMunz2009ZombieSizrc(biosim.BioModule):
    """BioModule wrapper for SBML model: Munz2009 - Zombie SIZRC."""

    def __init__(self, model_path: str = "data/BIOMD0000000882.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Munz2009ZombieSizrcBiomd0000000882Model = SbmlMunz2009ZombieSizrc
