...
"""Auto-generated SBML BioModule wrapper for Kurlovics2021 - Metformin partitioning from plasma to RBC,  single coefficient.

Source: biomodels_ebi:BIOMD0000001040
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001040
"""
...
class SbmlKurlovics2021MetforminPartitioningFromPlasmaToRbc(biosim.BioModule):
    """BioModule wrapper for SBML model: Kurlovics2021 - Metformin partitioning from plasma to RBC,  single coefficient."""

    def __init__(self, model_path: str = "data/BIOMD0000001040.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kurlovics2021MetforminPartitioningFromPlasmaBiomd0000001040Model = SbmlKurlovics2021MetforminPartitioningFromPlasmaToRbc
