...
"""Auto-generated SBML BioModule wrapper for Kamihira2000 - calcitonin fibrillation kinetics.

Source: biomodels_ebi:BIOMD0000000614
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000614
"""
...
class SbmlKamihira2000CalcitoninFibrillationKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Kamihira2000 - calcitonin fibrillation kinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000000614.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kamihira2000CalcitoninFibrillationKineticsBiomd0000000614Model = SbmlKamihira2000CalcitoninFibrillationKinetics
