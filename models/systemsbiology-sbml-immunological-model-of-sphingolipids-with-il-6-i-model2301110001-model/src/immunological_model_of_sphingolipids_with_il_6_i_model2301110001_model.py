...
"""Auto-generated SBML BioModule wrapper for Immunological Model of sphingolipids with IL-6/IL-17/IL-23 in L. major infection.

Source: biomodels_ebi:MODEL2301110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2301110001
"""
...
class SbmlImmunologicalModelOfSphingolipidsWithIl6Il17Il23(biosim.BioModule):
    """BioModule wrapper for SBML model: Immunological Model of sphingolipids with IL-6/IL-17/IL-23 in L. major infection."""

    def __init__(self, model_path: str = "data/MODEL2301110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ImmunologicalModelOfSphingolipidsWithIl6IModel2301110001Model = SbmlImmunologicalModelOfSphingolipidsWithIl6Il17Il23
