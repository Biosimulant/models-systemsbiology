...
"""Auto-generated SBML BioModule wrapper for Proctor2013 - Effect of Aβ immunisation in Alzheimer's disease (stochastic version).

Source: biomodels_ebi:BIOMD0000000634
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000634
"""
...
class SbmlProctor2013EffectOfAImmunisationInAlzheimerSDisease(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2013 - Effect of Aβ immunisation in Alzheimer's disease (stochastic version)."""

    def __init__(self, model_path: str = "data/BIOMD0000000634.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2013EffectOfAImmunisationInAlzheimeBiomd0000000634Model = SbmlProctor2013EffectOfAImmunisationInAlzheimerSDisease
