...
"""Auto-generated SBML BioModule wrapper for Mishra2018 - enhancing sorafenib efficacy by co-target identification through quantitive modelling approach.

Source: biomodels_ebi:MODEL1808060001
Original: https://www.ebi.ac.uk/biomodels/MODEL1808060001
"""
...
class SbmlMishra2018EnhancingSorafenibEfficacyByCoTarget(biosim.BioModule):
    """BioModule wrapper for SBML model: Mishra2018 - enhancing sorafenib efficacy by co-target identification through quantitive modelling approach."""

    def __init__(self, model_path: str = "data/MODEL1808060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mishra2018EnhancingSorafenibEfficacyByCoTaModel1808060001Model = SbmlMishra2018EnhancingSorafenibEfficacyByCoTarget
