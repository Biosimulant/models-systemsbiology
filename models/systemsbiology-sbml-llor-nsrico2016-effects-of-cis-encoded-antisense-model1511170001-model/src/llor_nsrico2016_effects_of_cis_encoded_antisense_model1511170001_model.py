...
"""Auto-generated SBML BioModule wrapper for LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case2.

Source: biomodels_ebi:MODEL1511170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1511170001
"""
...
class SbmlLlorensrico2016EffectsOfCisEncodedAntisenseRnas2(biosim.BioModule):
    """BioModule wrapper for SBML model: LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case2."""

    def __init__(self, model_path: str = "data/MODEL1511170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LlorNsrico2016EffectsOfCisEncodedAntisenseModel1511170001Model = SbmlLlorensrico2016EffectsOfCisEncodedAntisenseRnas2
