...
"""Auto-generated SBML BioModule wrapper for Masison2024 - Enterocyte Iron Mucosal Block.

Source: biomodels_ebi:MODEL2405170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2405170001
"""
...
class SbmlMasison2024EnterocyteIronMucosalBlock(biosim.BioModule):
    """BioModule wrapper for SBML model: Masison2024 - Enterocyte Iron Mucosal Block."""

    def __init__(self, model_path: str = "data/MODEL2405170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Masison2024EnterocyteIronMucosalBlockModel2405170001Model = SbmlMasison2024EnterocyteIronMucosalBlock
