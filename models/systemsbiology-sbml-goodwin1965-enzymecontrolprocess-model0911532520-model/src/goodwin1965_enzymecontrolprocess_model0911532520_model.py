...
"""Auto-generated SBML BioModule wrapper for Goodwin1965_EnzymeControlProcess.

Source: biomodels_ebi:MODEL0911532520
Original: https://www.ebi.ac.uk/biomodels/MODEL0911532520
"""
...
class SbmlGoodwin1965Enzymecontrolprocess(biosim.BioModule):
    """BioModule wrapper for SBML model: Goodwin1965_EnzymeControlProcess."""

    def __init__(self, model_path: str = "data/MODEL0911532520.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goodwin1965EnzymecontrolprocessModel0911532520Model = SbmlGoodwin1965Enzymecontrolprocess
