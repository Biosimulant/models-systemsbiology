...
"""Auto-generated SBML BioModule wrapper for Voršilák2020 - Bayesian estimation of synthetic accessibility of organic compounds.

Source: biomodels_ebi:MODEL2407180002
Original: https://www.ebi.ac.uk/biomodels/MODEL2407180002
"""
...
class SbmlVorsilak2020BayesianEstimationOfSyntheticAccessibility(biosim.BioModule):
    """BioModule wrapper for SBML model: Voršilák2020 - Bayesian estimation of synthetic accessibility of organic compounds."""

    def __init__(self, model_path: str = "data/MODEL2407180002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VorIlK2020BayesianEstimationOfSyntheticAcModel2407180002Model = SbmlVorsilak2020BayesianEstimationOfSyntheticAccessibility
