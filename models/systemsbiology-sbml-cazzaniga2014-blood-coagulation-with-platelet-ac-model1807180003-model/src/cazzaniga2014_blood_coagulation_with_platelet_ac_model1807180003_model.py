...
"""Auto-generated SBML BioModule wrapper for Cazzaniga2014 - Blood Coagulation with Platelet Activation.

Source: biomodels_ebi:MODEL1807180003
Original: https://www.ebi.ac.uk/biomodels/MODEL1807180003
"""
...
class SbmlCazzaniga2014BloodCoagulationWithPlateletActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Cazzaniga2014 - Blood Coagulation with Platelet Activation."""

    def __init__(self, model_path: str = "data/MODEL1807180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cazzaniga2014BloodCoagulationWithPlateletAcModel1807180003Model = SbmlCazzaniga2014BloodCoagulationWithPlateletActivation
