...
"""Auto-generated SBML BioModule wrapper for Proctor2017 - Identifying microRNA for muscle regeneration during ageing  (Mir181_in_muscle).

Source: biomodels_ebi:MODEL1704110001
Original: https://www.ebi.ac.uk/biomodels/MODEL1704110001
"""
...
class SbmlProctor2017IdentifyingMicrornaForMuscleRegeneration2(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017 - Identifying microRNA for muscle regeneration during ageing  (Mir181_in_muscle)."""

    def __init__(self, model_path: str = "data/MODEL1704110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017IdentifyingMicrornaForMuscleRegeModel1704110001Model = SbmlProctor2017IdentifyingMicrornaForMuscleRegeneration2
