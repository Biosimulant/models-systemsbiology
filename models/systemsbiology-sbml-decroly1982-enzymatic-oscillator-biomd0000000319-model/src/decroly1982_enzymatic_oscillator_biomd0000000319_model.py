...
"""Auto-generated SBML BioModule wrapper for Decroly1982_Enzymatic_Oscillator.

Source: biomodels_ebi:BIOMD0000000319
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000319
"""
...
class SbmlDecroly1982EnzymaticOscillator(biosim.BioModule):
    """BioModule wrapper for SBML model: Decroly1982_Enzymatic_Oscillator."""

    def __init__(self, model_path: str = "data/BIOMD0000000319.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Decroly1982EnzymaticOscillatorBiomd0000000319Model = SbmlDecroly1982EnzymaticOscillator
