...
"""Auto-generated SBML BioModule wrapper for Kolomeisky2003_MyosinV_Processivity.

Source: biomodels_ebi:BIOMD0000000305
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000305
"""
...
class SbmlKolomeisky2003MyosinvProcessivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Kolomeisky2003_MyosinV_Processivity."""

    def __init__(self, model_path: str = "data/BIOMD0000000305.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kolomeisky2003MyosinvProcessivityBiomd0000000305Model = SbmlKolomeisky2003MyosinvProcessivity
