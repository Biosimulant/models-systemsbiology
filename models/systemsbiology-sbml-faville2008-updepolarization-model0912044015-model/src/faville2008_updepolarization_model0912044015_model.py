...
"""Auto-generated SBML BioModule wrapper for Faville2008_UPdepolarization.

Source: biomodels_ebi:MODEL0912044015
Original: https://www.ebi.ac.uk/biomodels/MODEL0912044015
"""
...
class SbmlFaville2008Updepolarization(biosim.BioModule):
    """BioModule wrapper for SBML model: Faville2008_UPdepolarization."""

    def __init__(self, model_path: str = "data/MODEL0912044015.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Faville2008UpdepolarizationModel0912044015Model = SbmlFaville2008Updepolarization
