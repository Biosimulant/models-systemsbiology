...
"""Auto-generated SBML BioModule wrapper for Heldt2018 - Proliferation-quiescence decision in response to DNA damage.

Source: biomodels_ebi:BIOMD0000000700
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000700
"""
...
class SbmlHeldt2018ProliferationQuiescenceDecisionInResponseTo(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2018 - Proliferation-quiescence decision in response to DNA damage."""

    def __init__(self, model_path: str = "data/BIOMD0000000700.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2018ProliferationQuiescenceDecisionInRBiomd0000000700Model = SbmlHeldt2018ProliferationQuiescenceDecisionInResponseTo
