...
"""Auto-generated SBML BioModule wrapper for Zi2007_TGFbeta_signaling.

Source: biomodels_ebi:BIOMD0000000163
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000163
"""
...
class SbmlZi2007TgfbetaSignaling(biosim.BioModule):
    """BioModule wrapper for SBML model: Zi2007_TGFbeta_signaling."""

    def __init__(self, model_path: str = "data/BIOMD0000000163.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zi2007TgfbetaSignalingBiomd0000000163Model = SbmlZi2007TgfbetaSignaling
