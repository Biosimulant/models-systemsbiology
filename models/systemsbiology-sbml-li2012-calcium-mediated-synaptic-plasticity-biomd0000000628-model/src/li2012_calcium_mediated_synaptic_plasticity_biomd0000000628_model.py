...
"""Auto-generated SBML BioModule wrapper for Li2012 Calcium mediated synaptic plasticity.

Source: biomodels_ebi:BIOMD0000000628
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000628
"""
...
class SbmlLi2012CalciumMediatedSynapticPlasticity(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2012 Calcium mediated synaptic plasticity."""

    def __init__(self, model_path: str = "data/BIOMD0000000628.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2012CalciumMediatedSynapticPlasticityBiomd0000000628Model = SbmlLi2012CalciumMediatedSynapticPlasticity
