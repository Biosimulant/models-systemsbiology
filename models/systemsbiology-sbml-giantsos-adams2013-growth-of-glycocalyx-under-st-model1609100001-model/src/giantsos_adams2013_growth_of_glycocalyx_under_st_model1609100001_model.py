...
"""Auto-generated SBML BioModule wrapper for Giantsos-Adams2013 - Growth of glycocalyx under static conditions.

Source: biomodels_ebi:MODEL1609100001
Original: https://www.ebi.ac.uk/biomodels/MODEL1609100001
"""
...
class SbmlGiantsosAdams2013GrowthOfGlycocalyxUnderStatic(biosim.BioModule):
    """BioModule wrapper for SBML model: Giantsos-Adams2013 - Growth of glycocalyx under static conditions."""

    def __init__(self, model_path: str = "data/MODEL1609100001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GiantsosAdams2013GrowthOfGlycocalyxUnderStModel1609100001Model = SbmlGiantsosAdams2013GrowthOfGlycocalyxUnderStatic
