...
"""Auto-generated SBML BioModule wrapper for Ratushny2012_ASSURE_II.

Source: biomodels_ebi:BIOMD0000000421
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000421
"""
...
class SbmlRatushny2012AssureIi(biosim.BioModule):
    """BioModule wrapper for SBML model: Ratushny2012_ASSURE_II."""

    def __init__(self, model_path: str = "data/BIOMD0000000421.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ratushny2012AssureIiBiomd0000000421Model = SbmlRatushny2012AssureIi
