...
"""Auto-generated SBML BioModule wrapper for Benson2014 - FAAH inhibitors for the treatment of osteoarthritic pain.

Source: biomodels_ebi:BIOMD0000000512
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000512
"""
...
class SbmlBenson2014FaahInhibitorsForTheTreatmentOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Benson2014 - FAAH inhibitors for the treatment of osteoarthritic pain."""

    def __init__(self, model_path: str = "data/BIOMD0000000512.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Benson2014FaahInhibitorsForTheTreatmentOfBiomd0000000512Model = SbmlBenson2014FaahInhibitorsForTheTreatmentOf
