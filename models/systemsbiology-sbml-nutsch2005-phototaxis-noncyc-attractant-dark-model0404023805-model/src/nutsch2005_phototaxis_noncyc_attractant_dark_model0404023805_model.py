...
"""Auto-generated SBML BioModule wrapper for Nutsch2005_phototaxis_noncyc_attractant_dark.

Source: biomodels_ebi:MODEL0404023805
Original: https://www.ebi.ac.uk/biomodels/MODEL0404023805
"""
...
class SbmlNutsch2005PhototaxisNoncycAttractantDark(biosim.BioModule):
    """BioModule wrapper for SBML model: Nutsch2005_phototaxis_noncyc_attractant_dark."""

    def __init__(self, model_path: str = "data/MODEL0404023805.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nutsch2005PhototaxisNoncycAttractantDarkModel0404023805Model = SbmlNutsch2005PhototaxisNoncycAttractantDark
