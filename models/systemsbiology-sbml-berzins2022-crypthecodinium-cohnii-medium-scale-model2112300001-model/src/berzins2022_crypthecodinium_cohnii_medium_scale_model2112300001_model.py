...
"""Auto-generated SBML BioModule wrapper for Berzins2022 - Crypthecodinium cohnii medium scale model.

Source: biomodels_ebi:MODEL2112300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2112300001
"""
...
class SbmlBerzins2022CrypthecodiniumCohniiMediumScaleModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Berzins2022 - Crypthecodinium cohnii medium scale model."""

    def __init__(self, model_path: str = "data/MODEL2112300001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Berzins2022CrypthecodiniumCohniiMediumScaleModel2112300001Model = SbmlBerzins2022CrypthecodiniumCohniiMediumScaleModel
