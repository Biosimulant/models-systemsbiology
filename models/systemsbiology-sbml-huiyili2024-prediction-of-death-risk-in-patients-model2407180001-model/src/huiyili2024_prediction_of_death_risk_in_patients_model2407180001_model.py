...
"""Auto-generated SBML BioModule wrapper for HuiyiLi2024 - Prediction of death risk in patients with acute diquat poisoning using Random Forest Model.

Source: biomodels_ebi:MODEL2407180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407180001
"""
...
class SbmlHuiyili2024PredictionOfDeathRiskInPatientsWithAcute(biosim.BioModule):
    """BioModule wrapper for SBML model: HuiyiLi2024 - Prediction of death risk in patients with acute diquat poisoning using Random Forest Model."""

    def __init__(self, model_path: str = "data/MODEL2407180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Huiyili2024PredictionOfDeathRiskInPatientsModel2407180001Model = SbmlHuiyili2024PredictionOfDeathRiskInPatientsWithAcute
