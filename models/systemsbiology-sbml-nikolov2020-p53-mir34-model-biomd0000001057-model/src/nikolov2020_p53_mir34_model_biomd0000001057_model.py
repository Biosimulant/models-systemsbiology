...
"""Auto-generated SBML BioModule wrapper for Nikolov2020 - p53-miR34 model.

Source: biomodels_ebi:BIOMD0000001057
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001057
"""
...
class SbmlNikolov2020P53Mir34Model(biosim.BioModule):
    """BioModule wrapper for SBML model: Nikolov2020 - p53-miR34 model."""

    def __init__(self, model_path: str = "data/BIOMD0000001057.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nikolov2020P53Mir34ModelBiomd0000001057Model = SbmlNikolov2020P53Mir34Model
