...
"""Auto-generated SBML BioModule wrapper for McLean1991 - Behaviour of HIV in the presence of zidovudine.

Source: biomodels_ebi:BIOMD0000000967
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000967
"""
...
class SbmlMclean1991BehaviourOfHivInThePresenceOfZidovudine(biosim.BioModule):
    """BioModule wrapper for SBML model: McLean1991 - Behaviour of HIV in the presence of zidovudine."""

    def __init__(self, model_path: str = "data/BIOMD0000000967.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mclean1991BehaviourOfHivInThePresenceOfZBiomd0000000967Model = SbmlMclean1991BehaviourOfHivInThePresenceOfZidovudine
