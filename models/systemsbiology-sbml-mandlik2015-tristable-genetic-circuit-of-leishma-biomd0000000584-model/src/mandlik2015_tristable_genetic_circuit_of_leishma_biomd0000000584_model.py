...
"""Auto-generated SBML BioModule wrapper for Mandlik2015 - Tristable genetic circuit of Leishmania.

Source: biomodels_ebi:BIOMD0000000584
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000584
"""
...
class SbmlMandlik2015TristableGeneticCircuitOfLeishmania(biosim.BioModule):
    """BioModule wrapper for SBML model: Mandlik2015 - Tristable genetic circuit of Leishmania."""

    def __init__(self, model_path: str = "data/BIOMD0000000584.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mandlik2015TristableGeneticCircuitOfLeishmaBiomd0000000584Model = SbmlMandlik2015TristableGeneticCircuitOfLeishmania
