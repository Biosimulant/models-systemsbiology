...
"""Auto-generated SBML BioModule wrapper for Haffez2017 - RAR interaction with synthetic analogues.

Source: biomodels_ebi:BIOMD0000000629
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000629
"""
...
class SbmlHaffez2017RarInteractionWithSyntheticAnalogues(biosim.BioModule):
    """BioModule wrapper for SBML model: Haffez2017 - RAR interaction with synthetic analogues."""

    def __init__(self, model_path: str = "data/BIOMD0000000629.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haffez2017RarInteractionWithSyntheticAnalogBiomd0000000629Model = SbmlHaffez2017RarInteractionWithSyntheticAnalogues
