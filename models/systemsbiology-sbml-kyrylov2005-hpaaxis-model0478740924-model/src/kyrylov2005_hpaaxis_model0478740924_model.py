...
"""Auto-generated SBML BioModule wrapper for Kyrylov2005_HPAaxis.

Source: biomodels_ebi:MODEL0478740924
Original: https://www.ebi.ac.uk/biomodels/MODEL0478740924
"""
...
class SbmlKyrylov2005Hpaaxis(biosim.BioModule):
    """BioModule wrapper for SBML model: Kyrylov2005_HPAaxis."""

    def __init__(self, model_path: str = "data/MODEL0478740924.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kyrylov2005HpaaxisModel0478740924Model = SbmlKyrylov2005Hpaaxis
