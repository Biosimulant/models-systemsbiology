...
"""Auto-generated SBML BioModule wrapper for Kim2022 - BayeshERG: A deep learning model for predicting hERG channel blockers.

Source: biomodels_ebi:MODEL2408060001
Original: https://www.ebi.ac.uk/biomodels/MODEL2408060001
"""
...
class SbmlKim2022BayeshergADeepLearningModelForPredictingHerg(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2022 - BayeshERG: A deep learning model for predicting hERG channel blockers."""

    def __init__(self, model_path: str = "data/MODEL2408060001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2022BayeshergADeepLearningModelForPredModel2408060001Model = SbmlKim2022BayeshergADeepLearningModelForPredictingHerg
