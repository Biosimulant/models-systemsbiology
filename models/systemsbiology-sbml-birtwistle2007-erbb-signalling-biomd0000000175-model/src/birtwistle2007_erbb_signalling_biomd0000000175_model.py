...
"""Auto-generated SBML BioModule wrapper for Birtwistle2007_ErbB_Signalling.

Source: biomodels_ebi:BIOMD0000000175
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000175
"""
...
class SbmlBirtwistle2007ErbbSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Birtwistle2007_ErbB_Signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000175.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Birtwistle2007ErbbSignallingBiomd0000000175Model = SbmlBirtwistle2007ErbbSignalling
