...
"""Auto-generated SBML BioModule wrapper for Morris2009 - α-Synuclein aggregation variable temperature and pH.

Source: biomodels_ebi:BIOMD0000000566
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000566
"""
...
class SbmlMorris2009SynucleinAggregationVariableTemperatureAndPh(biosim.BioModule):
    """BioModule wrapper for SBML model: Morris2009 - α-Synuclein aggregation variable temperature and pH."""

    def __init__(self, model_path: str = "data/BIOMD0000000566.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Morris2009SynucleinAggregationVariableTemperBiomd0000000566Model = SbmlMorris2009SynucleinAggregationVariableTemperatureAndPh
