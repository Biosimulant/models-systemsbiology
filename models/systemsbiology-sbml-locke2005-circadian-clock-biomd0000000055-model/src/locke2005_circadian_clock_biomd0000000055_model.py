...
"""Auto-generated SBML BioModule wrapper for Locke2005 - Circadian Clock.

Source: biomodels_ebi:BIOMD0000000055
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000055
"""
...
class SbmlLocke2005CircadianClock(biosim.BioModule):
    """BioModule wrapper for SBML model: Locke2005 - Circadian Clock."""

    def __init__(self, model_path: str = "data/BIOMD0000000055.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Locke2005CircadianClockBiomd0000000055Model = SbmlLocke2005CircadianClock
