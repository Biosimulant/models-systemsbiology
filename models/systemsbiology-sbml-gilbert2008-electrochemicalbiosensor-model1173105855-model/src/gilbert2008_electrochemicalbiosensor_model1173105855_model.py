...
"""Auto-generated SBML BioModule wrapper for Gilbert2008_ElectrochemicalBiosensor.

Source: biomodels_ebi:MODEL1173105855
Original: https://www.ebi.ac.uk/biomodels/MODEL1173105855
"""
...
class SbmlGilbert2008Electrochemicalbiosensor(biosim.BioModule):
    """BioModule wrapper for SBML model: Gilbert2008_ElectrochemicalBiosensor."""

    def __init__(self, model_path: str = "data/MODEL1173105855.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gilbert2008ElectrochemicalbiosensorModel1173105855Model = SbmlGilbert2008Electrochemicalbiosensor
