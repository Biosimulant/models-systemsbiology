...
"""Auto-generated SBML BioModule wrapper for Pereira2020 - Discovering growth Inhibitors of Neisseria gonorrhoeae with Machine Learning.

Source: biomodels_ebi:MODEL2405080003
Original: https://www.ebi.ac.uk/biomodels/MODEL2405080003
"""
...
class SbmlPereira2020DiscoveringGrowthInhibitorsOfNeisseria(biosim.BioModule):
    """BioModule wrapper for SBML model: Pereira2020 - Discovering growth Inhibitors of Neisseria gonorrhoeae with Machine Learning."""

    def __init__(self, model_path: str = "data/MODEL2405080003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pereira2020DiscoveringGrowthInhibitorsOfNeiModel2405080003Model = SbmlPereira2020DiscoveringGrowthInhibitorsOfNeisseria
