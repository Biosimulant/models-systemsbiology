...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_HYpar-8mMCD).

Source: biomodels_ebi:MODEL1907260005
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260005
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoHypar8mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_HYpar-8mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoHModel1907260005Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoHypar8mmcd
