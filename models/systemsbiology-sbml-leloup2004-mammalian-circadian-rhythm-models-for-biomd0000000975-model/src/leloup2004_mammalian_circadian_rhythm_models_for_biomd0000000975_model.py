...
"""Auto-generated SBML BioModule wrapper for Leloup2004 - Mammalian Circadian Rhythm models for 23.8 and 24.2 hours timeperiod.

Source: biomodels_ebi:BIOMD0000000975
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000975
"""
...
class SbmlLeloup2004MammalianCircadianRhythmModelsFor238And(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup2004 - Mammalian Circadian Rhythm models for 23.8 and 24.2 hours timeperiod."""

    def __init__(self, model_path: str = "data/BIOMD0000000975.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup2004MammalianCircadianRhythmModelsForBiomd0000000975Model = SbmlLeloup2004MammalianCircadianRhythmModelsFor238And
