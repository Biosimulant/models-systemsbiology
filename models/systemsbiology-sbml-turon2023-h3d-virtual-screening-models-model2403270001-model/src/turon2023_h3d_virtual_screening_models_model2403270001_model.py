...
"""Auto-generated SBML BioModule wrapper for Turon2023 - H3D virtual screening models.

Source: biomodels_ebi:MODEL2403270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2403270001
"""
...
class SbmlTuron2023H3dVirtualScreeningModels(biosim.BioModule):
    """BioModule wrapper for SBML model: Turon2023 - H3D virtual screening models."""

    def __init__(self, model_path: str = "data/MODEL2403270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Turon2023H3dVirtualScreeningModelsModel2403270001Model = SbmlTuron2023H3dVirtualScreeningModels
