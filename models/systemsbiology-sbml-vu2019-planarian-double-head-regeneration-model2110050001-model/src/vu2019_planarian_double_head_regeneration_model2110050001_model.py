...
"""Auto-generated SBML BioModule wrapper for Vu2019 - Planarian double-head regeneration.

Source: biomodels_ebi:MODEL2110050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2110050001
"""
...
class SbmlVu2019PlanarianDoubleHeadRegeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Vu2019 - Planarian double-head regeneration."""

    def __init__(self, model_path: str = "data/MODEL2110050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vu2019PlanarianDoubleHeadRegenerationModel2110050001Model = SbmlVu2019PlanarianDoubleHeadRegeneration
