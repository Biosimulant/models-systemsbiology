...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactococcus lactis subsp. cremoris NZ9000.

Source: biomodels_ebi:MODEL2210190009
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190009
"""
...
class SbmlKoduru2022LactococcusLactisSubspCremorisNz9000(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactococcus lactis subsp. cremoris NZ9000."""

    def __init__(self, model_path: str = "data/MODEL2210190009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactococcusLactisSubspCremorisNz9Model2210190009Model = SbmlKoduru2022LactococcusLactisSubspCremorisNz9000
