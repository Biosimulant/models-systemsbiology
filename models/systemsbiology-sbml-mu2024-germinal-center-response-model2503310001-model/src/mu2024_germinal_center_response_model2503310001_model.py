...
"""Auto-generated SBML BioModule wrapper for Mu2024 - Germinal Center Response.

Source: biomodels_ebi:MODEL2503310001
Original: https://www.ebi.ac.uk/biomodels/MODEL2503310001
"""
...
class SbmlMu2024GerminalCenterResponse(biosim.BioModule):
    """BioModule wrapper for SBML model: Mu2024 - Germinal Center Response."""

    def __init__(self, model_path: str = "data/MODEL2503310001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mu2024GerminalCenterResponseModel2503310001Model = SbmlMu2024GerminalCenterResponse
