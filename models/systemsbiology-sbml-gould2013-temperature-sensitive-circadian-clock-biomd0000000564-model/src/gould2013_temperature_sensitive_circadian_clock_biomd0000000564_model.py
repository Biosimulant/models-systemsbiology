...
"""Auto-generated SBML BioModule wrapper for Gould2013 - Temperature Sensitive Circadian Clock.

Source: biomodels_ebi:BIOMD0000000564
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000564
"""
...
class SbmlGould2013TemperatureSensitiveCircadianClock(biosim.BioModule):
    """BioModule wrapper for SBML model: Gould2013 - Temperature Sensitive Circadian Clock."""

    def __init__(self, model_path: str = "data/BIOMD0000000564.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gould2013TemperatureSensitiveCircadianClockBiomd0000000564Model = SbmlGould2013TemperatureSensitiveCircadianClock
