...
"""Auto-generated SBML BioModule wrapper for Bingzheng1990_GlucocorticoidsSecretion.

Source: biomodels_ebi:MODEL1172200168
Original: https://www.ebi.ac.uk/biomodels/MODEL1172200168
"""
...
class SbmlBingzheng1990Glucocorticoidssecretion(biosim.BioModule):
    """BioModule wrapper for SBML model: Bingzheng1990_GlucocorticoidsSecretion."""

    def __init__(self, model_path: str = "data/MODEL1172200168.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bingzheng1990GlucocorticoidssecretionModel1172200168Model = SbmlBingzheng1990Glucocorticoidssecretion
