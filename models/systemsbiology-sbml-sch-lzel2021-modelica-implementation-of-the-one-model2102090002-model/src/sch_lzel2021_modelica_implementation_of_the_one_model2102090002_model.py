...
"""Auto-generated SBML BioModule wrapper for Schölzel2021 - Modelica implementation of the one-dimensional model of the rabbit atrioventricular node in Inada2009 (InaMo).

Source: biomodels_ebi:MODEL2102090002
Original: https://www.ebi.ac.uk/biomodels/MODEL2102090002
"""
...
class SbmlScholzel2021ModelicaImplementationOfTheOneDimensional(biosim.BioModule):
    """BioModule wrapper for SBML model: Schölzel2021 - Modelica implementation of the one-dimensional model of the rabbit atrioventricular node in Inada2009 (InaMo)."""

    def __init__(self, model_path: str = "data/MODEL2102090002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SchLzel2021ModelicaImplementationOfTheOneModel2102090002Model = SbmlScholzel2021ModelicaImplementationOfTheOneDimensional
