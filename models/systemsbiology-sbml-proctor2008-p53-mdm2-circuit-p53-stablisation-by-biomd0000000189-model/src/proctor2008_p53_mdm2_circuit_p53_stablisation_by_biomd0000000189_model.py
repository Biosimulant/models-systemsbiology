...
"""Auto-generated SBML BioModule wrapper for Proctor2008 - p53/Mdm2 circuit - p53 stablisation by p14ARF.

Source: biomodels_ebi:BIOMD0000000189
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000189
"""
...
class SbmlProctor2008P53Mdm2CircuitP53StablisationByP14arf(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2008 - p53/Mdm2 circuit - p53 stablisation by p14ARF."""

    def __init__(self, model_path: str = "data/BIOMD0000000189.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2008P53Mdm2CircuitP53StablisationByBiomd0000000189Model = SbmlProctor2008P53Mdm2CircuitP53StablisationByP14arf
