...
"""Auto-generated SBML BioModule wrapper for Wong2024 - Cytotoxicity Prediction from Human Cell Lines.

Source: biomodels_ebi:MODEL2405130002
Original: https://www.ebi.ac.uk/biomodels/MODEL2405130002
"""
...
class SbmlWong2024CytotoxicityPredictionFromHumanCellLines(biosim.BioModule):
    """BioModule wrapper for SBML model: Wong2024 - Cytotoxicity Prediction from Human Cell Lines."""

    def __init__(self, model_path: str = "data/MODEL2405130002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wong2024CytotoxicityPredictionFromHumanCellModel2405130002Model = SbmlWong2024CytotoxicityPredictionFromHumanCellLines
