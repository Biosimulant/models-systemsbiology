...
"""Auto-generated SBML BioModule wrapper for Lee2010_ThrombinActivation_OneForm.

Source: biomodels_ebi:BIOMD0000000364
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000364
"""
...
class SbmlLee2010ThrombinactivationOneform(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2010_ThrombinActivation_OneForm."""

    def __init__(self, model_path: str = "data/BIOMD0000000364.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2010ThrombinactivationOneformBiomd0000000364Model = SbmlLee2010ThrombinactivationOneform
