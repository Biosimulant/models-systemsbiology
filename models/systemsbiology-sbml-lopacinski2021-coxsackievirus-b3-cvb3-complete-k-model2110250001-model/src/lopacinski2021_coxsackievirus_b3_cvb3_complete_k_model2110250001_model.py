...
"""Auto-generated SBML BioModule wrapper for Lopacinski2021 - Coxsackievirus B3 (CVB3) complete kinetics ODE model.

Source: biomodels_ebi:MODEL2110250001
Original: https://www.ebi.ac.uk/biomodels/MODEL2110250001
"""
...
class SbmlLopacinski2021CoxsackievirusB3Cvb3CompleteKineticsOde(bsim.BioModule):
    """BioModule wrapper for SBML model: Lopacinski2021 - Coxsackievirus B3 (CVB3) complete kinetics ODE model."""

    def __init__(self, model_path: str = "data/MODEL2110250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lopacinski2021CoxsackievirusB3Cvb3CompleteKModel2110250001Model = SbmlLopacinski2021CoxsackievirusB3Cvb3CompleteKineticsOde
