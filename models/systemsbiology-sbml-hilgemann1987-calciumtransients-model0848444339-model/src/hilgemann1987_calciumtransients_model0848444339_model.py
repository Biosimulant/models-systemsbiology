...
"""Auto-generated SBML BioModule wrapper for Hilgemann1987_CalciumTransients.

Source: biomodels_ebi:MODEL0848444339
Original: https://www.ebi.ac.uk/biomodels/MODEL0848444339
"""
...
class SbmlHilgemann1987Calciumtransients(biosim.BioModule):
    """BioModule wrapper for SBML model: Hilgemann1987_CalciumTransients."""

    def __init__(self, model_path: str = "data/MODEL0848444339.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hilgemann1987CalciumtransientsModel0848444339Model = SbmlHilgemann1987Calciumtransients
