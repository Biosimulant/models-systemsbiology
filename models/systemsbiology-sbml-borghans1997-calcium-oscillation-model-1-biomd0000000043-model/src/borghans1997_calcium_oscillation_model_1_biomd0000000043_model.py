...
"""Auto-generated SBML BioModule wrapper for Borghans1997 - Calcium Oscillation - Model 1.

Source: biomodels_ebi:BIOMD0000000043
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000043
"""
...
class SbmlBorghans1997CalciumOscillationModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Borghans1997 - Calcium Oscillation - Model 1."""

    def __init__(self, model_path: str = "data/BIOMD0000000043.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borghans1997CalciumOscillationModel1Biomd0000000043Model = SbmlBorghans1997CalciumOscillationModel1
