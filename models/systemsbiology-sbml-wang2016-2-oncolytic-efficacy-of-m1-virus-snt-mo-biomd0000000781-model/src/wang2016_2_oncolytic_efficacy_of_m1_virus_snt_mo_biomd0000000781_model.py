...
"""Auto-generated SBML BioModule wrapper for Wang2016/2 - oncolytic efficacy of M1 virus-SNT model.

Source: biomodels_ebi:BIOMD0000000781
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000781
"""
...
class SbmlWang20162OncolyticEfficacyOfM1VirusSntModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2016/2 - oncolytic efficacy of M1 virus-SNT model."""

    def __init__(self, model_path: str = "data/BIOMD0000000781.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang20162OncolyticEfficacyOfM1VirusSntMoBiomd0000000781Model = SbmlWang20162OncolyticEfficacyOfM1VirusSntModel
