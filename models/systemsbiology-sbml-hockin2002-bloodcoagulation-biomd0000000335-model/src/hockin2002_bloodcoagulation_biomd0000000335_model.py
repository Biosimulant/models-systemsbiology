...
"""Auto-generated SBML BioModule wrapper for Hockin2002_BloodCoagulation.

Source: biomodels_ebi:BIOMD0000000335
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000335
"""
...
class SbmlHockin2002Bloodcoagulation(biosim.BioModule):
    """BioModule wrapper for SBML model: Hockin2002_BloodCoagulation."""

    def __init__(self, model_path: str = "data/BIOMD0000000335.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hockin2002BloodcoagulationBiomd0000000335Model = SbmlHockin2002Bloodcoagulation
