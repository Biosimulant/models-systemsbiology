...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactococcus lactis subsp. cremoris MG1363.

Source: biomodels_ebi:MODEL2210190011
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190011
"""
...
class SbmlKoduru2022LactococcusLactisSubspCremorisMg1363(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactococcus lactis subsp. cremoris MG1363."""

    def __init__(self, model_path: str = "data/MODEL2210190011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactococcusLactisSubspCremorisMg1Model2210190011Model = SbmlKoduru2022LactococcusLactisSubspCremorisMg1363
