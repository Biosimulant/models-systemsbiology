...
"""Auto-generated SBML BioModule wrapper for Li2021-MicroRNAs noncanonical feedback model.

Source: biomodels_ebi:MODEL2301180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2301180001
"""
...
class SbmlLi2021MicrornasNoncanonicalFeedbackModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Li2021-MicroRNAs noncanonical feedback model."""

    def __init__(self, model_path: str = "data/MODEL2301180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Li2021MicrornasNoncanonicalFeedbackModelModel2301180001Model = SbmlLi2021MicrornasNoncanonicalFeedbackModel
