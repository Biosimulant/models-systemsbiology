...
"""Auto-generated SBML BioModule wrapper for Rehm2006_Caspase.

Source: biomodels_ebi:BIOMD0000000256
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000256
"""
...
class SbmlRehm2006Caspase(biosim.BioModule):
    """BioModule wrapper for SBML model: Rehm2006_Caspase."""

    def __init__(self, model_path: str = "data/BIOMD0000000256.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rehm2006CaspaseBiomd0000000256Model = SbmlRehm2006Caspase
