...
"""Auto-generated SBML BioModule wrapper for Cao2013 - Application of ABSIS method in the reversible isomerization model.

Source: biomodels_ebi:BIOMD0000000486
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000486
"""
...
class SbmlCao2013ApplicationOfAbsisMethodInTheReversible(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2013 - Application of ABSIS method in the reversible isomerization model."""

    def __init__(self, model_path: str = "data/BIOMD0000000486.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2013ApplicationOfAbsisMethodInTheReverBiomd0000000486Model = SbmlCao2013ApplicationOfAbsisMethodInTheReversible
