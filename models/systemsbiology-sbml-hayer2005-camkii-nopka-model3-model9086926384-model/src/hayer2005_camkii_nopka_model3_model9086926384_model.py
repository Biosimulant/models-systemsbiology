...
"""Auto-generated SBML BioModule wrapper for Hayer2005_CaMKII_noPKA_model3.

Source: biomodels_ebi:MODEL9086926384
Original: https://www.ebi.ac.uk/biomodels/MODEL9086926384
"""
...
class SbmlHayer2005CamkiiNopkaModel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_CaMKII_noPKA_model3."""

    def __init__(self, model_path: str = "data/MODEL9086926384.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005CamkiiNopkaModel3Model9086926384Model = SbmlHayer2005CamkiiNopkaModel3
