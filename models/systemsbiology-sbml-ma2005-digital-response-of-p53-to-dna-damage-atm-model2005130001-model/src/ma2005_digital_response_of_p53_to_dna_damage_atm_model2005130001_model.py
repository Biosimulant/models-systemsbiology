...
"""Auto-generated SBML BioModule wrapper for Ma2005-digital response of p53 to DNA damage-ATM Activation Module.

Source: biomodels_ebi:MODEL2005130001
Original: https://www.ebi.ac.uk/biomodels/MODEL2005130001
"""
...
class SbmlMa2005DigitalResponseOfP53ToDnaDamageAtmActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Ma2005-digital response of p53 to DNA damage-ATM Activation Module."""

    def __init__(self, model_path: str = "data/MODEL2005130001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ma2005DigitalResponseOfP53ToDnaDamageAtmModel2005130001Model = SbmlMa2005DigitalResponseOfP53ToDnaDamageAtmActivation
