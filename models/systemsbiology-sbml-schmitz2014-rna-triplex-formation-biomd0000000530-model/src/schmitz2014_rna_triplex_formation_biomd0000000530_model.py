...
"""Auto-generated SBML BioModule wrapper for Schmitz2014 - RNA triplex formation.

Source: biomodels_ebi:BIOMD0000000530
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000530
"""
...
class SbmlSchmitz2014RnaTriplexFormation(biosim.BioModule):
    """BioModule wrapper for SBML model: Schmitz2014 - RNA triplex formation."""

    def __init__(self, model_path: str = "data/BIOMD0000000530.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schmitz2014RnaTriplexFormationBiomd0000000530Model = SbmlSchmitz2014RnaTriplexFormation
