...
"""Auto-generated SBML BioModule wrapper for Lopez2013 - extrinsic apoptosis M1a embedded.

Source: biomodels_ebi:MODEL1303010000
Original: https://www.ebi.ac.uk/biomodels/MODEL1303010000
"""
...
class SbmlLopez2013ExtrinsicApoptosisM1aEmbedded(biosim.BioModule):
    """BioModule wrapper for SBML model: Lopez2013 - extrinsic apoptosis M1a embedded."""

    def __init__(self, model_path: str = "data/MODEL1303010000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lopez2013ExtrinsicApoptosisM1aEmbeddedModel1303010000Model = SbmlLopez2013ExtrinsicApoptosisM1aEmbedded
