...
"""Auto-generated SBML BioModule wrapper for Martins2004_Yeast_Glycolysis_GlycerolSynthesis.

Source: biomodels_ebi:MODEL1009220000
Original: https://www.ebi.ac.uk/biomodels/MODEL1009220000
"""
...
class SbmlMartins2004YeastGlycolysisGlycerolsynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Martins2004_Yeast_Glycolysis_GlycerolSynthesis."""

    def __init__(self, model_path: str = "data/MODEL1009220000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Martins2004YeastGlycolysisGlycerolsynthesisModel1009220000Model = SbmlMartins2004YeastGlycolysisGlycerolsynthesis
