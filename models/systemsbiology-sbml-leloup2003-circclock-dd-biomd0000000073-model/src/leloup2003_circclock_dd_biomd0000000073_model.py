...
"""Auto-generated SBML BioModule wrapper for Leloup2003_CircClock_DD.

Source: biomodels_ebi:BIOMD0000000073
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000073
"""
...
class SbmlLeloup2003CircclockDd(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup2003_CircClock_DD."""

    def __init__(self, model_path: str = "data/BIOMD0000000073.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup2003CircclockDdBiomd0000000073Model = SbmlLeloup2003CircclockDd
