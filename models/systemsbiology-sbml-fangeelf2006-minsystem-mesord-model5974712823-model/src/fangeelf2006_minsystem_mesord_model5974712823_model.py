...
"""Auto-generated SBML BioModule wrapper for FangeElf2006_MinSystem_MesoRD.

Source: biomodels_ebi:MODEL5974712823
Original: https://www.ebi.ac.uk/biomodels/MODEL5974712823
"""
...
class SbmlFangeelf2006MinsystemMesord(biosim.BioModule):
    """BioModule wrapper for SBML model: FangeElf2006_MinSystem_MesoRD."""

    def __init__(self, model_path: str = "data/MODEL5974712823.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fangeelf2006MinsystemMesordModel5974712823Model = SbmlFangeelf2006MinsystemMesord
