...
"""Auto-generated SBML BioModule wrapper for Pearce2021 - Fibrin Polymerization.

Source: biomodels_ebi:BIOMD0000001054
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001054
"""
...
class SbmlPearce2021FibrinPolymerization(biosim.BioModule):
    """BioModule wrapper for SBML model: Pearce2021 - Fibrin Polymerization."""

    def __init__(self, model_path: str = "data/BIOMD0000001054.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pearce2021FibrinPolymerizationBiomd0000001054Model = SbmlPearce2021FibrinPolymerization
