...
"""Auto-generated SBML BioModule wrapper for Mouse Iron Distribution - Rich iron diet (No Tracer).

Source: biomodels_ebi:BIOMD0000000738
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000738
"""
...
class SbmlMouseIronDistributionRichIronDietNoTracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mouse Iron Distribution - Rich iron diet (No Tracer)."""

    def __init__(self, model_path: str = "data/BIOMD0000000738.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MouseIronDistributionRichIronDietNoTracerBiomd0000000738Model = SbmlMouseIronDistributionRichIronDietNoTracer
