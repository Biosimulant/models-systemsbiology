...
"""Auto-generated SBML BioModule wrapper for Bertram1995_PancreaticBetaCell_CRAC.

Source: biomodels_ebi:BIOMD0000000374
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000374
"""
...
class SbmlBertram1995PancreaticbetacellCrac(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram1995_PancreaticBetaCell_CRAC."""

    def __init__(self, model_path: str = "data/BIOMD0000000374.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram1995PancreaticbetacellCracBiomd0000000374Model = SbmlBertram1995PancreaticbetacellCrac
