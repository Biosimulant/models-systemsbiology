...
"""Auto-generated SBML BioModule wrapper for Sass2009 - Approach to an α-synuclein-based BST model of Parkinson's disease.

Source: biomodels_ebi:BIOMD0000000575
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000575
"""
...
class SbmlSass2009ApproachToAnSynucleinBasedBstModelOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Sass2009 - Approach to an α-synuclein-based BST model of Parkinson's disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000575.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sass2009ApproachToAnSynucleinBasedBstModeBiomd0000000575Model = SbmlSass2009ApproachToAnSynucleinBasedBstModelOf
