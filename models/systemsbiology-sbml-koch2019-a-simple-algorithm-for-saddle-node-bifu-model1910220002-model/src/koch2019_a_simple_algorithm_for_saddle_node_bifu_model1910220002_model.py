...
"""Auto-generated SBML BioModule wrapper for Koch2019 - a simple algorithm for saddle node bifurcation plots.

Source: biomodels_ebi:MODEL1910220002
Original: https://www.ebi.ac.uk/biomodels/MODEL1910220002
"""
...
class SbmlKoch2019ASimpleAlgorithmForSaddleNodeBifurcation(biosim.BioModule):
    """BioModule wrapper for SBML model: Koch2019 - a simple algorithm for saddle node bifurcation plots."""

    def __init__(self, model_path: str = "data/MODEL1910220002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koch2019ASimpleAlgorithmForSaddleNodeBifuModel1910220002Model = SbmlKoch2019ASimpleAlgorithmForSaddleNodeBifurcation
