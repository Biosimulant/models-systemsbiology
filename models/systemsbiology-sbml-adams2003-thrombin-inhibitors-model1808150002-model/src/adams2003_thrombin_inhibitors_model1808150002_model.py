...
"""Auto-generated SBML BioModule wrapper for Adams2003 - Thrombin Inhibitors.

Source: biomodels_ebi:MODEL1808150002
Original: https://www.ebi.ac.uk/biomodels/MODEL1808150002
"""
...
class SbmlAdams2003ThrombinInhibitors(biosim.BioModule):
    """BioModule wrapper for SBML model: Adams2003 - Thrombin Inhibitors."""

    def __init__(self, model_path: str = "data/MODEL1808150002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Adams2003ThrombinInhibitorsModel1808150002Model = SbmlAdams2003ThrombinInhibitors
