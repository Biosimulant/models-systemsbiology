...
"""Auto-generated SBML BioModule wrapper for Smallbone2011_TrehaloseBiosynthesis.

Source: biomodels_ebi:BIOMD0000000380
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000380
"""
...
class SbmlSmallbone2011Trehalosebiosynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2011_TrehaloseBiosynthesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000380.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2011TrehalosebiosynthesisBiomd0000000380Model = SbmlSmallbone2011Trehalosebiosynthesis
