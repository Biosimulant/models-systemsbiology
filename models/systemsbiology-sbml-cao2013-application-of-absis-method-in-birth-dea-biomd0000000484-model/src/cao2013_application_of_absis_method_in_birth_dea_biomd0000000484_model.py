...
"""Auto-generated SBML BioModule wrapper for Cao2013 - Application of ABSIS method in birth-death process.

Source: biomodels_ebi:BIOMD0000000484
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000484
"""
...
class SbmlCao2013ApplicationOfAbsisMethodInBirthDeathProcess(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2013 - Application of ABSIS method in birth-death process."""

    def __init__(self, model_path: str = "data/BIOMD0000000484.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2013ApplicationOfAbsisMethodInBirthDeaBiomd0000000484Model = SbmlCao2013ApplicationOfAbsisMethodInBirthDeathProcess
