...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Negative Feedback By MicroRNA).

Source: biomodels_ebi:BIOMD0000000864
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000864
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisNegative(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Negative Feedback By MicroRNA)."""

    def __init__(self, model_path: str = "data/BIOMD0000000864.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisBiomd0000000864Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisNegative
