...
"""Auto-generated SBML BioModule wrapper for Passos2010_DNAdamage_CellularSenescence.

Source: biomodels_ebi:BIOMD0000000287
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000287
"""
...
class SbmlPassos2010DnadamageCellularsenescence(biosim.BioModule):
    """BioModule wrapper for SBML model: Passos2010_DNAdamage_CellularSenescence."""

    def __init__(self, model_path: str = "data/BIOMD0000000287.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Passos2010DnadamageCellularsenescenceBiomd0000000287Model = SbmlPassos2010DnadamageCellularsenescence
