...
"""Auto-generated SBML BioModule wrapper for Sturrock2015 - glioma growth.

Source: biomodels_ebi:BIOMD0000000801
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000801
"""
...
class SbmlSturrock2015GliomaGrowth(biosim.BioModule):
    """BioModule wrapper for SBML model: Sturrock2015 - glioma growth."""

    def __init__(self, model_path: str = "data/BIOMD0000000801.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sturrock2015GliomaGrowthBiomd0000000801Model = SbmlSturrock2015GliomaGrowth
