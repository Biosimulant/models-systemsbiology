...
"""Auto-generated SBML BioModule wrapper for Cunha2022 - Virgin Phellogen Model for Quercus suber.

Source: biomodels_ebi:MODEL2205040004
Original: https://www.ebi.ac.uk/biomodels/MODEL2205040004
"""
...
class SbmlCunha2022VirginPhellogenModelForQuercusSuber(biosim.BioModule):
    """BioModule wrapper for SBML model: Cunha2022 - Virgin Phellogen Model for Quercus suber."""

    def __init__(self, model_path: str = "data/MODEL2205040004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cunha2022VirginPhellogenModelForQuercusSubModel2205040004Model = SbmlCunha2022VirginPhellogenModelForQuercusSuber
