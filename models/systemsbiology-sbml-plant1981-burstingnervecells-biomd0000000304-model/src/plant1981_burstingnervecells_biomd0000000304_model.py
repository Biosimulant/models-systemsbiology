...
"""Auto-generated SBML BioModule wrapper for Plant1981_BurstingNerveCells.

Source: biomodels_ebi:BIOMD0000000304
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000304
"""
...
class SbmlPlant1981Burstingnervecells(biosim.BioModule):
    """BioModule wrapper for SBML model: Plant1981_BurstingNerveCells."""

    def __init__(self, model_path: str = "data/BIOMD0000000304.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Plant1981BurstingnervecellsBiomd0000000304Model = SbmlPlant1981Burstingnervecells
