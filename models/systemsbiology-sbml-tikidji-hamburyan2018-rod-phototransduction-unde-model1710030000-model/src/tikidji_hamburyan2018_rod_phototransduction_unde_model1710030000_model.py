...
"""Auto-generated SBML BioModule wrapper for Tikidji-Hamburyan2018 - Rod phototransduction under strong illumination.

Source: biomodels_ebi:MODEL1710030000
Original: https://www.ebi.ac.uk/biomodels/MODEL1710030000
"""
...
class SbmlTikidjiHamburyan2018RodPhototransductionUnderStrong(biosim.BioModule):
    """BioModule wrapper for SBML model: Tikidji-Hamburyan2018 - Rod phototransduction under strong illumination."""

    def __init__(self, model_path: str = "data/MODEL1710030000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TikidjiHamburyan2018RodPhototransductionUndeModel1710030000Model = SbmlTikidjiHamburyan2018RodPhototransductionUnderStrong
