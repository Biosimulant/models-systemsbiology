...
"""Auto-generated SBML BioModule wrapper for Nijhout2004_Folate_Cycle.

Source: biomodels_ebi:BIOMD0000000213
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000213
"""
...
class SbmlNijhout2004FolateCycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Nijhout2004_Folate_Cycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000213.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nijhout2004FolateCycleBiomd0000000213Model = SbmlNijhout2004FolateCycle
