...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/BIOMD0000000747)
**Standard**: sbml
**Authors**: Hajime Nagashima
...
models:
  - path: ../../models/systemsbiology-sbml-nagashima2002-simulating-blood-coagulation-inhib-biomd0000000747-model
    alias: model
```
