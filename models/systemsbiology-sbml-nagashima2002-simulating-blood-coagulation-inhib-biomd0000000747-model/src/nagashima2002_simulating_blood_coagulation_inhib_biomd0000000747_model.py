...
"""Auto-generated SBML BioModule wrapper for Nagashima2002 - Simulating blood coagulation inhibitory effects.

Source: biomodels_ebi:BIOMD0000000747
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000747
"""
...
class SbmlNagashima2002SimulatingBloodCoagulationInhibitory(biosim.BioModule):
    """BioModule wrapper for SBML model: Nagashima2002 - Simulating blood coagulation inhibitory effects."""

    def __init__(self, model_path: str = "data/BIOMD0000000747.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nagashima2002SimulatingBloodCoagulationInhibBiomd0000000747Model = SbmlNagashima2002SimulatingBloodCoagulationInhibitory
