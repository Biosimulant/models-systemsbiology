...
"""Auto-generated SBML BioModule wrapper for Proctor2011_ProteinHomeostasis_NormalCondition.

Source: biomodels_ebi:BIOMD0000000344
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000344
"""
...
class SbmlProctor2011ProteinhomeostasisNormalcondition(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2011_ProteinHomeostasis_NormalCondition."""

    def __init__(self, model_path: str = "data/BIOMD0000000344.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2011ProteinhomeostasisNormalconditionBiomd0000000344Model = SbmlProctor2011ProteinhomeostasisNormalcondition
