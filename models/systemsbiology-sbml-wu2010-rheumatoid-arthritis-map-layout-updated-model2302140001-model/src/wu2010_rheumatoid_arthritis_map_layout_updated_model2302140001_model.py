...
"""Auto-generated SBML BioModule wrapper for Wu2010 - Rheumatoid arthritis map layout updated.

Source: biomodels_ebi:MODEL2302140001
Original: https://www.ebi.ac.uk/biomodels/MODEL2302140001
"""
...
class SbmlWu2010RheumatoidArthritisMapLayoutUpdated(biosim.BioModule):
    """BioModule wrapper for SBML model: Wu2010 - Rheumatoid arthritis map layout updated."""

    def __init__(self, model_path: str = "data/MODEL2302140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wu2010RheumatoidArthritisMapLayoutUpdatedModel2302140001Model = SbmlWu2010RheumatoidArthritisMapLayoutUpdated
