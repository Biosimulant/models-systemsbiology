...
"""Auto-generated SBML BioModule wrapper for Kremers2015 - Thrombin Inhibitor Kinetics.

Source: biomodels_ebi:MODEL1808210001
Original: https://www.ebi.ac.uk/biomodels/MODEL1808210001
"""
...
class SbmlKremers2015ThrombinInhibitorKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Kremers2015 - Thrombin Inhibitor Kinetics."""

    def __init__(self, model_path: str = "data/MODEL1808210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kremers2015ThrombinInhibitorKineticsModel1808210001Model = SbmlKremers2015ThrombinInhibitorKinetics
