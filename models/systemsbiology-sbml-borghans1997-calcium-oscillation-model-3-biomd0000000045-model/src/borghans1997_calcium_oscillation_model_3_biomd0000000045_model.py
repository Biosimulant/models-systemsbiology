...
"""Auto-generated SBML BioModule wrapper for Borghans1997 - Calcium Oscillation - Model 3.

Source: biomodels_ebi:BIOMD0000000045
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000045
"""
...
class SbmlBorghans1997CalciumOscillationModel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Borghans1997 - Calcium Oscillation - Model 3."""

    def __init__(self, model_path: str = "data/BIOMD0000000045.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borghans1997CalciumOscillationModel3Biomd0000000045Model = SbmlBorghans1997CalciumOscillationModel3
