...
"""Auto-generated SBML BioModule wrapper for Singh2006_TCA_Ecoli_glucose.

Source: biomodels_ebi:BIOMD0000000222
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000222
"""
...
class SbmlSingh2006TcaEcoliGlucose(biosim.BioModule):
    """BioModule wrapper for SBML model: Singh2006_TCA_Ecoli_glucose."""

    def __init__(self, model_path: str = "data/BIOMD0000000222.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Singh2006TcaEcoliGlucoseBiomd0000000222Model = SbmlSingh2006TcaEcoliGlucose
