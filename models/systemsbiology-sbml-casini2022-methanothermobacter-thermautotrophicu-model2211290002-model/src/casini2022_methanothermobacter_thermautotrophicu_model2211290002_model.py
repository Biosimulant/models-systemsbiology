...
"""Auto-generated SBML BioModule wrapper for Casini2022 - Methanothermobacter thermautotrophicus Z-245.

Source: biomodels_ebi:MODEL2211290002
Original: https://www.ebi.ac.uk/biomodels/MODEL2211290002
"""
...
class SbmlCasini2022MethanothermobacterThermautotrophicusZ245(biosim.BioModule):
    """BioModule wrapper for SBML model: Casini2022 - Methanothermobacter thermautotrophicus Z-245."""

    def __init__(self, model_path: str = "data/MODEL2211290002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Casini2022MethanothermobacterThermautotrophicuModel2211290002Model = SbmlCasini2022MethanothermobacterThermautotrophicusZ245
