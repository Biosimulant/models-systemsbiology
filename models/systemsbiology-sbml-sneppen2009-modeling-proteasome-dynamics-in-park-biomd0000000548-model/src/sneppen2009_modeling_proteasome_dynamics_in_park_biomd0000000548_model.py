...
"""Auto-generated SBML BioModule wrapper for Sneppen2009 - Modeling proteasome dynamics in Parkinson's disease.

Source: biomodels_ebi:BIOMD0000000548
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000548
"""
...
class SbmlSneppen2009ModelingProteasomeDynamicsInParkinsonS(biosim.BioModule):
    """BioModule wrapper for SBML model: Sneppen2009 - Modeling proteasome dynamics in Parkinson's disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000548.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sneppen2009ModelingProteasomeDynamicsInParkBiomd0000000548Model = SbmlSneppen2009ModelingProteasomeDynamicsInParkinsonS
