...
"""Auto-generated SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelB.

Source: biomodels_ebi:MODEL1006230003
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230003
"""
...
class SbmlWaugh2006WoundhealingDiabeticModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006_WoundHealing_Diabetic_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006WoundhealingDiabeticModelbModel1006230003Model = SbmlWaugh2006WoundhealingDiabeticModelb
