...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedforward Incoherent By MicroRNA)_1.

Source: biomodels_ebi:BIOMD0000000860
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000860
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive3(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedforward Incoherent By MicroRNA)_1."""

    def __init__(self, model_path: str = "data/BIOMD0000000860.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisBiomd0000000860Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive3
