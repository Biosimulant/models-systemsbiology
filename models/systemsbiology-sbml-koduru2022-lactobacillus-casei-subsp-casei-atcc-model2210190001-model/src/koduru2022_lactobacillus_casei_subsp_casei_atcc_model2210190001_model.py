...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactobacillus casei subsp. casei ATCC 393.

Source: biomodels_ebi:MODEL2210190001
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190001
"""
...
class SbmlKoduru2022LactobacillusCaseiSubspCaseiAtcc393(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactobacillus casei subsp. casei ATCC 393."""

    def __init__(self, model_path: str = "data/MODEL2210190001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactobacillusCaseiSubspCaseiAtccModel2210190001Model = SbmlKoduru2022LactobacillusCaseiSubspCaseiAtcc393
