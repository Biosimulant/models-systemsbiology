...
"""Auto-generated SBML BioModule wrapper for Wodarz2007 - Cytomegalovirus infection model with cytotoxic T lymphocyte response.

Source: biomodels_ebi:BIOMD0000000687
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000687
"""
...
class SbmlWodarz2007CytomegalovirusInfectionModelWithCytotoxicT(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2007 - Cytomegalovirus infection model with cytotoxic T lymphocyte response."""

    def __init__(self, model_path: str = "data/BIOMD0000000687.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2007CytomegalovirusInfectionModelWithBiomd0000000687Model = SbmlWodarz2007CytomegalovirusInfectionModelWithCytotoxicT
