...
"""Auto-generated SBML BioModule wrapper for Borghans1997 - Calcium Oscillation - Model 2.

Source: biomodels_ebi:BIOMD0000000044
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000044
"""
...
class SbmlBorghans1997CalciumOscillationModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: Borghans1997 - Calcium Oscillation - Model 2."""

    def __init__(self, model_path: str = "data/BIOMD0000000044.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Borghans1997CalciumOscillationModel2Biomd0000000044Model = SbmlBorghans1997CalciumOscillationModel2
