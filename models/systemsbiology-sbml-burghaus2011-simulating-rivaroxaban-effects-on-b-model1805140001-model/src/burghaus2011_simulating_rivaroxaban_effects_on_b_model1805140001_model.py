...
"""Auto-generated SBML BioModule wrapper for Burghaus2011 - Simulating Rivaroxaban effects on blood coagulation.

Source: biomodels_ebi:MODEL1805140001
Original: https://www.ebi.ac.uk/biomodels/MODEL1805140001
"""
...
class SbmlBurghaus2011SimulatingRivaroxabanEffectsOnBlood(biosim.BioModule):
    """BioModule wrapper for SBML model: Burghaus2011 - Simulating Rivaroxaban effects on blood coagulation."""

    def __init__(self, model_path: str = "data/MODEL1805140001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Burghaus2011SimulatingRivaroxabanEffectsOnBModel1805140001Model = SbmlBurghaus2011SimulatingRivaroxabanEffectsOnBlood
