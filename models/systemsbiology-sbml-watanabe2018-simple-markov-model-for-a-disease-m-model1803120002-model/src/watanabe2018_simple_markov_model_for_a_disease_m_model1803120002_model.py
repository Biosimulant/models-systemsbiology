...
"""Auto-generated SBML BioModule wrapper for Watanabe2018_Simple markov model for a disease model.

Source: biomodels_ebi:MODEL1803120002
Original: https://www.ebi.ac.uk/biomodels/MODEL1803120002
"""
...
class SbmlWatanabe2018SimpleMarkovModelForADiseaseModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Watanabe2018_Simple markov model for a disease model."""

    def __init__(self, model_path: str = "data/MODEL1803120002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Watanabe2018SimpleMarkovModelForADiseaseMModel1803120002Model = SbmlWatanabe2018SimpleMarkovModelForADiseaseModel
