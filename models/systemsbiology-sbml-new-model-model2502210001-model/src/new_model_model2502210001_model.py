...
"""Auto-generated SBML BioModule wrapper for New Model.

Source: biomodels_ebi:MODEL2502210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2502210001
"""
...
class SbmlNewModel(biosim.BioModule):
    """BioModule wrapper for SBML model: New Model."""

    def __init__(self, model_path: str = "data/MODEL2502210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NewModelModel2502210001Model = SbmlNewModel
