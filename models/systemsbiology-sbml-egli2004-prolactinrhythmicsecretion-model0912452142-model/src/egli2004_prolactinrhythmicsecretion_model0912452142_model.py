...
"""Auto-generated SBML BioModule wrapper for Egli2004_ProlactinRhythmicSecretion.

Source: biomodels_ebi:MODEL0912452142
Original: https://www.ebi.ac.uk/biomodels/MODEL0912452142
"""
...
class SbmlEgli2004Prolactinrhythmicsecretion(biosim.BioModule):
    """BioModule wrapper for SBML model: Egli2004_ProlactinRhythmicSecretion."""

    def __init__(self, model_path: str = "data/MODEL0912452142.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Egli2004ProlactinrhythmicsecretionModel0912452142Model = SbmlEgli2004Prolactinrhythmicsecretion
