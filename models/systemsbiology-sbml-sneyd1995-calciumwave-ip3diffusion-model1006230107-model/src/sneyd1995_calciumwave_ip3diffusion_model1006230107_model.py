...
"""Auto-generated SBML BioModule wrapper for Sneyd1995_CalciumWave_IP3diffusion.

Source: biomodels_ebi:MODEL1006230107
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230107
"""
...
class SbmlSneyd1995CalciumwaveIp3diffusion(biosim.BioModule):
    """BioModule wrapper for SBML model: Sneyd1995_CalciumWave_IP3diffusion."""

    def __init__(self, model_path: str = "data/MODEL1006230107.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sneyd1995CalciumwaveIp3diffusionModel1006230107Model = SbmlSneyd1995CalciumwaveIp3diffusion
