...
"""Auto-generated SBML BioModule wrapper for Abu-Soud1999_L-Arginine.

Source: biomodels_ebi:MODEL9087766308
Original: https://www.ebi.ac.uk/biomodels/MODEL9087766308
"""
...
class SbmlAbuSoud1999LArginine(biosim.BioModule):
    """BioModule wrapper for SBML model: Abu-Soud1999_L-Arginine."""

    def __init__(self, model_path: str = "data/MODEL9087766308.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AbuSoud1999LArginineModel9087766308Model = SbmlAbuSoud1999LArginine
