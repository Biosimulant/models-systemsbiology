...
"""Auto-generated SBML BioModule wrapper for Graner1992 - Simulation of Biological Cell Sorting Using a Two-Dimensional Extended Potts Model.

Source: biomodels_ebi:MODEL2212170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2212170001
"""
...
class SbmlGraner1992SimulationOfBiologicalCellSortingUsingA(biosim.BioModule):
    """BioModule wrapper for SBML model: Graner1992 - Simulation of Biological Cell Sorting Using a Two-Dimensional Extended Potts Model."""

    def __init__(self, model_path: str = "data/MODEL2212170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Graner1992SimulationOfBiologicalCellSortingModel2212170001Model = SbmlGraner1992SimulationOfBiologicalCellSortingUsingA
