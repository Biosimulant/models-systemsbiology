...
"""Auto-generated SBML BioModule wrapper for Diedrichs2018 - A data-entrained computational model for testing the regulatory logic of the vertebrate unfolded protein response.

Source: biomodels_ebi:BIOMD0000000703
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000703
"""
...
class SbmlDiedrichs2018ADataEntrainedComputationalModelFor(biosim.BioModule):
    """BioModule wrapper for SBML model: Diedrichs2018 - A data-entrained computational model for testing the regulatory logic of the vertebrate unfolded protein response."""

    def __init__(self, model_path: str = "data/BIOMD0000000703.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Diedrichs2018ADataEntrainedComputationalModBiomd0000000703Model = SbmlDiedrichs2018ADataEntrainedComputationalModelFor
