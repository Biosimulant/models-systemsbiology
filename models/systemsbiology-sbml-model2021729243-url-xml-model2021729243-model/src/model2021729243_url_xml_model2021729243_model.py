...
"""Auto-generated SBML BioModule wrapper for MODEL2021729243_url.xml.

Source: biomodels_ebi:MODEL2021729243
Original: https://www.ebi.ac.uk/biomodels/MODEL2021729243
"""
...
class SbmlModel2021729243UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL2021729243_url.xml."""

    def __init__(self, model_path: str = "data/MODEL2021729243.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model2021729243UrlXmlModel2021729243Model = SbmlModel2021729243UrlXml
