...
"""Auto-generated SBML BioModule wrapper for Burghaus2014 - Simulating blood coagulation factor Xa inhibitors.

Source: biomodels_ebi:MODEL1807180005
Original: https://www.ebi.ac.uk/biomodels/MODEL1807180005
"""
...
class SbmlBurghaus2014SimulatingBloodCoagulationFactorXa(biosim.BioModule):
    """BioModule wrapper for SBML model: Burghaus2014 - Simulating blood coagulation factor Xa inhibitors."""

    def __init__(self, model_path: str = "data/MODEL1807180005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Burghaus2014SimulatingBloodCoagulationFactorModel1807180005Model = SbmlBurghaus2014SimulatingBloodCoagulationFactorXa
