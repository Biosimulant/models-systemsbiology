...
"""Auto-generated SBML BioModule wrapper for Del_Conte_Zerial2008_Rab5_Rab7_cut_out_switch.

Source: biomodels_ebi:BIOMD0000000174
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000174
"""
...
class SbmlDelConteZerial2008Rab5Rab7CutOutSwitch(biosim.BioModule):
    """BioModule wrapper for SBML model: Del_Conte_Zerial2008_Rab5_Rab7_cut_out_switch."""

    def __init__(self, model_path: str = "data/BIOMD0000000174.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
DelConteZerial2008Rab5Rab7CutOutSwitchBiomd0000000174Model = SbmlDelConteZerial2008Rab5Rab7CutOutSwitch
