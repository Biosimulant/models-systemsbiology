...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1303140000)
**Standard**: sbml
...
models:
  - path: ../../models/systemsbiology-sbml-mazemondet2012-beta-catenin-dynamics-in-human-ne-model1303140000-model
    alias: model
```
