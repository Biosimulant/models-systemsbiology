...
"""Auto-generated SBML BioModule wrapper for Mazemondet2012 - beta-catenin dynamics in human neural progenitor cells.

Source: biomodels_ebi:MODEL1303140000
Original: https://www.ebi.ac.uk/biomodels/MODEL1303140000
"""
...
class SbmlMazemondet2012BetaCateninDynamicsInHumanNeural(biosim.BioModule):
    """BioModule wrapper for SBML model: Mazemondet2012 - beta-catenin dynamics in human neural progenitor cells."""

    def __init__(self, model_path: str = "data/MODEL1303140000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mazemondet2012BetaCateninDynamicsInHumanNeModel1303140000Model = SbmlMazemondet2012BetaCateninDynamicsInHumanNeural
