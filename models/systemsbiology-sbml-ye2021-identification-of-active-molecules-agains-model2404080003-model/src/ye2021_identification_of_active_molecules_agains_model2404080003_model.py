...
"""Auto-generated SBML BioModule wrapper for Ye2021 - Identification of active molecules against Mycobacterium tuberculosis with ML.

Source: biomodels_ebi:MODEL2404080003
Original: https://www.ebi.ac.uk/biomodels/MODEL2404080003
"""
...
class SbmlYe2021IdentificationOfActiveMoleculesAgainst(biosim.BioModule):
    """BioModule wrapper for SBML model: Ye2021 - Identification of active molecules against Mycobacterium tuberculosis with ML."""

    def __init__(self, model_path: str = "data/MODEL2404080003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ye2021IdentificationOfActiveMoleculesAgainsModel2404080003Model = SbmlYe2021IdentificationOfActiveMoleculesAgainst
