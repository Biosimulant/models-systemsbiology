...
"""Auto-generated SBML BioModule wrapper for DallePezze2016 - Activation of AMPK and mTOR by amino acids.

Source: biomodels_ebi:BIOMD0000000640
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000640
"""
...
class SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids2(biosim.BioModule):
    """BioModule wrapper for SBML model: DallePezze2016 - Activation of AMPK and mTOR by amino acids."""

    def __init__(self, model_path: str = "data/BIOMD0000000640.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dallepezze2016ActivationOfAmpkAndMtorByAmBiomd0000000640Model = SbmlDallepezze2016ActivationOfAmpkAndMtorByAminoAcids2
