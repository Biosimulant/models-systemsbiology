...
"""Auto-generated SBML BioModule wrapper for Wang2007 - ATP induced intracellular Calcium Oscillation.

Source: biomodels_ebi:BIOMD0000000145
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000145
"""
...
class SbmlWang2007AtpInducedIntracellularCalciumOscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2007 - ATP induced intracellular Calcium Oscillation."""

    def __init__(self, model_path: str = "data/BIOMD0000000145.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2007AtpInducedIntracellularCalciumOscilBiomd0000000145Model = SbmlWang2007AtpInducedIntracellularCalciumOscillation
