...
"""Auto-generated SBML BioModule wrapper for Steckmann2012 - Amyloid beta-protein fibrillogenesis (kinetics of secondary structure conversion).

Source: biomodels_ebi:BIOMD0000000533
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000533
"""
...
class SbmlSteckmann2012AmyloidBetaProteinFibrillogenesisKinetics(biosim.BioModule):
    """BioModule wrapper for SBML model: Steckmann2012 - Amyloid beta-protein fibrillogenesis (kinetics of secondary structure conversion)."""

    def __init__(self, model_path: str = "data/BIOMD0000000533.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Steckmann2012AmyloidBetaProteinFibrillogenesBiomd0000000533Model = SbmlSteckmann2012AmyloidBetaProteinFibrillogenesisKinetics
