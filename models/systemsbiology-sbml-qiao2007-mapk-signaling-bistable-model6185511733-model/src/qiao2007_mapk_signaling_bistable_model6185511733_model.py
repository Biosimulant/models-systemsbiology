...
"""Auto-generated SBML BioModule wrapper for Qiao2007_MAPK_Signaling_Bistable.

Source: biomodels_ebi:MODEL6185511733
Original: https://www.ebi.ac.uk/biomodels/MODEL6185511733
"""
...
class SbmlQiao2007MapkSignalingBistable(biosim.BioModule):
    """BioModule wrapper for SBML model: Qiao2007_MAPK_Signaling_Bistable."""

    def __init__(self, model_path: str = "data/MODEL6185511733.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qiao2007MapkSignalingBistableModel6185511733Model = SbmlQiao2007MapkSignalingBistable
