...
"""Auto-generated SBML BioModule wrapper for Wajima2009_BloodCoagulation_aPTTtest.

Source: biomodels_ebi:BIOMD0000000338
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000338
"""
...
class SbmlWajima2009BloodcoagulationAptttest(biosim.BioModule):
    """BioModule wrapper for SBML model: Wajima2009_BloodCoagulation_aPTTtest."""

    def __init__(self, model_path: str = "data/BIOMD0000000338.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wajima2009BloodcoagulationAptttestBiomd0000000338Model = SbmlWajima2009BloodcoagulationAptttest
