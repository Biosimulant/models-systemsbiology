...
"""Auto-generated SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelC.

Source: biomodels_ebi:MODEL1006230099
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230099
"""
...
class SbmlWaugh2006WoundhealingDiabeticModelc(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006_WoundHealing_Diabetic_ModelC."""

    def __init__(self, model_path: str = "data/MODEL1006230099.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006WoundhealingDiabeticModelcModel1006230099Model = SbmlWaugh2006WoundhealingDiabeticModelc
