...
"""Auto-generated SBML BioModule wrapper for Mouse Iron Distribution - Rich and Deficient iron diets (tracer).

Source: biomodels_ebi:BIOMD0000000734
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000734
"""
...
class SbmlMouseIronDistributionRichAndDeficientIronDietsTracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mouse Iron Distribution - Rich and Deficient iron diets (tracer)."""

    def __init__(self, model_path: str = "data/BIOMD0000000734.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MouseIronDistributionRichAndDeficientIronBiomd0000000734Model = SbmlMouseIronDistributionRichAndDeficientIronDietsTracer
