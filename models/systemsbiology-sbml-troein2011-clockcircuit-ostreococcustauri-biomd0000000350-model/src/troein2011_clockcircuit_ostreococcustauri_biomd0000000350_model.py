...
"""Auto-generated SBML BioModule wrapper for Troein2011_ClockCircuit_OstreococcusTauri.

Source: biomodels_ebi:BIOMD0000000350
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000350
"""
...
class SbmlTroein2011ClockcircuitOstreococcustauri(biosim.BioModule):
    """BioModule wrapper for SBML model: Troein2011_ClockCircuit_OstreococcusTauri."""

    def __init__(self, model_path: str = "data/BIOMD0000000350.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Troein2011ClockcircuitOstreococcustauriBiomd0000000350Model = SbmlTroein2011ClockcircuitOstreococcustauri
