...
"""Auto-generated SBML BioModule wrapper for Bakker2001_Glycolysis.

Source: biomodels_ebi:BIOMD0000000071
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000071
"""
...
class SbmlBakker2001Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bakker2001_Glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000071.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bakker2001GlycolysisBiomd0000000071Model = SbmlBakker2001Glycolysis
