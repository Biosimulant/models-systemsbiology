...
"""Auto-generated SBML BioModule wrapper for Nucleus Pulposus Regulatory Network.

Source: biomodels_ebi:MODEL2411040001
Original: https://www.ebi.ac.uk/biomodels/MODEL2411040001
"""
...
class SbmlNucleusPulposusRegulatoryNetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Nucleus Pulposus Regulatory Network."""

    def __init__(self, model_path: str = "data/MODEL2411040001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NucleusPulposusRegulatoryNetworkModel2411040001Model = SbmlNucleusPulposusRegulatoryNetwork
