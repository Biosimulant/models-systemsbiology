...
"""Auto-generated SBML BioModule wrapper for Hayer2005_AMPAR_traff_model1.

Source: biomodels_ebi:MODEL9086518048
Original: https://www.ebi.ac.uk/biomodels/MODEL9086518048
"""
...
class SbmlHayer2005AmparTraffModel1(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_AMPAR_traff_model1."""

    def __init__(self, model_path: str = "data/MODEL9086518048.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005AmparTraffModel1Model9086518048Model = SbmlHayer2005AmparTraffModel1
