...
"""Auto-generated SBML BioModule wrapper for Hatakeyama2003_MAPK.

Source: biomodels_ebi:BIOMD0000000146
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000146
"""
...
class SbmlHatakeyama2003Mapk(biosim.BioModule):
    """BioModule wrapper for SBML model: Hatakeyama2003_MAPK."""

    def __init__(self, model_path: str = "data/BIOMD0000000146.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hatakeyama2003MapkBiomd0000000146Model = SbmlHatakeyama2003Mapk
