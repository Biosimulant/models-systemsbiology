...
"""Auto-generated SBML BioModule wrapper for Crespo2012 - Kinetics of Amyloid Fibril Formation.

Source: biomodels_ebi:BIOMD0000000531
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000531
"""
...
class SbmlCrespo2012KineticsOfAmyloidFibrilFormation(biosim.BioModule):
    """BioModule wrapper for SBML model: Crespo2012 - Kinetics of Amyloid Fibril Formation."""

    def __init__(self, model_path: str = "data/BIOMD0000000531.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Crespo2012KineticsOfAmyloidFibrilFormationBiomd0000000531Model = SbmlCrespo2012KineticsOfAmyloidFibrilFormation
