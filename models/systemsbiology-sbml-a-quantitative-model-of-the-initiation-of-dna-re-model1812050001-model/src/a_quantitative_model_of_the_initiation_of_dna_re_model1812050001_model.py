...
"""Auto-generated SBML BioModule wrapper for A quantitative model of the initiation of DNA replication in Saccharomyces cerevisiae predicts the effects of system perturbations.

Source: biomodels_ebi:MODEL1812050001
Original: https://www.ebi.ac.uk/biomodels/MODEL1812050001
"""
...
class SbmlAQuantitativeModelOfTheInitiationOfDnaReplication(biosim.BioModule):
    """BioModule wrapper for SBML model: A quantitative model of the initiation of DNA replication in Saccharomyces cerevisiae predicts the effects of system perturbations."""

    def __init__(self, model_path: str = "data/MODEL1812050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AQuantitativeModelOfTheInitiationOfDnaReModel1812050001Model = SbmlAQuantitativeModelOfTheInitiationOfDnaReplication
