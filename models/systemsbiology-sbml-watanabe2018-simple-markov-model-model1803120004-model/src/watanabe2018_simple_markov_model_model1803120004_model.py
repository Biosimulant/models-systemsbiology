...
"""Auto-generated SBML BioModule wrapper for Watanabe2018_Simple markov model.

Source: biomodels_ebi:MODEL1803120004
Original: https://www.ebi.ac.uk/biomodels/MODEL1803120004
"""
...
class SbmlWatanabe2018SimpleMarkovModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Watanabe2018_Simple markov model."""

    def __init__(self, model_path: str = "data/MODEL1803120004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Watanabe2018SimpleMarkovModelModel1803120004Model = SbmlWatanabe2018SimpleMarkovModel
