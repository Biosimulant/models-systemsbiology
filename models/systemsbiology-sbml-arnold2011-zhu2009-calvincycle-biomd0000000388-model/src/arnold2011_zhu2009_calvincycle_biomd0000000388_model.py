...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Zhu2009_CalvinCycle.

Source: biomodels_ebi:BIOMD0000000388
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000388
"""
...
class SbmlArnold2011Zhu2009Calvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Zhu2009_CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000388.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Zhu2009CalvincycleBiomd0000000388Model = SbmlArnold2011Zhu2009Calvincycle
