...
"""Auto-generated SBML BioModule wrapper for LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case1.

Source: biomodels_ebi:MODEL1511170000
Original: https://www.ebi.ac.uk/biomodels/MODEL1511170000
"""
...
class SbmlLlorensrico2016EffectsOfCisEncodedAntisenseRnas(biosim.BioModule):
    """BioModule wrapper for SBML model: LlorénsRico2016 - Effects of cis-Encoded antisense RNAs (asRNAs) - Case1."""

    def __init__(self, model_path: str = "data/MODEL1511170000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LlorNsrico2016EffectsOfCisEncodedAntisenseModel1511170000Model = SbmlLlorensrico2016EffectsOfCisEncodedAntisenseRnas
