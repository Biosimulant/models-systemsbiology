...
"""Auto-generated SBML BioModule wrapper for Kim2011_Oscillator_SimpleIII.

Source: biomodels_ebi:BIOMD0000000323
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000323
"""
...
class SbmlKim2011OscillatorSimpleiii(biosim.BioModule):
    """BioModule wrapper for SBML model: Kim2011_Oscillator_SimpleIII."""

    def __init__(self, model_path: str = "data/BIOMD0000000323.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kim2011OscillatorSimpleiiiBiomd0000000323Model = SbmlKim2011OscillatorSimpleiii
