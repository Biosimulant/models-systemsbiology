...
"""Auto-generated SBML BioModule wrapper for Ajay_Bhalla_2004_PKM_Tuning.

Source: biomodels_ebi:MODEL9089491423
Original: https://www.ebi.ac.uk/biomodels/MODEL9089491423
"""
...
class SbmlAjayBhalla2004PkmTuning(biosim.BioModule):
    """BioModule wrapper for SBML model: Ajay_Bhalla_2004_PKM_Tuning."""

    def __init__(self, model_path: str = "data/MODEL9089491423.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AjayBhalla2004PkmTuningModel9089491423Model = SbmlAjayBhalla2004PkmTuning
