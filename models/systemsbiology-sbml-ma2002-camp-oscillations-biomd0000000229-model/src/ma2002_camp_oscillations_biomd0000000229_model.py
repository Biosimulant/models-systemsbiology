...
"""Auto-generated SBML BioModule wrapper for Ma2002_cAMP_oscillations.

Source: biomodels_ebi:BIOMD0000000229
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000229
"""
...
class SbmlMa2002CampOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Ma2002_cAMP_oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000229.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ma2002CampOscillationsBiomd0000000229Model = SbmlMa2002CampOscillations
