...
"""Auto-generated SBML BioModule wrapper for Albeck2008_extrinsic_apoptosis.

Source: biomodels_ebi:BIOMD0000000220
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000220
"""
...
class SbmlAlbeck2008ExtrinsicApoptosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Albeck2008_extrinsic_apoptosis."""

    def __init__(self, model_path: str = "data/BIOMD0000000220.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Albeck2008ExtrinsicApoptosisBiomd0000000220Model = SbmlAlbeck2008ExtrinsicApoptosis
