...
"""Auto-generated SBML BioModule wrapper for Masison2022 - Cellular ferritin iron storage.

Source: biomodels_ebi:MODEL2211030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2211030001
"""
...
class SbmlMasison2022CellularFerritinIronStorage(biosim.BioModule):
    """BioModule wrapper for SBML model: Masison2022 - Cellular ferritin iron storage."""

    def __init__(self, model_path: str = "data/MODEL2211030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Masison2022CellularFerritinIronStorageModel2211030001Model = SbmlMasison2022CellularFerritinIronStorage
