...
"""Auto-generated SBML BioModule wrapper for Dempsher1984_ACTH_CortisolSecretion.

Source: biomodels_ebi:MODEL0912835813
Original: https://www.ebi.ac.uk/biomodels/MODEL0912835813
"""
...
class SbmlDempsher1984ActhCortisolsecretion(biosim.BioModule):
    """BioModule wrapper for SBML model: Dempsher1984_ACTH_CortisolSecretion."""

    def __init__(self, model_path: str = "data/MODEL0912835813.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dempsher1984ActhCortisolsecretionModel0912835813Model = SbmlDempsher1984ActhCortisolsecretion
