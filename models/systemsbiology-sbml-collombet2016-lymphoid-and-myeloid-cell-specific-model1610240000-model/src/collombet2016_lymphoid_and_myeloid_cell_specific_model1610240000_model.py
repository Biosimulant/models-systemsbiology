...
"""Auto-generated SBML BioModule wrapper for Collombet2016 - Lymphoid and myeloid cell specification and transdifferentiation.

Source: biomodels_ebi:MODEL1610240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1610240000
"""
...
class SbmlCollombet2016LymphoidAndMyeloidCellSpecificationAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Collombet2016 - Lymphoid and myeloid cell specification and transdifferentiation."""

    def __init__(self, model_path: str = "data/MODEL1610240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Collombet2016LymphoidAndMyeloidCellSpecificModel1610240000Model = SbmlCollombet2016LymphoidAndMyeloidCellSpecificationAnd
