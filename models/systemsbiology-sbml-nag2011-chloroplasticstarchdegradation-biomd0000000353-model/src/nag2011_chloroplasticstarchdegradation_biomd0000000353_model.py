...
"""Auto-generated SBML BioModule wrapper for Nag2011_ChloroplasticStarchDegradation.

Source: biomodels_ebi:BIOMD0000000353
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000353
"""
...
class SbmlNag2011Chloroplasticstarchdegradation(biosim.BioModule):
    """BioModule wrapper for SBML model: Nag2011_ChloroplasticStarchDegradation."""

    def __init__(self, model_path: str = "data/BIOMD0000000353.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nag2011ChloroplasticstarchdegradationBiomd0000000353Model = SbmlNag2011Chloroplasticstarchdegradation
