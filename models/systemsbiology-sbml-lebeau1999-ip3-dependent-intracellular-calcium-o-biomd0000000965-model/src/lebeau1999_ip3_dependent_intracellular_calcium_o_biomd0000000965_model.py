...
"""Auto-generated SBML BioModule wrapper for LeBeau1999 - IP3-dependent intracellular calcium oscillations due to agonist stimulation from Cholecytokinin.

Source: biomodels_ebi:BIOMD0000000965
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000965
"""
...
class SbmlLebeau1999Ip3DependentIntracellularCalciumOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: LeBeau1999 - IP3-dependent intracellular calcium oscillations due to agonist stimulation from Cholecytokinin."""

    def __init__(self, model_path: str = "data/BIOMD0000000965.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lebeau1999Ip3DependentIntracellularCalciumOBiomd0000000965Model = SbmlLebeau1999Ip3DependentIntracellularCalciumOscillations
