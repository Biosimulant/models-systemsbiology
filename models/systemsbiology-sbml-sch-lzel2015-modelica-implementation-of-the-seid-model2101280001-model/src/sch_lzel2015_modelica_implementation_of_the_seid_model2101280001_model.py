...
"""Auto-generated SBML BioModule wrapper for Schölzel2015 - Modelica implementation of the Seidel-Herzel model of the human baroreflex (v1.6).

Source: biomodels_ebi:MODEL2101280001
Original: https://www.ebi.ac.uk/biomodels/MODEL2101280001
"""
...
class SbmlScholzel2015ModelicaImplementationOfTheSeidelHerzel(biosim.BioModule):
    """BioModule wrapper for SBML model: Schölzel2015 - Modelica implementation of the Seidel-Herzel model of the human baroreflex (v1.6)."""

    def __init__(self, model_path: str = "data/MODEL2101280001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SchLzel2015ModelicaImplementationOfTheSeidModel2101280001Model = SbmlScholzel2015ModelicaImplementationOfTheSeidelHerzel
