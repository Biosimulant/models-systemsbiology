...
"""Auto-generated SBML BioModule wrapper for Gall1999_CalciumBursting_BetaCellModel_C.

Source: biomodels_ebi:MODEL1201140000
Original: https://www.ebi.ac.uk/biomodels/MODEL1201140000
"""
...
class SbmlGall1999CalciumburstingBetacellmodelC(biosim.BioModule):
    """BioModule wrapper for SBML model: Gall1999_CalciumBursting_BetaCellModel_C."""

    def __init__(self, model_path: str = "data/MODEL1201140000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gall1999CalciumburstingBetacellmodelCModel1201140000Model = SbmlGall1999CalciumburstingBetacellmodelC
