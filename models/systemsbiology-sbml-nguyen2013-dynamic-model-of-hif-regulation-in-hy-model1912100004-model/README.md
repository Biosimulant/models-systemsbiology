...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1912100004)
**Standard**: sbml
**Authors**: Lan K Nguyen; Miguel A S Cavadas; Carsten C Scholz; Susan F Fitzpatrick; Ulrike Bruning
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/systemsbiology-sbml-nguyen2013-dynamic-model-of-hif-regulation-in-hy-model1912100004-model/model.yaml
```
