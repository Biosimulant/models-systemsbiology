...
"""Auto-generated SBML BioModule wrapper for Nguyen2013 - Dynamic model of HIF regulation in hypoxia.

Source: biomodels_ebi:MODEL1912100004
Original: https://www.ebi.ac.uk/biomodels/MODEL1912100004
"""
...
class SbmlNguyen2013DynamicModelOfHifRegulationInHypoxia(biosim.BioModule):
    """BioModule wrapper for SBML model: Nguyen2013 - Dynamic model of HIF regulation in hypoxia."""

    def __init__(self, model_path: str = "data/MODEL1912100004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nguyen2013DynamicModelOfHifRegulationInHyModel1912100004Model = SbmlNguyen2013DynamicModelOfHifRegulationInHypoxia
