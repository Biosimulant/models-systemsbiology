...
"""Auto-generated SBML BioModule wrapper for Willems1991 - Simulating thrombin generation.

Source: biomodels_ebi:MODEL1807240002
Original: https://www.ebi.ac.uk/biomodels/MODEL1807240002
"""
...
class SbmlWillems1991SimulatingThrombinGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Willems1991 - Simulating thrombin generation."""

    def __init__(self, model_path: str = "data/MODEL1807240002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Willems1991SimulatingThrombinGenerationModel1807240002Model = SbmlWillems1991SimulatingThrombinGeneration
