...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1807240002)
**Standard**: sbml
**Authors**: G M Willems; T Lindhout; W T Hermens; H C Hemker
...
models:
  - path: ../../models/systemsbiology-sbml-willems1991-simulating-thrombin-generation-model1807240002-model
    alias: model
```
