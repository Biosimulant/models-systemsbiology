...
"""Auto-generated SBML BioModule wrapper for Bekkar2018 - PPARA regulation in atherosclerosis.

Source: biomodels_ebi:MODEL1712240001
Original: https://www.ebi.ac.uk/biomodels/MODEL1712240001
"""
...
class SbmlBekkar2018PparaRegulationInAtherosclerosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Bekkar2018 - PPARA regulation in atherosclerosis."""

    def __init__(self, model_path: str = "data/MODEL1712240001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bekkar2018PparaRegulationInAtherosclerosisModel1712240001Model = SbmlBekkar2018PparaRegulationInAtherosclerosis
