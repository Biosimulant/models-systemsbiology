...
"""Auto-generated SBML BioModule wrapper for Reynolds2006 - Reduced model of the acute inflammatory response.

Source: biomodels_ebi:BIOMD0000000714
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000714
"""
...
class SbmlReynolds2006ReducedModelOfTheAcuteInflammatory(biosim.BioModule):
    """BioModule wrapper for SBML model: Reynolds2006 - Reduced model of the acute inflammatory response."""

    def __init__(self, model_path: str = "data/BIOMD0000000714.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Reynolds2006ReducedModelOfTheAcuteInflammaBiomd0000000714Model = SbmlReynolds2006ReducedModelOfTheAcuteInflammatory
