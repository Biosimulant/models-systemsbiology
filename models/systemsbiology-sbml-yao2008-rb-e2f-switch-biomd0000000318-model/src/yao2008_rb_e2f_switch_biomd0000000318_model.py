...
"""Auto-generated SBML BioModule wrapper for Yao2008_Rb_E2F_Switch.

Source: biomodels_ebi:BIOMD0000000318
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000318
"""
...
class SbmlYao2008RbE2fSwitch(biosim.BioModule):
    """BioModule wrapper for SBML model: Yao2008_Rb_E2F_Switch."""

    def __init__(self, model_path: str = "data/BIOMD0000000318.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yao2008RbE2fSwitchBiomd0000000318Model = SbmlYao2008RbE2fSwitch
