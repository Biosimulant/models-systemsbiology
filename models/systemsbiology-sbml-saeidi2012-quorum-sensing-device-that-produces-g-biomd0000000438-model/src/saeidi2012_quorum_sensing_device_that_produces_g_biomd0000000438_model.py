...
"""Auto-generated SBML BioModule wrapper for Saeidi2012 - Quorum sensing device that produces GFP.

Source: biomodels_ebi:BIOMD0000000438
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000438
"""
...
class SbmlSaeidi2012QuorumSensingDeviceThatProducesGfp(biosim.BioModule):
    """BioModule wrapper for SBML model: Saeidi2012 - Quorum sensing device that produces GFP."""

    def __init__(self, model_path: str = "data/BIOMD0000000438.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Saeidi2012QuorumSensingDeviceThatProducesGBiomd0000000438Model = SbmlSaeidi2012QuorumSensingDeviceThatProducesGfp
