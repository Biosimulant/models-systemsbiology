...
"""Auto-generated SBML BioModule wrapper for stseranidou2024 - Nucleus Pulposus Cell Network Modelling in the Intervertebral Disc.

Source: biomodels_ebi:MODEL2407080001
Original: https://www.ebi.ac.uk/biomodels/MODEL2407080001
"""
...
class SbmlStseranidou2024NucleusPulposusCellNetworkModellingIn(biosim.BioModule):
    """BioModule wrapper for SBML model: stseranidou2024 - Nucleus Pulposus Cell Network Modelling in the Intervertebral Disc."""

    def __init__(self, model_path: str = "data/MODEL2407080001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Stseranidou2024NucleusPulposusCellNetworkMoModel2407080001Model = SbmlStseranidou2024NucleusPulposusCellNetworkModellingIn
