...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Colon Crypt cycle - Version 0.

Source: biomodels_ebi:BIOMD0000000520
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000520
"""
...
class SbmlSmallbone2013ColonCryptCycleVersion0(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Colon Crypt cycle - Version 0."""

    def __init__(self, model_path: str = "data/BIOMD0000000520.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013ColonCryptCycleVersion0Biomd0000000520Model = SbmlSmallbone2013ColonCryptCycleVersion0
