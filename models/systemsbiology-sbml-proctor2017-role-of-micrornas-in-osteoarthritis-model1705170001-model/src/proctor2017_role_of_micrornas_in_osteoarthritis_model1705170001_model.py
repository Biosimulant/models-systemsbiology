...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (miR140-IL1 coherent feed forward).

Source: biomodels_ebi:MODEL1705170001
Original: https://www.ebi.ac.uk/biomodels/MODEL1705170001
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140Il12(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (miR140-IL1 coherent feed forward)."""

    def __init__(self, model_path: str = "data/MODEL1705170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1705170001Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140Il12
