...
"""Auto-generated SBML BioModule wrapper for Restif2006 - Whooping cough.

Source: biomodels_ebi:BIOMD0000000249
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000249
"""
...
class SbmlRestif2006WhoopingCough(biosim.BioModule):
    """BioModule wrapper for SBML model: Restif2006 - Whooping cough."""

    def __init__(self, model_path: str = "data/BIOMD0000000249.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Restif2006WhoopingCoughBiomd0000000249Model = SbmlRestif2006WhoopingCough
