...
"""Auto-generated SBML BioModule wrapper for Proctor2013 - Cartilage breakdown, interventions to reduce collagen release.

Source: biomodels_ebi:BIOMD0000000504
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000504
"""
...
class SbmlProctor2013CartilageBreakdownInterventionsToReduce(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2013 - Cartilage breakdown, interventions to reduce collagen release."""

    def __init__(self, model_path: str = "data/BIOMD0000000504.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2013CartilageBreakdownInterventionsToBiomd0000000504Model = SbmlProctor2013CartilageBreakdownInterventionsToReduce
