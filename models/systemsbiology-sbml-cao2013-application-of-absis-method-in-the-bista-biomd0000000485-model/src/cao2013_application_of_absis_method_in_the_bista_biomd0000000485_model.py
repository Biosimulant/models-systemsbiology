...
"""Auto-generated SBML BioModule wrapper for Cao2013 - Application of ABSIS method in the bistable Schlögl model.

Source: biomodels_ebi:BIOMD0000000485
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000485
"""
...
class SbmlCao2013ApplicationOfAbsisMethodInTheBistableSchlogl(biosim.BioModule):
    """BioModule wrapper for SBML model: Cao2013 - Application of ABSIS method in the bistable Schlögl model."""

    def __init__(self, model_path: str = "data/BIOMD0000000485.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cao2013ApplicationOfAbsisMethodInTheBistaBiomd0000000485Model = SbmlCao2013ApplicationOfAbsisMethodInTheBistableSchlogl
