...
"""Auto-generated SBML BioModule wrapper for Sengupta2015 - Knowledge base model of human energy pool network (HEPNet).

Source: biomodels_ebi:BIOMD0000000579
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000579
"""
...
class SbmlSengupta2015KnowledgeBaseModelOfHumanEnergyPool(biosim.BioModule):
    """BioModule wrapper for SBML model: Sengupta2015 - Knowledge base model of human energy pool network (HEPNet)."""

    def __init__(self, model_path: str = "data/BIOMD0000000579.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sengupta2015KnowledgeBaseModelOfHumanEnergBiomd0000000579Model = SbmlSengupta2015KnowledgeBaseModelOfHumanEnergyPool
