...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Schultz2003_RuBisCO-CalvinCycle.

Source: biomodels_ebi:BIOMD0000000385
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000385
"""
...
class SbmlArnold2011Schultz2003RubiscoCalvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Schultz2003_RuBisCO-CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000385.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Schultz2003RubiscoCalvincycleBiomd0000000385Model = SbmlArnold2011Schultz2003RubiscoCalvincycle
