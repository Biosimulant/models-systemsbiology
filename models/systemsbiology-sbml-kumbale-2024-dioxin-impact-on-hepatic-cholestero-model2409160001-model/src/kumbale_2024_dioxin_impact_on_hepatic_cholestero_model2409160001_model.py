...
"""Auto-generated SBML BioModule wrapper for Kumbale 2024 - Dioxin impact on Hepatic Cholesterol Biosynthesis.

Source: biomodels_ebi:MODEL2409160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2409160001
"""
...
class SbmlKumbale2024DioxinImpactOnHepaticCholesterol(bsim.BioModule):
    """BioModule wrapper for SBML model: Kumbale 2024 - Dioxin impact on Hepatic Cholesterol Biosynthesis."""

    def __init__(self, model_path: str = "data/MODEL2409160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kumbale2024DioxinImpactOnHepaticCholesteroModel2409160001Model = SbmlKumbale2024DioxinImpactOnHepaticCholesterol
