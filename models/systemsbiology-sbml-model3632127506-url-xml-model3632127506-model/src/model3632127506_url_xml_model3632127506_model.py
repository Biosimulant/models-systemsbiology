...
"""Auto-generated SBML BioModule wrapper for MODEL3632127506_url.xml.

Source: biomodels_ebi:MODEL3632127506
Original: https://www.ebi.ac.uk/biomodels/MODEL3632127506
"""
...
class SbmlModel3632127506UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL3632127506_url.xml."""

    def __init__(self, model_path: str = "data/MODEL3632127506.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model3632127506UrlXmlModel3632127506Model = SbmlModel3632127506UrlXml
