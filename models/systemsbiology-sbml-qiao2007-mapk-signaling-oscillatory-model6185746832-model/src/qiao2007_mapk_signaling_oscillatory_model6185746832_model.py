...
"""Auto-generated SBML BioModule wrapper for Qiao2007_MAPK_Signaling_Oscillatory.

Source: biomodels_ebi:MODEL6185746832
Original: https://www.ebi.ac.uk/biomodels/MODEL6185746832
"""
...
class SbmlQiao2007MapkSignalingOscillatory(biosim.BioModule):
    """BioModule wrapper for SBML model: Qiao2007_MAPK_Signaling_Oscillatory."""

    def __init__(self, model_path: str = "data/MODEL6185746832.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qiao2007MapkSignalingOscillatoryModel6185746832Model = SbmlQiao2007MapkSignalingOscillatory
