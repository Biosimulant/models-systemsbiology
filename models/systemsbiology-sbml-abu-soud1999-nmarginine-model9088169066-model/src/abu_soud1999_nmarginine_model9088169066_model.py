...
"""Auto-generated SBML BioModule wrapper for Abu-Soud1999_NMArginine.

Source: biomodels_ebi:MODEL9088169066
Original: https://www.ebi.ac.uk/biomodels/MODEL9088169066
"""
...
class SbmlAbuSoud1999Nmarginine(biosim.BioModule):
    """BioModule wrapper for SBML model: Abu-Soud1999_NMArginine."""

    def __init__(self, model_path: str = "data/MODEL9088169066.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
AbuSoud1999NmarginineModel9088169066Model = SbmlAbuSoud1999Nmarginine
