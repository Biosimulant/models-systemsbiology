...
"""Auto-generated SBML BioModule wrapper for Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions and PKA inhibits MAST3.

Source: biomodels_ebi:BIOMD0000000644
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000644
"""
...
class SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp2(biosim.BioModule):
    """BioModule wrapper for SBML model: Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions and PKA inhibits MAST3."""

    def __init__(self, model_path: str = "data/BIOMD0000000644.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Musante2017SwitchingBehaviourOfPp2aInhibitiBiomd0000000644Model = SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp2
