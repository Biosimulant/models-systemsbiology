...
"""Auto-generated SBML BioModule wrapper for Locke2008_Circadian_Clock.

Source: biomodels_ebi:BIOMD0000000185
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000185
"""
...
class SbmlLocke2008CircadianClock(biosim.BioModule):
    """BioModule wrapper for SBML model: Locke2008_Circadian_Clock."""

    def __init__(self, model_path: str = "data/BIOMD0000000185.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Locke2008CircadianClockBiomd0000000185Model = SbmlLocke2008CircadianClock
