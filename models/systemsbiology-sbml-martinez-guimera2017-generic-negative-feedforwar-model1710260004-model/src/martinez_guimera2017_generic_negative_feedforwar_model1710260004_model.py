...
"""Auto-generated SBML BioModule wrapper for Martinez-Guimera2017 - Generic negative feedforward circuit (Model 5).

Source: biomodels_ebi:MODEL1710260004
Original: https://www.ebi.ac.uk/biomodels/MODEL1710260004
"""
...
class SbmlMartinezGuimera2017GenericNegativeFeedforwardCircuit(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Guimera2017 - Generic negative feedforward circuit (Model 5)."""

    def __init__(self, model_path: str = "data/MODEL1710260004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericNegativeFeedforwarModel1710260004Model = SbmlMartinezGuimera2017GenericNegativeFeedforwardCircuit
