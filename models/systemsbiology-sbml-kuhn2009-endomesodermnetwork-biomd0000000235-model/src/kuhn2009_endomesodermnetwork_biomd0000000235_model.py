...
"""Auto-generated SBML BioModule wrapper for Kuhn2009_EndoMesodermNetwork.

Source: biomodels_ebi:BIOMD0000000235
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000235
"""
...
class SbmlKuhn2009Endomesodermnetwork(biosim.BioModule):
    """BioModule wrapper for SBML model: Kuhn2009_EndoMesodermNetwork."""

    def __init__(self, model_path: str = "data/BIOMD0000000235.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kuhn2009EndomesodermnetworkBiomd0000000235Model = SbmlKuhn2009Endomesodermnetwork
