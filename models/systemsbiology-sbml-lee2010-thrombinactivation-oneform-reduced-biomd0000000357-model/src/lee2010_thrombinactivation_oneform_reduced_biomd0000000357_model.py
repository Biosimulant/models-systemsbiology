...
"""Auto-generated SBML BioModule wrapper for Lee2010_ThrombinActivation_OneForm_reduced.

Source: biomodels_ebi:BIOMD0000000357
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000357
"""
...
class SbmlLee2010ThrombinactivationOneformReduced(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2010_ThrombinActivation_OneForm_reduced."""

    def __init__(self, model_path: str = "data/BIOMD0000000357.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2010ThrombinactivationOneformReducedBiomd0000000357Model = SbmlLee2010ThrombinactivationOneformReduced
