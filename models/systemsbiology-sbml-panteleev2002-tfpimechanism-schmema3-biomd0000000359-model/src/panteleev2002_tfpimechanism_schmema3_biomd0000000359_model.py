...
"""Auto-generated SBML BioModule wrapper for Panteleev2002_TFPImechanism_schmema3.

Source: biomodels_ebi:BIOMD0000000359
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000359
"""
...
class SbmlPanteleev2002TfpimechanismSchmema3(biosim.BioModule):
    """BioModule wrapper for SBML model: Panteleev2002_TFPImechanism_schmema3."""

    def __init__(self, model_path: str = "data/BIOMD0000000359.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Panteleev2002TfpimechanismSchmema3Biomd0000000359Model = SbmlPanteleev2002TfpimechanismSchmema3
