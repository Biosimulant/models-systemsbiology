...
"""Auto-generated SBML BioModule wrapper for Bagci2008_NO_Apoptosis_modelA.

Source: biomodels_ebi:MODEL1006230064
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230064
"""
...
class SbmlBagci2008NoApoptosisModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Bagci2008_NO_Apoptosis_modelA."""

    def __init__(self, model_path: str = "data/MODEL1006230064.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bagci2008NoApoptosisModelaModel1006230064Model = SbmlBagci2008NoApoptosisModela
