...
"""Auto-generated SBML BioModule wrapper for Hockin1999_BloodCoagulation_VaInactivation.

Source: biomodels_ebi:BIOMD0000000365
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000365
"""
...
class SbmlHockin1999BloodcoagulationVainactivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Hockin1999_BloodCoagulation_VaInactivation."""

    def __init__(self, model_path: str = "data/BIOMD0000000365.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hockin1999BloodcoagulationVainactivationBiomd0000000365Model = SbmlHockin1999BloodcoagulationVainactivation
