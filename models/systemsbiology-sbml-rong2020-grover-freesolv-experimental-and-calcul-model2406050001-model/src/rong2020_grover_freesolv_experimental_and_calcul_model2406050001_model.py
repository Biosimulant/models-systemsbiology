...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-Freesolv: Experimental and calculated hydration free energy of small molecules in water.

Source: biomodels_ebi:MODEL2406050001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050001
"""
...
class SbmlRong2020GroverFreesolvExperimentalAndCalculated(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-Freesolv: Experimental and calculated hydration free energy of small molecules in water."""

    def __init__(self, model_path: str = "data/MODEL2406050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverFreesolvExperimentalAndCalculModel2406050001Model = SbmlRong2020GroverFreesolvExperimentalAndCalculated
