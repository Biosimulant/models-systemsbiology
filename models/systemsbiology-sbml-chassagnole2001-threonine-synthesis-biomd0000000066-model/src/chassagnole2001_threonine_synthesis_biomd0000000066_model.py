...
"""Auto-generated SBML BioModule wrapper for Chassagnole2001_Threonine Synthesis.

Source: biomodels_ebi:BIOMD0000000066
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000066
"""
...
class SbmlChassagnole2001ThreonineSynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Chassagnole2001_Threonine Synthesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000066.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chassagnole2001ThreonineSynthesisBiomd0000000066Model = SbmlChassagnole2001ThreonineSynthesis
