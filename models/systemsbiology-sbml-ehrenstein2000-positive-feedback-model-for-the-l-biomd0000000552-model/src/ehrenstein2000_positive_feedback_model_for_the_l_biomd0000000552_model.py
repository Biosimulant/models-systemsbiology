...
"""Auto-generated SBML BioModule wrapper for Ehrenstein2000 - Positive-Feedback model for the loss of acetylcholine in Alzheimer's disease.

Source: biomodels_ebi:BIOMD0000000552
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000552
"""
...
class SbmlEhrenstein2000PositiveFeedbackModelForTheLossOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Ehrenstein2000 - Positive-Feedback model for the loss of acetylcholine in Alzheimer's disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000552.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ehrenstein2000PositiveFeedbackModelForTheLBiomd0000000552Model = SbmlEhrenstein2000PositiveFeedbackModelForTheLossOf
