...
"""Auto-generated SBML BioModule wrapper for Aguda1999_CellCycle.

Source: biomodels_ebi:BIOMD0000000169
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000169
"""
...
class SbmlAguda1999Cellcycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Aguda1999_CellCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000169.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aguda1999CellcycleBiomd0000000169Model = SbmlAguda1999Cellcycle
