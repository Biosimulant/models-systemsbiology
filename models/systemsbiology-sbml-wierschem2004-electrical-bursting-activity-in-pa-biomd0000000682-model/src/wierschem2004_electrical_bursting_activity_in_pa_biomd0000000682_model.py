...
"""Auto-generated SBML BioModule wrapper for Wierschem2004 - Electrical bursting activity in Pancreatic Islets.

Source: biomodels_ebi:BIOMD0000000682
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000682
"""
...
class SbmlWierschem2004ElectricalBurstingActivityInPancreatic(biosim.BioModule):
    """BioModule wrapper for SBML model: Wierschem2004 - Electrical bursting activity in Pancreatic Islets."""

    def __init__(self, model_path: str = "data/BIOMD0000000682.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wierschem2004ElectricalBurstingActivityInPaBiomd0000000682Model = SbmlWierschem2004ElectricalBurstingActivityInPancreatic
