...
"""Auto-generated SBML BioModule wrapper for Band2012_DII-Venus_ReducedModel.

Source: biomodels_ebi:BIOMD0000000414
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000414
"""
...
class SbmlBand2012DiiVenusReducedmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Band2012_DII-Venus_ReducedModel."""

    def __init__(self, model_path: str = "data/BIOMD0000000414.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Band2012DiiVenusReducedmodelBiomd0000000414Model = SbmlBand2012DiiVenusReducedmodel
