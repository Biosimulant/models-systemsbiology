...
"""Auto-generated SBML BioModule wrapper for Komarova2003_BoneRemodeling.

Source: biomodels_ebi:BIOMD0000000148
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000148
"""
...
class SbmlKomarova2003Boneremodeling(biosim.BioModule):
    """BioModule wrapper for SBML model: Komarova2003_BoneRemodeling."""

    def __init__(self, model_path: str = "data/BIOMD0000000148.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Komarova2003BoneremodelingBiomd0000000148Model = SbmlKomarova2003Boneremodeling
