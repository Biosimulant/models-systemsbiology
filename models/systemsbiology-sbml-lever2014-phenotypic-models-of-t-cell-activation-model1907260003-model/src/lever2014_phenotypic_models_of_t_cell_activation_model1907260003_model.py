...
"""Auto-generated SBML BioModule wrapper for Lever2014 - Phenotypic models of T cell activation..

Source: biomodels_ebi:MODEL1907260003
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260003
"""
...
class SbmlLever2014PhenotypicModelsOfTCellActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Lever2014 - Phenotypic models of T cell activation.."""

    def __init__(self, model_path: str = "data/MODEL1907260003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lever2014PhenotypicModelsOfTCellActivationModel1907260003Model = SbmlLever2014PhenotypicModelsOfTCellActivation
