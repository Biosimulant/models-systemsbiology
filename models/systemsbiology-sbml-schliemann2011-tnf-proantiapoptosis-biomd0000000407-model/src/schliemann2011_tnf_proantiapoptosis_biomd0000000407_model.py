...
"""Auto-generated SBML BioModule wrapper for Schliemann2011_TNF_ProAntiApoptosis.

Source: biomodels_ebi:BIOMD0000000407
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000407
"""
...
class SbmlSchliemann2011TnfProantiapoptosis(biosim.BioModule):
    """BioModule wrapper for SBML model: Schliemann2011_TNF_ProAntiApoptosis."""

    def __init__(self, model_path: str = "data/BIOMD0000000407.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schliemann2011TnfProantiapoptosisBiomd0000000407Model = SbmlSchliemann2011TnfProantiapoptosis
