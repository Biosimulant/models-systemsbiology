...
"""Auto-generated SBML BioModule wrapper for Karapetyan2016 - Genetic oscillatory network - Repressor Titration Circuit (RTC).

Source: biomodels_ebi:BIOMD0000000587
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000587
"""
...
class SbmlKarapetyan2016GeneticOscillatoryNetworkRepressor(biosim.BioModule):
    """BioModule wrapper for SBML model: Karapetyan2016 - Genetic oscillatory network - Repressor Titration Circuit (RTC)."""

    def __init__(self, model_path: str = "data/BIOMD0000000587.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karapetyan2016GeneticOscillatoryNetworkRepreBiomd0000000587Model = SbmlKarapetyan2016GeneticOscillatoryNetworkRepressor
