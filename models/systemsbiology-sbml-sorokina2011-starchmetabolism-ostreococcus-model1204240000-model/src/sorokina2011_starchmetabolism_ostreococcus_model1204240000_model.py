...
"""Auto-generated SBML BioModule wrapper for Sorokina2011_StarchMetabolism_Ostreococcus.

Source: biomodels_ebi:MODEL1204240000
Original: https://www.ebi.ac.uk/biomodels/MODEL1204240000
"""
...
class SbmlSorokina2011StarchmetabolismOstreococcus(biosim.BioModule):
    """BioModule wrapper for SBML model: Sorokina2011_StarchMetabolism_Ostreococcus."""

    def __init__(self, model_path: str = "data/MODEL1204240000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sorokina2011StarchmetabolismOstreococcusModel1204240000Model = SbmlSorokina2011StarchmetabolismOstreococcus
