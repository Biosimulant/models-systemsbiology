...
"""Auto-generated SBML BioModule wrapper for Zager2007_Genistein_Biliary_Excretion.

Source: biomodels_ebi:MODEL6963432821
Original: https://www.ebi.ac.uk/biomodels/MODEL6963432821
"""
...
class SbmlZager2007GenisteinBiliaryExcretion(biosim.BioModule):
    """BioModule wrapper for SBML model: Zager2007_Genistein_Biliary_Excretion."""

    def __init__(self, model_path: str = "data/MODEL6963432821.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zager2007GenisteinBiliaryExcretionModel6963432821Model = SbmlZager2007GenisteinBiliaryExcretion
