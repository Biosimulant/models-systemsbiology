...
"""Auto-generated SBML BioModule wrapper for MODEL8262229752_url.xml.

Source: biomodels_ebi:MODEL8262229752
Original: https://www.ebi.ac.uk/biomodels/MODEL8262229752
"""
...
class SbmlModel8262229752UrlXml(biosim.BioModule):
    """BioModule wrapper for SBML model: MODEL8262229752_url.xml."""

    def __init__(self, model_path: str = "data/MODEL8262229752.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Model8262229752UrlXmlModel8262229752Model = SbmlModel8262229752UrlXml
