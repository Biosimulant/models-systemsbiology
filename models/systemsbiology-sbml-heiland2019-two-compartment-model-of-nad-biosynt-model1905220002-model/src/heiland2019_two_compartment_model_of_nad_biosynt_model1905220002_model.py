...
"""Auto-generated SBML BioModule wrapper for Heiland2019 - Two compartment model of NAD biosynthesis and consumption.

Source: biomodels_ebi:MODEL1905220002
Original: https://www.ebi.ac.uk/biomodels/MODEL1905220002
"""
...
class SbmlHeiland2019TwoCompartmentModelOfNadBiosynthesisAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Heiland2019 - Two compartment model of NAD biosynthesis and consumption."""

    def __init__(self, model_path: str = "data/MODEL1905220002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heiland2019TwoCompartmentModelOfNadBiosyntModel1905220002Model = SbmlHeiland2019TwoCompartmentModelOfNadBiosynthesisAnd
