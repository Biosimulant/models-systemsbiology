...
"""Auto-generated SBML BioModule wrapper for Vazquez2014 - Chemical inhibition from amyloid protein aggregation kinetics.

Source: biomodels_ebi:BIOMD0000000532
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000532
"""
...
class SbmlVazquez2014ChemicalInhibitionFromAmyloidProtein(biosim.BioModule):
    """BioModule wrapper for SBML model: Vazquez2014 - Chemical inhibition from amyloid protein aggregation kinetics."""

    def __init__(self, model_path: str = "data/BIOMD0000000532.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vazquez2014ChemicalInhibitionFromAmyloidProBiomd0000000532Model = SbmlVazquez2014ChemicalInhibitionFromAmyloidProtein
