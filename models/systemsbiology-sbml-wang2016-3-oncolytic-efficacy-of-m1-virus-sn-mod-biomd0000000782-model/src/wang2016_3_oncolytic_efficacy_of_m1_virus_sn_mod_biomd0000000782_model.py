...
"""Auto-generated SBML BioModule wrapper for Wang2016/3 - oncolytic efficacy of M1 virus-SN model.

Source: biomodels_ebi:BIOMD0000000782
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000782
"""
...
class SbmlWang20163OncolyticEfficacyOfM1VirusSnModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2016/3 - oncolytic efficacy of M1 virus-SN model."""

    def __init__(self, model_path: str = "data/BIOMD0000000782.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang20163OncolyticEfficacyOfM1VirusSnModBiomd0000000782Model = SbmlWang20163OncolyticEfficacyOfM1VirusSnModel
