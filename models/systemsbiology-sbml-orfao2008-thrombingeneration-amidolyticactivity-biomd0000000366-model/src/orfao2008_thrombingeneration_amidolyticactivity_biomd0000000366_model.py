...
"""Auto-generated SBML BioModule wrapper for Orfao2008_ThrombinGeneration_AmidolyticActivity.

Source: biomodels_ebi:BIOMD0000000366
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000366
"""
...
class SbmlOrfao2008ThrombingenerationAmidolyticactivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Orfao2008_ThrombinGeneration_AmidolyticActivity."""

    def __init__(self, model_path: str = "data/BIOMD0000000366.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Orfao2008ThrombingenerationAmidolyticactivityBiomd0000000366Model = SbmlOrfao2008ThrombingenerationAmidolyticactivity
