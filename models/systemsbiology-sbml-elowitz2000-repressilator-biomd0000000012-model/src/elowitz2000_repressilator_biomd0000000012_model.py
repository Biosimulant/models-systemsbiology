...
"""Auto-generated SBML BioModule wrapper for Elowitz2000 - Repressilator.

Source: biomodels_ebi:BIOMD0000000012
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000012
"""
...
class SbmlElowitz2000Repressilator(biosim.BioModule):
    """BioModule wrapper for SBML model: Elowitz2000 - Repressilator."""

    def __init__(self, model_path: str = "data/BIOMD0000000012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Elowitz2000RepressilatorBiomd0000000012Model = SbmlElowitz2000Repressilator
