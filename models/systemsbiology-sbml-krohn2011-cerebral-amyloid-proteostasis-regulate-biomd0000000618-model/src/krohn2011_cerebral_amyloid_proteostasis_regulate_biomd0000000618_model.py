...
"""Auto-generated SBML BioModule wrapper for Krohn2011 - Cerebral amyloid-β proteostasis regulated by membrane transport protein ABCC1.

Source: biomodels_ebi:BIOMD0000000618
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000618
"""
...
class SbmlKrohn2011CerebralAmyloidProteostasisRegulatedBy(biosim.BioModule):
    """BioModule wrapper for SBML model: Krohn2011 - Cerebral amyloid-β proteostasis regulated by membrane transport protein ABCC1."""

    def __init__(self, model_path: str = "data/BIOMD0000000618.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Krohn2011CerebralAmyloidProteostasisRegulateBiomd0000000618Model = SbmlKrohn2011CerebralAmyloidProteostasisRegulatedBy
