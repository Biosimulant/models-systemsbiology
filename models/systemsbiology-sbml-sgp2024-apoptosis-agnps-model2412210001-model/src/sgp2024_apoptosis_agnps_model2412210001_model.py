...
"""Auto-generated SBML BioModule wrapper for SGP2024 - Apoptosis_AgNPs.

Source: biomodels_ebi:MODEL2412210001
Original: https://www.ebi.ac.uk/biomodels/MODEL2412210001
"""
...
class SbmlSgp2024ApoptosisAgnps(biosim.BioModule):
    """BioModule wrapper for SBML model: SGP2024 - Apoptosis_AgNPs."""

    def __init__(self, model_path: str = "data/MODEL2412210001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sgp2024ApoptosisAgnpsModel2412210001Model = SbmlSgp2024ApoptosisAgnps
