...
"""Auto-generated SBML BioModule wrapper for Sharp2019 - AML.

Source: biomodels_ebi:BIOMD0000000798
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000798
"""
...
class SbmlSharp2019Aml(biosim.BioModule):
    """BioModule wrapper for SBML model: Sharp2019 - AML."""

    def __init__(self, model_path: str = "data/BIOMD0000000798.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sharp2019AmlBiomd0000000798Model = SbmlSharp2019Aml
