...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (miR140 in osteoarthritis).

Source: biomodels_ebi:MODEL1705170005
Original: https://www.ebi.ac.uk/biomodels/MODEL1705170005
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140In(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (miR140 in osteoarthritis)."""

    def __init__(self, model_path: str = "data/MODEL1705170005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1705170005Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisMir140In
