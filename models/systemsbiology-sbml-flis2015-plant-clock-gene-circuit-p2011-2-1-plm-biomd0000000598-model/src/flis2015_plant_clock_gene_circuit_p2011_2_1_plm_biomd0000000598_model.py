...
"""Auto-generated SBML BioModule wrapper for Flis2015 - Plant clock gene circuit (P2011.2.1 PLM_71 ver 2).

Source: biomodels_ebi:BIOMD0000000598
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000598
"""
...
class SbmlFlis2015PlantClockGeneCircuitP201121Plm71Ver2(biosim.BioModule):
    """BioModule wrapper for SBML model: Flis2015 - Plant clock gene circuit (P2011.2.1 PLM_71 ver 2)."""

    def __init__(self, model_path: str = "data/BIOMD0000000598.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Flis2015PlantClockGeneCircuitP201121PlmBiomd0000000598Model = SbmlFlis2015PlantClockGeneCircuitP201121Plm71Ver2
