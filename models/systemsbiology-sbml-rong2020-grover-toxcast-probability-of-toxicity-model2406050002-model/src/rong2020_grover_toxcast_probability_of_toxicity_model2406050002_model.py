...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-Toxcast: Probability of toxicity against 617 biological targets.

Source: biomodels_ebi:MODEL2406050002
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050002
"""
...
class SbmlRong2020GroverToxcastProbabilityOfToxicityAgainst617(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-Toxcast: Probability of toxicity against 617 biological targets."""

    def __init__(self, model_path: str = "data/MODEL2406050002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverToxcastProbabilityOfToxicityModel2406050002Model = SbmlRong2020GroverToxcastProbabilityOfToxicityAgainst617
