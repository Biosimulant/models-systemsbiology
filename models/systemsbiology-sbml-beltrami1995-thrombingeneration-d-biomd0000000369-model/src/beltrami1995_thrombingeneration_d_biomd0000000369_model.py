...
"""Auto-generated SBML BioModule wrapper for Beltrami1995_ThrombinGeneration_D.

Source: biomodels_ebi:BIOMD0000000369
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000369
"""
...
class SbmlBeltrami1995ThrombingenerationD(biosim.BioModule):
    """BioModule wrapper for SBML model: Beltrami1995_ThrombinGeneration_D."""

    def __init__(self, model_path: str = "data/BIOMD0000000369.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Beltrami1995ThrombingenerationDBiomd0000000369Model = SbmlBeltrami1995ThrombingenerationD
