...
"""Auto-generated SBML BioModule wrapper for Phillips2008_AscendingArousalSystem_SleepDeprivation.

Source: biomodels_ebi:MODEL1006230115
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230115
"""
...
class SbmlPhillips2008AscendingarousalsystemSleepdeprivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Phillips2008_AscendingArousalSystem_SleepDeprivation."""

    def __init__(self, model_path: str = "data/MODEL1006230115.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phillips2008AscendingarousalsystemSleepdeprivaModel1006230115Model = SbmlPhillips2008AscendingarousalsystemSleepdeprivation
