...
"""Auto-generated SBML BioModule wrapper for Mouse Iron Distribution - Adequate iron diet (No Tracer).

Source: biomodels_ebi:BIOMD0000000736
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000736
"""
...
class SbmlMouseIronDistributionAdequateIronDietNoTracer(biosim.BioModule):
    """BioModule wrapper for SBML model: Mouse Iron Distribution - Adequate iron diet (No Tracer)."""

    def __init__(self, model_path: str = "data/BIOMD0000000736.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MouseIronDistributionAdequateIronDietNoTrBiomd0000000736Model = SbmlMouseIronDistributionAdequateIronDietNoTracer
