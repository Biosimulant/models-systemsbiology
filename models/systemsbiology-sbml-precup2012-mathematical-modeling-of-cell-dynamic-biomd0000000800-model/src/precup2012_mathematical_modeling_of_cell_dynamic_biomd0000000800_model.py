...
"""Auto-generated SBML BioModule wrapper for Precup2012 - Mathematical modeling of cell dynamics after allogeneic bone marrow transplantation.

Source: biomodels_ebi:BIOMD0000000800
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000800
"""
...
class SbmlPrecup2012MathematicalModelingOfCellDynamicsAfter(biosim.BioModule):
    """BioModule wrapper for SBML model: Precup2012 - Mathematical modeling of cell dynamics after allogeneic bone marrow transplantation."""

    def __init__(self, model_path: str = "data/BIOMD0000000800.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Precup2012MathematicalModelingOfCellDynamicBiomd0000000800Model = SbmlPrecup2012MathematicalModelingOfCellDynamicsAfter
