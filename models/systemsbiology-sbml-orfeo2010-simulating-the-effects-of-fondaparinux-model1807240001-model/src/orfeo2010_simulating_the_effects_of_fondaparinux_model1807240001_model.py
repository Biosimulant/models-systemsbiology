...
"""Auto-generated SBML BioModule wrapper for Orfeo2010 - Simulating the effects of fondaparinux and Rivaroxaban on thrombin generation.

Source: biomodels_ebi:MODEL1807240001
Original: https://www.ebi.ac.uk/biomodels/MODEL1807240001
"""
...
class SbmlOrfeo2010SimulatingTheEffectsOfFondaparinuxAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Orfeo2010 - Simulating the effects of fondaparinux and Rivaroxaban on thrombin generation."""

    def __init__(self, model_path: str = "data/MODEL1807240001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Orfeo2010SimulatingTheEffectsOfFondaparinuxModel1807240001Model = SbmlOrfeo2010SimulatingTheEffectsOfFondaparinuxAnd
