...
"""Auto-generated SBML BioModule wrapper for Best2009 - Homeostatic mechanisms in dopamine synthesis and release.

Source: biomodels_ebi:MODEL1502230000
Original: https://www.ebi.ac.uk/biomodels/MODEL1502230000
"""
...
class SbmlBest2009HomeostaticMechanismsInDopamineSynthesisAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Best2009 - Homeostatic mechanisms in dopamine synthesis and release."""

    def __init__(self, model_path: str = "data/MODEL1502230000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Best2009HomeostaticMechanismsInDopamineSyntModel1502230000Model = SbmlBest2009HomeostaticMechanismsInDopamineSynthesisAnd
