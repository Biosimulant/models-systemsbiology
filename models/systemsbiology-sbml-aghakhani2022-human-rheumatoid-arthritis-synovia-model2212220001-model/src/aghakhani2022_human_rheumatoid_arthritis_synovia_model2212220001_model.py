...
"""Auto-generated SBML BioModule wrapper for Aghakhani2022 - Human rheumatoid arthritis synovial fibroblast model.

Source: biomodels_ebi:MODEL2212220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2212220001
"""
...
class SbmlAghakhani2022HumanRheumatoidArthritisSynovial(biosim.BioModule):
    """BioModule wrapper for SBML model: Aghakhani2022 - Human rheumatoid arthritis synovial fibroblast model."""

    def __init__(self, model_path: str = "data/MODEL2212220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Aghakhani2022HumanRheumatoidArthritisSynoviaModel2212220001Model = SbmlAghakhani2022HumanRheumatoidArthritisSynovial
