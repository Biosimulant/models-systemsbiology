...
"""Auto-generated SBML BioModule wrapper for Pawelek2016 - Within-Host Models of High and Low Pathogenic Influenza Virus Infections.

Source: biomodels_ebi:MODEL1812040006
Original: https://www.ebi.ac.uk/biomodels/MODEL1812040006
"""
...
class SbmlPawelek2016WithinHostModelsOfHighAndLowPathogenic(biosim.BioModule):
    """BioModule wrapper for SBML model: Pawelek2016 - Within-Host Models of High and Low Pathogenic Influenza Virus Infections."""

    def __init__(self, model_path: str = "data/MODEL1812040006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pawelek2016WithinHostModelsOfHighAndLowPModel1812040006Model = SbmlPawelek2016WithinHostModelsOfHighAndLowPathogenic
