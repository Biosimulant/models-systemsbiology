...
"""Auto-generated SBML BioModule wrapper for Siebert2008_MuscleContraction_CC.

Source: biomodels_ebi:MODEL1006230119
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230119
"""
...
class SbmlSiebert2008MusclecontractionCc(biosim.BioModule):
    """BioModule wrapper for SBML model: Siebert2008_MuscleContraction_CC."""

    def __init__(self, model_path: str = "data/MODEL1006230119.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Siebert2008MusclecontractionCcModel1006230119Model = SbmlSiebert2008MusclecontractionCc
