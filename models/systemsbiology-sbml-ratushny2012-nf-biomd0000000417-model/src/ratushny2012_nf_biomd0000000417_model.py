...
"""Auto-generated SBML BioModule wrapper for Ratushny2012_NF.

Source: biomodels_ebi:BIOMD0000000417
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000417
"""
...
class SbmlRatushny2012Nf(biosim.BioModule):
    """BioModule wrapper for SBML model: Ratushny2012_NF."""

    def __init__(self, model_path: str = "data/BIOMD0000000417.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ratushny2012NfBiomd0000000417Model = SbmlRatushny2012Nf
