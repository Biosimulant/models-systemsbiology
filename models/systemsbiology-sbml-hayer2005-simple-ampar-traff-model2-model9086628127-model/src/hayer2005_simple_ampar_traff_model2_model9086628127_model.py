...
"""Auto-generated SBML BioModule wrapper for Hayer2005_simple_AMPAR_traff_model2.

Source: biomodels_ebi:MODEL9086628127
Original: https://www.ebi.ac.uk/biomodels/MODEL9086628127
"""
...
class SbmlHayer2005SimpleAmparTraffModel2(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_simple_AMPAR_traff_model2."""

    def __init__(self, model_path: str = "data/MODEL9086628127.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005SimpleAmparTraffModel2Model9086628127Model = SbmlHayer2005SimpleAmparTraffModel2
