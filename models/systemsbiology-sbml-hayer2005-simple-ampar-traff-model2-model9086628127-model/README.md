# Hayer2005_simple_AMPAR_traff_model2

**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL9086628127)
**Standard**: sbml
...
models:
  - path: ../../models/systemsbiology-sbml-hayer2005-simple-ampar-traff-model2-model9086628127-model
    alias: model
```
