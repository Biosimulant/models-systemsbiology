...
"""Auto-generated SBML BioModule wrapper for Holmes2006 - Hill's model of muscle contraction.

Source: biomodels_ebi:BIOMD0000000677
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000677
"""
...
class SbmlHolmes2006HillSModelOfMuscleContraction(biosim.BioModule):
    """BioModule wrapper for SBML model: Holmes2006 - Hill's model of muscle contraction."""

    def __init__(self, model_path: str = "data/BIOMD0000000677.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Holmes2006HillSModelOfMuscleContractionBiomd0000000677Model = SbmlHolmes2006HillSModelOfMuscleContraction
