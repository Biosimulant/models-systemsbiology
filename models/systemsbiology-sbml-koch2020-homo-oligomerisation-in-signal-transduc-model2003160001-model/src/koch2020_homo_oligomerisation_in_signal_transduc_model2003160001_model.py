...
"""Auto-generated SBML BioModule wrapper for Koch2020 - Homo-Oligomerisation in Signal Transduction: Dynamics, Homeostasis, Ultrasensitivity, Bistability.

Source: biomodels_ebi:MODEL2003160001
Original: https://www.ebi.ac.uk/biomodels/MODEL2003160001
"""
...
class SbmlKoch2020HomoOligomerisationInSignalTransduction(biosim.BioModule):
    """BioModule wrapper for SBML model: Koch2020 - Homo-Oligomerisation in Signal Transduction: Dynamics, Homeostasis, Ultrasensitivity, Bistability."""

    def __init__(self, model_path: str = "data/MODEL2003160001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koch2020HomoOligomerisationInSignalTransducModel2003160001Model = SbmlKoch2020HomoOligomerisationInSignalTransduction
