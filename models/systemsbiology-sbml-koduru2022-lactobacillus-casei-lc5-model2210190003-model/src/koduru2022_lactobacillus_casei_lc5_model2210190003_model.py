...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactobacillus casei LC5.

Source: biomodels_ebi:MODEL2210190003
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190003
"""
...
class SbmlKoduru2022LactobacillusCaseiLc5(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactobacillus casei LC5."""

    def __init__(self, model_path: str = "data/MODEL2210190003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactobacillusCaseiLc5Model2210190003Model = SbmlKoduru2022LactobacillusCaseiLc5
