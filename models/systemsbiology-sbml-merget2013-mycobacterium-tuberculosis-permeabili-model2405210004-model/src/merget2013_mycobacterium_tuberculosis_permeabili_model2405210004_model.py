...
"""Auto-generated SBML BioModule wrapper for Merget2013 - Mycobacterium tuberculosis permeability prediction tool.

Source: biomodels_ebi:MODEL2405210004
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210004
"""
...
class SbmlMerget2013MycobacteriumTuberculosisPermeability(biosim.BioModule):
    """BioModule wrapper for SBML model: Merget2013 - Mycobacterium tuberculosis permeability prediction tool."""

    def __init__(self, model_path: str = "data/MODEL2405210004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Merget2013MycobacteriumTuberculosisPermeabiliModel2405210004Model = SbmlMerget2013MycobacteriumTuberculosisPermeability
