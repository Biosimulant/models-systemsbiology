...
"""Auto-generated SBML BioModule wrapper for Friedland2009_Ara_RTC3_counter.

Source: biomodels_ebi:BIOMD0000000301
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000301
"""
...
class SbmlFriedland2009AraRtc3Counter(biosim.BioModule):
    """BioModule wrapper for SBML model: Friedland2009_Ara_RTC3_counter."""

    def __init__(self, model_path: str = "data/BIOMD0000000301.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Friedland2009AraRtc3CounterBiomd0000000301Model = SbmlFriedland2009AraRtc3Counter
