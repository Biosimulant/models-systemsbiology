...
"""Auto-generated SBML BioModule wrapper for Rozi2003_GlycogenPhosphorylase_Activation.

Source: biomodels_ebi:BIOMD0000000100
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000100
"""
...
class SbmlRozi2003GlycogenphosphorylaseActivation(biosim.BioModule):
    """BioModule wrapper for SBML model: Rozi2003_GlycogenPhosphorylase_Activation."""

    def __init__(self, model_path: str = "data/BIOMD0000000100.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rozi2003GlycogenphosphorylaseActivationBiomd0000000100Model = SbmlRozi2003GlycogenphosphorylaseActivation
