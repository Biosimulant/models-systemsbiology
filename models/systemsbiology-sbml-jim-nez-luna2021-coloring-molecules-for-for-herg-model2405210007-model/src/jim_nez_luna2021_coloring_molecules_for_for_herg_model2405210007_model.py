...
"""Auto-generated SBML BioModule wrapper for Jiménez-Luna2021 - Coloring molecules for for hERG blockade.

Source: biomodels_ebi:MODEL2405210007
Original: https://www.ebi.ac.uk/biomodels/MODEL2405210007
"""
...
class SbmlJimenezLuna2021ColoringMoleculesForForHergBlockade(biosim.BioModule):
    """BioModule wrapper for SBML model: Jiménez-Luna2021 - Coloring molecules for for hERG blockade."""

    def __init__(self, model_path: str = "data/MODEL2405210007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
JimNezLuna2021ColoringMoleculesForForHergModel2405210007Model = SbmlJimenezLuna2021ColoringMoleculesForForHergBlockade
