...
"""Auto-generated SBML BioModule wrapper for Dolan2014 - calcium homeostasis (SOCE).

Source: biomodels_ebi:MODEL1405070000
Original: https://www.ebi.ac.uk/biomodels/MODEL1405070000
"""
...
class SbmlDolan2014CalciumHomeostasisSoce(biosim.BioModule):
    """BioModule wrapper for SBML model: Dolan2014 - calcium homeostasis (SOCE)."""

    def __init__(self, model_path: str = "data/MODEL1405070000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dolan2014CalciumHomeostasisSoceModel1405070000Model = SbmlDolan2014CalciumHomeostasisSoce
