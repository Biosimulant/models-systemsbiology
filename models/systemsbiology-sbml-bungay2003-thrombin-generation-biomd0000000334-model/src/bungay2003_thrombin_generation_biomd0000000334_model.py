...
"""Auto-generated SBML BioModule wrapper for Bungay2003_Thrombin_Generation.

Source: biomodels_ebi:BIOMD0000000334
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000334
"""
...
class SbmlBungay2003ThrombinGeneration(biosim.BioModule):
    """BioModule wrapper for SBML model: Bungay2003_Thrombin_Generation."""

    def __init__(self, model_path: str = "data/BIOMD0000000334.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bungay2003ThrombinGenerationBiomd0000000334Model = SbmlBungay2003ThrombinGeneration
