...
"""Auto-generated SBML BioModule wrapper for Ciliberto2005 - Steady states and oscillations in the p53/Mdm2 network.

Source: biomodels_ebi:BIOMD0000001006
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001006
"""
...
class SbmlCiliberto2005SteadyStatesAndOscillationsInTheP53(biosim.BioModule):
    """BioModule wrapper for SBML model: Ciliberto2005 - Steady states and oscillations in the p53/Mdm2 network."""

    def __init__(self, model_path: str = "data/BIOMD0000001006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ciliberto2005SteadyStatesAndOscillationsInBiomd0000001006Model = SbmlCiliberto2005SteadyStatesAndOscillationsInTheP53
