...
"""Auto-generated SBML BioModule wrapper for Nelson2000_HIV-1_intracellular_delay.

Source: biomodels_ebi:MODEL8102792069
Original: https://www.ebi.ac.uk/biomodels/MODEL8102792069
"""
...
class SbmlNelson2000Hiv1IntracellularDelay(biosim.BioModule):
    """BioModule wrapper for SBML model: Nelson2000_HIV-1_intracellular_delay."""

    def __init__(self, model_path: str = "data/MODEL8102792069.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nelson2000Hiv1IntracellularDelayModel8102792069Model = SbmlNelson2000Hiv1IntracellularDelay
