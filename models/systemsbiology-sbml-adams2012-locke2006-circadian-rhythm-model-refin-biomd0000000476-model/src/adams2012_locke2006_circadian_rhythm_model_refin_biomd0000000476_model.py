...
"""Auto-generated SBML BioModule wrapper for Adams2012 - Locke2006 Circadian Rhythm model refined with Input Signal Light Function.

Source: biomodels_ebi:BIOMD0000000476
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000476
"""
...
class SbmlAdams2012Locke2006CircadianRhythmModelRefinedWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Adams2012 - Locke2006 Circadian Rhythm model refined with Input Signal Light Function."""

    def __init__(self, model_path: str = "data/BIOMD0000000476.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Adams2012Locke2006CircadianRhythmModelRefinBiomd0000000476Model = SbmlAdams2012Locke2006CircadianRhythmModelRefinedWith
