...
"""Auto-generated SBML BioModule wrapper for Lee2010_ThrombinActivation_OneForm_minimal.

Source: biomodels_ebi:BIOMD0000000363
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000363
"""
...
class SbmlLee2010ThrombinactivationOneformMinimal(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2010_ThrombinActivation_OneForm_minimal."""

    def __init__(self, model_path: str = "data/BIOMD0000000363.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2010ThrombinactivationOneformMinimalBiomd0000000363Model = SbmlLee2010ThrombinactivationOneformMinimal
