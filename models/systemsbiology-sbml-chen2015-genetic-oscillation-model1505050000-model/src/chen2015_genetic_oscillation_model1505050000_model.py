...
"""Auto-generated SBML BioModule wrapper for Chen2015 - Genetic Oscillation.

Source: biomodels_ebi:MODEL1505050000
Original: https://www.ebi.ac.uk/biomodels/MODEL1505050000
"""
...
class SbmlChen2015GeneticOscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2015 - Genetic Oscillation."""

    def __init__(self, model_path: str = "data/MODEL1505050000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chen2015GeneticOscillationModel1505050000Model = SbmlChen2015GeneticOscillation
