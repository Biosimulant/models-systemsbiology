...
"""Auto-generated SBML BioModule wrapper for DellOrco2009_phototransduction.

Source: biomodels_ebi:BIOMD0000000326
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000326
"""
...
class SbmlDellorco2009Phototransduction(biosim.BioModule):
    """BioModule wrapper for SBML model: DellOrco2009_phototransduction."""

    def __init__(self, model_path: str = "data/BIOMD0000000326.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dellorco2009PhototransductionBiomd0000000326Model = SbmlDellorco2009Phototransduction
