...
"""Auto-generated SBML BioModule wrapper for Phillips2013 - physiologically based modeling explaining Mammalian rest/activity patterns.

Source: biomodels_ebi:BIOMD0000001072
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001072
"""
...
class SbmlPhillips2013PhysiologicallyBasedModelingExplaining(biosim.BioModule):
    """BioModule wrapper for SBML model: Phillips2013 - physiologically based modeling explaining Mammalian rest/activity patterns."""

    def __init__(self, model_path: str = "data/BIOMD0000001072.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Phillips2013PhysiologicallyBasedModelingExplBiomd0000001072Model = SbmlPhillips2013PhysiologicallyBasedModelingExplaining
