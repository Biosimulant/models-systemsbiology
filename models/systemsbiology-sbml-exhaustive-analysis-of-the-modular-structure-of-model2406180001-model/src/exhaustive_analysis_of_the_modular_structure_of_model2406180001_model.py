...
"""Auto-generated SBML BioModule wrapper for Exhaustive Analysis of the Modular Structure of the Spliceosomal Assembly Network: A Petri Net Approach.

Source: biomodels_ebi:MODEL2406180001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406180001
"""
...
class SbmlExhaustiveAnalysisOfTheModularStructureOfThe(biosim.BioModule):
    """BioModule wrapper for SBML model: Exhaustive Analysis of the Modular Structure of the Spliceosomal Assembly Network: A Petri Net Approach."""

    def __init__(self, model_path: str = "data/MODEL2406180001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ExhaustiveAnalysisOfTheModularStructureOfModel2406180001Model = SbmlExhaustiveAnalysisOfTheModularStructureOfThe
