...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-embedding: A self-supervised Graph Neural Network for molecular representation.

Source: biomodels_ebi:MODEL2406050006
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050006
"""
...
class SbmlRong2020GroverEmbeddingASelfSupervisedGraphNeural(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-embedding: A self-supervised Graph Neural Network for molecular representation."""

    def __init__(self, model_path: str = "data/MODEL2406050006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverEmbeddingASelfSupervisedGrapModel2406050006Model = SbmlRong2020GroverEmbeddingASelfSupervisedGraphNeural
