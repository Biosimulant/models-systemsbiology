...
"""Auto-generated SBML BioModule wrapper for Amstein2022 - TNFR1 Signal Transduction, Petri Net.

Source: biomodels_ebi:MODEL2210170001
Original: https://www.ebi.ac.uk/biomodels/MODEL2210170001
"""
...
class SbmlAmstein2022Tnfr1SignalTransductionPetriNet(biosim.BioModule):
    """BioModule wrapper for SBML model: Amstein2022 - TNFR1 Signal Transduction, Petri Net."""

    def __init__(self, model_path: str = "data/MODEL2210170001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Amstein2022Tnfr1SignalTransductionPetriNetModel2210170001Model = SbmlAmstein2022Tnfr1SignalTransductionPetriNet
