...
"""Auto-generated SBML BioModule wrapper for Rodriguez-Caso2006_Polyamine_Metabolism.

Source: biomodels_ebi:BIOMD0000000190
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000190
"""
...
class SbmlRodriguezCaso2006PolyamineMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Rodriguez-Caso2006_Polyamine_Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000190.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RodriguezCaso2006PolyamineMetabolismBiomd0000000190Model = SbmlRodriguezCaso2006PolyamineMetabolism
