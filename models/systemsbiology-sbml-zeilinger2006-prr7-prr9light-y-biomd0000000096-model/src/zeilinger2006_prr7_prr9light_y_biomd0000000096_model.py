...
"""Auto-generated SBML BioModule wrapper for Zeilinger2006_PRR7-PRR9light-Y.

Source: biomodels_ebi:BIOMD0000000096
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000096
"""
...
class SbmlZeilinger2006Prr7Prr9lightY(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeilinger2006_PRR7-PRR9light-Y."""

    def __init__(self, model_path: str = "data/BIOMD0000000096.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeilinger2006Prr7Prr9lightYBiomd0000000096Model = SbmlZeilinger2006Prr7Prr9lightY
