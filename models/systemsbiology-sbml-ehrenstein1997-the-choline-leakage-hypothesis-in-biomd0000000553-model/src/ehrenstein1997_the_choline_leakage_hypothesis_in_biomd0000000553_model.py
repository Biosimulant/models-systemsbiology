...
"""Auto-generated SBML BioModule wrapper for Ehrenstein1997 - The choline-leakage hypothesis in Alzheimer's disease.

Source: biomodels_ebi:BIOMD0000000553
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000553
"""
...
class SbmlEhrenstein1997TheCholineLeakageHypothesisInAlzheimer(biosim.BioModule):
    """BioModule wrapper for SBML model: Ehrenstein1997 - The choline-leakage hypothesis in Alzheimer's disease."""

    def __init__(self, model_path: str = "data/BIOMD0000000553.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ehrenstein1997TheCholineLeakageHypothesisInBiomd0000000553Model = SbmlEhrenstein1997TheCholineLeakageHypothesisInAlzheimer
