...
"""Auto-generated SBML BioModule wrapper for Chassagnole2002_Carbon_Metabolism.

Source: biomodels_ebi:BIOMD0000000051
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000051
"""
...
class SbmlChassagnole2002CarbonMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Chassagnole2002_Carbon_Metabolism."""

    def __init__(self, model_path: str = "data/BIOMD0000000051.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chassagnole2002CarbonMetabolismBiomd0000000051Model = SbmlChassagnole2002CarbonMetabolism
