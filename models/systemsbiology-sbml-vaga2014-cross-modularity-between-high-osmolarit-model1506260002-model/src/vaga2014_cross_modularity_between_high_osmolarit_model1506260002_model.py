...
"""Auto-generated SBML BioModule wrapper for Vaga2014 - Cross-modularity between high osmolarity and mating pathways - logical model.

Source: biomodels_ebi:MODEL1506260002
Original: https://www.ebi.ac.uk/biomodels/MODEL1506260002
"""
...
class SbmlVaga2014CrossModularityBetweenHighOsmolarityAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Vaga2014 - Cross-modularity between high osmolarity and mating pathways - logical model."""

    def __init__(self, model_path: str = "data/MODEL1506260002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vaga2014CrossModularityBetweenHighOsmolaritModel1506260002Model = SbmlVaga2014CrossModularityBetweenHighOsmolarityAnd
