...
"""Auto-generated SBML BioModule wrapper for Martinez-Guimera2017 - Generic negative feedback circuit (Model 4).

Source: biomodels_ebi:MODEL1710260003
Original: https://www.ebi.ac.uk/biomodels/MODEL1710260003
"""
...
class SbmlMartinezGuimera2017GenericNegativeFeedbackCircuit(biosim.BioModule):
    """BioModule wrapper for SBML model: Martinez-Guimera2017 - Generic negative feedback circuit (Model 4)."""

    def __init__(self, model_path: str = "data/MODEL1710260003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MartinezGuimera2017GenericNegativeFeedbackCModel1710260003Model = SbmlMartinezGuimera2017GenericNegativeFeedbackCircuit
