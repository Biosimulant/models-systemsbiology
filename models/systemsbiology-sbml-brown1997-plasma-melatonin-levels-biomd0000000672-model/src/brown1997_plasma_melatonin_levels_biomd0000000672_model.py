...
"""Auto-generated SBML BioModule wrapper for Brown1997 - Plasma Melatonin Levels.

Source: biomodels_ebi:BIOMD0000000672
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000672
"""
...
class SbmlBrown1997PlasmaMelatoninLevels(biosim.BioModule):
    """BioModule wrapper for SBML model: Brown1997 - Plasma Melatonin Levels."""

    def __init__(self, model_path: str = "data/BIOMD0000000672.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Brown1997PlasmaMelatoninLevelsBiomd0000000672Model = SbmlBrown1997PlasmaMelatoninLevels
