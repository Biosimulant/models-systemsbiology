...
"""Auto-generated SBML BioModule wrapper for FelixGarza2017 - Blue Light Treatment of Psoriasis (simplified).

Source: biomodels_ebi:BIOMD0000000695
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000695
"""
...
class SbmlFelixgarza2017BlueLightTreatmentOfPsoriasisSimplified(biosim.BioModule):
    """BioModule wrapper for SBML model: FelixGarza2017 - Blue Light Treatment of Psoriasis (simplified)."""

    def __init__(self, model_path: str = "data/BIOMD0000000695.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Felixgarza2017BlueLightTreatmentOfPsoriasisBiomd0000000695Model = SbmlFelixgarza2017BlueLightTreatmentOfPsoriasisSimplified
