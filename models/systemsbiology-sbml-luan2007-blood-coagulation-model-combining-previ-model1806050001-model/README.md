...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1806050001)
**Standard**: sbml
...
models:
  - path: ../../models/systemsbiology-sbml-luan2007-blood-coagulation-model-combining-previ-model1806050001-model
    alias: model
```
