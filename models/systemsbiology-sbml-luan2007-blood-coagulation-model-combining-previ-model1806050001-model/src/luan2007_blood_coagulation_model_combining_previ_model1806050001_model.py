...
"""Auto-generated SBML BioModule wrapper for Luan2007 - Blood coagulation model combining previous models and platelet activation.

Source: biomodels_ebi:MODEL1806050001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806050001
"""
...
class SbmlLuan2007BloodCoagulationModelCombiningPreviousModels(biosim.BioModule):
    """BioModule wrapper for SBML model: Luan2007 - Blood coagulation model combining previous models and platelet activation."""

    def __init__(self, model_path: str = "data/MODEL1806050001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luan2007BloodCoagulationModelCombiningPreviModel1806050001Model = SbmlLuan2007BloodCoagulationModelCombiningPreviousModels
