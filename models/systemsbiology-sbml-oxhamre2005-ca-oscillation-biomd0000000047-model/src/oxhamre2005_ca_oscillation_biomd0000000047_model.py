...
"""Auto-generated SBML BioModule wrapper for Oxhamre2005_Ca_oscillation.

Source: biomodels_ebi:BIOMD0000000047
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000047
"""
...
class SbmlOxhamre2005CaOscillation(biosim.BioModule):
    """BioModule wrapper for SBML model: Oxhamre2005_Ca_oscillation."""

    def __init__(self, model_path: str = "data/BIOMD0000000047.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Oxhamre2005CaOscillationBiomd0000000047Model = SbmlOxhamre2005CaOscillation
