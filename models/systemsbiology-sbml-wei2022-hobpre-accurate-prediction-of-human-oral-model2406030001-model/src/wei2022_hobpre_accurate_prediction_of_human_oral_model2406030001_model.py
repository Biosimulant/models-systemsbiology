...
"""Auto-generated SBML BioModule wrapper for Wei2022 - HobPre: accurate prediction of human oral bioavailability for small molecules.

Source: biomodels_ebi:MODEL2406030001
Original: https://www.ebi.ac.uk/biomodels/MODEL2406030001
"""
...
class SbmlWei2022HobpreAccuratePredictionOfHumanOral(biosim.BioModule):
    """BioModule wrapper for SBML model: Wei2022 - HobPre: accurate prediction of human oral bioavailability for small molecules."""

    def __init__(self, model_path: str = "data/MODEL2406030001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wei2022HobpreAccuratePredictionOfHumanOralModel2406030001Model = SbmlWei2022HobpreAccuratePredictionOfHumanOral
