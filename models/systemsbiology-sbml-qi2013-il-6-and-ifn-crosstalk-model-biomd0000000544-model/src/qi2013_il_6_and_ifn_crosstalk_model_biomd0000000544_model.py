...
"""Auto-generated SBML BioModule wrapper for Qi2013 - IL-6 and IFN crosstalk model.

Source: biomodels_ebi:BIOMD0000000544
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000544
"""
...
class SbmlQi2013Il6AndIfnCrosstalkModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Qi2013 - IL-6 and IFN crosstalk model."""

    def __init__(self, model_path: str = "data/BIOMD0000000544.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qi2013Il6AndIfnCrosstalkModelBiomd0000000544Model = SbmlQi2013Il6AndIfnCrosstalkModel
