...
"""Auto-generated SBML BioModule wrapper for Dokos1996_SinoatrialNode.

Source: biomodels_ebi:MODEL0912503622
Original: https://www.ebi.ac.uk/biomodels/MODEL0912503622
"""
...
class SbmlDokos1996Sinoatrialnode(biosim.BioModule):
    """BioModule wrapper for SBML model: Dokos1996_SinoatrialNode."""

    def __init__(self, model_path: str = "data/MODEL0912503622.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Dokos1996SinoatrialnodeModel0912503622Model = SbmlDokos1996Sinoatrialnode
