...
"""Auto-generated SBML BioModule wrapper for Wodarz2007 - Basic Model of Cytomegalovirus Infection.

Source: biomodels_ebi:BIOMD0000000686
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000686
"""
...
class SbmlWodarz2007BasicModelOfCytomegalovirusInfection(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2007 - Basic Model of Cytomegalovirus Infection."""

    def __init__(self, model_path: str = "data/BIOMD0000000686.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2007BasicModelOfCytomegalovirusInfectBiomd0000000686Model = SbmlWodarz2007BasicModelOfCytomegalovirusInfection
