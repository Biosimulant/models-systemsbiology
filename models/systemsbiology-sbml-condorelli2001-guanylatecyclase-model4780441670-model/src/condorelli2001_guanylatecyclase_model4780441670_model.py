...
"""Auto-generated SBML BioModule wrapper for Condorelli2001_GuanylateCyclase.

Source: biomodels_ebi:MODEL4780441670
Original: https://www.ebi.ac.uk/biomodels/MODEL4780441670
"""
...
class SbmlCondorelli2001Guanylatecyclase(biosim.BioModule):
    """BioModule wrapper for SBML model: Condorelli2001_GuanylateCyclase."""

    def __init__(self, model_path: str = "data/MODEL4780441670.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Condorelli2001GuanylatecyclaseModel4780441670Model = SbmlCondorelli2001Guanylatecyclase
