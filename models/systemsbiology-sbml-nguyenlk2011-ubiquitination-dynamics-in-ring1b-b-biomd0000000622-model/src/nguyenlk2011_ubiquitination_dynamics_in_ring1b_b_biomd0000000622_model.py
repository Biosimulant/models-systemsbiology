...
"""Auto-generated SBML BioModule wrapper for NguyenLK2011 - Ubiquitination dynamics in Ring1B/Bmi1 system.

Source: biomodels_ebi:BIOMD0000000622
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000622
"""
...
class SbmlNguyenlk2011UbiquitinationDynamicsInRing1bBmi1System(biosim.BioModule):
    """BioModule wrapper for SBML model: NguyenLK2011 - Ubiquitination dynamics in Ring1B/Bmi1 system."""

    def __init__(self, model_path: str = "data/BIOMD0000000622.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nguyenlk2011UbiquitinationDynamicsInRing1bBBiomd0000000622Model = SbmlNguyenlk2011UbiquitinationDynamicsInRing1bBmi1System
