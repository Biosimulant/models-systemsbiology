...
"""Auto-generated SBML BioModule wrapper for Ayati2010_BoneRemodelingDynamics_WithTumour+DrugTreatment.

Source: biomodels_ebi:BIOMD0000000403
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000403
"""
...
class SbmlAyati2010BoneremodelingdynamicsWithtumourDrugtreatment(biosim.BioModule):
    """BioModule wrapper for SBML model: Ayati2010_BoneRemodelingDynamics_WithTumour+DrugTreatment."""

    def __init__(self, model_path: str = "data/BIOMD0000000403.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ayati2010BoneremodelingdynamicsWithtumourDrugBiomd0000000403Model = SbmlAyati2010BoneremodelingdynamicsWithtumourDrugtreatment
