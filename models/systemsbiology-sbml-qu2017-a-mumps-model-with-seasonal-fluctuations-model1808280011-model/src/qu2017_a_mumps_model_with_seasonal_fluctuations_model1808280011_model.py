...
"""Auto-generated SBML BioModule wrapper for Qu2017 - A mumps model with seasonal fluctuations in China.

Source: biomodels_ebi:MODEL1808280011
Original: https://www.ebi.ac.uk/biomodels/MODEL1808280011
"""
...
class SbmlQu2017AMumpsModelWithSeasonalFluctuationsInChina(biosim.BioModule):
    """BioModule wrapper for SBML model: Qu2017 - A mumps model with seasonal fluctuations in China."""

    def __init__(self, model_path: str = "data/MODEL1808280011.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Qu2017AMumpsModelWithSeasonalFluctuationsModel1808280011Model = SbmlQu2017AMumpsModelWithSeasonalFluctuationsInChina
