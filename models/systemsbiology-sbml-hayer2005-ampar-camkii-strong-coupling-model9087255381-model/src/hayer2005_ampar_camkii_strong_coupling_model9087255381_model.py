...
"""Auto-generated SBML BioModule wrapper for Hayer2005_AMPAR_CaMKII_strong_coupling.

Source: biomodels_ebi:MODEL9087255381
Original: https://www.ebi.ac.uk/biomodels/MODEL9087255381
"""
...
class SbmlHayer2005AmparCamkiiStrongCoupling(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_AMPAR_CaMKII_strong_coupling."""

    def __init__(self, model_path: str = "data/MODEL9087255381.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005AmparCamkiiStrongCouplingModel9087255381Model = SbmlHayer2005AmparCamkiiStrongCoupling
