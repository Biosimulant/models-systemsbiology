...
"""Auto-generated SBML BioModule wrapper for Barr2017 - Dynamics of p21 in hTert-RPE1 cells.

Source: biomodels_ebi:BIOMD0000000660
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000660
"""
...
class SbmlBarr2017DynamicsOfP21InHtertRpe1Cells(bsim.BioModule):
    """BioModule wrapper for SBML model: Barr2017 - Dynamics of p21 in hTert-RPE1 cells."""

    def __init__(self, model_path: str = "data/BIOMD0000000660.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Barr2017DynamicsOfP21InHtertRpe1CellsBiomd0000000660Model = SbmlBarr2017DynamicsOfP21InHtertRpe1Cells
