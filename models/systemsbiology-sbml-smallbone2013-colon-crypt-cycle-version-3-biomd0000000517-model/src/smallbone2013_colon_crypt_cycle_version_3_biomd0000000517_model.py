...
"""Auto-generated SBML BioModule wrapper for Smallbone2013 - Colon Crypt cycle - Version 3.

Source: biomodels_ebi:BIOMD0000000517
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000517
"""
...
class SbmlSmallbone2013ColonCryptCycleVersion3(biosim.BioModule):
    """BioModule wrapper for SBML model: Smallbone2013 - Colon Crypt cycle - Version 3."""

    def __init__(self, model_path: str = "data/BIOMD0000000517.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Smallbone2013ColonCryptCycleVersion3Biomd0000000517Model = SbmlSmallbone2013ColonCryptCycleVersion3
