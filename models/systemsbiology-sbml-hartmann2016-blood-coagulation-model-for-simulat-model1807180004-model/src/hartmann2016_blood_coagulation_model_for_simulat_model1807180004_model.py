...
"""Auto-generated SBML BioModule wrapper for Hartmann2016 - Blood coagulation model for simulating anticoagulants.

Source: biomodels_ebi:MODEL1807180004
Original: https://www.ebi.ac.uk/biomodels/MODEL1807180004
"""
...
class SbmlHartmann2016BloodCoagulationModelForSimulating(biosim.BioModule):
    """BioModule wrapper for SBML model: Hartmann2016 - Blood coagulation model for simulating anticoagulants."""

    def __init__(self, model_path: str = "data/MODEL1807180004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hartmann2016BloodCoagulationModelForSimulatModel1807180004Model = SbmlHartmann2016BloodCoagulationModelForSimulating
