...
"""Auto-generated SBML BioModule wrapper for Shao2022 - Predicting HepG2 toxicity using the S2DV technique.

Source: biomodels_ebi:MODEL2408070003
Original: https://www.ebi.ac.uk/biomodels/MODEL2408070003
"""
...
class SbmlShao2022PredictingHepg2ToxicityUsingTheS2dvTechnique(biosim.BioModule):
    """BioModule wrapper for SBML model: Shao2022 - Predicting HepG2 toxicity using the S2DV technique."""

    def __init__(self, model_path: str = "data/MODEL2408070003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Shao2022PredictingHepg2ToxicityUsingTheS2dModel2408070003Model = SbmlShao2022PredictingHepg2ToxicityUsingTheS2dvTechnique
