...
"""Auto-generated SBML BioModule wrapper for Albert2005_Glycolysis.

Source: biomodels_ebi:BIOMD0000000211
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000211
"""
...
class SbmlAlbert2005Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Albert2005_Glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000211.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Albert2005GlycolysisBiomd0000000211Model = SbmlAlbert2005Glycolysis
