...
"""Auto-generated SBML BioModule wrapper for Heldt2019 - Chlamydomonas multiple-fission cycles.

Source: biomodels_ebi:MODEL1904020001
Original: https://www.ebi.ac.uk/biomodels/MODEL1904020001
"""
...
class SbmlHeldt2019ChlamydomonasMultipleFissionCycles(biosim.BioModule):
    """BioModule wrapper for SBML model: Heldt2019 - Chlamydomonas multiple-fission cycles."""

    def __init__(self, model_path: str = "data/MODEL1904020001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Heldt2019ChlamydomonasMultipleFissionCyclesModel1904020001Model = SbmlHeldt2019ChlamydomonasMultipleFissionCycles
