...
"""Auto-generated SBML BioModule wrapper for Tang2010_PolyGlutamate.

Source: biomodels_ebi:BIOMD0000000285
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000285
"""
...
class SbmlTang2010Polyglutamate(biosim.BioModule):
    """BioModule wrapper for SBML model: Tang2010_PolyGlutamate."""

    def __init__(self, model_path: str = "data/BIOMD0000000285.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tang2010PolyglutamateBiomd0000000285Model = SbmlTang2010Polyglutamate
