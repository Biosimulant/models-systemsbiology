...
"""Auto-generated SBML BioModule wrapper for Wodarz2007 - Cytomegalovirus infection model with cytotoxic T lymphocyte and natural killer cell response.

Source: biomodels_ebi:BIOMD0000000688
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000688
"""
...
class SbmlWodarz2007CytomegalovirusInfectionModelWithCytotoxicT2(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz2007 - Cytomegalovirus infection model with cytotoxic T lymphocyte and natural killer cell response."""

    def __init__(self, model_path: str = "data/BIOMD0000000688.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz2007CytomegalovirusInfectionModelWithBiomd0000000688Model = SbmlWodarz2007CytomegalovirusInfectionModelWithCytotoxicT2
