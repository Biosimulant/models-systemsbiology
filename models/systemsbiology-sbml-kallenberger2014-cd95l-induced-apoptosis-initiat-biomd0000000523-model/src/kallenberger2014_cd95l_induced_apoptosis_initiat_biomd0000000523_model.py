...
"""Auto-generated SBML BioModule wrapper for Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, CD95 HeLa cells (cis/trans variant).

Source: biomodels_ebi:BIOMD0000000523
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000523
"""
...
class SbmlKallenberger2014Cd95lInducedApoptosisInitiatedBy(biosim.BioModule):
    """BioModule wrapper for SBML model: Kallenberger2014 - CD95L induced apoptosis initiated by caspase-8, CD95 HeLa cells (cis/trans variant)."""

    def __init__(self, model_path: str = "data/BIOMD0000000523.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kallenberger2014Cd95lInducedApoptosisInitiatBiomd0000000523Model = SbmlKallenberger2014Cd95lInducedApoptosisInitiatedBy
