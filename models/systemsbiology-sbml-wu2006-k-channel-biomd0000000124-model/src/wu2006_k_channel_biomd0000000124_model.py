...
"""Auto-generated SBML BioModule wrapper for Wu2006_K+Channel.

Source: biomodels_ebi:BIOMD0000000124
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000124
"""
...
class SbmlWu2006KChannel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wu2006_K+Channel."""

    def __init__(self, model_path: str = "data/BIOMD0000000124.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wu2006KChannelBiomd0000000124Model = SbmlWu2006KChannel
