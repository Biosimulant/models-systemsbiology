...
"""Auto-generated SBML BioModule wrapper for Maltsev2009_PacemakerCellModel_SteadyState.

Source: biomodels_ebi:MODEL1006230104
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230104
"""
...
class SbmlMaltsev2009PacemakercellmodelSteadystate(biosim.BioModule):
    """BioModule wrapper for SBML model: Maltsev2009_PacemakerCellModel_SteadyState."""

    def __init__(self, model_path: str = "data/MODEL1006230104.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Maltsev2009PacemakercellmodelSteadystateModel1006230104Model = SbmlMaltsev2009PacemakercellmodelSteadystate
