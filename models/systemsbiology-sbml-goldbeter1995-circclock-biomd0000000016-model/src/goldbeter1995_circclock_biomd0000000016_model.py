...
"""Auto-generated SBML BioModule wrapper for Goldbeter1995_CircClock.

Source: biomodels_ebi:BIOMD0000000016
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000016
"""
...
class SbmlGoldbeter1995Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Goldbeter1995_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000016.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Goldbeter1995CircclockBiomd0000000016Model = SbmlGoldbeter1995Circclock
