...
"""Auto-generated SBML BioModule wrapper for Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions.

Source: biomodels_ebi:BIOMD0000000643
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000643
"""
...
class SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp(biosim.BioModule):
    """BioModule wrapper for SBML model: Musante2017 - Switching behaviour of PP2A inhibition by ARPP-16 - mutual inhibitions."""

    def __init__(self, model_path: str = "data/BIOMD0000000643.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Musante2017SwitchingBehaviourOfPp2aInhibitiBiomd0000000643Model = SbmlMusante2017SwitchingBehaviourOfPp2aInhibitionByArpp
