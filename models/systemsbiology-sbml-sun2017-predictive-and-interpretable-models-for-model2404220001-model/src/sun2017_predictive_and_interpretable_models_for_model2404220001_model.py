...
"""Auto-generated SBML BioModule wrapper for Sun2017 - predictive and interpretable models for PAMPA permeability 7.

Source: biomodels_ebi:MODEL2404220001
Original: https://www.ebi.ac.uk/biomodels/MODEL2404220001
"""
...
class SbmlSun2017PredictiveAndInterpretableModelsForPampa(biosim.BioModule):
    """BioModule wrapper for SBML model: Sun2017 - predictive and interpretable models for PAMPA permeability 7."""

    def __init__(self, model_path: str = "data/MODEL2404220001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sun2017PredictiveAndInterpretableModelsForModel2404220001Model = SbmlSun2017PredictiveAndInterpretableModelsForPampa
