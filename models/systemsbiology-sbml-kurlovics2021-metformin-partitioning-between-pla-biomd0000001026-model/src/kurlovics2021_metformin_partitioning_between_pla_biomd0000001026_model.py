...
"""Auto-generated SBML BioModule wrapper for Kurlovics2021 - Metformin partitioning between plasma and RBC with independent Kin and Kout coefficients.

Source: biomodels_ebi:BIOMD0000001026
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001026
"""
...
class SbmlKurlovics2021MetforminPartitioningBetweenPlasmaAndRbc(biosim.BioModule):
    """BioModule wrapper for SBML model: Kurlovics2021 - Metformin partitioning between plasma and RBC with independent Kin and Kout coefficients."""

    def __init__(self, model_path: str = "data/BIOMD0000001026.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kurlovics2021MetforminPartitioningBetweenPlaBiomd0000001026Model = SbmlKurlovics2021MetforminPartitioningBetweenPlasmaAndRbc
