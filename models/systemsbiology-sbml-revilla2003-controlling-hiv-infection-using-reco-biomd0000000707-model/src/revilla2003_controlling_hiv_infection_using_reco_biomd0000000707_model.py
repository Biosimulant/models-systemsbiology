...
"""Auto-generated SBML BioModule wrapper for Revilla2003 - Controlling HIV infection using recombinant viruses.

Source: biomodels_ebi:BIOMD0000000707
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000707
"""
...
class SbmlRevilla2003ControllingHivInfectionUsingRecombinant(biosim.BioModule):
    """BioModule wrapper for SBML model: Revilla2003 - Controlling HIV infection using recombinant viruses."""

    def __init__(self, model_path: str = "data/BIOMD0000000707.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Revilla2003ControllingHivInfectionUsingRecoBiomd0000000707Model = SbmlRevilla2003ControllingHivInfectionUsingRecombinant
