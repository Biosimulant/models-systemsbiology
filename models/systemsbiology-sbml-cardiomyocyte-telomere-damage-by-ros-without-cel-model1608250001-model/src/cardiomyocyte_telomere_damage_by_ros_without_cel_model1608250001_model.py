...
"""Auto-generated SBML BioModule wrapper for Cardiomyocyte Telomere Damage by ROS without Cell Division.

Source: biomodels_ebi:MODEL1608250001
Original: https://www.ebi.ac.uk/biomodels/MODEL1608250001
"""
...
class SbmlCardiomyocyteTelomereDamageByRosWithoutCellDivision(biosim.BioModule):
    """BioModule wrapper for SBML model: Cardiomyocyte Telomere Damage by ROS without Cell Division."""

    def __init__(self, model_path: str = "data/MODEL1608250001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
CardiomyocyteTelomereDamageByRosWithoutCelModel1608250001Model = SbmlCardiomyocyteTelomereDamageByRosWithoutCellDivision
