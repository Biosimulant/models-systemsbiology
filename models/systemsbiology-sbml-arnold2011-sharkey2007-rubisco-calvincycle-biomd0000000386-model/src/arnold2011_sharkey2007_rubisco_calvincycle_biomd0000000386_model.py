...
"""Auto-generated SBML BioModule wrapper for Arnold2011_Sharkey2007_RuBisCO-CalvinCycle.

Source: biomodels_ebi:BIOMD0000000386
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000386
"""
...
class SbmlArnold2011Sharkey2007RubiscoCalvincycle(biosim.BioModule):
    """BioModule wrapper for SBML model: Arnold2011_Sharkey2007_RuBisCO-CalvinCycle."""

    def __init__(self, model_path: str = "data/BIOMD0000000386.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Arnold2011Sharkey2007RubiscoCalvincycleBiomd0000000386Model = SbmlArnold2011Sharkey2007RubiscoCalvincycle
