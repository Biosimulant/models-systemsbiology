...
"""Auto-generated SBML BioModule wrapper for Bartholome2007_MDCKII.

Source: biomodels_ebi:BIOMD0000000197
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000197
"""
...
class SbmlBartholome2007Mdckii(biosim.BioModule):
    """BioModule wrapper for SBML model: Bartholome2007_MDCKII."""

    def __init__(self, model_path: str = "data/BIOMD0000000197.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bartholome2007MdckiiBiomd0000000197Model = SbmlBartholome2007Mdckii
