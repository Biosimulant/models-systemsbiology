...
"""Auto-generated SBML BioModule wrapper for Mears1997_CRAC_PancreaticBetaCells.

Source: biomodels_ebi:BIOMD0000000375
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000375
"""
...
class SbmlMears1997CracPancreaticbetacells(biosim.BioModule):
    """BioModule wrapper for SBML model: Mears1997_CRAC_PancreaticBetaCells."""

    def __init__(self, model_path: str = "data/BIOMD0000000375.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mears1997CracPancreaticbetacellsBiomd0000000375Model = SbmlMears1997CracPancreaticbetacells
