...
"""Auto-generated SBML BioModule wrapper for ChenXF2008_CICR.

Source: biomodels_ebi:BIOMD0000000202
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000202
"""
...
class SbmlChenxf2008Cicr(biosim.BioModule):
    """BioModule wrapper for SBML model: ChenXF2008_CICR."""

    def __init__(self, model_path: str = "data/BIOMD0000000202.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Chenxf2008CicrBiomd0000000202Model = SbmlChenxf2008Cicr
