...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_GSpar-8mMCD).

Source: biomodels_ebi:MODEL1907260009
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260009
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoGspar8mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_GSpar-8mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoGModel1907260009Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoGspar8mmcd
