...
"""Auto-generated SBML BioModule wrapper for Cronwright2002_Glycerol_Synthesis.

Source: biomodels_ebi:BIOMD0000000076
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000076
"""
...
class SbmlCronwright2002GlycerolSynthesis(biosim.BioModule):
    """BioModule wrapper for SBML model: Cronwright2002_Glycerol_Synthesis."""

    def __init__(self, model_path: str = "data/BIOMD0000000076.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Cronwright2002GlycerolSynthesisBiomd0000000076Model = SbmlCronwright2002GlycerolSynthesis
