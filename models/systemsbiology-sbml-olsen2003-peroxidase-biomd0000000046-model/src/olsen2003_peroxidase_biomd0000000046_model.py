...
"""Auto-generated SBML BioModule wrapper for Olsen2003_peroxidase.

Source: biomodels_ebi:BIOMD0000000046
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000046
"""
...
class SbmlOlsen2003Peroxidase(biosim.BioModule):
    """BioModule wrapper for SBML model: Olsen2003_peroxidase."""

    def __init__(self, model_path: str = "data/BIOMD0000000046.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Olsen2003PeroxidaseBiomd0000000046Model = SbmlOlsen2003Peroxidase
