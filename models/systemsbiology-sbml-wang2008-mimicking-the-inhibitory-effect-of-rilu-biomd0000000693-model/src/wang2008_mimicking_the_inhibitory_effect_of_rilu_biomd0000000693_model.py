...
"""Auto-generated SBML BioModule wrapper for Wang2008 - Mimicking the inhibitory effect of riluzole on membrane conductance in skeletal fibres.

Source: biomodels_ebi:BIOMD0000000693
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000693
"""
...
class SbmlWang2008MimickingTheInhibitoryEffectOfRiluzoleOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2008 - Mimicking the inhibitory effect of riluzole on membrane conductance in skeletal fibres."""

    def __init__(self, model_path: str = "data/BIOMD0000000693.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang2008MimickingTheInhibitoryEffectOfRiluBiomd0000000693Model = SbmlWang2008MimickingTheInhibitoryEffectOfRiluzoleOn
