...
"""Auto-generated SBML BioModule wrapper for Jenior2021 - Clostridium difficile 630 model.

Source: biomodels_ebi:MODEL2205060002
Original: https://www.ebi.ac.uk/biomodels/MODEL2205060002
"""
...
class SbmlJenior2021ClostridiumDifficile630Model(biosim.BioModule):
    """BioModule wrapper for SBML model: Jenior2021 - Clostridium difficile 630 model."""

    def __init__(self, model_path: str = "data/MODEL2205060002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Jenior2021ClostridiumDifficile630ModelModel2205060002Model = SbmlJenior2021ClostridiumDifficile630Model
