...
"""Auto-generated SBML BioModule wrapper for Guisoni2016 - Cis-regulatory system (CRS) can drive sustained oscillations.

Source: biomodels_ebi:MODEL1611030000
Original: https://www.ebi.ac.uk/biomodels/MODEL1611030000
"""
...
class SbmlGuisoni2016CisRegulatorySystemCrsCanDriveSustained(biosim.BioModule):
    """BioModule wrapper for SBML model: Guisoni2016 - Cis-regulatory system (CRS) can drive sustained oscillations."""

    def __init__(self, model_path: str = "data/MODEL1611030000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Guisoni2016CisRegulatorySystemCrsCanDriveModel1611030000Model = SbmlGuisoni2016CisRegulatorySystemCrsCanDriveSustained
