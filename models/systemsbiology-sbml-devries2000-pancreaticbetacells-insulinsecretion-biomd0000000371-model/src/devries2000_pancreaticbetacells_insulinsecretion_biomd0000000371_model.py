...
"""Auto-generated SBML BioModule wrapper for DeVries2000_PancreaticBetaCells_InsulinSecretion.

Source: biomodels_ebi:BIOMD0000000371
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000371
"""
...
class SbmlDevries2000PancreaticbetacellsInsulinsecretion(biosim.BioModule):
    """BioModule wrapper for SBML model: DeVries2000_PancreaticBetaCells_InsulinSecretion."""

    def __init__(self, model_path: str = "data/BIOMD0000000371.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Devries2000PancreaticbetacellsInsulinsecretionBiomd0000000371Model = SbmlDevries2000PancreaticbetacellsInsulinsecretion
