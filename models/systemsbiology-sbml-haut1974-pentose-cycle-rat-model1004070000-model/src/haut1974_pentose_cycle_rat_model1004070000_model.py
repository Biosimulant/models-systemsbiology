...
"""Auto-generated SBML BioModule wrapper for Haut1974_Pentose_Cycle_Rat.

Source: biomodels_ebi:MODEL1004070000
Original: https://www.ebi.ac.uk/biomodels/MODEL1004070000
"""
...
class SbmlHaut1974PentoseCycleRat(biosim.BioModule):
    """BioModule wrapper for SBML model: Haut1974_Pentose_Cycle_Rat."""

    def __init__(self, model_path: str = "data/MODEL1004070000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Haut1974PentoseCycleRatModel1004070000Model = SbmlHaut1974PentoseCycleRat
