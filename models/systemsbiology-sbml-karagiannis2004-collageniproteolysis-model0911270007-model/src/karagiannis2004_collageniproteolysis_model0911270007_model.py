...
"""Auto-generated SBML BioModule wrapper for Karagiannis2004_CollagenIproteolysis.

Source: biomodels_ebi:MODEL0911270007
Original: https://www.ebi.ac.uk/biomodels/MODEL0911270007
"""
...
class SbmlKaragiannis2004Collageniproteolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Karagiannis2004_CollagenIproteolysis."""

    def __init__(self, model_path: str = "data/MODEL0911270007.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karagiannis2004CollageniproteolysisModel0911270007Model = SbmlKaragiannis2004Collageniproteolysis
