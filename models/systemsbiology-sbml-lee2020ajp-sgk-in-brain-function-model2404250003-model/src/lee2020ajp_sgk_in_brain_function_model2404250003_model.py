...
"""Auto-generated SBML BioModule wrapper for Lee2020AJP-SGK in brain function.

Source: biomodels_ebi:MODEL2404250003
Original: https://www.ebi.ac.uk/biomodels/MODEL2404250003
"""
...
class SbmlLee2020ajpSgkInBrainFunction(biosim.BioModule):
    """BioModule wrapper for SBML model: Lee2020AJP-SGK in brain function."""

    def __init__(self, model_path: str = "data/MODEL2404250003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Lee2020ajpSgkInBrainFunctionModel2404250003Model = SbmlLee2020ajpSgkInBrainFunction
