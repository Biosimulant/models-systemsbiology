...
"""Auto-generated SBML BioModule wrapper for Bertram2000_PancreaticBetaCells_Oscillations.

Source: biomodels_ebi:BIOMD0000000377
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000377
"""
...
class SbmlBertram2000PancreaticbetacellsOscillations(biosim.BioModule):
    """BioModule wrapper for SBML model: Bertram2000_PancreaticBetaCells_Oscillations."""

    def __init__(self, model_path: str = "data/BIOMD0000000377.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bertram2000PancreaticbetacellsOscillationsBiomd0000000377Model = SbmlBertram2000PancreaticbetacellsOscillations
