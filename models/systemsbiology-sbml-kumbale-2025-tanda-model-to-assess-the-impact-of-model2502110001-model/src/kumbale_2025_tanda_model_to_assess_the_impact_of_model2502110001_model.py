...
"""Auto-generated SBML BioModule wrapper for Kumbale 2025 - T&A Model to Assess the Impact of Dioxin on Cholesterol and Steroidogenesis.

Source: biomodels_ebi:MODEL2502110001
Original: https://www.ebi.ac.uk/biomodels/MODEL2502110001
"""
...
class SbmlKumbale2025TAModelToAssessTheImpactOfDioxinOn(biosim.BioModule):
    """BioModule wrapper for SBML model: Kumbale 2025 - T&A Model to Assess the Impact of Dioxin on Cholesterol and Steroidogenesis."""

    def __init__(self, model_path: str = "data/MODEL2502110001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kumbale2025TandaModelToAssessTheImpactOfModel2502110001Model = SbmlKumbale2025TAModelToAssessTheImpactOfDioxinOn
