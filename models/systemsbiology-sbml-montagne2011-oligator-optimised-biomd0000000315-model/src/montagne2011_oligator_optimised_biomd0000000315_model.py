...
"""Auto-generated SBML BioModule wrapper for Montagne2011_Oligator_optimised.

Source: biomodels_ebi:BIOMD0000000315
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000315
"""
...
class SbmlMontagne2011OligatorOptimised(biosim.BioModule):
    """BioModule wrapper for SBML model: Montagne2011_Oligator_optimised."""

    def __init__(self, model_path: str = "data/BIOMD0000000315.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Montagne2011OligatorOptimisedBiomd0000000315Model = SbmlMontagne2011OligatorOptimised
