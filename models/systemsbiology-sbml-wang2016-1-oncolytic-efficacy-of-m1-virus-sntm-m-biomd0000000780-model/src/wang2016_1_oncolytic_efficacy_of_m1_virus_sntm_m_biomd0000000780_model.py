...
"""Auto-generated SBML BioModule wrapper for Wang2016/1 - oncolytic efficacy of M1 virus-SNTM model.

Source: biomodels_ebi:BIOMD0000000780
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000780
"""
...
class SbmlWang20161OncolyticEfficacyOfM1VirusSntmModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Wang2016/1 - oncolytic efficacy of M1 virus-SNTM model."""

    def __init__(self, model_path: str = "data/BIOMD0000000780.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wang20161OncolyticEfficacyOfM1VirusSntmMBiomd0000000780Model = SbmlWang20161OncolyticEfficacyOfM1VirusSntmModel
