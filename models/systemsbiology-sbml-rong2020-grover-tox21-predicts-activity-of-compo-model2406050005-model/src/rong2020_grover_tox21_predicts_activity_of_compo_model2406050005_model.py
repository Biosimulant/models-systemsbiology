...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-tox21: Predicts activity of compounds accross the Tox21 panel..

Source: biomodels_ebi:MODEL2406050005
Original: https://www.ebi.ac.uk/biomodels/MODEL2406050005
"""
...
class SbmlRong2020GroverTox21PredictsActivityOfCompounds(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-tox21: Predicts activity of compounds accross the Tox21 panel.."""

    def __init__(self, model_path: str = "data/MODEL2406050005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverTox21PredictsActivityOfCompoModel2406050005Model = SbmlRong2020GroverTox21PredictsActivityOfCompounds
