...
"""Auto-generated SBML BioModule wrapper for Karim2021 - CardioTox net: Ligand-based prediction of hERG blockade.

Source: biomodels_ebi:MODEL2407180003
Original: https://www.ebi.ac.uk/biomodels/MODEL2407180003
"""
...
class SbmlKarim2021CardiotoxNetLigandBasedPredictionOfHerg(biosim.BioModule):
    """BioModule wrapper for SBML model: Karim2021 - CardioTox net: Ligand-based prediction of hERG blockade."""

    def __init__(self, model_path: str = "data/MODEL2407180003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Karim2021CardiotoxNetLigandBasedPredictionModel2407180003Model = SbmlKarim2021CardiotoxNetLigandBasedPredictionOfHerg
