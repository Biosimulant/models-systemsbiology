...
"""Auto-generated SBML BioModule wrapper for Potassium balance in lactating and non-lactating dairy cows.

Source: biomodels_ebi:BIOMD0000000849
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000849
"""
...
class SbmlPotassiumBalanceInLactatingAndNonLactatingDairyCows(biosim.BioModule):
    """BioModule wrapper for SBML model: Potassium balance in lactating and non-lactating dairy cows."""

    def __init__(self, model_path: str = "data/BIOMD0000000849.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PotassiumBalanceInLactatingAndNonLactatingBiomd0000000849Model = SbmlPotassiumBalanceInLactatingAndNonLactatingDairyCows
