...
"""Auto-generated SBML BioModule wrapper for Zeilinger2006_PRR7-PRR9-Y.

Source: biomodels_ebi:BIOMD0000000095
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000095
"""
...
class SbmlZeilinger2006Prr7Prr9Y(biosim.BioModule):
    """BioModule wrapper for SBML model: Zeilinger2006_PRR7-PRR9-Y."""

    def __init__(self, model_path: str = "data/BIOMD0000000095.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zeilinger2006Prr7Prr9YBiomd0000000095Model = SbmlZeilinger2006Prr7Prr9Y
