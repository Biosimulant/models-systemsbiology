...
"""Auto-generated SBML BioModule wrapper for Leloup1999_CircClock.

Source: biomodels_ebi:BIOMD0000000021
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000021
"""
...
class SbmlLeloup1999Circclock(biosim.BioModule):
    """BioModule wrapper for SBML model: Leloup1999_CircClock."""

    def __init__(self, model_path: str = "data/BIOMD0000000021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Leloup1999CircclockBiomd0000000021Model = SbmlLeloup1999Circclock
