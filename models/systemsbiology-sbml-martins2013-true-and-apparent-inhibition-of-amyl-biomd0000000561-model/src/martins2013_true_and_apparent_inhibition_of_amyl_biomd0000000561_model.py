...
"""Auto-generated SBML BioModule wrapper for Martins2013 - True and apparent inhibition of amyloid fribril formation.

Source: biomodels_ebi:BIOMD0000000561
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000561
"""
...
class SbmlMartins2013TrueAndApparentInhibitionOfAmyloidFribril(biosim.BioModule):
    """BioModule wrapper for SBML model: Martins2013 - True and apparent inhibition of amyloid fribril formation."""

    def __init__(self, model_path: str = "data/BIOMD0000000561.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Martins2013TrueAndApparentInhibitionOfAmylBiomd0000000561Model = SbmlMartins2013TrueAndApparentInhibitionOfAmyloidFribril
