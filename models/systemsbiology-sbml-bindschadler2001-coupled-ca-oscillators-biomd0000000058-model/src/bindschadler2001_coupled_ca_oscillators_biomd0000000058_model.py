...
"""Auto-generated SBML BioModule wrapper for Bindschadler2001_coupled_Ca_oscillators.

Source: biomodels_ebi:BIOMD0000000058
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000058
"""
...
class SbmlBindschadler2001CoupledCaOscillators(biosim.BioModule):
    """BioModule wrapper for SBML model: Bindschadler2001_coupled_Ca_oscillators."""

    def __init__(self, model_path: str = "data/BIOMD0000000058.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bindschadler2001CoupledCaOscillatorsBiomd0000000058Model = SbmlBindschadler2001CoupledCaOscillators
