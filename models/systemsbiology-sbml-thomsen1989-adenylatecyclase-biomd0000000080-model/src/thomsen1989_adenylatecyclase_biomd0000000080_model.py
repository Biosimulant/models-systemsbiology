...
"""Auto-generated SBML BioModule wrapper for Thomsen1989_AdenylateCyclase.

Source: biomodels_ebi:BIOMD0000000080
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000080
"""
...
class SbmlThomsen1989Adenylatecyclase(biosim.BioModule):
    """BioModule wrapper for SBML model: Thomsen1989_AdenylateCyclase."""

    def __init__(self, model_path: str = "data/BIOMD0000000080.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Thomsen1989AdenylatecyclaseBiomd0000000080Model = SbmlThomsen1989Adenylatecyclase
