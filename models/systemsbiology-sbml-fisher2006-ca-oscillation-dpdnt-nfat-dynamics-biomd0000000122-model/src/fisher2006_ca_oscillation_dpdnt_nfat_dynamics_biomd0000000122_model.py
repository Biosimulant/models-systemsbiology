...
"""Auto-generated SBML BioModule wrapper for Fisher2006_Ca_Oscillation_dpdnt_NFAT_dynamics.

Source: biomodels_ebi:BIOMD0000000122
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000122
"""
...
class SbmlFisher2006CaOscillationDpdntNfatDynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Fisher2006_Ca_Oscillation_dpdnt_NFAT_dynamics."""

    def __init__(self, model_path: str = "data/BIOMD0000000122.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fisher2006CaOscillationDpdntNfatDynamicsBiomd0000000122Model = SbmlFisher2006CaOscillationDpdntNfatDynamics
