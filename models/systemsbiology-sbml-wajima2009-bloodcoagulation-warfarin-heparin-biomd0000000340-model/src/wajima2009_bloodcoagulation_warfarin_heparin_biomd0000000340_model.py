...
"""Auto-generated SBML BioModule wrapper for Wajima2009_BloodCoagulation_warfarin_heparin.

Source: biomodels_ebi:BIOMD0000000340
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000340
"""
...
class SbmlWajima2009BloodcoagulationWarfarinHeparin(biosim.BioModule):
    """BioModule wrapper for SBML model: Wajima2009_BloodCoagulation_warfarin_heparin."""

    def __init__(self, model_path: str = "data/BIOMD0000000340.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wajima2009BloodcoagulationWarfarinHeparinBiomd0000000340Model = SbmlWajima2009BloodcoagulationWarfarinHeparin
