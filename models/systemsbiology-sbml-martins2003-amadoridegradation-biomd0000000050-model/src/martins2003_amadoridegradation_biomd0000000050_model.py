...
"""Auto-generated SBML BioModule wrapper for Martins2003_AmadoriDegradation.

Source: biomodels_ebi:BIOMD0000000050
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000050
"""
...
class SbmlMartins2003Amadoridegradation(biosim.BioModule):
    """BioModule wrapper for SBML model: Martins2003_AmadoriDegradation."""

    def __init__(self, model_path: str = "data/BIOMD0000000050.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Martins2003AmadoridegradationBiomd0000000050Model = SbmlMartins2003Amadoridegradation
