...
"""Auto-generated SBML BioModule wrapper for Ratushny2012_ASSURE_I.

Source: biomodels_ebi:BIOMD0000000420
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000420
"""
...
class SbmlRatushny2012AssureI(biosim.BioModule):
    """BioModule wrapper for SBML model: Ratushny2012_ASSURE_I."""

    def __init__(self, model_path: str = "data/BIOMD0000000420.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ratushny2012AssureIBiomd0000000420Model = SbmlRatushny2012AssureI
