...
"""Auto-generated SBML BioModule wrapper for Bungay2006_FollicularFluid.

Source: biomodels_ebi:BIOMD0000000333
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000333
"""
...
class SbmlBungay2006Follicularfluid(biosim.BioModule):
    """BioModule wrapper for SBML model: Bungay2006_FollicularFluid."""

    def __init__(self, model_path: str = "data/BIOMD0000000333.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Bungay2006FollicularfluidBiomd0000000333Model = SbmlBungay2006Follicularfluid
