...
"""Auto-generated SBML BioModule wrapper for Akhtar2025 - Pancreatic beta-cell turnover.

Source: biomodels_ebi:MODEL2503030004
Original: https://www.ebi.ac.uk/biomodels/MODEL2503030004
"""
...
class SbmlAkhtar2025PancreaticBetaCellTurnover(biosim.BioModule):
    """BioModule wrapper for SBML model: Akhtar2025 - Pancreatic beta-cell turnover."""

    def __init__(self, model_path: str = "data/MODEL2503030004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Akhtar2025PancreaticBetaCellTurnoverModel2503030004Model = SbmlAkhtar2025PancreaticBetaCellTurnover
