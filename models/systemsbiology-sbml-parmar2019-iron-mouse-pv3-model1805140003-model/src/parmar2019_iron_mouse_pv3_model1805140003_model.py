...
"""Auto-generated SBML BioModule wrapper for Parmar2019 - Iron Mouse PV3.

Source: biomodels_ebi:MODEL1805140003
Original: https://www.ebi.ac.uk/biomodels/MODEL1805140003
"""
...
class SbmlParmar2019IronMousePv3(biosim.BioModule):
    """BioModule wrapper for SBML model: Parmar2019 - Iron Mouse PV3."""

    def __init__(self, model_path: str = "data/MODEL1805140003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Parmar2019IronMousePv3Model1805140003Model = SbmlParmar2019IronMousePv3
