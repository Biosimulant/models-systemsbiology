...
"""Auto-generated SBML BioModule wrapper for Nielsen1998_Glycolysis.

Source: biomodels_ebi:BIOMD0000000042
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000042
"""
...
class SbmlNielsen1998Glycolysis(biosim.BioModule):
    """BioModule wrapper for SBML model: Nielsen1998_Glycolysis."""

    def __init__(self, model_path: str = "data/BIOMD0000000042.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nielsen1998GlycolysisBiomd0000000042Model = SbmlNielsen1998Glycolysis
