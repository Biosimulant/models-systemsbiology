...
"""Auto-generated SBML BioModule wrapper for Siebert2008_MuscleContraction_CCSEC.

Source: biomodels_ebi:MODEL1006230120
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230120
"""
...
class SbmlSiebert2008MusclecontractionCcsec(biosim.BioModule):
    """BioModule wrapper for SBML model: Siebert2008_MuscleContraction_CCSEC."""

    def __init__(self, model_path: str = "data/MODEL1006230120.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Siebert2008MusclecontractionCcsecModel1006230120Model = SbmlSiebert2008MusclecontractionCcsec
