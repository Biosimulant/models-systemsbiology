...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_S-par-8mMCD).

Source: biomodels_ebi:MODEL1907260013
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260013
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoSPar8mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_S-par-8mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260013.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoSModel1907260013Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoSPar8mmcd
