...
"""Auto-generated SBML BioModule wrapper for Banaji2005_Brain_Cell_Metabolism.

Source: biomodels_ebi:MODEL4992089662
Original: https://www.ebi.ac.uk/biomodels/MODEL4992089662
"""
...
class SbmlBanaji2005BrainCellMetabolism(biosim.BioModule):
    """BioModule wrapper for SBML model: Banaji2005_Brain_Cell_Metabolism."""

    def __init__(self, model_path: str = "data/MODEL4992089662.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Banaji2005BrainCellMetabolismModel4992089662Model = SbmlBanaji2005BrainCellMetabolism
