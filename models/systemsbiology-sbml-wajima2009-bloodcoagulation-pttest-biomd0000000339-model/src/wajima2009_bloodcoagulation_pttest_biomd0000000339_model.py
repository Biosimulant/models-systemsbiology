...
"""Auto-generated SBML BioModule wrapper for Wajima2009_BloodCoagulation_PTtest.

Source: biomodels_ebi:BIOMD0000000339
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000339
"""
...
class SbmlWajima2009BloodcoagulationPttest(biosim.BioModule):
    """BioModule wrapper for SBML model: Wajima2009_BloodCoagulation_PTtest."""

    def __init__(self, model_path: str = "data/BIOMD0000000339.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wajima2009BloodcoagulationPttestBiomd0000000339Model = SbmlWajima2009BloodcoagulationPttest
