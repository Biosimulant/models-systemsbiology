...
"""Auto-generated SBML BioModule wrapper for Hinch2004_VentricularMyocytes.

Source: biomodels_ebi:MODEL0848342500
Original: https://www.ebi.ac.uk/biomodels/MODEL0848342500
"""
...
class SbmlHinch2004Ventricularmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Hinch2004_VentricularMyocytes."""

    def __init__(self, model_path: str = "data/MODEL0848342500.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hinch2004VentricularmyocytesModel0848342500Model = SbmlHinch2004Ventricularmyocytes
