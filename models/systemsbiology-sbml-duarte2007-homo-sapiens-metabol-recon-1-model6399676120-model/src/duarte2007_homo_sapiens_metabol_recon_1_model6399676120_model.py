...
"""Auto-generated SBML BioModule wrapper for Duarte2007_Homo_sapiens_Metabol_Recon_1.

Source: biomodels_ebi:MODEL6399676120
Original: https://www.ebi.ac.uk/biomodels/MODEL6399676120
"""
...
class SbmlDuarte2007HomoSapiensMetabolRecon1(biosim.BioModule):
    """BioModule wrapper for SBML model: Duarte2007_Homo_sapiens_Metabol_Recon_1."""

    def __init__(self, model_path: str = "data/MODEL6399676120.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Duarte2007HomoSapiensMetabolRecon1Model6399676120Model = SbmlDuarte2007HomoSapiensMetabolRecon1
