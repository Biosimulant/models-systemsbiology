...
"""Auto-generated SBML BioModule wrapper for Viertel2019 - A Computational model of the mammalian external tufted cell.

Source: biomodels_ebi:BIOMD0000000844
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000844
"""
...
class SbmlViertel2019AComputationalModelOfTheMammalianExternal(biosim.BioModule):
    """BioModule wrapper for SBML model: Viertel2019 - A Computational model of the mammalian external tufted cell."""

    def __init__(self, model_path: str = "data/BIOMD0000000844.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Viertel2019AComputationalModelOfTheMammaliBiomd0000000844Model = SbmlViertel2019AComputationalModelOfTheMammalianExternal
