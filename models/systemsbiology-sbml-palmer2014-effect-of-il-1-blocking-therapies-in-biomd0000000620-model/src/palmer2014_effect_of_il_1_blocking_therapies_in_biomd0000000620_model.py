...
"""Auto-generated SBML BioModule wrapper for Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Disease Condition.

Source: biomodels_ebi:BIOMD0000000620
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000620
"""
...
class SbmlPalmer2014EffectOfIl1BlockingTherapiesInT2dm(biosim.BioModule):
    """BioModule wrapper for SBML model: Palmer2014 - Effect of IL-1β-Blocking therapies in T2DM - Disease Condition."""

    def __init__(self, model_path: str = "data/BIOMD0000000620.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Palmer2014EffectOfIl1BlockingTherapiesInBiomd0000000620Model = SbmlPalmer2014EffectOfIl1BlockingTherapiesInT2dm
