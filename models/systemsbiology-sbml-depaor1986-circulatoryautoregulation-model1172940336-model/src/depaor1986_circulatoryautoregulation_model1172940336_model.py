...
"""Auto-generated SBML BioModule wrapper for DePaor1986_CirculatoryAutoregulation.

Source: biomodels_ebi:MODEL1172940336
Original: https://www.ebi.ac.uk/biomodels/MODEL1172940336
"""
...
class SbmlDepaor1986Circulatoryautoregulation(biosim.BioModule):
    """BioModule wrapper for SBML model: DePaor1986_CirculatoryAutoregulation."""

    def __init__(self, model_path: str = "data/MODEL1172940336.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Depaor1986CirculatoryautoregulationModel1172940336Model = SbmlDepaor1986Circulatoryautoregulation
