...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1172940336)
**Standard**: sbml
**Authors**: Annraoi M. De Paor; Patrick Timmons
...
models:
  - path: ../../models/systemsbiology-sbml-depaor1986-circulatoryautoregulation-model1172940336-model
    alias: model
```
