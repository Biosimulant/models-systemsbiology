...
"""Auto-generated SBML BioModule wrapper for Ataullahkhanov1996_Adenylate.

Source: biomodels_ebi:BIOMD0000000054
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000054
"""
...
class SbmlAtaullahkhanov1996Adenylate(biosim.BioModule):
    """BioModule wrapper for SBML model: Ataullahkhanov1996_Adenylate."""

    def __init__(self, model_path: str = "data/BIOMD0000000054.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Ataullahkhanov1996AdenylateBiomd0000000054Model = SbmlAtaullahkhanov1996Adenylate
