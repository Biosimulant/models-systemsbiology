...
"""Auto-generated SBML BioModule wrapper for Zatorsky2006_p53_Model4.

Source: biomodels_ebi:BIOMD0000000157
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000157
"""
...
class SbmlZatorsky2006P53Model4(biosim.BioModule):
    """BioModule wrapper for SBML model: Zatorsky2006_p53_Model4."""

    def __init__(self, model_path: str = "data/BIOMD0000000157.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zatorsky2006P53Model4Biomd0000000157Model = SbmlZatorsky2006P53Model4
