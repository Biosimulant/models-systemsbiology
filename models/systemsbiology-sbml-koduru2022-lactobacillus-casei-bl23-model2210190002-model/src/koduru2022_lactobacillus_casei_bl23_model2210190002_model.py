...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Lactobacillus casei BL23.

Source: biomodels_ebi:MODEL2210190002
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190002
"""
...
class SbmlKoduru2022LactobacillusCaseiBl23(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Lactobacillus casei BL23."""

    def __init__(self, model_path: str = "data/MODEL2210190002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LactobacillusCaseiBl23Model2210190002Model = SbmlKoduru2022LactobacillusCaseiBl23
