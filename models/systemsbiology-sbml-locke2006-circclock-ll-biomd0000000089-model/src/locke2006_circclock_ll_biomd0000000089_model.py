...
"""Auto-generated SBML BioModule wrapper for Locke2006_CircClock_LL.

Source: biomodels_ebi:BIOMD0000000089
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000089
"""
...
class SbmlLocke2006CircclockLl(biosim.BioModule):
    """BioModule wrapper for SBML model: Locke2006_CircClock_LL."""

    def __init__(self, model_path: str = "data/BIOMD0000000089.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Locke2006CircclockLlBiomd0000000089Model = SbmlLocke2006CircclockLl
