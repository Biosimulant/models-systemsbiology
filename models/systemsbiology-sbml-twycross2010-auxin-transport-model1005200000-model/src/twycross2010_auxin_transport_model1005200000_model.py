...
"""Auto-generated SBML BioModule wrapper for Twycross2010_Auxin_Transport.

Source: biomodels_ebi:MODEL1005200000
Original: https://www.ebi.ac.uk/biomodels/MODEL1005200000
"""
...
class SbmlTwycross2010AuxinTransport(biosim.BioModule):
    """BioModule wrapper for SBML model: Twycross2010_Auxin_Transport."""

    def __init__(self, model_path: str = "data/MODEL1005200000.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Twycross2010AuxinTransportModel1005200000Model = SbmlTwycross2010AuxinTransport
