...
"""Auto-generated SBML BioModule wrapper for Clarke2006_Smad_signalling.

Source: biomodels_ebi:BIOMD0000000112
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000112
"""
...
class SbmlClarke2006SmadSignalling(biosim.BioModule):
    """BioModule wrapper for SBML model: Clarke2006_Smad_signalling."""

    def __init__(self, model_path: str = "data/BIOMD0000000112.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Clarke2006SmadSignallingBiomd0000000112Model = SbmlClarke2006SmadSignalling
