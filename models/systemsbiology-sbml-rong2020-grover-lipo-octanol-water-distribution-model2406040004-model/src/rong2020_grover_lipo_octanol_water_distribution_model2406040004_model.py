...
"""Auto-generated SBML BioModule wrapper for Rong2020 - Grover-Lipo: Octanol/water distribution coefficient.

Source: biomodels_ebi:MODEL2406040004
Original: https://www.ebi.ac.uk/biomodels/MODEL2406040004
"""
...
class SbmlRong2020GroverLipoOctanolWaterDistributionCoefficient(biosim.BioModule):
    """BioModule wrapper for SBML model: Rong2020 - Grover-Lipo: Octanol/water distribution coefficient."""

    def __init__(self, model_path: str = "data/MODEL2406040004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Rong2020GroverLipoOctanolWaterDistributionModel2406040004Model = SbmlRong2020GroverLipoOctanolWaterDistributionCoefficient
