...
"""Auto-generated SBML BioModule wrapper for Tsirvouli2023 - PsoriaSys model: a multiscale psoriasis model.

Source: biomodels_ebi:MODEL2308300001
Original: https://www.ebi.ac.uk/biomodels/MODEL2308300001
"""
...
class SbmlTsirvouli2023PsoriasysModelAMultiscalePsoriasisModel(biosim.BioModule):
    """BioModule wrapper for SBML model: Tsirvouli2023 - PsoriaSys model: a multiscale psoriasis model."""

    def __init__(self, model_path: str = "data/MODEL2308300001.sbml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tsirvouli2023PsoriasysModelAMultiscalePsoriModel2308300001Model = SbmlTsirvouli2023PsoriasysModelAMultiscalePsoriasisModel
