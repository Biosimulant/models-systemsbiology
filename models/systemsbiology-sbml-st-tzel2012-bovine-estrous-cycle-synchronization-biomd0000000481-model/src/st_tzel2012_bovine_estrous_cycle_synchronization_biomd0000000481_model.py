...
"""Auto-generated SBML BioModule wrapper for Stötzel2012 - Bovine estrous cycle, synchronization with prostaglandin F2α.

Source: biomodels_ebi:BIOMD0000000481
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000481
"""
...
class SbmlStotzel2012BovineEstrousCycleSynchronizationWith(biosim.BioModule):
    """BioModule wrapper for SBML model: Stötzel2012 - Bovine estrous cycle, synchronization with prostaglandin F2α."""

    def __init__(self, model_path: str = "data/BIOMD0000000481.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
StTzel2012BovineEstrousCycleSynchronizationBiomd0000000481Model = SbmlStotzel2012BovineEstrousCycleSynchronizationWith
