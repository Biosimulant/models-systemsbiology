...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedback By Micro RNA).

Source: biomodels_ebi:BIOMD0000000862
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000862
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Positive Feedback By Micro RNA)."""

    def __init__(self, model_path: str = "data/BIOMD0000000862.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisBiomd0000000862Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisPositive
