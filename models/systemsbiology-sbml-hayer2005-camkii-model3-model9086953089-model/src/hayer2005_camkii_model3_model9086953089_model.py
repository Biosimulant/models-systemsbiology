...
"""Auto-generated SBML BioModule wrapper for Hayer2005_CaMKII_model3.

Source: biomodels_ebi:MODEL9086953089
Original: https://www.ebi.ac.uk/biomodels/MODEL9086953089
"""
...
class SbmlHayer2005CamkiiModel3(biosim.BioModule):
    """BioModule wrapper for SBML model: Hayer2005_CaMKII_model3."""

    def __init__(self, model_path: str = "data/MODEL9086953089.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hayer2005CamkiiModel3Model9086953089Model = SbmlHayer2005CamkiiModel3
