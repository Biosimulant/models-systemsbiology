...
"""Auto-generated SBML BioModule wrapper for Koduru2022 - Leuconostoc mesenteroides subsp. mesenteroides ATCC 8293.

Source: biomodels_ebi:MODEL2210190012
Original: https://www.ebi.ac.uk/biomodels/MODEL2210190012
"""
...
class SbmlKoduru2022LeuconostocMesenteroidesSubspMesenteroides(biosim.BioModule):
    """BioModule wrapper for SBML model: Koduru2022 - Leuconostoc mesenteroides subsp. mesenteroides ATCC 8293."""

    def __init__(self, model_path: str = "data/MODEL2210190012.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Koduru2022LeuconostocMesenteroidesSubspMesenModel2210190012Model = SbmlKoduru2022LeuconostocMesenteroidesSubspMesenteroides
