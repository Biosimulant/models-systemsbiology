...
"""Auto-generated SBML BioModule wrapper for Sharan2014 - model of anti-VEGF agents to investigate circulating angiogenic factor modulation.

Source: biomodels_ebi:MODEL1604270003
Original: https://www.ebi.ac.uk/biomodels/MODEL1604270003
"""
...
class SbmlSharan2014ModelOfAntiVegfAgentsToInvestigate(biosim.BioModule):
    """BioModule wrapper for SBML model: Sharan2014 - model of anti-VEGF agents to investigate circulating angiogenic factor modulation."""

    def __init__(self, model_path: str = "data/MODEL1604270003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sharan2014ModelOfAntiVegfAgentsToInvestigModel1604270003Model = SbmlSharan2014ModelOfAntiVegfAgentsToInvestigate
