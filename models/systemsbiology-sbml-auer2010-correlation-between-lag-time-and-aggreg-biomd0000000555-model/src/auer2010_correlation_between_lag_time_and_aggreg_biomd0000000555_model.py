...
"""Auto-generated SBML BioModule wrapper for Auer2010 - Correlation between lag time and aggregation rate in protein aggregation.

Source: biomodels_ebi:BIOMD0000000555
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000555
"""
...
class SbmlAuer2010CorrelationBetweenLagTimeAndAggregationRate(biosim.BioModule):
    """BioModule wrapper for SBML model: Auer2010 - Correlation between lag time and aggregation rate in protein aggregation."""

    def __init__(self, model_path: str = "data/BIOMD0000000555.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Auer2010CorrelationBetweenLagTimeAndAggregBiomd0000000555Model = SbmlAuer2010CorrelationBetweenLagTimeAndAggregationRate
