...
"""Auto-generated SBML BioModule wrapper for Fridlyand2003_Calcium_flux.

Source: biomodels_ebi:BIOMD0000000059
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000059
"""
...
class SbmlFridlyand2003CalciumFlux(biosim.BioModule):
    """BioModule wrapper for SBML model: Fridlyand2003_Calcium_flux."""

    def __init__(self, model_path: str = "data/BIOMD0000000059.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fridlyand2003CalciumFluxBiomd0000000059Model = SbmlFridlyand2003CalciumFlux
