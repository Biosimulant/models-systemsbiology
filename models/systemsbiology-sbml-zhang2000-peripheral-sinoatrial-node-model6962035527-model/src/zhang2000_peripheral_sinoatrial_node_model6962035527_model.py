...
"""Auto-generated SBML BioModule wrapper for Zhang2000_Peripheral_Sinoatrial_Node.

Source: biomodels_ebi:MODEL6962035527
Original: https://www.ebi.ac.uk/biomodels/MODEL6962035527
"""
...
class SbmlZhang2000PeripheralSinoatrialNode(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhang2000_Peripheral_Sinoatrial_Node."""

    def __init__(self, model_path: str = "data/MODEL6962035527.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhang2000PeripheralSinoatrialNodeModel6962035527Model = SbmlZhang2000PeripheralSinoatrialNode
