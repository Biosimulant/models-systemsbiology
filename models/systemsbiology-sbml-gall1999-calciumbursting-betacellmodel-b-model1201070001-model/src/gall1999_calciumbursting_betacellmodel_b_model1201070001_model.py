...
"""Auto-generated SBML BioModule wrapper for Gall1999_CalciumBursting_BetaCellModel_B.

Source: biomodels_ebi:MODEL1201070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1201070001
"""
...
class SbmlGall1999CalciumburstingBetacellmodelB(biosim.BioModule):
    """BioModule wrapper for SBML model: Gall1999_CalciumBursting_BetaCellModel_B."""

    def __init__(self, model_path: str = "data/MODEL1201070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gall1999CalciumburstingBetacellmodelBModel1201070001Model = SbmlGall1999CalciumburstingBetacellmodelB
