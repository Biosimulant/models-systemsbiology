...
"""Auto-generated SBML BioModule wrapper for Zhou2015 - Blood coagulation model predicting effects of factor Xa inhibitors.

Source: biomodels_ebi:MODEL1806070001
Original: https://www.ebi.ac.uk/biomodels/MODEL1806070001
"""
...
class SbmlZhou2015BloodCoagulationModelPredictingEffectsOf(biosim.BioModule):
    """BioModule wrapper for SBML model: Zhou2015 - Blood coagulation model predicting effects of factor Xa inhibitors."""

    def __init__(self, model_path: str = "data/MODEL1806070001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Zhou2015BloodCoagulationModelPredictingEffeModel1806070001Model = SbmlZhou2015BloodCoagulationModelPredictingEffectsOf
