...
"""Auto-generated SBML BioModule wrapper for Liu2011_Complement_System.

Source: biomodels_ebi:BIOMD0000000303
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000303
"""
...
class SbmlLiu2011ComplementSystem(biosim.BioModule):
    """BioModule wrapper for SBML model: Liu2011_Complement_System."""

    def __init__(self, model_path: str = "data/BIOMD0000000303.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Liu2011ComplementSystemBiomd0000000303Model = SbmlLiu2011ComplementSystem
