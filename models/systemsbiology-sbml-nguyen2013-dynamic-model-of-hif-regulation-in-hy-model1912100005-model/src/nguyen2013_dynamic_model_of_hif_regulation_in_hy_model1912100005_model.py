...
"""Auto-generated SBML BioModule wrapper for Nguyen2013 - Dynamic model of HIF regulation in hypoxia (reduced model).

Source: biomodels_ebi:MODEL1912100005
Original: https://www.ebi.ac.uk/biomodels/MODEL1912100005
"""
...
class SbmlNguyen2013DynamicModelOfHifRegulationInHypoxia2(biosim.BioModule):
    """BioModule wrapper for SBML model: Nguyen2013 - Dynamic model of HIF regulation in hypoxia (reduced model)."""

    def __init__(self, model_path: str = "data/MODEL1912100005.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nguyen2013DynamicModelOfHifRegulationInHyModel1912100005Model = SbmlNguyen2013DynamicModelOfHifRegulationInHypoxia2
