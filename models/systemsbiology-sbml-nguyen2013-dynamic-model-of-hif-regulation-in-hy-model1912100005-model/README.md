...
**Source**: [biomodels_ebi](https://www.ebi.ac.uk/biomodels/MODEL1912100005)
**Standard**: sbml
...
models:
  - path: ../../models/systemsbiology-sbml-nguyen2013-dynamic-model-of-hif-regulation-in-hy-model1912100005-model
    alias: model
```
