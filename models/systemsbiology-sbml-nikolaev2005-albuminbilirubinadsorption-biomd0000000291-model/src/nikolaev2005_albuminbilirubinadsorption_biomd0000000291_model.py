...
"""Auto-generated SBML BioModule wrapper for Nikolaev2005_AlbuminBilirubinAdsorption.

Source: biomodels_ebi:BIOMD0000000291
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000291
"""
...
class SbmlNikolaev2005Albuminbilirubinadsorption(biosim.BioModule):
    """BioModule wrapper for SBML model: Nikolaev2005_AlbuminBilirubinAdsorption."""

    def __init__(self, model_path: str = "data/BIOMD0000000291.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Nikolaev2005AlbuminbilirubinadsorptionBiomd0000000291Model = SbmlNikolaev2005Albuminbilirubinadsorption
