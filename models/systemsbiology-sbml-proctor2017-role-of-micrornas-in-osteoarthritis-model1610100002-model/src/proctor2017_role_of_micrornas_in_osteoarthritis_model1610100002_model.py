...
"""Auto-generated SBML BioModule wrapper for Proctor2017- Role of microRNAs in osteoarthritis (Negative Feedback By MicroRNA with Delay).

Source: biomodels_ebi:MODEL1610100002
Original: https://www.ebi.ac.uk/biomodels/MODEL1610100002
"""
...
class SbmlProctor2017RoleOfMicrornasInOsteoarthritisNegative2(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2017- Role of microRNAs in osteoarthritis (Negative Feedback By MicroRNA with Delay)."""

    def __init__(self, model_path: str = "data/MODEL1610100002.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2017RoleOfMicrornasInOsteoarthritisModel1610100002Model = SbmlProctor2017RoleOfMicrornasInOsteoarthritisNegative2
