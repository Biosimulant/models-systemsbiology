...
"""Auto-generated SBML BioModule wrapper for Boehm2014 - isoform-specific dimerization of pSTAT5A and pSTAT5B.

Source: biomodels_ebi:BIOMD0000000591
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000591
"""
...
class SbmlBoehm2014IsoformSpecificDimerizationOfPstat5aAnd(biosim.BioModule):
    """BioModule wrapper for SBML model: Boehm2014 - isoform-specific dimerization of pSTAT5A and pSTAT5B."""

    def __init__(self, model_path: str = "data/BIOMD0000000591.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Boehm2014IsoformSpecificDimerizationOfPstatBiomd0000000591Model = SbmlBoehm2014IsoformSpecificDimerizationOfPstat5aAnd
