...
"""Auto-generated SBML BioModule wrapper for VanTol2020 - Thalassiosira pseudonana CCMP 1335 GEM, acclimated to medium light intensity.

Source: biomodels_ebi:MODEL2010230001
Original: https://www.ebi.ac.uk/biomodels/MODEL2010230001
"""
...
class SbmlVantol2020ThalassiosiraPseudonanaCcmp1335Gem(biosim.BioModule):
    """BioModule wrapper for SBML model: VanTol2020 - Thalassiosira pseudonana CCMP 1335 GEM, acclimated to medium light intensity."""

    def __init__(self, model_path: str = "data/MODEL2010230001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Vantol2020ThalassiosiraPseudonanaCcmp1335GeModel2010230001Model = SbmlVantol2020ThalassiosiraPseudonanaCcmp1335Gem
