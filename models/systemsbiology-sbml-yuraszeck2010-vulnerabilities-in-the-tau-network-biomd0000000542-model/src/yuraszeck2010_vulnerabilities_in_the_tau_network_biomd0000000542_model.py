...
"""Auto-generated SBML BioModule wrapper for Yuraszeck2010 - Vulnerabilities in the Tau Network in Tau Pathophysiology.

Source: biomodels_ebi:BIOMD0000000542
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000542
"""
...
class SbmlYuraszeck2010VulnerabilitiesInTheTauNetworkInTau(biosim.BioModule):
    """BioModule wrapper for SBML model: Yuraszeck2010 - Vulnerabilities in the Tau Network in Tau Pathophysiology."""

    def __init__(self, model_path: str = "data/BIOMD0000000542.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yuraszeck2010VulnerabilitiesInTheTauNetworkBiomd0000000542Model = SbmlYuraszeck2010VulnerabilitiesInTheTauNetworkInTau
