...
"""Auto-generated SBML BioModule wrapper for Wodarz1999 CTL memory response HIV.

Source: biomodels_ebi:BIOMD0000000683
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000683
"""
...
class SbmlWodarz1999CtlMemoryResponseHiv(biosim.BioModule):
    """BioModule wrapper for SBML model: Wodarz1999 CTL memory response HIV."""

    def __init__(self, model_path: str = "data/BIOMD0000000683.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Wodarz1999CtlMemoryResponseHivBiomd0000000683Model = SbmlWodarz1999CtlMemoryResponseHiv
