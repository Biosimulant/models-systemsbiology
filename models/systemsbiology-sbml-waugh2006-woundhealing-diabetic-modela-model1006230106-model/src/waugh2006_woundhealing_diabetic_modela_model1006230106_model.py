...
"""Auto-generated SBML BioModule wrapper for Waugh2006_WoundHealing_Diabetic_ModelA.

Source: biomodels_ebi:MODEL1006230106
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230106
"""
...
class SbmlWaugh2006WoundhealingDiabeticModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Waugh2006_WoundHealing_Diabetic_ModelA."""

    def __init__(self, model_path: str = "data/MODEL1006230106.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Waugh2006WoundhealingDiabeticModelaModel1006230106Model = SbmlWaugh2006WoundhealingDiabeticModela
