...
"""Auto-generated SBML BioModule wrapper for Szeliova 2020 - biomass specific iCHO model (iCHO_HYher-8mMCD).

Source: biomodels_ebi:MODEL1907260004
Original: https://www.ebi.ac.uk/biomodels/MODEL1907260004
"""
...
class SbmlSzeliova2020BiomassSpecificIchoModelIchoHyher8mmcd(biosim.BioModule):
    """BioModule wrapper for SBML model: Szeliova 2020 - biomass specific iCHO model (iCHO_HYher-8mMCD)."""

    def __init__(self, model_path: str = "data/MODEL1907260004.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Szeliova2020BiomassSpecificIchoModelIchoHModel1907260004Model = SbmlSzeliova2020BiomassSpecificIchoModelIchoHyher8mmcd
