...
"""Auto-generated SBML BioModule wrapper for Proctor2007 - Age related decline of proteolysis, ubiquitin-proteome system.

Source: biomodels_ebi:BIOMD0000000105
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000105
"""
...
class SbmlProctor2007AgeRelatedDeclineOfProteolysisUbiquitin(biosim.BioModule):
    """BioModule wrapper for SBML model: Proctor2007 - Age related decline of proteolysis, ubiquitin-proteome system."""

    def __init__(self, model_path: str = "data/BIOMD0000000105.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Proctor2007AgeRelatedDeclineOfProteolysisUBiomd0000000105Model = SbmlProctor2007AgeRelatedDeclineOfProteolysisUbiquitin
